import { AppMobTreeModel, Errorlog } from 'ibiz-vue';
import { ControlServiceBase, ModelTool, Util, ModelParser } from 'ibiz-core';
 ...
 */
export class AppMobTreeService extends ControlServiceBase {
    /**
     * 移动端树视图部件实例对象
     *
     * @memberof MainModel
    ...
    public async initServiceParam(opts: any) {
        ...
        this.model = new AppMobTreeModel(opts);
        // todo加载每个节点需要的服务
    }
