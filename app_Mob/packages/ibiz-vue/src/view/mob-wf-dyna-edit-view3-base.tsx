...
import { MobWFDynaEditViewEngine, Util, ModelTool, GetModelService, AppModelService, LogUtil } from 'ibiz-core';
        ...
        if (this.deDRTabPages && this.deDRTabPages.length > 0) {
            ...
            return (
                <van-tabs 
                    ...
                    <van-tab tab={tabsName} title={this.drtabInstance.M?.editItemCaption ? this.drtabInstance.M?.editItemCaption : this.editFormInstance.logicName}>
                            ...
                            <van-tab tab={tabsName} title={this.$tl(deDRTabPage.getCapPSLanguageRes()?.lanResTag, deDRTabPage.caption)}>
                                { this.$createElement('app-view-shell', {
                                    props: {
                                        ...
                                        dynamicProps: {
                                           _context: JSON.stringify(Object.assign(tempContext, { viewpath: deDRTabPage?.M?.getPSAppView?.path })),
