 ...
 * @extends {AuthService}
 */
export class IbzReportAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzReportAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Mob/PSAPPDATAENTITIES/IbzReport.json";

    /**
     * Creates an instance of  IbzReportAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzReportAuthServiceBase
     */
