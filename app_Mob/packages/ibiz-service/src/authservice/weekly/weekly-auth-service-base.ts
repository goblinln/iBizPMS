 ...
 *
 * @export
 * @class WeeklyAuthServiceBase
 * @extends {AuthService}
 */
export class WeeklyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof WeeklyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Mob/PSAPPDATAENTITIES/Weekly.json";

    /**
     * Creates an instance of  WeeklyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  WeeklyAuthServiceBase
     */
