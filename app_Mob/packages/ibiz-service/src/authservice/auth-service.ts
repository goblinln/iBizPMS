...
export class AuthService extends AuthServiceBase {
     ...
     */
    public defaultOPPrivs: any = {CREATE: 1,DAILY: 1,DELETE: 1,DENY: 1,DOC: 1,DOCLIB: 1,FILE: 1,MODULE: 1,MONTHLY: 1,NONE: 1,NOTOP: 1,READ: 1,REPORTLY: 1,SRFUR__ADMIN: 1,SRFUR__BUG_ACTIVATE_BUT: 1,SRFUR__BUG_ASSIGNTO_BUT: 1,SRFUR__BUG_CLOSE_BUT: 1,SRFUR__BUG_CONFIRM_BUT: 1,SRFUR__BUG_CREATECASE_BUT: 1,SRFUR__BUG_CREATE_BUT: 1,SRFUR__BUG_DELETE_BUT: 1,SRFUR__BUG_EDIT_BUT: 1,SRFUR__BUG_FAVOR_BUT: 1,SRFUR__BUG_NFAVOR_BUT: 1,SRFUR__BUG_RESOLVE_BUT: 1,SRFUR__BUG_TOSTORY_BUT: 1,SRFUR__BUG_UNLINK_BUT: 1,SRFUR__BUILD_CREATE_BUT: 1,SRFUR__BUILD_DELETE_BUT: 1,SRFUR__BUILD_EDIT_BUT: 1,SRFUR__BUILD_LINK_BUT: 1,SRFUR__BUILD_SUBT_BUT: 1,SRFUR__CASE_CASECOF_BUT: 1,SRFUR__CASE_CASERESULT_BUT: 1,SRFUR__CASE_CASERUN_BUT: 1,SRFUR__CASE_CASETOBUG_BUT: 1,SRFUR__CASE_CONFIRM_BUT: 1,SRFUR__CASE_CREATE_BUT: 1,SRFUR__CASE_DELETE_BUT: 1,SRFUR__CASE_EDIT_BUT: 1,SRFUR__CASE_FAVOR_BUT: 1,SRFUR__CASE_NFAVOR_BUT: 1,SRFUR__CASE_RESULT_BUT: 1,SRFUR__CASE_RUN_BUT: 1,SRFUR__CASE_TOBUG_BUT: 1,SRFUR__CASE_UNLINK_BUT: 1,SRFUR__CUTINTBEHAVIOR: 1,SRFUR__DAILY_SUBMIT_BUT: 1,SRFUR__DOCLIBMODULE_EDIT_BUT: 1,SRFUR__DOCLIBMODULE_FAVOUR_BUT: 1,SRFUR__DOCLIBMODULE_MAINTENANCE_BUT: 1,SRFUR__DOCLIBMODULE_NFAVOUR_BUT: 1,SRFUR__DOCLIB_EDIT_BUT: 1,SRFUR__DOCLIB_FAVOUR_BUT: 1,SRFUR__DOCLIB_NFAVOUR_BUT: 1,SRFUR__DOC_DELETE_BUT: 1,SRFUR__DOC_EDIT_BUT: 1,SRFUR__DOC_FAVOUR_BUT: 1,SRFUR__DOC_NFAVOUR_BUT: 1,SRFUR__FILE_DELETE_BUT: 1,SRFUR__FILE_DOWNLOAD_BUT: 1,SRFUR__LIBM_CREATE_BUT: 1,SRFUR__LIBM_EDIT_BUT: 1,SRFUR__LIBM_OPEN_BUT: 1,SRFUR__LIB_CREATE_BUT: 1,SRFUR__LIB_EDIT_BUT: 1,SRFUR__LIB_OPEN_BUT: 1,SRFUR__LICASE_CREATE_BUT: 1,SRFUR__LICASE_EDIT_BUT: 1,SRFUR__LICASE_OPEN_BUT: 1,SRFUR__MONTHLY_EDIT_BUT: 1,SRFUR__MONTHLY_SUBMIT_BUT: 1,SRFUR__PRODSTA_ADDPROD_BUT: 1,SRFUR__PRODSTA_PLANCRT_BUT: 1,SRFUR__PRODSTA_PROJCRT_BUT: 1,SRFUR__PRODSTA_RELCRT_BUT: 1,SRFUR__PRODSTA_STOREOP_BUT: 1,SRFUR__PRODSTA_STORYCRT_BUT: 1,SRFUR__PRODUCTLIN_BUT: 1,SRFUR__PRODUCT_MANAGER: 1,SRFUR__PROD_CLOSED_BUT: 1,SRFUR__PROD_CREATE_BUT: 1,SRFUR__PROD_DELETE_BUT: 1,SRFUR__PROD_EDIT_BUT: 1,SRFUR__PROD_UPDATE_BUT: 1,SRFUR__PROJECT_MANAGER: 1,SRFUR__PROJECT_REPORT_BUT: 1,SRFUR__PROJT_TM_BUT: 1,SRFUR__PROJ_ACTIVATION_BUT: 1,SRFUR__PROJ_CLOSED_BUT: 1,SRFUR__PROJ_CREATE_BUT: 1,SRFUR__PROJ_DELAY_BUT: 1,SRFUR__PROJ_DELETE_BUT: 1,SRFUR__PROJ_EDIT_BUT: 1,SRFUR__PROJ_MANAGE_BUT: 1,SRFUR__PROJ_START_BUT: 1,SRFUR__PROJ_SUSPEND_BUT: 1,SRFUR__PROP_CHILD_BUT: 1,SRFUR__PROP_CREATE_BUT: 1,SRFUR__PROP_DELETE_BUT: 1,SRFUR__PROP_EDIT_BUT: 1,SRFUR__PROP_LBUG_BUT: 1,SRFUR__PROP_LSTORY_BUT: 1,SRFUR__RELEASE_ACTIVE: 1,SRFUR__RELEASE_COMMON: 1,SRFUR__RELEASE_TERMINATE: 1,SRFUR__REPORTLY_EDIT_BUT: 1,SRFUR__REPORTLY_SUBMIT_BUT: 1,SRFUR__REPORT_CREATE_BUT: 1,SRFUR__REPORT_DELETE_BUT: 1,SRFUR__REPORT_EDIT_BUT: 1,SRFUR__STEP_CREATE_BUT: 1,SRFUR__STEP_EDIT_BUT: 1,SRFUR__STEP_OPEN_BUT: 1,SRFUR__STORY_ACTIVE_BUT: 1,SRFUR__STORY_ASS_BUT: 1,SRFUR__STORY_CCASE_BUT: 1,SRFUR__STORY_CHANGED_BUT: 1,SRFUR__STORY_CLOSED_BUT: 1,SRFUR__STORY_CREATE_BUT: 1,SRFUR__STORY_DELETE_BUT: 1,SRFUR__STORY_EDIT_BUT: 1,SRFUR__STORY_FAVOR_BUT: 1,SRFUR__STORY_FJTASK_BUT: 1,SRFUR__STORY_NFAVOR_BUT: 1,SRFUR__STORY_REVIEW_BUT: 1,SRFUR__STORY_UNLP_BUT: 1,SRFUR__STORY_XQXF_BUT: 1,SRFUR__TASK_ACTIVATION_BUT: 1,SRFUR__TASK_ASSIGN_BUT: 1,SRFUR__TASK_CANCEL_BUT: 1,SRFUR__TASK_CLOSE_BUT: 1,SRFUR__TASK_COMPLETE_BUT: 1,SRFUR__TASK_CONSUM_BUT: 1,SRFUR__TASK_CREATE_BUT: 1,SRFUR__TASK_DELETE_BUT: 1,SRFUR__TASK_EDIT_BUT: 1,SRFUR__TASK_FAVOR_BUT: 1,SRFUR__TASK_FORWARD_BUT: 1,SRFUR__TASK_NFAVOR_BUT: 1,SRFUR__TASK_PAUSE_BUT: 1,SRFUR__TASK_PROCEED_BUT: 1,SRFUR__TASK_START_BUT: 1,SRFUR__TASK_SUBTASKS_BUT: 1,SRFUR__TASK_XQCHANGE_BUT: 1,SRFUR__TESTMOD_FIX_BUT: 1,SRFUR__TESTMOD_OQCVIEW_BUT: 1,SRFUR__TESTSU_CREATE_BUT: 1,SRFUR__TESTSU_DELETE_BUT: 1,SRFUR__TESTSU_EDITSUITE_BUT: 1,SRFUR__TESTSU_LINKCASE_BUT: 1,SRFUR__TESTT_ACTIVITE_BUT: 1,SRFUR__TESTT_BLOCK_BUT: 1,SRFUR__TESTT_CLOSED_BUT: 1,SRFUR__TESTT_CREATE_BUT: 1,SRFUR__TESTT_DELETE_BUT: 1,SRFUR__TESTT_EDIT_BUT: 1,SRFUR__TESTT_LCASE_BUT: 1,SRFUR__TESTT_OPEN_BUT: 1,SRFUR__TESTT_START_BUT: 1,SRFUR__UNIVERSALCREATE: 1,SRFUR__UNIVERSALDELETE: 1,SRFUR__UNIVERSALEDIT: 1,SRFUR__UNIVERSALSAVE: 1,SRFUR__WEEKLY_NSUBMIT_BUT: 1,SRFUR__WEEKLY_SUBMIT_BUT: 1,TOP: 1,UPDATE: 1,WEEKLY: 1,WFSTART: 1}; 
    ...
    public registerSysOPPrivs(){
        ...
        this.sysOPPrivsMap.set('SRFUR__CASE_FAVOR_BUT','CASE_FAVOR_BUT');
        this.sysOPPrivsMap.set('SRFUR__CASE_NFAVOR_BUT','CASE_NFAVOR_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__DAILY_SUBMIT_BUT','DAILY_SUBMIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOCLIBMODULE_EDIT_BUT','DOCLIBMODULE_EDIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOCLIBMODULE_FAVOUR_BUT','DOCLIBMODULE_FAVOUR_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOCLIBMODULE_MAINTENANCE_BUT','DOCLIBMODULE_MAINTENANCE_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOCLIBMODULE_NFAVOUR_BUT','DOCLIBMODULE_NFAVOUR_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOCLIB_EDIT_BUT','DOCLIB_EDIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOCLIB_FAVOUR_BUT','DOCLIB_FAVOUR_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOCLIB_NFAVOUR_BUT','DOCLIB_NFAVOUR_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOC_DELETE_BUT','DOC_DELETE_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOC_EDIT_BUT','DOC_EDIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOC_FAVOUR_BUT','DOC_FAVOUR_BUT');
        this.sysOPPrivsMap.set('SRFUR__DOC_NFAVOUR_BUT','DOC_NFAVOUR_BUT');
        this.sysOPPrivsMap.set('SRFUR__FILE_DELETE_BUT','FILE_DELETE_BUT');
        this.sysOPPrivsMap.set('SRFUR__FILE_DOWNLOAD_BUT','FILE_DOWNLOAD_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__MONTHLY_EDIT_BUT','MONTHLY_EDIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__MONTHLY_SUBMIT_BUT','MONTHLY_SUBMIT_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__PRODUCTLIN_BUT','PRODUCTLIN_BUT');
        this.sysOPPrivsMap.set('SRFUR__PRODUCT_MANAGER','PRODUCT_MANAGER');
        ...
        this.sysOPPrivsMap.set('SRFUR__PROJECT_MANAGER','PROJECT_MANAGER');
        this.sysOPPrivsMap.set('SRFUR__PROJECT_REPORT_BUT','PROJECT_REPORT_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__REPORTLY_EDIT_BUT','REPORTLY_EDIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__REPORTLY_SUBMIT_BUT','REPORTLY_SUBMIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__REPORT_CREATE_BUT','REPORT_CREATE_BUT');
        this.sysOPPrivsMap.set('SRFUR__REPORT_DELETE_BUT','REPORT_DELETE_BUT');
        this.sysOPPrivsMap.set('SRFUR__REPORT_EDIT_BUT','REPORT_EDIT_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__STORY_XQXF_BUT','STORY_XQXF_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__TASK_CONSUM_BUT','TASK_CONSUM_BUT');
        this.sysOPPrivsMap.set('SRFUR__TASK_CREATE_BUT','TASK_CREATE_BUT');
        this.sysOPPrivsMap.set('SRFUR__TASK_DELETE_BUT','TASK_DELETE_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__TASK_XQCHANGE_BUT','TASK_XQCHANGE_BUT');
        ...
        this.sysOPPrivsMap.set('SRFUR__WEEKLY_NSUBMIT_BUT','WEEKLY_NSUBMIT_BUT');
        this.sysOPPrivsMap.set('SRFUR__WEEKLY_SUBMIT_BUT','WEEKLY_SUBMIT_BUT');
    }
