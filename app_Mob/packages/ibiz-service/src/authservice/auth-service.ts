...
export class AuthService extends AuthServiceBase {
    ...
    public registerSysOPPrivs(){
        ...
        this.sysOPPrivsMap.set('SRFUR__PROJ_LINKSTORY_BUT','PROJ_LINKSTORY_BUT');
