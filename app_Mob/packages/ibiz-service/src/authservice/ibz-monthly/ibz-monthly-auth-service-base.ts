 ...
 *
 * @export
 * @class IbzMonthlyAuthServiceBase
 * @extends {AuthService}
 */
export class IbzMonthlyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzMonthlyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Mob/PSAPPDATAENTITIES/IbzMonthly.json";

    /**
     * Creates an instance of  IbzMonthlyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzMonthlyAuthServiceBase
     */
