 ...
 *
 * @export
 * @class SysAccountAuthServiceBase
 * @extends {AuthService}
 */
export class SysAccountAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof SysAccountAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Mob/PSAPPDATAENTITIES/SysAccount.json";

    /**
     * Creates an instance of  SysAccountAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  SysAccountAuthServiceBase
     */
