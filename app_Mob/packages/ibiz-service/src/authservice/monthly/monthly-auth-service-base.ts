 ...
 *
 * @export
 * @class MonthlyAuthServiceBase
 * @extends {AuthService}
 */
export class MonthlyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof MonthlyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Mob/PSAPPDATAENTITIES/Monthly.json";

    /**
     * Creates an instance of  MonthlyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  MonthlyAuthServiceBase
     */
