 ...
 *
 * @export
 * @class EmployeeAuthServiceBase
 * @extends {AuthService}
 */
export class EmployeeAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof EmployeeAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Mob/PSAPPDATAENTITIES/Employee.json";

    /**
     * Creates an instance of  EmployeeAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  EmployeeAuthServiceBase
     */
