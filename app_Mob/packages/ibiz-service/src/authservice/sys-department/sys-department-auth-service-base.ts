 ...
 *
 * @export
 * @class SysDepartmentAuthServiceBase
 * @extends {AuthService}
 */
export class SysDepartmentAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof SysDepartmentAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Mob/PSAPPDATAENTITIES/SysDepartment.json";

    /**
     * Creates an instance of  SysDepartmentAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  SysDepartmentAuthServiceBase
     */
