...
import { IIbzReportly } from '../interface';
 ...
 * @export
 * @abstract
 * @class IbzReportlyBase
 * @extends {EntityBase}
 * @implements {IIbzReportly}
 */
export abstract class IbzReportlyBase extends EntityBase implements IIbzReportly {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IbzReportlyBase
     */
