...
import { IProductStats } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductStatsBase
 * @extends {EntityBase}
 * @implements {IProductStats}
 */
export abstract class ProductStatsBase extends EntityBase implements IProductStats {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductStatsBase
     */
