 ...
 * @implements {IAction}
 */
export abstract class ActionBase extends EntityBase implements IAction {
    /**
     * 实体名称
     *
     * @readonly
