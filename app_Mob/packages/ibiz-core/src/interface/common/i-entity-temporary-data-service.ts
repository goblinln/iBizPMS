...
export interface IEntityLocalDataService<T> {
     ...
     * @memberof EntityBaseService
     */
    GetDraft(context: IContext, params?: any): Promise<IHttpResponse>;
     ...
     * @memberof EntityBaseService
     */
    FetchDefault(context: IContext, params?: any): Promise<IHttpResponse>;
     ...
     * @memberof EntityBaseService
     */
    GetDraftTemp(context: IContext, params?: any): Promise<IHttpResponse>;
