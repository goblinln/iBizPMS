...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ibizpms-app-mob\/testtasks\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: getwflink");
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ibizpms-app-mob\/testtasks\/process-definitions-nodes$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: getwfstep");
    console.table({url:config.url, method: config.method, data:config.data});
    console.groupEnd();
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// Select
mock.onGet(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    ...
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
...
// Create
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Update
mock.onPut(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
...
// GetDraft
mock.onGet(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/getdraft$/)).reply((config: any) => {
...
// Activate
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/activate$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/activate$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Block
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/block$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/block$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// CheckKey
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Close
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/close$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/close$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// LinkCase
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/linkcase$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/linkcase$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// MobTestTaskCounter
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/mobtesttaskcounter$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: MobTestTaskCounter");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/mobtesttaskcounter$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// MobTestTaskCounter
mock.onPost(new RegExp(/^\/products\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/mobtesttaskcounter$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: MobTestTaskCounter");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/products\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/mobtesttaskcounter$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// MobTestTaskCounter
mock.onPost(new RegExp(/^\/testtasks\/?([a-zA-Z0-9\-\;]{0,35})\/mobtesttaskcounter$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: MobTestTaskCounter");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['id'];
    const matchArray:any = new RegExp(/^\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/mobtesttaskcounter$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Save
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/save$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/save$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Start
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/start$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/start$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// UnlinkCase
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/unlinkcase$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/unlinkcase$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// FetchDefault
mock.onGet(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/fetchdefault$/)).reply((config: any) => {
    ...
    const paramArray:Array<any> = ['id'];
    let tempValue: any = {};
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/fetchdefault$/).exec(config.url);
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
                enumerable: true,
...
// FetchMyTestTaskPc
mock.onGet(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FetchMyTestTaskPc");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
    ...
    const paramArray:Array<any> = ['id'];
    let tempValue: any = {};
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/fetchmytesttaskpc$/).exec(config.url);
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
                enumerable: true,
...
// FetchMyTestTaskPc
mock.onGet(new RegExp(/^\/products\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FetchMyTestTaskPc");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['id'];
    let tempValue: any = {};
    const matchArray:any = new RegExp(/^\/products\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/fetchmytesttaskpc$/).exec(config.url);
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
                enumerable: true,
...
// FetchMyTestTaskPc
mock.onGet(new RegExp(/^\/testtasks\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FetchMyTestTaskPc");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// FetchMyTestTaskPc
mock.onGet(new RegExp(/^\/testtasks\/fetchmytesttaskpc(\?[\w-./?%&=,]*)*$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FetchMyTestTaskPc");
    console.table({url:config.url, method: config.method, data:config.data});
    if(config.url.includes('page')){
        let url = config.url.split('?')[1];
...
// GetUserConcat
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: GetUserConcat");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// GetUserConcat
mock.onPost(new RegExp(/^\/products\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: GetUserConcat");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['id','id'];
    const matchArray:any = new RegExp(/^\/products\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// GetUserConcat
mock.onPost(new RegExp(/^\/testtasks\/?([a-zA-Z0-9\-\;]{0,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: GetUserConcat");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['id'];
    const matchArray:any = new RegExp(/^\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// FilterUpdate
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FilterUpdate");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
...
// FilterSearch
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FilterSearch");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
...
// FilterGet
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FilterGet");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
...
// FilterCreate
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FilterCreate");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
...
// FilterGetDraft
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FilterGetDraft");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
...
// FilterRemove
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FilterRemove");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
...
// FilterFetch
mock.onPost(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})\/fetchmytesttaskpc$/)).reply((config: any) => {
    console.groupCollapsed("实体:testtask 方法: FilterFetch");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
        return [status, null];
...
// Remove
mock.onDelete(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
...
// Get
mock.onGet(new RegExp(/^\/projects\/([a-zA-Z0-9\-\;]{1,35})\/testtasks\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
