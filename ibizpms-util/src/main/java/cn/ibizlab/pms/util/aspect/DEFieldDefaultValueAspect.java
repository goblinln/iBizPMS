...
public class DEFieldDefaultValueAspect
{
    ...
    @Before(value = "execution(* cn.ibizlab.pms.core.*.service.*.createBatch(..))")
    ...
    @Before(value = "execution(* cn.ibizlab.pms.core.*.service.*.updateBatch(..))")
     ...
     * @throws Exception
     */
    @Before(value = "execution(* cn.ibizlab.pms.core.*.service.*.save(..))")
    public void BeforeSave(JoinPoint point) throws Exception {
        fillDEFieldDefaultValue(point);
    }
    @Before(value = "execution(* cn.ibizlab.pms.core.*.service.*.saveBatch(..))")
