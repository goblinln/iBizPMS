...
public interface TestResultMapper extends BaseMapper<TestResult> {
    ...
    List<TestResult> selectCurTestRun(@Param("srf") TestResultSearchContext context, @Param("ew") Wrapper<TestResult> wrapper);
    List<TestResult> selectDefault(@Param("srf") TestResultSearchContext context, @Param("ew") Wrapper<TestResult> wrapper);
    List<TestResult> selectView(@Param("srf") TestResultSearchContext context, @Param("ew") Wrapper<TestResult> wrapper);
