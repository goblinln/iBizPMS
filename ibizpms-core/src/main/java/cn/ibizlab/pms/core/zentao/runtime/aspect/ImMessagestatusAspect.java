...
import cn.ibizlab.pms.core.sample.runtime.IImMessagestatusRuntime;
...
@Slf4j
public class ImMessagestatusAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IImMessagestatusRuntime imMessagestatusRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) imMessagestatusRuntime;
    }
