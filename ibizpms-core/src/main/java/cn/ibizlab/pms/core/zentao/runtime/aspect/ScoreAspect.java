...
import cn.ibizlab.pms.core.sample.runtime.IScoreRuntime;
...
@Slf4j
public class ScoreAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IScoreRuntime scoreRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) scoreRuntime;
    }
