...
@Slf4j
public class ImClientRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IImClientRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),ImClient.class);
        } catch (Exception e) {
    ...
    public Page<ImClient> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return imclientService.searchDefault(searchContext);    
        return null;
    }
    ...
    public List<ImClient> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return imclientService.selectDefault(searchContext);
        if (iPSDataQuery.getName().equals("VIEW"))
            return imclientService.selectView(searchContext);
        return null;
    }
    ...
    public List<ImClient> select(ISearchContextBase iSearchContextBase) {
        ImClientSearchContext searchContext = (ImClientSearchContext) iSearchContextBase;
        return imclientService.select(searchContext);
    }
