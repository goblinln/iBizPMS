...
public interface ExtensionMapper extends BaseMapper<Extension> {
    ...
    @Override
    Extension selectById(Serializable id);
    @Override
    int insert(Extension entity);
    @Override
    int updateById(@Param(Constants.ENTITY) Extension entity);
    @Override
    int update(@Param(Constants.ENTITY) Extension entity, @Param("ew") Wrapper<Extension> updateWrapper);
    @Override
