...
@TableName(value = "zt_history", resultMap = "IBZDailyHistoryResultMap")
@ApiModel("日报操作历史")
public class IBZDailyHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZDailyAction dailyhistory;
