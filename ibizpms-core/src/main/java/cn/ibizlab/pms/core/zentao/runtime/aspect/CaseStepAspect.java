...
import cn.ibizlab.pms.core.sample.runtime.ICaseStepRuntime;
...
@Slf4j
public class CaseStepAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ICaseStepRuntime caseStepRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) caseStepRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundDataSet("CurTest", point);
        }
            ...
            return getDataEntityRuntime().aroundDataSet("Mob", point);
        }
        else if (action.equals("searchVersion")) {
            return getDataEntityRuntime().aroundDataSet("Version", point);
        }
        else if (action.equals("searchVersions")) {
            return getDataEntityRuntime().aroundDataSet("Versions", point);
        }
        return point.proceed();
    }
}
