...
public class PSDataEntityFeignClientConfiguration {
    ...
    @Bean
    public PSDataEntityFeignClient pSDataEntityFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(PSDataEntityFeignClient.class, new PSDataEntityFallback(), serviceValue, requestInterceptors);
    }
}
