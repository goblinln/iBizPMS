...
public class SysRoleFeignClientConfiguration {
    ...
    @Bean
    public SysRoleFeignClient sysRoleFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(SysRoleFeignClient.class, new SysRoleFallback(), serviceValue, requestInterceptors);
    }
}
