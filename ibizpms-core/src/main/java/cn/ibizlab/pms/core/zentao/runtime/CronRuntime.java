...
@Slf4j
public class CronRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ICronRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Cron.class);
        } catch (Exception e) {
    ...
    public Page<Cron> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return cronService.searchDefault(searchContext);    
        return null;
    }
