...
import cn.ibizlab.pms.core.sample.runtime.IImMessageRuntime;
...
@Slf4j
public class ImMessageAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IImMessageRuntime imMessageRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) imMessageRuntime;
    }
