...
@Component("ProjectTeamModelImpl")
public class ProjectTeamModelImpl extends DataEntityModelImpl {


    @Autowired
    public IProjectTeamService projectteamService;

    public ProjectTeamModelImpl(){
        this.entity = "IBZ_PROJECTTEAM";
        this.pkey = "T1.ID";
        this.orgDRField = "" ;
        this.deptDRField = "";
    }
    ...
    public boolean test(Serializable key, String action) {
        ...
        //检查数据范围
        ProjectTeamSearchContext context = new ProjectTeamSearchContext();
