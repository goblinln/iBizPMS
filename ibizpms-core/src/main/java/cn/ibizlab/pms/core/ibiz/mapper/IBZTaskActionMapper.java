...
public interface IBZTaskActionMapper extends BaseMapper<IBZTaskAction> {
    ...
    @Override
    int insert(IBZTaskAction entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IBZTaskAction entity);
    @Override
    int update(@Param(Constants.ENTITY) IBZTaskAction entity, @Param("ew") Wrapper<IBZTaskAction> updateWrapper);
    @Override
    ...
    */
    ...
    List<IBZTaskAction> selectByObjectid(@Param("id") Serializable id);
