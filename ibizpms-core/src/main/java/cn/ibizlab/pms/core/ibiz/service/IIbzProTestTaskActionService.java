...
public interface IIbzProTestTaskActionService extends IService<IbzProTestTaskAction> {
    ...
    boolean commentBatch(List<IbzProTestTaskAction> etList);
    IbzProTestTaskAction createHis(IbzProTestTaskAction et);
    boolean createHisBatch(List<IbzProTestTaskAction> etList);
    IbzProTestTaskAction editComment(IbzProTestTaskAction et);
    boolean editCommentBatch(List<IbzProTestTaskAction> etList);
    IbzProTestTaskAction managePmsEe(IbzProTestTaskAction et);
    boolean managePmsEeBatch(List<IbzProTestTaskAction> etList);
    ...
    boolean sendMarkDoneBatch(List<IbzProTestTaskAction> etList);
    IbzProTestTaskAction sendTodo(IbzProTestTaskAction et);
    boolean sendTodoBatch(List<IbzProTestTaskAction> etList);
    IbzProTestTaskAction sendToread(IbzProTestTaskAction et);
    boolean sendToreadBatch(List<IbzProTestTaskAction> etList);
