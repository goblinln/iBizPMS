...
@Slf4j
public class IbzCaseRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IIbzCaseRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),IbzCase.class);
        } catch (Exception e) {
    ...
    public List<IbzCase> select(ISearchContextBase iSearchContextBase) {
        IbzCaseSearchContext searchContext = (IbzCaseSearchContext) iSearchContextBase;
        return ibzcaseService.select(searchContext);
    }
