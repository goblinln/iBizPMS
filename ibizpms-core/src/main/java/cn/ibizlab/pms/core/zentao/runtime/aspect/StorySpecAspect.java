...
import cn.ibizlab.pms.core.sample.runtime.IStorySpecRuntime;
...
@Slf4j
public class StorySpecAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IStorySpecRuntime storySpecRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) storySpecRuntime;
    }
