...
/**
 * 关系型数据实体[IbzWeekly] 查询条件对象
 */
@Slf4j
@Data
public class IbzWeeklySearchContext extends QueryWrapperContext<IbzWeekly> {
