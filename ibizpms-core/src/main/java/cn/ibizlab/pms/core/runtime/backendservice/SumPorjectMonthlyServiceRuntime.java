...
@Aspect
@Order(100)
@Component("SumPorjectMonthlyServiceRuntime")
public class SumPorjectMonthlyServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/ibizpro/PSSYSBACKSERVICES/SumPorjectMonthly.json";
    }
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.SumPorjectMonthlyJobHandler.execute(..))")
