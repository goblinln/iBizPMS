...
@TableName(value = "zt_history", resultMap = "IBZProBugHostoryResultMap")
@ApiModel("Bug操作历史")
public class IBZProBugHostory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IbzProBugAction ibzprobughistory;
