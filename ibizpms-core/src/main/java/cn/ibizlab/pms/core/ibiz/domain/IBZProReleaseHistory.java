...
@TableName(value = "zt_history", resultMap = "IBZProReleaseHistoryResultMap")
@ApiModel("发布操作历史")
public class IBZProReleaseHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZProReleaseAction ibzprorelease;
