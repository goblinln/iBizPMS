...
@Component("IBZDailyActionRuntime")
@Slf4j
public class IBZDailyActionRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

    @Autowired
    IIBZDailyActionService ibzdailyactionService;
    ...
    protected IEntityBase getSimpleEntity(Object o) {
        if (o instanceof net.ibizsys.runtime.util.IEntityBase) {
            ...
            return ibzdailyactionService.sysGet((Long) o);
        }
    }

    @Override
    public String getId() {
        return "PSMODULES/ibiz/PSDATAENTITIES/IBZDailyAction.json";
    }

    @Override
    public String getName() {
        return "IBZPRO_DAILYACTION";
    }

    @Override
    public IEntityBase createEntity() {
        return new IBZDailyAction();
    }

    @Override
    protected IService getService() {
        return this.ibzdailyactionService;
    }

    @Override
    public IBZDailyActionSearchContext createSearchContext() {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),IBZDailyAction.class);
        } catch (Exception e) {
    ...
    @Override
    public Page<IBZDailyAction> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
    ...
    @Override
    public List<IBZDailyAction> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        IBZDailyActionSearchContext searchContext = (IBZDailyActionSearchContext) iSearchContextBase;
    ...
    @Override
    public List<IBZDailyAction> select(ISearchContextBase iSearchContextBase) {
        IBZDailyActionSearchContext searchContext = (IBZDailyActionSearchContext) iSearchContextBase;
        return ibzdailyactionService.select(searchContext);
    }
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        IBZDailyAction entity = null;
        String action = iPSDEAction.getName();
        if (arg0 instanceof IBZDailyAction) {
            entity = (IBZDailyAction) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = ibzdailyactionService.sysGet((Long) arg0);
            } else if ("remove".equalsIgnoreCase(action)) {
                entity = new IBZDailyAction();
    ...
    @Around("execution(* cn.ibizlab.pms.core.ibiz.service.impl.IBZDailyActionServiceImpl.*(..))")
    @Transactional
