...
public class PSSysAppFeignClientConfiguration {
    ...
    @Bean
    public PSSysAppFeignClient pSSysAppFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(PSSysAppFeignClient.class, new PSSysAppFallback(), serviceValue, requestInterceptors);
    }
}
