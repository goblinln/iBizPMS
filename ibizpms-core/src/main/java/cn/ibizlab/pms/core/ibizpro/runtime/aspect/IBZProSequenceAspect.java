...
import cn.ibizlab.pms.core.sample.runtime.IIBZProSequenceRuntime;
...
@Slf4j
public class IBZProSequenceAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIBZProSequenceRuntime iBZProSequenceRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) iBZProSequenceRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("INIT", point);
        }
