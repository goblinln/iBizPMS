...
import cn.ibizlab.pms.core.sample.runtime.ISysUpdateFeaturesRuntime;
...
@Slf4j
public class SysUpdateFeaturesAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ISysUpdateFeaturesRuntime sysUpdateFeaturesRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) sysUpdateFeaturesRuntime;
    }
