...
import cn.ibizlab.pms.core.sample.runtime.IConfigRuntime;
...
@Slf4j
public class ConfigAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IConfigRuntime configRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) configRuntime;
    }
