...
import cn.ibizlab.pms.core.sample.runtime.IImQueueRuntime;
...
@Slf4j
public class ImQueueAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IImQueueRuntime imQueueRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) imQueueRuntime;
    }
