...
public interface IProjectStatsService extends IService<ProjectStats> {
    ...
    List<ProjectStats> selectProjectBugType(ProjectStatsSearchContext context);
    List<ProjectStats> selectProjectInputStats(ProjectStatsSearchContext context);
    List<ProjectStats> selectProjectProgress(ProjectStatsSearchContext context);
    List<ProjectStats> selectProjectQuality(ProjectStatsSearchContext context);
    List<ProjectStats> selectProjectStoryStageStats(ProjectStatsSearchContext context);
    List<ProjectStats> selectProjectStoryStatusStats(ProjectStatsSearchContext context);
    List<ProjectStats> selectProjectTaskCountByTaskStatus(ProjectStatsSearchContext context);
    List<ProjectStats> selectProjectTaskCountByType(ProjectStatsSearchContext context);
    List<ProjectStats> selectTaskTime(ProjectStatsSearchContext context);
    List<ProjectStats> selectView(ProjectStatsSearchContext context);
