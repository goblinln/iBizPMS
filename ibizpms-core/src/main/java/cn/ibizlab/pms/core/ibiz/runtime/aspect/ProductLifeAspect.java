...
import cn.ibizlab.pms.core.sample.runtime.IProductLifeRuntime;
...
@Slf4j
public class ProductLifeAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IProductLifeRuntime productLifeRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) productLifeRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundDataSet("GetRoadmap", point);
        }
        else if (action.equals("searchGetRoadmapS")) {
            return getDataEntityRuntime().aroundDataSet("GetRoadmapS", point);
        }
        else if (action.equals("searchRoadMapYear")) {
            return getDataEntityRuntime().aroundDataSet("RoadMapYear", point);
        }
        return point.proceed();
    }
}
