...
import cn.ibizlab.pms.core.sample.runtime.IRepoFilesRuntime;
...
@Slf4j
public class RepoFilesAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IRepoFilesRuntime repoFilesRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) repoFilesRuntime;
    }
