...
public interface IIbzProBuildActionService extends IService<IbzProBuildAction> {
    ...
    boolean commentBatch(List<IbzProBuildAction> etList);
    IbzProBuildAction createHis(IbzProBuildAction et);
    boolean createHisBatch(List<IbzProBuildAction> etList);
    IbzProBuildAction editComment(IbzProBuildAction et);
    boolean editCommentBatch(List<IbzProBuildAction> etList);
    IbzProBuildAction managePmsEe(IbzProBuildAction et);
    boolean managePmsEeBatch(List<IbzProBuildAction> etList);
    ...
    boolean sendMarkDoneBatch(List<IbzProBuildAction> etList);
    IbzProBuildAction sendTodo(IbzProBuildAction et);
    boolean sendTodoBatch(List<IbzProBuildAction> etList);
    IbzProBuildAction sendToread(IbzProBuildAction et);
    boolean sendToreadBatch(List<IbzProBuildAction> etList);
