...
@Slf4j
public class RepoRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IRepoRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Repo.class);
        } catch (Exception e) {
    ...
    public List<Repo> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return repoService.selectDefault(searchContext);
        if (iPSDataQuery.getName().equals("VIEW"))
            return repoService.selectView(searchContext);
        return null;
    }
        ...
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                ...
                if(args[0] instanceof Repo){
                    ...
                    CachedBeanCopier.copy(repoService.get(arg.getId()), arg);
                    return arg;
                }else{
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof Repo){
                    Repo arg = (Repo) args[0] ;
                    CachedBeanCopier.copy(repoService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return repoService.sysUpdate((Repo) args[0]);
            }             
        }
