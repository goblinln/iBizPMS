...
@Slf4j
public class CompanyStatsRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ICompanyStatsRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),CompanyStats.class);
        } catch (Exception e) {
    ...
    public Page<CompanyStats> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDEDataSet.getName().equals("CompanyDynamicStats"))
            return companystatsService.searchCompanyDynamicStats(searchContext);    
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return companystatsService.searchDefault(searchContext);    
        return null;
    }
    ...
    public List<CompanyStats> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("CompanyDynamicStats"))
            return companystatsService.selectCompanyDynamicStats(searchContext);
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return companystatsService.selectDefault(searchContext);
    ...
    public List<CompanyStats> select(ISearchContextBase iSearchContextBase) {
        CompanyStatsSearchContext searchContext = (CompanyStatsSearchContext) iSearchContextBase;
        return companystatsService.select(searchContext);
    }
