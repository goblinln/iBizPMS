...
import cn.ibizlab.pms.core.sample.runtime.IIbzLibCaseStepRuntime;
...
@Slf4j
public class IbzLibCaseStepAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzLibCaseStepRuntime ibzLibCaseStepRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzLibCaseStepRuntime;
    }
