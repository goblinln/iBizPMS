...
import cn.ibizlab.pms.core.sample.runtime.IGroupRuntime;
...
@Slf4j
public class GroupAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IGroupRuntime groupRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) groupRuntime;
    }
