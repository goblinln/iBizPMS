...
@TableName(value = "zt_history", resultMap = "IBZTaskHistoryResultMap")
@ApiModel("任务操作历史")
public class IBZTaskHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZTaskAction taskaction;
