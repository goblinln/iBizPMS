...
public interface IPSSysServiceAPIService {
    ...
    List<PSSysServiceAPI> selectQueryByDefault(PSSysServiceAPISearchContext context);
    List<PSSysServiceAPI> selectQueryByView(PSSysServiceAPISearchContext context);
