...
public class SysTeamFeignClientConfiguration {
    ...
    @Bean
    public SysTeamFeignClient sysTeamFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(SysTeamFeignClient.class, new SysTeamFallback(), serviceValue, requestInterceptors);
    }
}
