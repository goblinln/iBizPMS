...
@Slf4j
public class RepoHistoryRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IRepoHistoryRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),RepoHistory.class);
        } catch (Exception e) {
    ...
    public List<RepoHistory> select(ISearchContextBase iSearchContextBase) {
        RepoHistorySearchContext searchContext = (RepoHistorySearchContext) iSearchContextBase;
        return repohistoryService.select(searchContext);
    }
