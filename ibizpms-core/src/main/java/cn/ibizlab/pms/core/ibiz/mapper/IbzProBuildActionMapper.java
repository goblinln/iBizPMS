...
public interface IbzProBuildActionMapper extends BaseMapper<IbzProBuildAction> {
    ...
    @Override
    int insert(IbzProBuildAction entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IbzProBuildAction entity);
    @Override
    int update(@Param(Constants.ENTITY) IbzProBuildAction entity, @Param("ew") Wrapper<IbzProBuildAction> updateWrapper);
    @Override
    ...
    */
    ...
    List<IbzProBuildAction> selectByObjectid(@Param("id") Serializable id);
