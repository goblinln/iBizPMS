...
import cn.ibizlab.pms.core.sample.runtime.IIbzPlanTempletRuntime;
...
@Slf4j
public class IbzPlanTempletAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzPlanTempletRuntime ibzPlanTempletRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzPlanTempletRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("getPlan", point);
        }
        else if (action.equals("save")) {
            return getDataEntityRuntime().aroundAction("Save", point);
        }
        else if (action.equals("searchCurUserTemplet")) {
            return getDataEntityRuntime().aroundDataSet("CurUserTemplet", point);
        }
