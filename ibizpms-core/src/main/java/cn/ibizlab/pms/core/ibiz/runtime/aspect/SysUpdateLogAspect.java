...
import cn.ibizlab.pms.core.sample.runtime.ISysUpdateLogRuntime;
...
@Slf4j
public class SysUpdateLogAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ISysUpdateLogRuntime sysUpdateLogRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) sysUpdateLogRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("getLastUpdateInfo", point);
        }
