...
@TableName(value = "zt_action", resultMap = "IBZCaseActionResultMap")
@ApiModel("测试用例日志")
public class IBZCaseAction extends EntityMP implements Serializable {
    ...
    @TableField(exist = false)
    private cn.ibizlab.pms.core.zentao.domain.Case ibzprocase;
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private List<cn.ibizlab.pms.core.ibiz.domain.IBZCaseHistory> ibzcasehistory;
