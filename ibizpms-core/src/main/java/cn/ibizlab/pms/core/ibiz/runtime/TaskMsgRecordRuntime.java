...
@Slf4j
public class TaskMsgRecordRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ITaskMsgRecordRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),TaskMsgRecord.class);
        } catch (Exception e) {
    ...
    public Page<TaskMsgRecord> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return taskmsgrecordService.searchDefault(searchContext);    
        return null;
    }
    ...
    public List<TaskMsgRecord> select(ISearchContextBase iSearchContextBase) {
        TaskMsgRecordSearchContext searchContext = (TaskMsgRecordSearchContext) iSearchContextBase;
        return taskmsgrecordService.select(searchContext);
    }
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                return taskmsgrecordService.create((TaskMsgRecord) args[0]);
            }
            else if (iPSDEAction.getName().equals("Update")) {
                return taskmsgrecordService.update((TaskMsgRecord) args[0]);
            }
            else if (iPSDEAction.getName().equals("Remove")) {
                return taskmsgrecordService.remove((String) args[0]);
            }
                ...
                return taskmsgrecordService.getDraft((TaskMsgRecord) args[0]);
            }
            else if (iPSDEAction.getName().equals("CheckKey")) {
                return taskmsgrecordService.checkKey((TaskMsgRecord) args[0]);
            }
            else if (iPSDEAction.getName().equals("Save")) {
                return taskmsgrecordService.save((TaskMsgRecord) args[0]);
            }
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof TaskMsgRecord){
                    TaskMsgRecord arg = (TaskMsgRecord) args[0] ;
                    CachedBeanCopier.copy(taskmsgrecordService.sysGet(arg.getTaskmsgrecordid()), arg);
                    return arg;
                }else{
                    ...
                    return taskmsgrecordService.sysUpdate((TaskMsgRecord) args[0]);
            }             
        }
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        TaskMsgRecord entity = null;
        String action = iPSDEAction.getName();
        if (arg0 instanceof TaskMsgRecord) {
            entity = (TaskMsgRecord) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = taskmsgrecordService.sysGet((String) arg0);
            } else if ("remove".equalsIgnoreCase(action)) {
                entity = new TaskMsgRecord();
                entity.setTaskmsgrecordid((String) arg0);
            }
        }
        if (entity != null) {
