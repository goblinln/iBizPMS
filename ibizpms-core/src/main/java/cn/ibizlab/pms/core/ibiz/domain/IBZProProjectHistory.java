...
@TableName(value = "zt_history", resultMap = "IBZProProjectHistoryResultMap")
@ApiModel("项目操作历史")
public class IBZProProjectHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZProProjectAction ibzproprojecthistory;
