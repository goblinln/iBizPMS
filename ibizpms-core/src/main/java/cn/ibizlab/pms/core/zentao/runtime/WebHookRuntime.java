...
public class WebHookRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),WebHook.class);
        } catch (Exception e) {
    ...
    public Page<WebHook> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return webhookService.searchDefault(searchContext);    
        return null;
    }
    ...
    public List<WebHook> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return webhookService.selectDefault(searchContext);
