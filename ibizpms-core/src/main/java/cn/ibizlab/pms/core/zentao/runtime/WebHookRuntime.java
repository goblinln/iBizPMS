...
@Slf4j
public class WebHookRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    @Override
    public String getId() {
        return "PSMODULES/zentao/PSDATAENTITIES/WebHook.json";
    }
    ...
    public Page<WebHook> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return webhookService.searchDefault((WebHookSearchContext) iSearchContextBase);
        return null;
    }
    ...
    public List<WebHook> select(ISearchContextBase iSearchContextBase) {
        return webhookService.searchDefault((WebHookSearchContext) iSearchContextBase).getContent();
    }
        ...
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                ...
                if(args[0] instanceof WebHook){
                    ...
                    arg = webhookService.get(arg.getId()) ;
                    return arg;
                }else{
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (arg0 instanceof WebHook) {
            entity = (WebHook) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = webhookService.sysGet((Long) arg0);
