...
import cn.ibizlab.pms.core.sample.runtime.IUserViewRuntime;
...
@Slf4j
public class UserViewAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IUserViewRuntime userViewRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) userViewRuntime;
    }
