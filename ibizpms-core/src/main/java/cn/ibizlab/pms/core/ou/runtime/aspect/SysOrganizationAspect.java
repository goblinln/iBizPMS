...
import cn.ibizlab.pms.core.sample.runtime.ISysOrganizationRuntime;
...
@Component("SysOrganizationRuntime")
@Slf4j
public class SysOrganizationAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ISysOrganizationRuntime sysOrganizationRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) sysOrganizationRuntime;
    }

    @Around("execution(* cn.ibizlab.pms.core.ou.service.impl.SysOrganizationServiceImpl.*(..))")
    @Transactional
