...
import cn.ibizlab.pms.core.sample.runtime.IIbzCaseRuntime;
...
@Slf4j
public class IbzCaseAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzCaseRuntime ibzCaseRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzCaseRuntime;
    }
