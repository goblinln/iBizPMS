...
/**
 * 关系型数据实体[IBZProWeeklyAction] 查询条件对象
 */
@Slf4j
@Data
public class IBZProWeeklyActionSearchContext extends QueryWrapperContext<IBZProWeeklyAction> {
	...
	private Long n_objectid_eq;//[周报标识]
