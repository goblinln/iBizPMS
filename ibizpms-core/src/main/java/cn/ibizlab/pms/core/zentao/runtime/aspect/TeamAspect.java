...
import cn.ibizlab.pms.core.sample.runtime.ITeamRuntime;
...
@Slf4j
public class TeamAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ITeamRuntime teamRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) teamRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("managePorjectMembers", point);
        }
        else if (action.equals("save")) {
            return getDataEntityRuntime().aroundAction("Save", point);
        }
        else if (action.equals("unlinkPorjectMember")) {
            return getDataEntityRuntime().aroundAction("unlinkPorjectMember", point);
        }
