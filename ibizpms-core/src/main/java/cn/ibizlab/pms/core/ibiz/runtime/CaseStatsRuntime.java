...
@Slf4j
public class CaseStatsRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ICaseStatsRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),CaseStats.class);
        } catch (Exception e) {
    ...
    public List<CaseStats> select(ISearchContextBase iSearchContextBase) {
        CaseStatsSearchContext searchContext = (CaseStatsSearchContext) iSearchContextBase;
        return casestatsService.select(searchContext);
    }
