...
@Aspect
@Order(100)
@Component("BurnServiceServiceRuntime")
public class BurnServiceServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/zentao/PSSYSBACKSERVICES/BurnService.json";
    }
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.BurnServiceJobHandler.execute(..))")
