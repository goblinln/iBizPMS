...
@TableName(value = "zt_history", resultMap = "IbzProMonthlyHistoryResultMap")
@ApiModel("月报操作历史")
public class IbzProMonthlyHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IbzProMonthlyAction ibzpromonthlyhistory;
