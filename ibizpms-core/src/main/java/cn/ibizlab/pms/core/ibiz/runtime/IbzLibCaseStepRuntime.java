...
@Slf4j
public class IbzLibCaseStepRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IIbzLibCaseStepRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),IbzLibCaseStep.class);
        } catch (Exception e) {
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof IbzLibCaseStep){
                    IbzLibCaseStep arg = (IbzLibCaseStep) args[0] ;
                    CachedBeanCopier.copy(ibzlibcasestepService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return ibzlibcasestepService.sysUpdate((IbzLibCaseStep) args[0]);
            }             
        }
