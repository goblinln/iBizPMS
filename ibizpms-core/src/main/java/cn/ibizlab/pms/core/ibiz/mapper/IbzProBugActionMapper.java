...
public interface IbzProBugActionMapper extends BaseMapper<IbzProBugAction> {
    ...
    @Override
    int insert(IbzProBugAction entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IbzProBugAction entity);
    @Override
    int update(@Param(Constants.ENTITY) IbzProBugAction entity, @Param("ew") Wrapper<IbzProBugAction> updateWrapper);
    @Override
    ...
    */
    ...
    List<IbzProBugAction> selectByObjectid(@Param("id") Serializable id);
