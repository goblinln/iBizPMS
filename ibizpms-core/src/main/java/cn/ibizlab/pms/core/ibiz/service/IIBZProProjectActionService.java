...
public interface IIBZProProjectActionService extends IService<IBZProProjectAction> {
    ...
    IBZProProjectAction comment(IBZProProjectAction et);
    boolean commentBatch(List<IBZProProjectAction> etList);
    IBZProProjectAction createHis(IBZProProjectAction et);
    boolean createHisBatch(List<IBZProProjectAction> etList);
    IBZProProjectAction editComment(IBZProProjectAction et);
    boolean editCommentBatch(List<IBZProProjectAction> etList);
    IBZProProjectAction managePmsEe(IBZProProjectAction et);
    boolean managePmsEeBatch(List<IBZProProjectAction> etList);
    ...
    boolean sendMarkDoneBatch(List<IBZProProjectAction> etList);
    IBZProProjectAction sendTodo(IBZProProjectAction et);
    boolean sendTodoBatch(List<IBZProProjectAction> etList);
    IBZProProjectAction sendToread(IBZProProjectAction et);
    boolean sendToreadBatch(List<IBZProProjectAction> etList);
