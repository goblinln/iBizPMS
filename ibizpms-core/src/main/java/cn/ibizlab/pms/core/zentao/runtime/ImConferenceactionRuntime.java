...
@Slf4j
public class ImConferenceactionRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IImConferenceactionRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),ImConferenceaction.class);
        } catch (Exception e) {
