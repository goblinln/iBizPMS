...
@Slf4j
public class JobRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IJobRuntime {
    ...
    @Override
    public JobSearchContext createSearchContext() {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Job.class);
        } catch (Exception e) {
    ...
    public Page<Job> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return jobService.searchDefault(searchContext);    
        return null;
    }
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        ...
        if (arg0 instanceof Job) {
            ...
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = jobService.sysGet((Long) arg0);
