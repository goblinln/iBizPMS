...
@Component("SysEmployeeModelImpl")
public class SysEmployeeModelImpl extends DataEntityModelImpl {


    @Autowired
    public ISysEmployeeService sysemployeeService;

    public SysEmployeeModelImpl(){
        this.entity = "IBZEMP";
        this.pkey = "T1.USERID";
    ...
    public boolean test(Serializable key, String action) {
        ...
        if (sysemployeeService.searchDefault(context).getTotalElements() == 0) {
            return false;
        }
    ...
    public boolean test(List<Serializable> keys, String action) {
        ...
        if (sysemployeeService.searchDefault(context).getTotalElements() != keys.size()) {
            return false;
        }
