...
import cn.ibizlab.pms.core.sample.runtime.IDeptRuntime;
...
@Slf4j
public class DeptAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IDeptRuntime deptRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) deptRuntime;
    }
