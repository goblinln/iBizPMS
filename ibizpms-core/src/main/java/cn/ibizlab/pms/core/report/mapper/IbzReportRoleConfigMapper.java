...
public interface IbzReportRoleConfigMapper extends BaseMapper<IbzReportRoleConfig> {
    ...
    @Override
    IbzReportRoleConfig selectById(Serializable id);
    @Override
    int insert(IbzReportRoleConfig entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IbzReportRoleConfig entity);
    @Override
    int update(@Param(Constants.ENTITY) IbzReportRoleConfig entity, @Param("ew") Wrapper<IbzReportRoleConfig> updateWrapper);
    @Override
