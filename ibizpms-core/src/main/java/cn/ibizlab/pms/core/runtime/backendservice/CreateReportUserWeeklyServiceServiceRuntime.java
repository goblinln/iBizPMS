...
@Aspect
@Order(100)
@Component("CreateReportUserWeeklyServiceServiceRuntime")
public class CreateReportUserWeeklyServiceServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/report/PSSYSBACKSERVICES/CreateReportUserWeeklyService.json";
    }
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.CreateReportUserWeeklyServiceJobHandler.execute(..))")
