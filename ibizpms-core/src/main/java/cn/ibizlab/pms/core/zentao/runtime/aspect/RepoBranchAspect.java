...
import cn.ibizlab.pms.core.sample.runtime.IRepoBranchRuntime;
...
@Slf4j
public class RepoBranchAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IRepoBranchRuntime repoBranchRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) repoBranchRuntime;
    }
