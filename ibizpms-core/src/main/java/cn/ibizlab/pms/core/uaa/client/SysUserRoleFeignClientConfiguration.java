...
public class SysUserRoleFeignClientConfiguration {
    ...
    @Value("${ibiz.ref.service.ibzuaa-api.super:false}")
    boolean superapi;
    ...
    @Bean
    public SysUserRoleFeignClient sysUserRoleFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(SysUserRoleFeignClient.class, new SysUserRoleFallback(), serviceValue, requestInterceptors);
    }
}
