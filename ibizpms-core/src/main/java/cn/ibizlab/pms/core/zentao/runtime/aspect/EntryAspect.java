...
import cn.ibizlab.pms.core.sample.runtime.IEntryRuntime;
...
@Slf4j
public class EntryAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IEntryRuntime entryRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) entryRuntime;
    }
