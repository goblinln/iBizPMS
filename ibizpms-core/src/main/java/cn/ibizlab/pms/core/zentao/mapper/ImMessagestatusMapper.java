...
public interface ImMessagestatusMapper extends BaseMapper<ImMessagestatus> {
    ...
    List<ImMessagestatus> selectDefault(@Param("srf") ImMessagestatusSearchContext context, @Param("ew") Wrapper<ImMessagestatus> wrapper);
    List<ImMessagestatus> selectView(@Param("srf") ImMessagestatusSearchContext context, @Param("ew") Wrapper<ImMessagestatus> wrapper);
