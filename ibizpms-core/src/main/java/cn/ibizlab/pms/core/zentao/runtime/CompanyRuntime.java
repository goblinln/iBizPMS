...
@Slf4j
public class CompanyRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ICompanyRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Company.class);
        } catch (Exception e) {
