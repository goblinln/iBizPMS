...
@Aspect
@Order(100)
@Component("PushReportUserMonthlyServiceServiceRuntime")
public class PushReportUserMonthlyServiceServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/report/PSSYSBACKSERVICES/PushReportUserMonthlyService.json";
    }
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.PushReportUserMonthlyServiceJobHandler.execute(..))")
