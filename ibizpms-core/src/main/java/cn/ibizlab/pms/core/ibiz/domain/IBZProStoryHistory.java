...
@TableName(value = "zt_history", resultMap = "IBZProStoryHistoryResultMap")
@ApiModel("需求操作历史")
public class IBZProStoryHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZStoryAction der1nIbzproStoryhistoryIbzproStoryactionAction;
