...
public interface IIBZCaseActionService extends IService<IBZCaseAction> {
    ...
    IBZCaseAction comment(IBZCaseAction et);
    boolean commentBatch(List<IBZCaseAction> etList);
    IBZCaseAction createHis(IBZCaseAction et);
    boolean createHisBatch(List<IBZCaseAction> etList);
    IBZCaseAction editComment(IBZCaseAction et);
    boolean editCommentBatch(List<IBZCaseAction> etList);
    IBZCaseAction managePmsEe(IBZCaseAction et);
    boolean managePmsEeBatch(List<IBZCaseAction> etList);
    boolean save(IBZCaseAction et);
    void saveBatch(List<IBZCaseAction> list);
    IBZCaseAction sendMarkDone(IBZCaseAction et);
    boolean sendMarkDoneBatch(List<IBZCaseAction> etList);
    IBZCaseAction sendTodo(IBZCaseAction et);
    boolean sendTodoBatch(List<IBZCaseAction> etList);
    IBZCaseAction sendToread(IBZCaseAction et);
    boolean sendToreadBatch(List<IBZCaseAction> etList);
