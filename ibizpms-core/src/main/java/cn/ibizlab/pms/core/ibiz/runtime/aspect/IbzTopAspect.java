...
import cn.ibizlab.pms.core.sample.runtime.IIbzTopRuntime;
...
@Slf4j
public class IbzTopAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzTopRuntime ibzTopRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzTopRuntime;
    }
