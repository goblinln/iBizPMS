...
public class IbzproProjectUserTaskRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    protected IService getService() {
        return this.ibzproprojectusertaskService;
    }
    ...
    public boolean existsData(ISearchContextBase iSearchContextBase) {
        Page<IbzproProjectUserTask> domains = ibzproprojectusertaskService.searchDefault((IbzproProjectUserTaskSearchContext) iSearchContextBase);
    ...
    public Page<IbzproProjectUserTask> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return ibzproprojectusertaskService.searchDefault((IbzproProjectUserTaskSearchContext) iSearchContextBase);
        return null;
    }
    ...
    @Override
    public IbzproProjectUserTask selectOne(ISearchContextBase iSearchContextBase) {
        //单条数据查询，多条数数据时 返回第一条
        Page<IbzproProjectUserTask> domains = ibzproprojectusertaskService.searchDefault((IbzproProjectUserTaskSearchContext) iSearchContextBase);
        if (domains.getSize() == 0)
            return null;
    ...
    public List<IbzproProjectUserTask> select(ISearchContextBase iSearchContextBase) {
        return ibzproprojectusertaskService.searchDefault((IbzproProjectUserTaskSearchContext) iSearchContextBase).getContent();
    }
