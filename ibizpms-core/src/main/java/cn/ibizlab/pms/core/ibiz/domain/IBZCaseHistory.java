...
@TableName(value = "zt_history", resultMap = "IBZCaseHistoryResultMap")
@ApiModel("测试操作历史")
public class IBZCaseHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZCaseAction caseaction;
