...
import cn.ibizlab.pms.core.sample.runtime.IPSSubSysSADERuntime;
...
@Slf4j
public class PSSubSysSADEAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IPSSubSysSADERuntime pSSubSysSADERuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) pSSubSysSADERuntime;
    }
