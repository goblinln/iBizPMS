...
public interface RepoMapper extends BaseMapper<Repo> {
    ...
    List<Repo> selectDefault(@Param("srf") RepoSearchContext context, @Param("ew") Wrapper<Repo> wrapper);
    List<Repo> selectView(@Param("srf") RepoSearchContext context, @Param("ew") Wrapper<Repo> wrapper);
    ...
    @Override
    int insert(Repo entity);
    @Override
    int updateById(@Param(Constants.ENTITY) Repo entity);
    @Override
