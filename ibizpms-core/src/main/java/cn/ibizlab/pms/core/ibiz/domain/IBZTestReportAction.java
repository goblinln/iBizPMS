...
@TableName(value = "zt_action", resultMap = "IBZTestReportActionResultMap")
@ApiModel("报告日志")
public class IBZTestReportAction extends EntityMP implements Serializable {
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private List<cn.ibizlab.pms.core.ibiz.domain.IBZTestReportHistory> ibztestreporthistory;
