...
public interface CompanyStatsMapper extends BaseMapper<CompanyStats> {
    ...
    @Override
    CompanyStats selectById(Serializable id);
    @Override
    int insert(CompanyStats entity);
    @Override
    int updateById(@Param(Constants.ENTITY) CompanyStats entity);
    @Override
    int update(@Param(Constants.ENTITY) CompanyStats entity, @Param("ew") Wrapper<CompanyStats> updateWrapper);
    @Override
