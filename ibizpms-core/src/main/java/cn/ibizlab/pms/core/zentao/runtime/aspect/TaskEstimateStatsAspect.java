...
import cn.ibizlab.pms.core.sample.runtime.ITaskEstimateStatsRuntime;
...
@Slf4j
public class TaskEstimateStatsAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ITaskEstimateStatsRuntime taskEstimateStatsRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) taskEstimateStatsRuntime;
    }
