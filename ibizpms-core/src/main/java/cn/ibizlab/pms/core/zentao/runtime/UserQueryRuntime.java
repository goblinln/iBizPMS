...
@Aspect
@Order(100)
@Component("UserQueryRuntime")
@Slf4j
public class UserQueryRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    protected IEntityBase getSimpleEntity(Object o) {
        if (o instanceof net.ibizsys.runtime.util.IEntityBase) {
            ...
            return userqueryService.sysGet((Long) o);
        }
    }

    @Override
    public String getId() {
        return "PSMODULES/zentao/PSDATAENTITIES/UserQuery.json";
    }
    ...
    @Override
    public UserQuerySearchContext createSearchContext() {
        return new UserQuerySearchContext();
    }
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),UserQuery.class);
        } catch (Exception e) {
    ...
    public List<UserQuery> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return userqueryService.selectDefault(searchContext);
    ...
    public List<UserQuery> select(ISearchContextBase iSearchContextBase) {
        UserQuerySearchContext searchContext = (UserQuerySearchContext) iSearchContextBase;
        return userqueryService.select(searchContext);
    }
        ...
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                ...
                if(args[0] instanceof UserQuery){
                    ...
                    arg = userqueryService.get(arg.getId()) ;
                    return arg;
                }else{
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        UserQuery entity = null;
        String action = iPSDEAction.getName();
        if (arg0 instanceof UserQuery) {
            entity = (UserQuery) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = userqueryService.sysGet((Long) arg0);
            } else if ("remove".equalsIgnoreCase(action)) {
                entity = new UserQuery();
    ...
    @Around("execution(* cn.ibizlab.pms.core.zentao.service.impl.UserQueryServiceImpl.*(..))")
    @Transactional
