...
import cn.ibizlab.pms.core.sample.runtime.INotifyRuntime;
...
@Slf4j
public class NotifyAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    INotifyRuntime notifyRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) notifyRuntime;
    }
