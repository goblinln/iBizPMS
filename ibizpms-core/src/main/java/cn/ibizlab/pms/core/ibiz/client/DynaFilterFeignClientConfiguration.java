...
public class DynaFilterFeignClientConfiguration {
    ...
    @Bean
    public DynaFilterFeignClient dynaFilterFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(DynaFilterFeignClient.class, new DynaFilterFallback(), serviceValue, requestInterceptors);
    }
}
