...
@Slf4j
public class StorySpecRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IStorySpecRuntime {
    ...
    @Override
    public StorySpecSearchContext createSearchContext() {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),StorySpec.class);
        } catch (Exception e) {
    ...
    public List<StorySpec> select(ISearchContextBase iSearchContextBase) {
        StorySpecSearchContext searchContext = (StorySpecSearchContext) iSearchContextBase;
        return storyspecService.select(searchContext);
    }
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        StorySpec entity = null;
        String action = iPSDEAction.getName();
        if (arg0 instanceof StorySpec) {
            entity = (StorySpec) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = storyspecService.sysGet((String) arg0);
            } else if ("remove".equalsIgnoreCase(action)) {
                entity = new StorySpec();
