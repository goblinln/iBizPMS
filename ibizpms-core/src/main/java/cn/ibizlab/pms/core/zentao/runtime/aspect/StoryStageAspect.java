...
import cn.ibizlab.pms.core.sample.runtime.IStoryStageRuntime;
...
@Slf4j
public class StoryStageAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IStoryStageRuntime storyStageRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) storyStageRuntime;
    }
