...
public class IbzproProjectUserTaskModelImpl extends DataEntityModelImpl {
    ...
    public boolean test(Serializable key, String action) {
        ...
        if (ibzproprojectusertaskService.searchDefault(context).getTotalElements() == 0) {
            return false;
        }
    ...
    public boolean test(List<Serializable> keys, String action) {
        ...
        if (ibzproprojectusertaskService.searchDefault(context).getTotalElements() != keys.size()) {
            return false;
        }
