...
@Slf4j
public class EffortRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IEffortRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Effort.class);
        } catch (Exception e) {
        ...
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                ...
                if(args[0] instanceof Effort){
                    ...
                    CachedBeanCopier.copy(effortService.get(arg.getId()), arg);
                    return arg;
                }else{
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof Effort){
                    Effort arg = (Effort) args[0] ;
                    CachedBeanCopier.copy(effortService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return effortService.sysUpdate((Effort) args[0]);
            }             
        }
