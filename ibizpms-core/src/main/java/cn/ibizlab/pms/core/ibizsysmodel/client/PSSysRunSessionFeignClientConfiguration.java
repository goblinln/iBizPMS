...
/**
 * 实体[PSSysRunSession] 服务对象接口配置
 */
@Configuration
public class PSSysRunSessionFeignClientConfiguration {
    ...
    @Bean
    public PSSysRunSessionFeignClient pSSysRunSessionFeignClient(Decoder decoder, Encoder encoder, Client client, Contract contract, List<RequestInterceptor> requestInterceptors) {
        ...
        if (builder instanceof HystrixFeign.Builder) {
            ...
            return nameBuilder.target(PSSysRunSessionFeignClient.class, "http://" + serviceValue, new PSSysRunSessionFallback());
        } else {
            Feign.Builder nameBuilder = Feign.builder()
                    ...
                    .contract(contract)
                    .requestInterceptors(requestInterceptors);
            return nameBuilder.target(PSSysRunSessionFeignClient.class, "http://" + serviceValue);
        }
    }
}
