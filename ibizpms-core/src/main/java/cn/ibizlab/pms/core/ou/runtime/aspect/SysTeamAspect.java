...
import cn.ibizlab.pms.core.sample.runtime.ISysTeamRuntime;
...
@Slf4j
public class SysTeamAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ISysTeamRuntime sysTeamRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) sysTeamRuntime;
    }
