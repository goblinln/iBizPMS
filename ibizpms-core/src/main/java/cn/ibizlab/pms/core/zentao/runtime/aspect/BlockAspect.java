...
import cn.ibizlab.pms.core.sample.runtime.IBlockRuntime;
...
@Slf4j
public class BlockAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IBlockRuntime blockRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) blockRuntime;
    }
