...
public interface IBZProReleaseActionMapper extends BaseMapper<IBZProReleaseAction> {
    ...
    @Override
    int insert(IBZProReleaseAction entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IBZProReleaseAction entity);
    @Override
    int update(@Param(Constants.ENTITY) IBZProReleaseAction entity, @Param("ew") Wrapper<IBZProReleaseAction> updateWrapper);
    @Override
