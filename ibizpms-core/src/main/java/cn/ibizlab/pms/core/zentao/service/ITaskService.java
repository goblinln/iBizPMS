...
public interface ITaskService extends IService<Task> {
    ...
    List<Task> selectQueryByByModule(TaskSearchContext context);
    List<Task> selectQueryByChildDefault(TaskSearchContext context);
    List<Task> selectQueryByChildTask(TaskSearchContext context);
    List<Task> selectQueryByChildTaskTree(TaskSearchContext context);
    List<Task> selectQueryByCurFinishTask(TaskSearchContext context);
    List<Task> selectQueryByCurProjectTaskQuery(TaskSearchContext context);
    List<Task> selectQueryByDefault(TaskSearchContext context);
    List<Task> selectQueryByDefaultRow(TaskSearchContext context);
    List<Task> selectQueryByESBulk(TaskSearchContext context);
    List<Task> selectQueryByMyAgentTask(TaskSearchContext context);
    List<Task> selectQueryByMyAllTask(TaskSearchContext context);
    List<Task> selectQueryByMyCompleteTask(TaskSearchContext context);
    List<Task> selectQueryByMyCompleteTaskMobDaily(TaskSearchContext context);
    List<Task> selectQueryByMyCompleteTaskMobMonthly(TaskSearchContext context);
    List<Task> selectQueryByMyCompleteTaskMonthlyZS(TaskSearchContext context);
    List<Task> selectQueryByMyCompleteTaskZS(TaskSearchContext context);
    List<Task> selectQueryByMyFavorites(TaskSearchContext context);
    List<Task> selectQueryByMyPlansTaskMobMonthly(TaskSearchContext context);
    List<Task> selectQueryByMyTomorrowPlanTask(TaskSearchContext context);
    List<Task> selectQueryByMyTomorrowPlanTaskMobDaily(TaskSearchContext context);
    List<Task> selectQueryByNextWeekCompleteTaskMobZS(TaskSearchContext context);
    List<Task> selectQueryByNextWeekCompleteTaskZS(TaskSearchContext context);
    List<Task> selectQueryByNextWeekPlanCompleteTask(TaskSearchContext context);
    List<Task> selectQueryByPlanTask(TaskSearchContext context);
    List<Task> selectQueryByProjectAppTask(TaskSearchContext context);
    List<Task> selectQueryByProjectTask(TaskSearchContext context);
    List<Task> selectQueryByRootTask(TaskSearchContext context);
    List<Task> selectQueryByTaskLinkPlan(TaskSearchContext context);
    List<Task> selectQueryByThisMonthCompleteTaskChoice(TaskSearchContext context);
    List<Task> selectQueryByThisWeekCompleteTask(TaskSearchContext context);
    List<Task> selectQueryByThisWeekCompleteTaskChoice(TaskSearchContext context);
    List<Task> selectQueryByThisWeekCompleteTaskMobZS(TaskSearchContext context);
    List<Task> selectQueryByThisWeekCompleteTaskZS(TaskSearchContext context);
    List<Task> selectQueryByTodoListTask(TaskSearchContext context);
    List<Task> selectQueryByTypeGroup(TaskSearchContext context);
    List<Task> selectQueryByTypeGroupPlan(TaskSearchContext context);
    List<Task> selectQueryByView(TaskSearchContext context);
