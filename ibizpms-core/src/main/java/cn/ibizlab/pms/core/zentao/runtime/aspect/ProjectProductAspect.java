...
import cn.ibizlab.pms.core.sample.runtime.IProjectProductRuntime;
...
@Slf4j
public class ProjectProductAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IProjectProductRuntime projectProductRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) projectProductRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundDataSet("RelationPlan", point);
        }
        return point.proceed();
    }
}
