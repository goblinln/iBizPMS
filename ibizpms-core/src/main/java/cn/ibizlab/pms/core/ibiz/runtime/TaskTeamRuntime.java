...
@Slf4j
public class TaskTeamRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ITaskTeamRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),TaskTeam.class);
        } catch (Exception e) {
    ...
    public List<TaskTeam> select(ISearchContextBase iSearchContextBase) {
        TaskTeamSearchContext searchContext = (TaskTeamSearchContext) iSearchContextBase;
        return taskteamService.select(searchContext);
    }
