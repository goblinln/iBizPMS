...
import cn.ibizlab.pms.core.sample.runtime.ITaskStatsRuntime;
...
@Slf4j
public class TaskStatsAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ITaskStatsRuntime taskStatsRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) taskStatsRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        else if (action.equals("searchTaskFinishHuiZong")) {
            return getDataEntityRuntime().aroundDataSet("TaskFinishHuiZong", point);
        }
        else if (action.equals("searchUserFinishTaskSum")) {
            return getDataEntityRuntime().aroundDataSet("UserFinishTaskSum", point);
        }
        return point.proceed();
    }
}
