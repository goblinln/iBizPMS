 ...
 */
@Configuration
public class SysPostFeignClientConfiguration {
    ...
    @Bean
    public SysPostFeignClient sysPostFeignClient(Decoder decoder, Encoder encoder, Client client, Contract contract, List<RequestInterceptor> requestInterceptors) {
        ...
        if (builder instanceof HystrixFeign.Builder) {
            ...
            return nameBuilder.target(SysPostFeignClient.class, "http://" + serviceValue, new SysPostFallback());
        } else {
            Feign.Builder nameBuilder = Feign.builder()
                    ...
                    .contract(contract)
                    .requestInterceptors(requestInterceptors);
            return nameBuilder.target(SysPostFeignClient.class, "http://" + serviceValue);
        }
    }
}
