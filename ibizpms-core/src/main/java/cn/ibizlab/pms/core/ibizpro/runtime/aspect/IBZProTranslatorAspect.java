...
import cn.ibizlab.pms.core.sample.runtime.IIBZProTranslatorRuntime;
...
@Slf4j
public class IBZProTranslatorAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIBZProTranslatorRuntime iBZProTranslatorRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) iBZProTranslatorRuntime;
    }
