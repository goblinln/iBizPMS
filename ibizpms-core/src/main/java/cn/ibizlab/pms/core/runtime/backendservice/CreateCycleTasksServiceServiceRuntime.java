...
@Aspect
@Order(100)
@Component("CreateCycleTasksServiceServiceRuntime")
public class CreateCycleTasksServiceServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/ibizpro/PSSYSBACKSERVICES/CreateCycleTasksService.json";
    }
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.CreateCycleTasksServiceJobHandler.execute(..))")
