...
@Aspect
@Order(100)
@Component("pushProjectWeeklyServiceRuntime")
public class pushProjectWeeklyServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.pushProjectWeeklyJobHandler.execute(..))")
