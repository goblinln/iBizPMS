...
@TableName(value = "zt_history", resultMap = "IBZProTestTaskHistoryResultMap")
@ApiModel("测试单操作历史")
public class IBZProTestTaskHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IbzProTestTaskAction ibzprotesttask;
