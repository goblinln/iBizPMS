...
import cn.ibizlab.pms.core.sample.runtime.IImClientRuntime;
...
@Slf4j
public class ImClientAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IImClientRuntime imClientRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) imClientRuntime;
    }
