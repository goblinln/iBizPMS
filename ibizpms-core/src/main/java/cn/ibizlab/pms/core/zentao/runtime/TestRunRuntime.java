...
public class TestRunRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    public boolean existsData(ISearchContextBase iSearchContextBase) {
        Page<TestRun> domains = testrunService.searchDefault((TestRunSearchContext) iSearchContextBase);
    ...
    public Page<TestRun> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return testrunService.searchDefault((TestRunSearchContext) iSearchContextBase);
        return null;
    }
    ...
    public List<TestRun> select(ISearchContextBase iSearchContextBase) {
        return testrunService.searchDefault((TestRunSearchContext) iSearchContextBase).getContent();
    }
