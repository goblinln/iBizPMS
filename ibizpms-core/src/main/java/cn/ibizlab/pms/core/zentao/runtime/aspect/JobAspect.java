...
import cn.ibizlab.pms.core.sample.runtime.IJobRuntime;
...
@Slf4j
public class JobAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IJobRuntime jobRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) jobRuntime;
    }
