...
public interface IbizproProjectMonthlyMapper extends BaseMapper<IbizproProjectMonthly> {
    ...
    List<IbizproProjectMonthly> selectDefault(@Param("srf") IbizproProjectMonthlySearchContext context, @Param("ew") Wrapper<IbizproProjectMonthly> wrapper);
    List<IbizproProjectMonthly> selectView(@Param("srf") IbizproProjectMonthlySearchContext context, @Param("ew") Wrapper<IbizproProjectMonthly> wrapper);
