...
@TableName(value = "zt_history", resultMap = "IBZProToDoHistoryResultMap")
@ApiModel("todo操作历史")
public class IBZProToDoHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZProToDoAction ibzprotodohistory;
