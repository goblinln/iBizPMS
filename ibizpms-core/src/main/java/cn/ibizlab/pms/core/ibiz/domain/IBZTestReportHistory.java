...
@TableName(value = "zt_history", resultMap = "IBZTestReportHistoryResultMap")
@ApiModel("报告操作历史")
public class IBZTestReportHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZTestReportAction testreportaction;
