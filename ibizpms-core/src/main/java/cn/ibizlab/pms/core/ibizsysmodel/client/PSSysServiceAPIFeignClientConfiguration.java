...
/**
 * 实体[PSSysServiceAPI] 服务对象接口配置
 */
@Configuration
public class PSSysServiceAPIFeignClientConfiguration {
    ...
    @Bean
    public PSSysServiceAPIFeignClient pSSysServiceAPIFeignClient(Decoder decoder, Encoder encoder, Client client, Contract contract, List<RequestInterceptor> requestInterceptors) {
        ...
        if (builder instanceof HystrixFeign.Builder) {
            ...
            return nameBuilder.target(PSSysServiceAPIFeignClient.class, "http://" + serviceValue, new PSSysServiceAPIFallback());
        } else {
            Feign.Builder nameBuilder = Feign.builder()
                    ...
                    .contract(contract)
                    .requestInterceptors(requestInterceptors);
            return nameBuilder.target(PSSysServiceAPIFeignClient.class, "http://" + serviceValue);
        }
    }
}
