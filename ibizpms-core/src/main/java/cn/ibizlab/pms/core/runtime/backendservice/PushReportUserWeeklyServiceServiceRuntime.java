...
@Aspect
@Order(100)
@Component("PushReportUserWeeklyServiceServiceRuntime")
public class PushReportUserWeeklyServiceServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/report/PSSYSBACKSERVICES/PushReportUserWeeklyService.json";
    }

    @Override
    public String getName() {
        return "定时推送待阅提醒用户周报提交";
    }

    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.PushReportUserWeeklyServiceJobHandler.execute(..))")
