...
public interface IbzProTestTaskActionMapper extends BaseMapper<IbzProTestTaskAction> {
    ...
    @Override
    int insert(IbzProTestTaskAction entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IbzProTestTaskAction entity);
    @Override
    int update(@Param(Constants.ENTITY) IbzProTestTaskAction entity, @Param("ew") Wrapper<IbzProTestTaskAction> updateWrapper);
    @Override
