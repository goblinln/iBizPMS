...
@Component
@Slf4j
public class ConfigRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IConfigRuntime {
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof Config){
                    Config arg = (Config) args[0] ;
                    CachedBeanCopier.copy(configService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return configService.sysUpdate((Config) args[0]);
            }             
        }
