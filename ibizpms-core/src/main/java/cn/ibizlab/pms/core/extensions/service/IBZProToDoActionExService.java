...
import cn.ibizlab.pms.core.ibiz.service.impl.IBZProToDoActionServiceImpl;
...
@Slf4j
@Primary
@Service("IBZProToDoActionExService")
public class IBZProToDoActionExService extends IBZProToDoActionServiceImpl {
