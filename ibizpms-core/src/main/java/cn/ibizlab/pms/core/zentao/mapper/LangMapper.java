...
public interface LangMapper extends BaseMapper<Lang> {
    ...
    @Override
    Lang selectById(Serializable id);
    @Override
    int insert(Lang entity);
    @Override
    int updateById(@Param(Constants.ENTITY) Lang entity);
    @Override
    int update(@Param(Constants.ENTITY) Lang entity, @Param("ew") Wrapper<Lang> updateWrapper);
    @Override
