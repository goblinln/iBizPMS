...
public interface TaskEstimateMapper extends BaseMapper<TaskEstimate> {
    ...
    Page<TaskEstimate> searchActionDate(IPage page, @Param("srf") TaskEstimateSearchContext context, @Param("ew") Wrapper<TaskEstimate> wrapper);
    Page<TaskEstimate> searchActionDateByProject(IPage page, @Param("srf") TaskEstimateSearchContext context, @Param("ew") Wrapper<TaskEstimate> wrapper);
    ...
    Page<TaskEstimate> searchMyActionDate(IPage page, @Param("srf") TaskEstimateSearchContext context, @Param("ew") Wrapper<TaskEstimate> wrapper);
    Page<TaskEstimate> searchPersonalEstimate(IPage page, @Param("srf") TaskEstimateSearchContext context, @Param("ew") Wrapper<TaskEstimate> wrapper);
    ...
    Page<TaskEstimate> searchProjectMemberLog(IPage page, @Param("srf") TaskEstimateSearchContext context, @Param("ew") Wrapper<TaskEstimate> wrapper);
