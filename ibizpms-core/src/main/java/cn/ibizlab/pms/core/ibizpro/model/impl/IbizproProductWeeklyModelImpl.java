...
public class IbizproProductWeeklyModelImpl extends DataEntityModelImpl {
    ...
    public boolean test(Serializable key, String action) {
        ...
        if (ibizproproductweeklyService.searchDefault(context).getTotalElements() == 0) {
            return false;
        }
    ...
    public boolean test(List<Serializable> keys, String action) {
        ...
        if (ibizproproductweeklyService.searchDefault(context).getTotalElements() != keys.size()) {
            return false;
        }
