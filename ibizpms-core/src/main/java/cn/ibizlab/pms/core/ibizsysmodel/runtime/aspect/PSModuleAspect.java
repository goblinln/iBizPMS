...
import cn.ibizlab.pms.core.ibizsysmodel.runtime.IPSModuleRuntime;
...
@Slf4j
@Component
public class PSModuleAspect {

     @Autowired
    IPSModuleRuntime pSModuleRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) pSModuleRuntime;
    }
