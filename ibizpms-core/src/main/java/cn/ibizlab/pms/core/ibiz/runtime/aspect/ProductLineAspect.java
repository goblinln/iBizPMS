...
import cn.ibizlab.pms.core.sample.runtime.IProductLineRuntime;
...
@Slf4j
public class ProductLineAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IProductLineRuntime productLineRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) productLineRuntime;
    }
