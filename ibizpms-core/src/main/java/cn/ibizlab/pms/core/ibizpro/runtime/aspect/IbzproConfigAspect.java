...
import cn.ibizlab.pms.core.sample.runtime.IIbzproConfigRuntime;
...
@Slf4j
public class IbzproConfigAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzproConfigRuntime ibzproConfigRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzproConfigRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("GetSystemConfig", point);
        }
