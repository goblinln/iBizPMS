...
import cn.ibizlab.pms.core.sample.runtime.IIbizproProductMonthlyRuntime;
...
@Slf4j
public class IbizproProductMonthlyAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbizproProductMonthlyRuntime ibizproProductMonthlyRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibizproProductMonthlyRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("ManualCreateMonthly", point);
        }
        else if (action.equals("save")) {
            return getDataEntityRuntime().aroundAction("Save", point);
        }
        else if (action.equals("statsProductMonthly")) {
            return getDataEntityRuntime().aroundAction("StatsProductMonthly", point);
        }
