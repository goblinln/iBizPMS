...
public class IbizproProjectWeeklyRuntime extends DataEntityRuntime {
    ...
    @Around("execution(* cn.ibizlab.pms.core.ibizpro.service.IbizproProjectWeeklyServiceImpl.*(..))")
