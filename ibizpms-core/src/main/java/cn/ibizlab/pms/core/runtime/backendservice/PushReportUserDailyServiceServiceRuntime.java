...
@Aspect
@Order(100)
@Component("PushReportUserDailyServiceServiceRuntime")
public class PushReportUserDailyServiceServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/report/PSSYSBACKSERVICES/PushReportUserDailyService.json";
    }
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.PushReportUserDailyServiceJobHandler.execute(..))")
