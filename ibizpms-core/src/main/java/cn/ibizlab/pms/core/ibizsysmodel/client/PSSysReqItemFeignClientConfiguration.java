...
/**
 * 实体[PSSysReqItem] 服务对象接口配置
 */
@Configuration
public class PSSysReqItemFeignClientConfiguration {
    ...
    @Bean
    public PSSysReqItemFeignClient pSSysReqItemFeignClient(Decoder decoder, Encoder encoder, Client client, Contract contract, List<RequestInterceptor> requestInterceptors) {
        ...
        if (builder instanceof HystrixFeign.Builder) {
            ...
            return nameBuilder.target(PSSysReqItemFeignClient.class, "http://" + serviceValue, new PSSysReqItemFallback());
        } else {
            Feign.Builder nameBuilder = Feign.builder()
                    ...
                    .contract(contract)
                    .requestInterceptors(requestInterceptors);
            return nameBuilder.target(PSSysReqItemFeignClient.class, "http://" + serviceValue);
        }
    }
}
