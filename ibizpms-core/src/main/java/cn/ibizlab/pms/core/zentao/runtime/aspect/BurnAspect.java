...
import cn.ibizlab.pms.core.sample.runtime.IBurnRuntime;
...
@Slf4j
public class BurnAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IBurnRuntime burnRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) burnRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("ComputeBurn", point);
        }
            ...
            return getDataEntityRuntime().aroundDataSet("ESTIMATEANDLEFT", point);
        }
        return point.proceed();
    }
}
