...
@Component
@Slf4j
public class IbiLoginRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IIbiLoginRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),IbiLogin.class);
        } catch (Exception e) {
    ...
    public List<IbiLogin> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return ibiloginService.selectDefault(searchContext);
