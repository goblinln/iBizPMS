...
import cn.ibizlab.pms.core.sample.runtime.IProjectStoryRuntime;
...
@Slf4j
public class ProjectStoryAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IProjectStoryRuntime projectStoryRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) projectStoryRuntime;
    }
