...
public class PSSubSysSADEFeignClientConfiguration {
    ...
    @Bean
    public PSSubSysSADEFeignClient pSSubSysSADEFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(PSSubSysSADEFeignClient.class, new PSSubSysSADEFallback(), serviceValue, requestInterceptors);
    }
}
