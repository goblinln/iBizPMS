...
import cn.ibizlab.pms.core.sample.runtime.IAccountTaskestimateRuntime;
...
@Slf4j
public class AccountTaskestimateAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IAccountTaskestimateRuntime accountTaskestimateRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) accountTaskestimateRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundDataSet("AllAccountEstimate", point);
        }
