...
import cn.ibizlab.pms.core.sample.runtime.IUserQueryRuntime;
...
@Slf4j
public class UserQueryAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IUserQueryRuntime userQueryRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) userQueryRuntime;
    }
