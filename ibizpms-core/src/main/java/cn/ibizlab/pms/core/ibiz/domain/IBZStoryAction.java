...
@TableName(value = "zt_action", resultMap = "IBZStoryActionResultMap")
@ApiModel("需求日志")
public class IBZStoryAction extends EntityMP implements Serializable {
    ...
    @TableField(exist = false)
    private cn.ibizlab.pms.core.zentao.domain.Story der1nIbzproStoryactionZtStoryObjectid;
