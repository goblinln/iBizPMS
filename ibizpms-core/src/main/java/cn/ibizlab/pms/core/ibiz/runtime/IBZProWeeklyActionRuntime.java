...
@Component("IBZProWeeklyActionRuntime")
@Slf4j
public class IBZProWeeklyActionRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

    @Autowired
    IIBZProWeeklyActionService ibzproweeklyactionService;
    ...
    protected IEntityBase getSimpleEntity(Object o) {
        if (o instanceof net.ibizsys.runtime.util.IEntityBase) {
            ...
            return ibzproweeklyactionService.sysGet((Long) o);
        }
    }

    @Override
    public String getId() {
        return "PSMODULES/ibiz/PSDATAENTITIES/IBZProWeeklyAction.json";
    }

    @Override
    public String getName() {
        return "IBZPRO_WEEKLYACTION";
    }

    @Override
    public IEntityBase createEntity() {
        return new IBZProWeeklyAction();
    }

    @Override
    protected IService getService() {
        return this.ibzproweeklyactionService;
    }

    @Override
    public IBZProWeeklyActionSearchContext createSearchContext() {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),IBZProWeeklyAction.class);
        } catch (Exception e) {
    ...
    @Override
    public Page<IBZProWeeklyAction> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
    ...
    @Override
    public List<IBZProWeeklyAction> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        IBZProWeeklyActionSearchContext searchContext = (IBZProWeeklyActionSearchContext) iSearchContextBase;
    ...
    @Override
    public List<IBZProWeeklyAction> select(ISearchContextBase iSearchContextBase) {
        IBZProWeeklyActionSearchContext searchContext = (IBZProWeeklyActionSearchContext) iSearchContextBase;
        return ibzproweeklyactionService.select(searchContext);
    }
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        IBZProWeeklyAction entity = null;
        String action = iPSDEAction.getName();
        if (arg0 instanceof IBZProWeeklyAction) {
            entity = (IBZProWeeklyAction) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = ibzproweeklyactionService.sysGet((Long) arg0);
            } else if ("remove".equalsIgnoreCase(action)) {
                entity = new IBZProWeeklyAction();
    ...
    @Around("execution(* cn.ibizlab.pms.core.ibiz.service.impl.IBZProWeeklyActionServiceImpl.*(..))")
    @Transactional
