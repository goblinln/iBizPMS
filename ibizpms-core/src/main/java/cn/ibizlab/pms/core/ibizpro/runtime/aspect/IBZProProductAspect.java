...
import cn.ibizlab.pms.core.sample.runtime.IIBZProProductRuntime;
...
@Slf4j
public class IBZProProductAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIBZProProductRuntime iBZProProductRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) iBZProProductRuntime;
    }
