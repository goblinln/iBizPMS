...
@Component
@Slf4j
public class RepoFilesRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IRepoFilesRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),RepoFiles.class);
        } catch (Exception e) {
    ...
    @Override
    public Page<RepoFiles> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        RepoFilesSearchContext searchContext = (RepoFilesSearchContext) iSearchContextBase;
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return repofilesService.searchDefault(searchContext);    
        return null;
    }
    ...
    public List<RepoFiles> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return repofilesService.selectDefault(searchContext);
        if (iPSDataQuery.getName().equals("VIEW"))
            return repofilesService.selectView(searchContext);
        return null;
    }
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof RepoFiles){
                    RepoFiles arg = (RepoFiles) args[0] ;
                    CachedBeanCopier.copy(repofilesService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return repofilesService.sysUpdate((RepoFiles) args[0]);
            }             
        }
