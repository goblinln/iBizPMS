...
import cn.ibizlab.pms.core.sample.runtime.ITaskMsgRecordRuntime;
...
@Slf4j
public class TaskMsgRecordAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ITaskMsgRecordRuntime taskMsgRecordRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) taskMsgRecordRuntime;
    }
