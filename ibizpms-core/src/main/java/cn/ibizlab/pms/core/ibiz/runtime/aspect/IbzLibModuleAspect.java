...
import cn.ibizlab.pms.core.sample.runtime.IIbzLibModuleRuntime;
...
@Slf4j
public class IbzLibModuleAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzLibModuleRuntime ibzLibModuleRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzLibModuleRuntime;
    }
