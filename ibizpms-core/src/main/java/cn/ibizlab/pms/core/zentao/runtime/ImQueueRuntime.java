...
@Slf4j
public class ImQueueRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IImQueueRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),ImQueue.class);
        } catch (Exception e) {
    ...
    public Page<ImQueue> searchDataSet(IPSDEDataSet iPSDEDataSet, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDEDataSet.getName().equals("DEFAULT"))
            return imqueueService.searchDefault(searchContext);    
        return null;
    }
    ...
    public List<ImQueue> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return imqueueService.selectDefault(searchContext);
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        ...
        if (arg0 instanceof ImQueue) {
            entity = (ImQueue) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = imqueueService.sysGet((Long) arg0);
