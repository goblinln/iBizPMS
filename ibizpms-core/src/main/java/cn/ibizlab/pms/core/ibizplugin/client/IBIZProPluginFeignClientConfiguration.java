...
public class IBIZProPluginFeignClientConfiguration {
    ...
    @Bean
    public IBIZProPluginFeignClient iBIZProPluginFeignClient() {
        ...
        return outsideAccessorUtils.buildAccessor(IBIZProPluginFeignClient.class, new IBIZProPluginFallback(), serviceValue, requestInterceptors);
    }
}
