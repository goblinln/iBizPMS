...
import cn.ibizlab.pms.core.sample.runtime.IIbzFavoritesRuntime;
...
@Slf4j
public class IbzFavoritesAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzFavoritesRuntime ibzFavoritesRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzFavoritesRuntime;
    }
