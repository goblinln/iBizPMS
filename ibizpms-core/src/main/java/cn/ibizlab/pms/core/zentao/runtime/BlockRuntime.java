...
public class BlockRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IBlockRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Block.class);
        } catch (Exception e) {
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof Block){
                    Block arg = (Block) args[0] ;
                    CachedBeanCopier.copy(blockService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return blockService.sysUpdate((Block) args[0]);
            }             
        }
