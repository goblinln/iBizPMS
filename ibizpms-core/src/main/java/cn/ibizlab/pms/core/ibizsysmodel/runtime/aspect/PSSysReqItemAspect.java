...
import cn.ibizlab.pms.core.ibizsysmodel.runtime.IPSSysReqItemRuntime;
...
@Slf4j
@Component
public class PSSysReqItemAspect {

     @Autowired
    IPSSysReqItemRuntime pSSysReqItemRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) pSSysReqItemRuntime;
    }
