...
import net.ibizsys.runtime.dataentity.DEActionModes;
import net.ibizsys.runtime.dataentity.DEActions;
import net.ibizsys.runtime.dataentity.DERTypes;
...
public abstract class SystemDataEntityRuntime extends SystemDataEntityRuntimeBase {
    ...
    @Override
    protected void translateEntityAfterProceed(Object arg0, Object objRet, String strActionName, IPSDEAction iPSDEAction, IPSDataEntity iPSDataEntity, ProceedingJoinPoint joinPoint) throws Throwable {
     ...
     * @throws Exception
     */
    protected void resetEntityInvalidFKey(IEntityBase arg0, String strActionName, IPSDEAction iPSDEAction, IPSDataEntity iPSDataEntity, ProceedingJoinPoint joinPoint) throws Throwable {
        //查询实体的从关系
    ...
    protected void resetEntityInvalidFKey(IEntityBase arg0, String strActionName, IPSDEAction iPSDEAction, IPSDER1N iPSDER1N, IPSDataEntity iPSDataEntity, ProceedingJoinPoint joinPoint) throws Throwable {
