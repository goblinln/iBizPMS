...
public interface IIBZTestSuiteActionService extends IService<IBZTestSuiteAction> {
    ...
    IBZTestSuiteAction comment(IBZTestSuiteAction et);
    boolean commentBatch(List<IBZTestSuiteAction> etList);
    IBZTestSuiteAction createHis(IBZTestSuiteAction et);
    boolean createHisBatch(List<IBZTestSuiteAction> etList);
    IBZTestSuiteAction editComment(IBZTestSuiteAction et);
    boolean editCommentBatch(List<IBZTestSuiteAction> etList);
    IBZTestSuiteAction managePmsEe(IBZTestSuiteAction et);
    boolean managePmsEeBatch(List<IBZTestSuiteAction> etList);
    boolean save(IBZTestSuiteAction et);
    void saveBatch(List<IBZTestSuiteAction> list);
    IBZTestSuiteAction sendMarkDone(IBZTestSuiteAction et);
    boolean sendMarkDoneBatch(List<IBZTestSuiteAction> etList);
    IBZTestSuiteAction sendTodo(IBZTestSuiteAction et);
    boolean sendTodoBatch(List<IBZTestSuiteAction> etList);
    IBZTestSuiteAction sendToread(IBZTestSuiteAction et);
    boolean sendToreadBatch(List<IBZTestSuiteAction> etList);
