...
@TableName(value = "zt_history", resultMap = "IBZProProductHistoryResultMap")
@ApiModel("产品操作历史")
public class IBZProProductHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZProProductAction productaction;
