...
/**
 * 关系型数据实体[IBZProProjectAction] 查询条件对象
 */
@Slf4j
@Data
public class IBZProProjectActionSearchContext extends QueryWrapperContext<IBZProProjectAction> {
	...
	private Long n_objectid_eq;//[项目编号]
