...
@Component
@Slf4j
public class ImChatRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IImChatRuntime {
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof ImChat){
                    ImChat arg = (ImChat) args[0] ;
                    CachedBeanCopier.copy(imchatService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return imchatService.sysUpdate((ImChat) args[0]);
            }             
        }
