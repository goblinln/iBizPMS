...
public class IbzproProductUserTaskRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    protected IEntityBase getSimpleEntity(Object o) {
        if (o instanceof net.ibizsys.runtime.util.IEntity) {
            ...
            return (IEntityBase) ibzproproductusertaskService.sysGet((Long) o);
        }
    }
    ...
    @Override
    public Page<IbzproProductUserTask> searchDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        //暂未实现
        return null;
    }
        ...
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                ...
                if(args[0] instanceof IbzproProductUserTask){
                    ...
                    arg = ibzproproductusertaskService.get(arg.getId()) ;
                    return arg;
                }else{
