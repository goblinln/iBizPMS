...
import cn.ibizlab.pms.core.sample.runtime.IImConferenceRuntime;
...
@Slf4j
public class ImConferenceAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IImConferenceRuntime imConferenceRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) imConferenceRuntime;
    }
