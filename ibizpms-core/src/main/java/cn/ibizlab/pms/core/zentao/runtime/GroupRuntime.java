...
@Aspect
@Order(100)
@Component("GroupRuntime")
@Slf4j
public class GroupRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    protected IEntityBase getSimpleEntity(Object o) {
        if (o instanceof net.ibizsys.runtime.util.IEntityBase) {
            ...
            return groupService.sysGet((Long) o);
        }
    }

    @Override
    public String getId() {
        return "PSMODULES/zentao/PSDATAENTITIES/Group.json";
    }
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Group.class);
        } catch (Exception e) {
    ...
    public Group selectOne(ISearchContextBase iSearchContextBase) {
        ...
        List<Group> domains = groupService.select(searchContext);
        if (domains.size() == 0)
            return null;
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        ...
        if (arg0 instanceof Group) {
            ...
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = groupService.sysGet((Long) arg0);
    ...
    @Around("execution(* cn.ibizlab.pms.core.zentao.service.impl.GroupServiceImpl.*(..))")
    @Transactional
