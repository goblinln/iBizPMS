...
import cn.ibizlab.pms.core.ibizsysmodel.runtime.IPSSysRunSessionRuntime;
...
@Slf4j
@Component
public class PSSysRunSessionAspect {

     @Autowired
    IPSSysRunSessionRuntime pSSysRunSessionRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) pSSysRunSessionRuntime;
    }

    @Around("execution(* cn.ibizlab.pms.core.ibizsysmodel.service.impl.PSSysRunSessionServiceImpl.*(..))")
    @Transactional
