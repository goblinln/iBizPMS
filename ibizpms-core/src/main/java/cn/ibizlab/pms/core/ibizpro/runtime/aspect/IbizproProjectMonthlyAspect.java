...
import cn.ibizlab.pms.core.sample.runtime.IIbizproProjectMonthlyRuntime;
...
@Slf4j
public class IbizproProjectMonthlyAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbizproProjectMonthlyRuntime ibizproProjectMonthlyRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibizproProjectMonthlyRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("SumProjectMonthly", point);
        }
