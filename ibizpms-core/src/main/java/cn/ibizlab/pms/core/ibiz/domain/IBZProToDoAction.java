...
@TableName(value = "zt_action", resultMap = "IBZProToDoActionResultMap")
@ApiModel("ToDo日志")
public class IBZProToDoAction extends EntityMP implements Serializable {
    ...
    @TableField(exist = false)
    private cn.ibizlab.pms.core.zentao.domain.Todo ibzprotodoaction;
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private List<cn.ibizlab.pms.core.ibiz.domain.IBZProToDoHistory> ibzprotodohistory;
