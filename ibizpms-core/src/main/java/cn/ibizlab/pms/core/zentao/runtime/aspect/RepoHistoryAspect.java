...
import cn.ibizlab.pms.core.sample.runtime.IRepoHistoryRuntime;
...
@Slf4j
public class RepoHistoryAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IRepoHistoryRuntime repoHistoryRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) repoHistoryRuntime;
    }
