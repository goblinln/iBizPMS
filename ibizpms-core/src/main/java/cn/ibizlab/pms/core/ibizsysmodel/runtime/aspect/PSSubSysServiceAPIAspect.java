...
import cn.ibizlab.pms.core.sample.runtime.IPSSubSysServiceAPIRuntime;
...
@Slf4j
public class PSSubSysServiceAPIAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IPSSubSysServiceAPIRuntime pSSubSysServiceAPIRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) pSSubSysServiceAPIRuntime;
    }
