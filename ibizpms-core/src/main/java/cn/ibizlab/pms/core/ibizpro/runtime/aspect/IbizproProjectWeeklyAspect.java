...
import cn.ibizlab.pms.core.sample.runtime.IIbizproProjectWeeklyRuntime;
...
@Slf4j
public class IbizproProjectWeeklyAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbizproProjectWeeklyRuntime ibizproProjectWeeklyRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibizproProjectWeeklyRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundAction("pushSumProjectWeekly", point);
        }
