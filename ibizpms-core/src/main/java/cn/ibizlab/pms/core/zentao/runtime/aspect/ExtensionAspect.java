...
import cn.ibizlab.pms.core.sample.runtime.IExtensionRuntime;
...
@Slf4j
public class ExtensionAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IExtensionRuntime extensionRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) extensionRuntime;
    }
