...
import cn.ibizlab.pms.core.sample.runtime.IIbzReportRoleConfigRuntime;
...
@Slf4j
public class IbzReportRoleConfigAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIbzReportRoleConfigRuntime ibzReportRoleConfigRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) ibzReportRoleConfigRuntime;
    }
