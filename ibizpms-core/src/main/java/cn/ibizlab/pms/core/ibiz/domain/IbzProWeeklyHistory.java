...
@TableName(value = "zt_history", resultMap = "IbzProWeeklyHistoryResultMap")
@ApiModel("周报操作历史")
public class IbzProWeeklyHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZProWeeklyAction ibzproweeklyhistory;
