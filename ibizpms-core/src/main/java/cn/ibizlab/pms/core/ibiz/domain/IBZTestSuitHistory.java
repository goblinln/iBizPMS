...
@TableName(value = "zt_history", resultMap = "IBZTestSuitHistoryResultMap")
@ApiModel("套件操作历史")
public class IBZTestSuitHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IBZTestSuiteAction testsuitaction;
