...
public class IbzLibModuleRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    protected IService getService() {
        return this.ibzlibmoduleService;
    }

    @Override
    public IbzLibModuleSearchContext createSearchContext() {
        return new IbzLibModuleSearchContext();
    }
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),IbzLibModule.class);
        } catch (Exception e) {
    ...
    public List<IbzLibModule> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return ibzlibmoduleService.selectDefault(searchContext);
        if (iPSDataQuery.getName().equals("Root_NoBranch"))
            return ibzlibmoduleService.selectRoot_NoBranch(searchContext);
        if (iPSDataQuery.getName().equals("VIEW"))
            return ibzlibmoduleService.selectView(searchContext);
        return null;
    }
    ...
    public List<IbzLibModule> select(ISearchContextBase iSearchContextBase) {
        IbzLibModuleSearchContext searchContext = (IbzLibModuleSearchContext) iSearchContextBase;
        return ibzlibmoduleService.select(searchContext);
    }
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                return ibzlibmoduleService.create((IbzLibModule) args[0]);
            }
            else if (iPSDEAction.getName().equals("Update")) {
                return ibzlibmoduleService.update((IbzLibModule) args[0]);
            }
            else if (iPSDEAction.getName().equals("Remove")) {
                return ibzlibmoduleService.remove((Long) args[0]);
            }
            else if (iPSDEAction.getName().equals("Get")) {
                if(args[0] instanceof IbzLibModule){
                    IbzLibModule arg = (IbzLibModule) args[0] ;
                    CachedBeanCopier.copy(ibzlibmoduleService.get(arg.getId()), arg);
                    return arg;
                }else{
                    return ibzlibmoduleService.get((Long) args[0]);
                }
            }
            else if (iPSDEAction.getName().equals("GetDraft")) {
                return ibzlibmoduleService.getDraft((IbzLibModule) args[0]);
            }
            else if (iPSDEAction.getName().equals("CheckKey")) {
                return ibzlibmoduleService.checkKey((IbzLibModule) args[0]);
            }
            else if (iPSDEAction.getName().equals("Save")) {
                return ibzlibmoduleService.save((IbzLibModule) args[0]);
            }
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof IbzLibModule){
                    IbzLibModule arg = (IbzLibModule) args[0] ;
                    CachedBeanCopier.copy(ibzlibmoduleService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return ibzlibmoduleService.sysUpdate((IbzLibModule) args[0]);
            }             
        }
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        IbzLibModule entity = null;
        String action = iPSDEAction.getName();
        if (arg0 instanceof IbzLibModule) {
            entity = (IbzLibModule) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = ibzlibmoduleService.sysGet((Long) arg0);
            } else if ("remove".equalsIgnoreCase(action)) {
                entity = new IbzLibModule();
