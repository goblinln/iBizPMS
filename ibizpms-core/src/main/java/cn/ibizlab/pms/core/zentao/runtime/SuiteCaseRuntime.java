...
@Slf4j
public class SuiteCaseRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ISuiteCaseRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),SuiteCase.class);
        } catch (Exception e) {
    ...
    public List<SuiteCase> select(ISearchContextBase iSearchContextBase) {
        SuiteCaseSearchContext searchContext = (SuiteCaseSearchContext) iSearchContextBase;
        return suitecaseService.select(searchContext);
    }
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof SuiteCase){
                    SuiteCase arg = (SuiteCase) args[0] ;
                    CachedBeanCopier.copy(suitecaseService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return suitecaseService.sysUpdate((SuiteCase) args[0]);
            }             
        }
