...
@Component
@Slf4j
public class ScoreRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IScoreRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Score.class);
        } catch (Exception e) {
