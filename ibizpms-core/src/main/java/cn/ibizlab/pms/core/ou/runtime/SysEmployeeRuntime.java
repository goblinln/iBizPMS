...
@Slf4j
public class SysEmployeeRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return aroundDataSet("ContActList", point);
        }
        else if (action.equals("searchDefault")) {
            return aroundDataSet("DEFAULT", point);
        }
        else if (action.equals("searchProductTeamM")) {
            return aroundDataSet("ProductTeamM", point);
        }
            ...
            return aroundDataSet("ProjectTeamMProduct", point);
        }
        else if (action.equals("searchProjectTeamTaskUserTemp")) {
            return aroundDataSet("ProjectTeamTaskUserTemp", point);
        }
            ...
            return aroundDataSet("ProjectteamPk", point);
        }
        else if (action.equals("searchStoryProductTeamPK")) {
            return aroundDataSet("StoryProductTeamChoice", point);
        }
        else if (action.equals("searchTaskMTeam")) {
            return aroundDataSet("TaskMTeam", point);
        }
