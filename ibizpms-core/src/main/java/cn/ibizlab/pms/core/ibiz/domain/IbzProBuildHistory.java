...
@TableName(value = "zt_history", resultMap = "IbzProBuildHistoryResultMap")
@ApiModel("版本操作历史")
public class IbzProBuildHistory extends EntityMP implements Serializable {
    ...
    private cn.ibizlab.pms.core.ibiz.domain.IbzProBuildAction ibzprobuildhistory;
