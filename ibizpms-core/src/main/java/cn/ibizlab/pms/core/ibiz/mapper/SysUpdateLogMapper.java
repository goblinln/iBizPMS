...
public interface SysUpdateLogMapper extends BaseMapper<SysUpdateLog> {
    ...
    @Override
    SysUpdateLog selectById(Serializable id);
    @Override
    int insert(SysUpdateLog entity);
    @Override
    int updateById(@Param(Constants.ENTITY) SysUpdateLog entity);
    @Override
    int update(@Param(Constants.ENTITY) SysUpdateLog entity, @Param("ew") Wrapper<SysUpdateLog> updateWrapper);
    @Override
