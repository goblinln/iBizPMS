...
import cn.ibizlab.pms.core.sample.runtime.IGroupPrivRuntime;
...
@Slf4j
public class GroupPrivAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IGroupPrivRuntime groupPrivRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) groupPrivRuntime;
    }
