...
import cn.ibizlab.pms.core.sample.runtime.ISysRoleRuntime;
...
@Slf4j
public class SysRoleAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ISysRoleRuntime sysRoleRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) sysRoleRuntime;
    }

    @Around("execution(* cn.ibizlab.pms.core.uaa.service.impl.SysRoleServiceImpl.*(..))")
    @Transactional
