...
import cn.ibizlab.pms.core.sample.runtime.IIBIZProKeywordRuntime;
...
@Slf4j
public class IBIZProKeywordAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIBIZProKeywordRuntime iBIZProKeywordRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) iBIZProKeywordRuntime;
    }
