...
@Slf4j
public class DeptRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IDeptRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Dept.class);
        } catch (Exception e) {
    ...
    public List<Dept> selectDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        ...
        if (iPSDataQuery.getName().equals("DEFAULT"))
            return deptService.selectDefault(searchContext);
        if (iPSDataQuery.getName().equals("ROOT"))
            return deptService.selectRoot(searchContext);
    ...
    protected void onExecuteActionLogics(Object arg0, IPSDEAction iPSDEAction, String strAttachMode, IDynaInstRuntime iDynaInstRuntime, Object joinPoint) throws Throwable {
        ...
        if (arg0 instanceof Dept) {
            entity = (Dept) arg0;
        } else {
            if (arg0 != null && "get".equalsIgnoreCase(action)) {
                entity = deptService.sysGet((Long) arg0);
