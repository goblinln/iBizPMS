...
import cn.ibizlab.pms.core.sample.runtime.IIBZProStoryRuntime;
...
@Slf4j
public class IBZProStoryAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IIBZProStoryRuntime iBZProStoryRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) iBZProStoryRuntime;
    }
