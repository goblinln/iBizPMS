...
public interface IbizproProjectDailyMapper extends BaseMapper<IbizproProjectDaily> {
    ...
    @Override
    IbizproProjectDaily selectById(Serializable id);
    @Override
    int insert(IbizproProjectDaily entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IbizproProjectDaily entity);
    @Override
    int update(@Param(Constants.ENTITY) IbizproProjectDaily entity, @Param("ew") Wrapper<IbizproProjectDaily> updateWrapper);
    @Override
    ...
    */
    ...
    List<IbizproProjectDaily> selectByProject(@Param("id") Serializable id);
