...
public interface IBZProSequenceMapper extends BaseMapper<IBZProSequence> {
    ...
    @Override
    IBZProSequence selectById(Serializable id);
    @Override
    int insert(IBZProSequence entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IBZProSequence entity);
    @Override
    int update(@Param(Constants.ENTITY) IBZProSequence entity, @Param("ew") Wrapper<IBZProSequence> updateWrapper);
    @Override
