...
public interface ImConferenceMapper extends BaseMapper<ImConference> {
    ...
    @Override
    ImConference selectById(Serializable id);
    @Override
    int insert(ImConference entity);
    @Override
    int updateById(@Param(Constants.ENTITY) ImConference entity);
    @Override
    int update(@Param(Constants.ENTITY) ImConference entity, @Param("ew") Wrapper<ImConference> updateWrapper);
    @Override
