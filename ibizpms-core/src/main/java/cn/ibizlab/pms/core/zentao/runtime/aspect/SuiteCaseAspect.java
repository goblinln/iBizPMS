...
import cn.ibizlab.pms.core.sample.runtime.ISuiteCaseRuntime;
...
@Slf4j
public class SuiteCaseAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    ISuiteCaseRuntime suiteCaseRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) suiteCaseRuntime;
    }
