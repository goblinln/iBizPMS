...
@Slf4j
public class UserTplRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IUserTplRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),UserTpl.class);
        } catch (Exception e) {
