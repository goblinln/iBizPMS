...
public class ProjectTaskestimateRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {
    ...
    protected IEntityBase getSimpleEntity(Object o) {
        if (o instanceof net.ibizsys.runtime.util.IEntity) {
            ...
            return (IEntityBase) projecttaskestimateService.sysGet((String) o);
        }
    }
    ...
    @Override
    public Page<ProjectTaskestimate> searchDataQuery(IPSDEDataQuery iPSDataQuery, ISearchContextBase iSearchContextBase) {
        //暂未实现
        return null;
    }
