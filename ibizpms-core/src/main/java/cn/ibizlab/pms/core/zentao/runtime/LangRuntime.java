...
@Slf4j
public class LangRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements ILangRuntime {
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof Lang){
                    Lang arg = (Lang) args[0] ;
                    CachedBeanCopier.copy(langService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return langService.sysUpdate((Lang) args[0]);
            }             
        }
