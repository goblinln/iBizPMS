...
/**
 * 实体[PSSysReqModule] 服务对象接口配置
 */
@Configuration
public class PSSysReqModuleFeignClientConfiguration {
    ...
    @Bean
    public PSSysReqModuleFeignClient pSSysReqModuleFeignClient(Decoder decoder, Encoder encoder, Client client, Contract contract, List<RequestInterceptor> requestInterceptors) {
        ...
        if (builder instanceof HystrixFeign.Builder) {
            ...
            return nameBuilder.target(PSSysReqModuleFeignClient.class, "http://" + serviceValue, new PSSysReqModuleFallback());
        } else {
            Feign.Builder nameBuilder = Feign.builder()
                    ...
                    .contract(contract)
                    .requestInterceptors(requestInterceptors);
            return nameBuilder.target(PSSysReqModuleFeignClient.class, "http://" + serviceValue);
        }
    }
}
