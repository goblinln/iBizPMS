...
@Slf4j
public class EntryRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IEntryRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),Entry.class);
        } catch (Exception e) {
        ...
        if (iPSDEAction != null) {
            if (iPSDEAction.getName().equals("Create")) {
                ...
                if(args[0] instanceof Entry){
                    ...
                    CachedBeanCopier.copy(entryService.get(arg.getId()), arg);
                    return arg;
                }else{
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof Entry){
                    Entry arg = (Entry) args[0] ;
                    CachedBeanCopier.copy(entryService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return entryService.sysUpdate((Entry) args[0]);
            }             
        }
