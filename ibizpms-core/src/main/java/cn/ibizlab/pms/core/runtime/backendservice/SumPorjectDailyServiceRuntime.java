...
@Aspect
@Order(100)
@Component("SumPorjectDailyServiceRuntime")
public class SumPorjectDailyServiceRuntime extends net.ibizsys.runtime.backend.SysDEActionBackendTaskRuntimeBase {
    ...
    @Override
    public String getId() {
        return "PSMODULES/ibizpro/PSSYSBACKSERVICES/SumPorjectDaily.json";
    }
    ...
    @Override
    @Around("execution(* cn.ibizlab.pms.core.util.job.SumPorjectDailyJobHandler.execute(..))")
