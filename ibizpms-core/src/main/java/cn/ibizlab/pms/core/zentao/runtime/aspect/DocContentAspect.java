...
import cn.ibizlab.pms.core.sample.runtime.IDocContentRuntime;
...
@Slf4j
public class DocContentAspect extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime {

     @Autowired
    IDocContentRuntime docContentRuntime;

    private SystemDataEntityRuntime getDataEntityRuntime() {
        return (SystemDataEntityRuntime) docContentRuntime;
    }
    ...
    public Object aroundMethod(ProceedingJoinPoint point) throws Throwable {
        ...
        if (action.equals("create")) {
            ...
            return getDataEntityRuntime().aroundDataSet("CurVersion", point);
        }
