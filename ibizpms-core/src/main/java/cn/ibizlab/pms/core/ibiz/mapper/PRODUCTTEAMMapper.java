...
public interface PRODUCTTEAMMapper extends BaseMapper<PRODUCTTEAM> {
    ...
    Page<PRODUCTTEAM> searchProjectProductTeam(IPage page, @Param("srf") PRODUCTTEAMSearchContext context, @Param("ew") Wrapper<PRODUCTTEAM> wrapper);
    ...
    @Override
    int insert(PRODUCTTEAM entity);
    @Override
    int updateById(@Param(Constants.ENTITY) PRODUCTTEAM entity);
    @Override
    int update(@Param(Constants.ENTITY) PRODUCTTEAM entity, @Param("ew") Wrapper<PRODUCTTEAM> updateWrapper);
    @Override
    ...
    */
    ...
    List<PRODUCTTEAM> selectByRoot(@Param("id") Serializable id);
