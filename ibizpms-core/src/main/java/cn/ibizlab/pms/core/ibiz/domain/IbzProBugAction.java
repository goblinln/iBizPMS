...
@TableName(value = "zt_action", resultMap = "IbzProBugActionResultMap")
@ApiModel("Bug日志")
public class IbzProBugAction extends EntityMP implements Serializable {
    ...
    @TableField(exist = false)
    private cn.ibizlab.pms.core.zentao.domain.Bug ibzprobugaction;
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private List<cn.ibizlab.pms.core.ibiz.domain.IBZProBugHostory> ibzprobughostory;
