...
@Component
@Slf4j
public class IbzLibRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IIbzLibRuntime {
    ...
    public Object executeAction(String strActionName, IPSDEAction iPSDEAction, Object[] args) throws Throwable {
        if (iPSDEAction != null) {
            ...
            if (strActionName.equalsIgnoreCase("Create")) {
                ...
                if(args[0] instanceof IbzLib){
                    IbzLib arg = (IbzLib) args[0] ;
                    CachedBeanCopier.copy(ibzlibService.sysGet(arg.getId()), arg);
                    return arg;
                }else{
                    ...
                    return ibzlibService.sysUpdate((IbzLib) args[0]);
            }             
        }
