...
@Slf4j
public class ImChatuserRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IImChatuserRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),ImChatuser.class);
        } catch (Exception e) {
    ...
    public List<ImChatuser> select(ISearchContextBase iSearchContextBase) {
        ImChatuserSearchContext searchContext = (ImChatuserSearchContext) iSearchContextBase;
        return imchatuserService.select(searchContext);
    }
