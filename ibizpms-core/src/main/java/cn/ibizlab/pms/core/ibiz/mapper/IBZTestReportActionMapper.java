...
public interface IBZTestReportActionMapper extends BaseMapper<IBZTestReportAction> {
    ...
    @Override
    int insert(IBZTestReportAction entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IBZTestReportAction entity);
    @Override
    int update(@Param(Constants.ENTITY) IBZTestReportAction entity, @Param("ew") Wrapper<IBZTestReportAction> updateWrapper);
    @Override
