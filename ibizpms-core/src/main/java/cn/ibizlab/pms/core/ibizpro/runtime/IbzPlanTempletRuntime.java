...
@Slf4j
public class IbzPlanTempletRuntime extends cn.ibizlab.pms.core.runtime.SystemDataEntityRuntime implements IIbzPlanTempletRuntime {
    ...
    public IEntityBase deserializeEntity(Object objData) {
        try {
            return MAPPER.readValue(String.valueOf(objData),IbzPlanTemplet.class);
        } catch (Exception e) {
