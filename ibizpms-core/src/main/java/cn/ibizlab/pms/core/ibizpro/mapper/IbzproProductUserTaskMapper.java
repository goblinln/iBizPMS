...
public interface IbzproProductUserTaskMapper extends BaseMapper<IbzproProductUserTask> {
    ...
    @Override
    int insert(IbzproProductUserTask entity);
    @Override
    int updateById(@Param(Constants.ENTITY) IbzproProductUserTask entity);
    @Override
    int update(@Param(Constants.ENTITY) IbzproProductUserTask entity, @Param("ew") Wrapper<IbzproProductUserTask> updateWrapper);
    @Override
