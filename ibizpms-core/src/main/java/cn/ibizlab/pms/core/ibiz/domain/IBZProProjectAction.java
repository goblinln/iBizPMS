...
@TableName(value = "zt_action", resultMap = "IBZProProjectActionResultMap")
@ApiModel("项目日志")
public class IBZProProjectAction extends EntityMP implements Serializable {
    ...
    @TableField(exist = false)
    private cn.ibizlab.pms.core.zentao.domain.Project ibzproproject;
    ...
    @JSONField(serialize = false)
    @TableField(exist = false)
    private List<cn.ibizlab.pms.core.ibiz.domain.IBZProProjectHistory> ibzproprojecthistory;
