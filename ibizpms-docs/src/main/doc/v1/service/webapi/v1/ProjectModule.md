...
| 4 | n_rootname_eq | String | 允许 | 条件字段：rootname<br>条件组合方式：`=` |
| 5 | n_rootname_like | String | 允许 | 条件字段：rootname<br>条件组合方式：`%like%` |
| 6 | n_parentname_eq | String | 允许 | 条件字段：parentname<br>条件组合方式：`=` |
| 7 | n_parentname_like | String | 允许 | 条件字段：parentname<br>条件组合方式：`%like%` |
