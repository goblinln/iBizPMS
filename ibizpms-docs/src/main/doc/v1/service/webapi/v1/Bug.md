...
| 32 | n_casename_eq | String | 允许 | 条件字段：casename<br>条件组合方式：`=` |
| 33 | n_casename_like | String | 允许 | 条件字段：casename<br>条件组合方式：`%like%` |
| 34 | n_projectname_eq | String | 允许 | 条件字段：projectname<br>条件组合方式：`=` |
| 35 | n_projectname_like | String | 允许 | 条件字段：projectname<br>条件组合方式：`%like%` |
| 36 | n_storyname_eq | String | 允许 | 条件字段：storyname<br>条件组合方式：`=` |
| 37 | n_storyname_like | String | 允许 | 条件字段：storyname<br>条件组合方式：`%like%` |
| 38 | n_modulename_eq | String | 允许 | 条件字段：modulename<br>条件组合方式：`=` |
| 39 | n_modulename_like | String | 允许 | 条件字段：modulename<br>条件组合方式：`%like%` |
| 40 | n_tostory_eq | Long | 允许 | 条件字段：tostory<br>条件组合方式：`=` |
| 41 | n_entry_eq | Long | 允许 | 条件字段：entry<br>条件组合方式：`=` |
| 42 | n_product_eq | Long | 允许 | 条件字段：product<br>条件组合方式：`=` |
| 43 | n_totask_eq | Long | 允许 | 条件字段：totask<br>条件组合方式：`=` |
| 44 | n_plan_eq | Long | 允许 | 条件字段：plan<br>条件组合方式：`=` |
| 45 | n_module_eq | Long | 允许 | 条件字段：module<br>条件组合方式：`=` |
| 46 | n_branch_eq | Long | 允许 | 条件字段：branch<br>条件组合方式：`=` |
| 47 | n_duplicatebug_eq | Long | 允许 | 条件字段：duplicatebug<br>条件组合方式：`=` |
| 48 | n_repo_eq | Long | 允许 | 条件字段：repo<br>条件组合方式：`=` |
| 49 | n_story_eq | Long | 允许 | 条件字段：story<br>条件组合方式：`=` |
| 50 | n_case_eq | Long | 允许 | 条件字段：case<br>条件组合方式：`=` |
| 51 | n_project_eq | Long | 允许 | 条件字段：project<br>条件组合方式：`=` |
| 52 | n_task_eq | Long | 允许 | 条件字段：task<br>条件组合方式：`=` |
| 53 | n_testtask_eq | Long | 允许 | 条件字段：testtask<br>条件组合方式：`=` |
