...
| 4 | n_evaluationstatus_eq | String | 允许 | 条件字段：evaluationstatus<br>条件组合方式：`=` |
| 5 | n_month_eq | String | 允许 | 条件字段：month<br>条件组合方式：`=` |
| 6 | n_taskname_eq | String | 允许 | 条件字段：taskname<br>条件组合方式：`=` |
| 7 | n_taskname_like | String | 允许 | 条件字段：taskname<br>条件组合方式：`%like%` |
