...
| 序号 | 参数名 | 参数类型 | 说明 |
| ---- | ---- | ---- | ---- |
| 1 | usertpldto | [UserTplDTO](#UserTplDTO) | 用户模板实体传输对象 |

#### 返回说明
| 项目 | 说明 |
| ---- | ---- |
| 返回状态 | 200：请求成功。<br>401：用户未认证。<br>500：服务异常。 |
| 返回类型 | [UserTplDTO](#UserTplDTO)：用户模板实体传输对象 |
...
| 序号 | 参数名 | 参数类型 | 说明 |
| ---- | ---- | ---- | ---- |
| 1 | usertpldtos | List<[UserTplDTO](#UserTplDTO)> | 用户模板实体传输对象列表 |
...
| 序号 | 参数名 | 参数类型 | 说明 |
| ---- | ---- | ---- | ---- |
| 1 | usertpl_id | Long | 用户模板主键ID |
| 2 | usertpldto | [UserTplDTO](#UserTplDTO) | 用户模板实体传输对象 |
...
| 4 | n_public_eq | String | 允许 | 条件字段：public<br>条件组合方式：`=` |
