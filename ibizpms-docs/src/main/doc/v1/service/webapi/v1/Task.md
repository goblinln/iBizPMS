...
### 继续后剩余工时为0
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/{task_id}/recordtimzeroleftaftercontinue
...
### 剩余工时为0时不设为已完成
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/{task_id}/recordtimatezeroleft
...
### 开始后剩余工时为0
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/{task_id}/recordtimatezeroleftafterstart
...
### 根据获取指派给我任务（EE）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchassignedtomytaskee
...
### 根据查询指派给我任务（EE）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchassignedtomytaskee
...
### 根据获取通过模块查询（聚微）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchbymoduleee
...
### 根据查询通过模块查询（聚微）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchbymoduleee
...
### 根据获取数据查询（子任务）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchchilddefault
...
### 根据获取指定人员任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchcurpersontasks
...
### 根据查询指定人员任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchcurpersontasks
...
### 根据获取我相关的任务（聚微）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchmyalltaskee
...
### 根据查询我相关的任务（聚微）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchmyalltaskee
...
### 根据获取我的任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchmyprojecttask
...
### 根据查询我的任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchmyprojecttask
...
### 根据获取人员任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchpersonnaltasks
...
### 根据查询人员任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchpersonnaltasks
...
### 根据获取项目成员任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchprojectmembertask
...
### 根据查询项目成员任务
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchprojectmembertask
...
### 根据获取项目任务（聚微）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/fetchprojecttaskee
...
### 根据查询项目任务（聚微）
#### 访问路径
/projectmodules/{projectmodule_id}/tasks/searchprojecttaskee
...
### 继续后剩余工时为0
#### 访问路径
/productplans/{productplan_id}/tasks/{task_id}/recordtimzeroleftaftercontinue
...
### 剩余工时为0时不设为已完成
#### 访问路径
/productplans/{productplan_id}/tasks/{task_id}/recordtimatezeroleft
...
### 开始后剩余工时为0
#### 访问路径
/productplans/{productplan_id}/tasks/{task_id}/recordtimatezeroleftafterstart
...
### 根据获取指派给我任务（EE）
#### 访问路径
/productplans/{productplan_id}/tasks/fetchassignedtomytaskee
...
### 根据查询指派给我任务（EE）
#### 访问路径
/productplans/{productplan_id}/tasks/searchassignedtomytaskee
...
### 根据获取通过模块查询（聚微）
#### 访问路径
/productplans/{productplan_id}/tasks/fetchbymoduleee
...
### 根据查询通过模块查询（聚微）
#### 访问路径
/productplans/{productplan_id}/tasks/searchbymoduleee
...
### 根据获取数据查询（子任务）
#### 访问路径
/productplans/{productplan_id}/tasks/fetchchilddefault
...
### 根据查询数据查询（子任务）
#### 访问路径
/productplans/{productplan_id}/tasks/searchchilddefault
...
### 根据获取指定人员任务
#### 访问路径
/productplans/{productplan_id}/tasks/fetchcurpersontasks
...
### 根据查询指定人员任务
#### 访问路径
/productplans/{productplan_id}/tasks/searchcurpersontasks
...
### 根据获取我相关的任务（聚微）
#### 访问路径
/productplans/{productplan_id}/tasks/fetchmyalltaskee
...
### 根据查询我相关的任务（聚微）
#### 访问路径
/productplans/{productplan_id}/tasks/searchmyalltaskee
...
### 根据获取我的任务
#### 访问路径
/productplans/{productplan_id}/tasks/fetchmyprojecttask
...
### 根据查询我的任务
#### 访问路径
/productplans/{productplan_id}/tasks/searchmyprojecttask
...
### 根据获取人员任务
#### 访问路径
/productplans/{productplan_id}/tasks/fetchpersonnaltasks
...
### 根据查询人员任务
#### 访问路径
/productplans/{productplan_id}/tasks/searchpersonnaltasks
...
### 根据获取项目成员任务
#### 访问路径
/productplans/{productplan_id}/tasks/fetchprojectmembertask
...
### 根据查询项目成员任务
#### 访问路径
/productplans/{productplan_id}/tasks/searchprojectmembertask
...
### 根据获取项目任务（聚微）
#### 访问路径
/productplans/{productplan_id}/tasks/fetchprojecttaskee
...
### 根据查询项目任务（聚微）
#### 访问路径
/productplans/{productplan_id}/tasks/searchprojecttaskee
...
### 继续后剩余工时为0
#### 访问路径
/stories/{story_id}/tasks/{task_id}/recordtimzeroleftaftercontinue
...
### 剩余工时为0时不设为已完成
#### 访问路径
/stories/{story_id}/tasks/{task_id}/recordtimatezeroleft
...
### 开始后剩余工时为0
#### 访问路径
/stories/{story_id}/tasks/{task_id}/recordtimatezeroleftafterstart
...
### 根据获取指派给我任务（EE）
#### 访问路径
/stories/{story_id}/tasks/fetchassignedtomytaskee
...
### 根据查询指派给我任务（EE）
#### 访问路径
/stories/{story_id}/tasks/searchassignedtomytaskee
...
### 根据获取通过模块查询（聚微）
#### 访问路径
/stories/{story_id}/tasks/fetchbymoduleee
...
### 根据查询通过模块查询（聚微）
#### 访问路径
/stories/{story_id}/tasks/searchbymoduleee
...
### 根据获取数据查询（子任务）
#### 访问路径
/stories/{story_id}/tasks/fetchchilddefault
...
### 根据获取指定人员任务
#### 访问路径
/stories/{story_id}/tasks/fetchcurpersontasks
...
### 根据查询指定人员任务
#### 访问路径
/stories/{story_id}/tasks/searchcurpersontasks
...
### 根据获取我相关的任务（聚微）
#### 访问路径
/stories/{story_id}/tasks/fetchmyalltaskee
...
### 根据查询我相关的任务（聚微）
#### 访问路径
/stories/{story_id}/tasks/searchmyalltaskee
...
### 根据获取我的任务
#### 访问路径
/stories/{story_id}/tasks/fetchmyprojecttask
...
### 根据查询我的任务
#### 访问路径
/stories/{story_id}/tasks/searchmyprojecttask
...
### 根据获取人员任务
#### 访问路径
/stories/{story_id}/tasks/fetchpersonnaltasks
...
### 根据查询人员任务
#### 访问路径
/stories/{story_id}/tasks/searchpersonnaltasks
...
### 根据获取项目成员任务
#### 访问路径
/stories/{story_id}/tasks/fetchprojectmembertask
...
### 根据查询项目成员任务
#### 访问路径
/stories/{story_id}/tasks/searchprojectmembertask
...
### 根据获取项目任务（聚微）
#### 访问路径
/stories/{story_id}/tasks/fetchprojecttaskee
...
### 根据查询项目任务（聚微）
#### 访问路径
/stories/{story_id}/tasks/searchprojecttaskee
...
### 继续后剩余工时为0
#### 访问路径
/projects/{project_id}/tasks/{task_id}/recordtimzeroleftaftercontinue
...
### 剩余工时为0时不设为已完成
#### 访问路径
/projects/{project_id}/tasks/{task_id}/recordtimatezeroleft
...
### 开始后剩余工时为0
#### 访问路径
/projects/{project_id}/tasks/{task_id}/recordtimatezeroleftafterstart
...
### 根据获取指派给我任务（EE）
#### 访问路径
/projects/{project_id}/tasks/fetchassignedtomytaskee
...
### 根据查询指派给我任务（EE）
#### 访问路径
/projects/{project_id}/tasks/searchassignedtomytaskee
...
### 根据获取通过模块查询（聚微）
#### 访问路径
/projects/{project_id}/tasks/fetchbymoduleee
...
### 根据查询通过模块查询（聚微）
#### 访问路径
/projects/{project_id}/tasks/searchbymoduleee
...
### 根据获取数据查询（子任务）
#### 访问路径
/projects/{project_id}/tasks/fetchchilddefault
...
### 根据查询数据查询（子任务）
#### 访问路径
/projects/{project_id}/tasks/searchchilddefault
...
### 根据获取指定人员任务
#### 访问路径
/projects/{project_id}/tasks/fetchcurpersontasks
...
### 根据查询指定人员任务
#### 访问路径
/projects/{project_id}/tasks/searchcurpersontasks
...
### 根据获取我相关的任务（聚微）
#### 访问路径
/projects/{project_id}/tasks/fetchmyalltaskee
...
### 根据查询我相关的任务（聚微）
#### 访问路径
/projects/{project_id}/tasks/searchmyalltaskee
...
### 根据获取我的任务
#### 访问路径
/projects/{project_id}/tasks/fetchmyprojecttask
...
### 根据查询我的任务
#### 访问路径
/projects/{project_id}/tasks/searchmyprojecttask
...
### 根据获取人员任务
#### 访问路径
/projects/{project_id}/tasks/fetchpersonnaltasks
...
### 根据查询人员任务
#### 访问路径
/projects/{project_id}/tasks/searchpersonnaltasks
...
### 根据获取项目成员任务
#### 访问路径
/projects/{project_id}/tasks/fetchprojectmembertask
...
### 根据查询项目成员任务
#### 访问路径
/projects/{project_id}/tasks/searchprojectmembertask
...
### 根据获取项目任务（聚微）
#### 访问路径
/projects/{project_id}/tasks/fetchprojecttaskee
...
### 根据查询项目任务（聚微）
#### 访问路径
/projects/{project_id}/tasks/searchprojecttaskee
...
### 继续后剩余工时为0
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/recordtimzeroleftaftercontinue
...
### 剩余工时为0时不设为已完成
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/recordtimatezeroleft
...
### 开始后剩余工时为0
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/recordtimatezeroleftafterstart
...
### 根据获取指派给我任务（EE）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchassignedtomytaskee
...
### 根据查询指派给我任务（EE）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchassignedtomytaskee
...
### 根据获取通过模块查询（聚微）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchbymoduleee
...
### 根据查询通过模块查询（聚微）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchbymoduleee
...
### 根据获取数据查询（子任务）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchchilddefault
...
### 根据获取指定人员任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchcurpersontasks
...
### 根据查询指定人员任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchcurpersontasks
...
### 根据获取我相关的任务（聚微）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchmyalltaskee
...
### 根据查询我相关的任务（聚微）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchmyalltaskee
...
### 根据获取我的任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchmyprojecttask
...
### 根据查询我的任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchmyprojecttask
...
### 根据获取人员任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchpersonnaltasks
...
### 根据查询人员任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchpersonnaltasks
...
### 根据获取项目成员任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchprojectmembertask
...
### 根据查询项目成员任务
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchprojectmembertask
...
### 根据获取项目任务（聚微）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/fetchprojecttaskee
...
### 根据查询项目任务（聚微）
#### 访问路径
/products/{product_id}/productplans/{productplan_id}/tasks/searchprojecttaskee
...
### 继续后剩余工时为0
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/{task_id}/recordtimzeroleftaftercontinue
...
### 剩余工时为0时不设为已完成
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/{task_id}/recordtimatezeroleft
...
### 开始后剩余工时为0
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/{task_id}/recordtimatezeroleftafterstart
...
### 根据获取指派给我任务（EE）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchassignedtomytaskee
...
### 根据查询指派给我任务（EE）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchassignedtomytaskee
...
### 根据获取通过模块查询（聚微）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchbymoduleee
...
### 根据查询通过模块查询（聚微）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchbymoduleee
...
### 根据获取数据查询（子任务）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchchilddefault
...
### 根据查询数据查询（子任务）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchchilddefault
...
### 根据获取指定人员任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchcurpersontasks
...
### 根据查询指定人员任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchcurpersontasks
...
### 根据获取我相关的任务（聚微）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchmyalltaskee
...
### 根据查询我相关的任务（聚微）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchmyalltaskee
...
### 根据获取我的任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchmyprojecttask
...
### 根据查询我的任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchmyprojecttask
...
### 根据获取人员任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchpersonnaltasks
...
### 根据查询人员任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchpersonnaltasks
...
### 根据获取项目成员任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchprojectmembertask
...
### 根据查询项目成员任务
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchprojectmembertask
...
### 根据获取项目任务（聚微）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/fetchprojecttaskee
...
### 根据查询项目任务（聚微）
#### 访问路径
/products/{product_id}/stories/{story_id}/tasks/searchprojecttaskee
...
### 继续后剩余工时为0
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/recordtimzeroleftaftercontinue
...
### 剩余工时为0时不设为已完成
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/recordtimatezeroleft
...
### 开始后剩余工时为0
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/recordtimatezeroleftafterstart
...
### 根据获取指派给我任务（EE）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchassignedtomytaskee
...
### 根据查询指派给我任务（EE）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchassignedtomytaskee
...
### 根据获取通过模块查询（聚微）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchbymoduleee
...
### 根据查询通过模块查询（聚微）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchbymoduleee
...
### 根据获取数据查询（子任务）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchchilddefault
...
### 根据获取指定人员任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchcurpersontasks
...
### 根据查询指定人员任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchcurpersontasks
...
### 根据获取我相关的任务（聚微）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchmyalltaskee
...
### 根据查询我相关的任务（聚微）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchmyalltaskee
...
### 根据获取我的任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchmyprojecttask
...
### 根据查询我的任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchmyprojecttask
...
### 根据获取人员任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchpersonnaltasks
...
### 根据查询人员任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchpersonnaltasks
...
### 根据获取项目成员任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchprojectmembertask
...
### 根据查询项目成员任务
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchprojectmembertask
...
### 根据获取项目任务（聚微）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchprojecttaskee
...
### 根据查询项目任务（聚微）
#### 访问路径
/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchprojecttaskee
