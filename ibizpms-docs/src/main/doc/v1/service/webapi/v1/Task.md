...
| 20 | n_multiple_eq | String | 允许 | 条件字段：multiple<br>条件组合方式：`=` |
| 21 | n_name_like | String | 允许 | 条件字段：name<br>条件组合方式：`%like%` |
| 22 | n_closeddate_ltandeq | Timestamp | 允许 | 条件字段：closeddate<br>条件组合方式：`<=`<br>时间格式：yyyy-MM-dd HH:mm:ss |
| 23 | n_type_eq | String | 允许 | 条件字段：type<br>条件组合方式：`=` |
| 24 | n_assignedto_eq | String | 允许 | 条件字段：assignedto<br>条件组合方式：`=` |
| 25 | n_assignedto_in | String | 允许 | 条件字段：assignedto<br>条件组合方式：`in(...)` |
| 26 | n_eststarted_gtandeq | Timestamp | 允许 | 条件字段：eststarted<br>条件组合方式：`>=`<br>时间格式：yyyy-MM-dd |
| 27 | n_eststarted_ltandeq | Timestamp | 允许 | 条件字段：eststarted<br>条件组合方式：`<=`<br>时间格式：yyyy-MM-dd |
| 28 | n_cycle_eq | Integer | 允许 | 条件字段：cycle<br>条件组合方式：`=` |
| 29 | n_openedby_eq | String | 允许 | 条件字段：openedby<br>条件组合方式：`=` |
| 30 | n_tasktype_eq | String | 允许 | 条件字段：tasktype<br>条件组合方式：`=` |
| 31 | n_finisheddate_ltandeq | Timestamp | 允许 | 条件字段：finisheddate<br>条件组合方式：`<=`<br>时间格式：yyyy-MM-dd |
| 32 | n_modulename_eq | String | 允许 | 条件字段：modulename<br>条件组合方式：`=` |
| 33 | n_modulename_like | String | 允许 | 条件字段：modulename<br>条件组合方式：`%like%` |
| 34 | n_storyname_eq | String | 允许 | 条件字段：storyname<br>条件组合方式：`=` |
| 35 | n_storyname_like | String | 允许 | 条件字段：storyname<br>条件组合方式：`%like%` |
| 36 | n_path_like | String | 允许 | 条件字段：path<br>条件组合方式：`%like%` |
| 37 | n_planname_eq | String | 允许 | 条件字段：planname<br>条件组合方式：`=` |
| 38 | n_planname_like | String | 允许 | 条件字段：planname<br>条件组合方式：`%like%` |
| 39 | n_projectname_eq | String | 允许 | 条件字段：projectname<br>条件组合方式：`=` |
| 40 | n_projectname_like | String | 允许 | 条件字段：projectname<br>条件组合方式：`%like%` |
| 41 | n_product_eq | Long | 允许 | 条件字段：product<br>条件组合方式：`=` |
| 42 | n_parentname_eq | String | 允许 | 条件字段：parentname<br>条件组合方式：`=` |
| 43 | n_parentname_like | String | 允许 | 条件字段：parentname<br>条件组合方式：`%like%` |
| 44 | n_project_eq | Long | 允许 | 条件字段：project<br>条件组合方式：`=` |
| 45 | n_project_in | Long | 允许 | 条件字段：project<br>条件组合方式：`in(...)` |
| 46 | n_plan_eq | Long | 允许 | 条件字段：plan<br>条件组合方式：`=` |
| 47 | n_plan_noteq | Long | 允许 | 条件字段：plan<br>条件组合方式：`!=`或者`<>` |
| 48 | n_module_eq | Long | 允许 | 条件字段：module<br>条件组合方式：`=` |
| 49 | n_story_eq | Long | 允许 | 条件字段：story<br>条件组合方式：`=` |
| 50 | n_parent_eq | Long | 允许 | 条件字段：parent<br>条件组合方式：`=` |
| 51 | n_parent_gtandeq | Long | 允许 | 条件字段：parent<br>条件组合方式：`>=` |
| 52 | n_parent_ltandeq | Long | 允许 | 条件字段：parent<br>条件组合方式：`<=` |
| 53 | n_frombug_eq | Long | 允许 | 条件字段：frombug<br>条件组合方式：`=` |
| 54 | customcond | String | 允许 | 自定义查询条件 |
| 55 | customparams | String | 允许 | 自定义查询参数 |
| 56 | query | String | 允许 | 快速搜索 |
| 57 | filter | QueryFilter | 允许 | 条件表达式<br>参照`cn.ibizlab.pms.util.filter.QueryFilter` |
| 58 | page | int | 允许 | 当前页数<br>默认值0 |
| 59 | size | int | 允许 | 每页显示条数<br>默认值20 |
| 60 | sort | String | 允许 | 排序 |
