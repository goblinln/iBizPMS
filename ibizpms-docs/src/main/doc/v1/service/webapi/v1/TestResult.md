...
| 3 | n_product_like | Long | 允许 | 条件字段：product<br>条件组合方式：`%like%` |
| 4 | n_job_eq | Long | 允许 | 条件字段：job<br>条件组合方式：`=` |
| 5 | n_case_eq | Long | 允许 | 条件字段：case<br>条件组合方式：`=` |
| 6 | n_run_eq | Long | 允许 | 条件字段：run<br>条件组合方式：`=` |
| 7 | n_compile_eq | Long | 允许 | 条件字段：compile<br>条件组合方式：`=` |
