...
| 6 | n_sqlid_eq | String | 允许 | 条件字段：sqlid<br>条件组合方式：`=` |
| 7 | n_frontapplication_eq | String | 允许 | 条件字段：frontapplication<br>条件组合方式：`=` |
| 8 | n_date_ltandeq | Timestamp | 允许 | 条件字段：date<br>条件组合方式：`<=`<br>时间格式：yyyy-MM-dd |
