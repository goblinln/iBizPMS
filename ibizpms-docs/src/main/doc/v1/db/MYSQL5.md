...
`ENTITY2NAME`  VARCHAR(200) COMMENT '实体2名称' 
,`ENTITY2ID`  VARCHAR(100)  NOT NULL PRIMARY KEY COMMENT '实体2标识' 
,`CREATEMAN`  VARCHAR(60) COMMENT '建立人' 
,`CREATEDATE`  DATETIME COMMENT '建立时间' 
,`UPDATEMAN`  VARCHAR(60) COMMENT '更新人' 
,`UPDATEDATE`  DATETIME COMMENT '更新时间' 
...
,`ID`  BIGINT(8)  UNSIGNED  NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '编号' 
,`BEGIN`  DATETIME COMMENT '预计开始日期' 
,`DESC`  MEDIUMTEXT COMMENT '描述' 
,`END`  DATETIME COMMENT '预计结束日期' 
...
,`PRODUCT`  BIGINT(8)  UNSIGNED COMMENT '产品' 
,`BEGINACT`  DATETIME COMMENT '实际开始日期' 
,`ENDACT`  DATETIME COMMENT '实际结束日期' 
)COMMENT='产品计划';
```
...
,`PRIVATE`  VARCHAR(2000) COMMENT '私人事务' 
...
,`CLOSEDBY`  VARCHAR(30) COMMENT '由谁关闭' 
,`DESC`  MEDIUMTEXT COMMENT '描述' 
,`IDVALUE`  BIGINT(8)  UNSIGNED COMMENT '项目编号' 
,`CONSUMED`  DOUBLE COMMENT '工时' 
)COMMENT='项目其他活动';
```
