...
function getLocaleResourceBase(){
	...
	fields: {
		...
		exportColumns: {
			...
			uiactions: {
				productrelease_linkstory: commonLogic.appcommonhandle("关联需求",null),
				refresh: commonLogic.appcommonhandle("刷新",null),
				productrelease_linkbug: commonLogic.appcommonhandle("关联bug",null),
				productrelease_terminal: commonLogic.appcommonhandle("停止维护",null),
				productrelease_active: commonLogic.appcommonhandle("激活",null),
				productrelease_quickedit: commonLogic.appcommonhandle("编辑",null),
				copy: commonLogic.appcommonhandle("拷贝",null),
				productrelease_remove: commonLogic.appcommonhandle("删除",null),
			},
		},
