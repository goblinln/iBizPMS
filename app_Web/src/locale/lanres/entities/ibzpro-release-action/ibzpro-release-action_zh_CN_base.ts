...
function getLocaleResourceBase(){
	...
	fields: {
		...
		'objectid': commonLogic.appcommonhandle("ID",null),
		...
		views: {
			...
			'editview': {
				caption: commonLogic.appcommonhandle("发布日志",null),
				title: commonLogic.appcommonhandle("发布日志编辑视图",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("发布日志",null),
				title: commonLogic.appcommonhandle("发布日志列表视图",null),
			},
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("发布日志列表视图（添加备注）",null),
			},
		},
		addcomment_form: {
			details: {
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("发布日志基本信息",null), 
				'formpage1': commonLogic.appcommonhandle("基本信息",null), 
