...
function getLocaleResourceBase(){
	...
	fields: {
		...
		monthmain_grid: {
			...
			uiactions: {
			monthly_projectmonthly: commonLogic.appcommonhandle("项目月报查看详情",null),
			},
		},
		...
		myreceived_grid: {
			...
			nodata:commonLogic.appcommonhandle("",null),
			uiactions: {
			monthly_haveread: commonLogic.appcommonhandle("已读",null),
			},
		},
		main_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
			monthly_edit: commonLogic.appcommonhandle("修改",null),
			monthly_submit: commonLogic.appcommonhandle("提交",null),
			},
		},
		default_searchform: {
			details: {
