...
function getLocaleResourceBase(){
	...
	fields: {
		...
		'objectid': commonLogic.appcommonhandle("Bug编号",null),
	},
		views: {
			'optionview': {
			...
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("Bug日志列表视图（添加备注）",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("Bug日志",null),
				title: commonLogic.appcommonhandle("Bug日志列表视图",null),
			},
			'editview': {
				caption: commonLogic.appcommonhandle("Bug日志",null),
				title: commonLogic.appcommonhandle("Bug日志编辑视图",null),
			},
		},
		addcomment_form: {
			details: {
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("Bug日志基本信息",null), 
				'formpage1': commonLogic.appcommonhandle("基本信息",null), 
