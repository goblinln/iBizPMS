	...
	fields: {
		...
		views: {
			'addlistview': {
				...
				title: commonLogic.appcommonhandle("汇报日志列表视图（添加备注）",null),
			},
			'optionview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
			...
			'editview': {
				caption: commonLogic.appcommonhandle("汇报日志",null),
				title: commonLogic.appcommonhandle("汇报日志编辑视图",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("汇报日志",null),
				title: commonLogic.appcommonhandle("汇报日志列表视图",null),
			},
		},
		addcomment_form: {
			details: {
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("汇报日志基本信息",null), 
				'formpage1': commonLogic.appcommonhandle("基本信息",null), 
