...
function getLocaleResourceBase(){
	...
	fields: {
		...
		exportColumns: {
			...
			uiactions: {
			testcase_edits: commonLogic.appcommonhandle("概况",null),
			testcase_confirmchange: commonLogic.appcommonhandle("确认用例变动",null),
			testcase_newbugbytestcaseresult: commonLogic.appcommonhandle("转Bug",null),
			testcase_caseopentestrunresultview: commonLogic.appcommonhandle("结果",null),
			testcase_caseexecute: commonLogic.appcommonhandle("执行",null),
			testcase_unlinkcase: commonLogic.appcommonhandle("移除",null),
			},
		},
		mainlinktest_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
			testcase_confirmstorychange: commonLogic.appcommonhandle("确认",null),
			testcase_opentestrunresultview: commonLogic.appcommonhandle("结果",null),
			testcase_execute: commonLogic.appcommonhandle("执行",null),
			testcase_mainedit: commonLogic.appcommonhandle("编辑",null),
			refresh: commonLogic.appcommonhandle("刷新",null),
			testcase_newbugbycaseresult: commonLogic.appcommonhandle("转Bug",null),
			copy: commonLogic.appcommonhandle("Copy",null),
			testcase_casefavorite: commonLogic.appcommonhandle("收藏",null),
			testcase_casenfavorite: commonLogic.appcommonhandle("取消收藏",null),
			},
		},
		batchnew_grid: {
			columns: {
