...
function getLocaleResourceBase(){
	...
	fields: {
		...
		dailyinfocalendar_form: {
			...
			uiactions: {
			daily_editcz: commonLogic.appcommonhandle("修改",null),
			daily_submit: commonLogic.appcommonhandle("提交",null),
			},
		},
		main_grid: {
			columns: {
			...
			uiactions: {
			daily_edit: commonLogic.appcommonhandle("修改",null),
			daily_submitcz: commonLogic.appcommonhandle("提交",null),
			},
		},
		mymain_grid: {
			columns: {
			...
			nodata:commonLogic.appcommonhandle("",null),
			uiactions: {
			daily_haveread: commonLogic.appcommonhandle("已读",null),
			},
		},
		projectdailymain_grid: {
			...
			nodata:commonLogic.appcommonhandle("",null),
			uiactions: {
			daily_projectdaily: commonLogic.appcommonhandle("项目日报查看详情",null),
			},
		},
