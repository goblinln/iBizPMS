...
function getLocaleResourceBase(){
	...
	fields: {
		...
		views: {
			...
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("测试单日志列表视图（添加备注）",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("测试单日志",null),
				title: commonLogic.appcommonhandle("测试单日志列表视图",null),
			},
			'editview': {
				caption: commonLogic.appcommonhandle("测试单日志",null),
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("测试单基本信息",null), 
				'formpage1': commonLogic.appcommonhandle("基本信息",null), 
