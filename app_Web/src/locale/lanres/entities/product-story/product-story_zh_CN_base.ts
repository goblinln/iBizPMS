	...
	fields: {
		...
		main_editmode_form: {
			details: {
				...
				'button1': commonLogic.appcommonhandle("保存",null), 
		...
		storyspeccalendar_form: {
			...
			uiactions: {
				productstory_assigntodash: commonLogic.appcommonhandle("指派",null),
				productstory_reviewstorydash: commonLogic.appcommonhandle("评审",null),
				productstory_activitedash: commonLogic.appcommonhandle("激活",null),
				productstory_closestorydash: commonLogic.appcommonhandle("关闭",null),
				productstory_changestorydetaildash: commonLogic.appcommonhandle("变更",null),
				productstory_substorycz: commonLogic.appcommonhandle("细分",null),
				productstory_openbaseinfoc: commonLogic.appcommonhandle("编辑",null),
			},
		},
		main3_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
				productstory_storytobug: commonLogic.appcommonhandle("提缺陷",null),
				productstory_changestorydetail: commonLogic.appcommonhandle("变更",null),
				productstory_reviewstory: commonLogic.appcommonhandle("评审",null),
				productstory_closestory: commonLogic.appcommonhandle("关闭",null),
				productstory_opencasecreateview: commonLogic.appcommonhandle("建用例",null),
				productstory_substory: commonLogic.appcommonhandle("需求细分",null),
				copy: commonLogic.appcommonhandle("拷贝",null),
				productstory_storyfavorites: commonLogic.appcommonhandle("收藏",null),
				productstory_storynfavorites: commonLogic.appcommonhandle("取消收藏",null),
			},
		},
		main_plansub_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
				productstory_unlinkstory: commonLogic.appcommonhandle("移除关联",null),
			},
		},
		pickupgrid_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
				productstory_buildunlinkstory: commonLogic.appcommonhandle("解绑需求",null),
			},
		},
		main_reportsub_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
				productstory_assignto: commonLogic.appcommonhandle("指派",null),
				productstory_storytobug: commonLogic.appcommonhandle("提缺陷",null),
				productstory_changestorydetail: commonLogic.appcommonhandle("变更",null),
				productstory_reviewstory: commonLogic.appcommonhandle("评审",null),
				productstory_closestory: commonLogic.appcommonhandle("关闭",null),
		...
		exportColumns: {
			...
			uiactions: {
				productstory_releaseunlinkstory: commonLogic.appcommonhandle("移除关联",null),
			},
		},
		myfavoritemain_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
				...
				productstory_reviewstory: commonLogic.appcommonhandle("评审",null),
				productstory_closestory: commonLogic.appcommonhandle("关闭",null),
				productstory_openbaseinfoeditview: commonLogic.appcommonhandle("编辑",null),
				productstory_opencasecreateview: commonLogic.appcommonhandle("建用例",null),
				productstory_substory: commonLogic.appcommonhandle("需求细分",null),
				productstory_storyfavorites: commonLogic.appcommonhandle("收藏",null),
				productstory_storynfavorites: commonLogic.appcommonhandle("取消收藏",null),
