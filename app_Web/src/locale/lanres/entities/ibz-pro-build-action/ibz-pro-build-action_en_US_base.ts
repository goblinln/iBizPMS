...
function getLocaleResourceBase(){
	...
	fields: {
		...
		views: {
			'editview': {
				caption: commonLogic.appcommonhandle("版本日志",null),
				title: commonLogic.appcommonhandle("版本日志编辑视图",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("版本日志",null),
				title: commonLogic.appcommonhandle("版本日志列表视图",null),
			},
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("版本日志列表视图（添加备注）",null),
			},
			'optionview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("版本日志基本信息",null), 
