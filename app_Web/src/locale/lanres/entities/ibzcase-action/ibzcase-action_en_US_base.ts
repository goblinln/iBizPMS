...
function getLocaleResourceBase(){
	...
	fields: {
		...
		'objectid': commonLogic.appcommonhandle("用例编号",null),
		'project': commonLogic.appcommonhandle("项目",null),
	},
		views: {
			'editview': {
				caption: commonLogic.appcommonhandle("测试用例日志",null),
				title: commonLogic.appcommonhandle("测试日志编辑视图",null),
			},
			'optionview': {
			...
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("测试用例日志列表视图（添加备注）",null),
			},
		},
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("测试日志基本信息",null), 
