...
function getLocaleResourceBase(){
	...
	fields: {
		...
		calendarmain_form: {
			...
			uiactions: {
				projecttesttask_startdash: commonLogic.appcommonhandle("开始",null),
				projecttesttask_closedash: commonLogic.appcommonhandle("关闭",null),
				projecttesttask_blockdash: commonLogic.appcommonhandle("阻塞",null),
				projecttesttask_editedit: commonLogic.appcommonhandle("编辑",null),
				projecttesttask_look: commonLogic.appcommonhandle("查看",null),
			},
		},
		main_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
				projecttesttask_linkcase: commonLogic.appcommonhandle("关联用例",null),
				projecttesttask_testreportr: commonLogic.appcommonhandle("测试报告",null),
				projecttesttask_openinfoview: commonLogic.appcommonhandle("概况",null),
				projecttesttask_editedit: commonLogic.appcommonhandle("编辑",null),
				projecttesttask_delete: commonLogic.appcommonhandle("删除",null),
			},
		},
		main2_grid: {
			columns: {
