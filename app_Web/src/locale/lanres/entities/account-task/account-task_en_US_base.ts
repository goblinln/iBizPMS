...
function getLocaleResourceBase(){
	...
	fields: {
		...
		exportColumns: {
			...
			uiactions: {
			accounttask_morechild: commonLogic.appcommonhandle("子任务",null),
			accounttask_tasktobug: commonLogic.appcommonhandle("提缺陷",null),
			accounttask_confirmstorychange: commonLogic.appcommonhandle("确认",null),
			accounttask_starttask: commonLogic.appcommonhandle("开始",null),
			accounttask_closetask: commonLogic.appcommonhandle("关闭",null),
			accounttask_donetask: commonLogic.appcommonhandle("完成",null),
			accounttask_mainedit: commonLogic.appcommonhandle("编辑",null),
			accounttask_newsubtask: commonLogic.appcommonhandle("子任务",null),
			copy: commonLogic.appcommonhandle("Copy",null),
			accounttask_taskfavorites: commonLogic.appcommonhandle("收藏",null),
			accounttask_tasknfavorites: commonLogic.appcommonhandle("取消收藏",null),
			accounttask_checkforward: commonLogic.appcommonhandle("转交",null),
			accounttask_forward: commonLogic.appcommonhandle("转交",null),
			accounttask_assigntask: commonLogic.appcommonhandle("指派",null),
			},
		},
		main2my_grid: {
			columns: {
