...
function getLocaleResourceBase(){
	...
	fields: {
		...
		'objectid': commonLogic.appcommonhandle("月报标识",null),
	},
		views: {
			'listview': {
				caption: commonLogic.appcommonhandle("月报日志",null),
				title: commonLogic.appcommonhandle("月报日志列表视图",null),
			},
			'editview': {
				caption: commonLogic.appcommonhandle("月报日志",null),
				title: commonLogic.appcommonhandle("月报日志编辑视图",null),
			},
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("月报日志列表视图（添加备注）",null),
			},
			'optionview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("月报日志基本信息",null), 
