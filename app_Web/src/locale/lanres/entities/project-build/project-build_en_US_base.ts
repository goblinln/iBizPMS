...
function getLocaleResourceBase(){
	...
	fields: {
		...
		exportColumns: {
			...
			uiactions: {
			projectbuild_linkstories: commonLogic.appcommonhandle("关联需求",null),
			projectbuild_submittotesting: commonLogic.appcommonhandle("提交测试",null),
			projectbuild_viewbugs: commonLogic.appcommonhandle("查看Bug",null),
			projectbuild_editbuild: commonLogic.appcommonhandle("编辑版本",null),
			projectbuild_delete: commonLogic.appcommonhandle("删除",null),
			},
		},
		testrounds_grid: {
			columns: {
