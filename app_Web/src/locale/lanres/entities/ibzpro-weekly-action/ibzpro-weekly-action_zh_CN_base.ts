...
function getLocaleResourceBase(){
	...
	fields: {
		...
		'objectid': commonLogic.appcommonhandle("周报标识",null),
		'project': commonLogic.appcommonhandle("项目",null),
	},
		views: {
			'editview': {
				caption: commonLogic.appcommonhandle("周报日志",null),
				title: commonLogic.appcommonhandle("周报日志编辑视图",null),
			},
			'optionview': {
			...
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("周报日志列表视图（添加备注）",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("周报日志",null),
				title: commonLogic.appcommonhandle("周报日志列表视图",null),
			},
		},
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("周报日志基本信息",null), 
