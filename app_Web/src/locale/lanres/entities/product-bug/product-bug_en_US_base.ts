...
function getLocaleResourceBase(){
	...
	fields: {
		...
		calendarmain_form: {
			...
			uiactions: {
			productbug_confirmbugdash: commonLogic.appcommonhandle("确认",null),
			productbug_assingtobugcz: commonLogic.appcommonhandle("指派",null),
			productbug_resolvebugdash: commonLogic.appcommonhandle("解决",null),
			productbug_closebugdash: commonLogic.appcommonhandle("关闭",null),
			productbug_activation: commonLogic.appcommonhandle("激活",null),
			productbug_maineditdash: commonLogic.appcommonhandle("编辑",null),
			},
		},
		storyaffectbug_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
			productbug_unlinkbug: commonLogic.appcommonhandle("移除关联",null),
			},
		},
		pickupgird_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
			productbug_assingtobug: commonLogic.appcommonhandle("指派",null),
			productbug_confirmbug: commonLogic.appcommonhandle("确认",null),
			productbug_resolvebug: commonLogic.appcommonhandle("解决",null),
			productbug_closebug: commonLogic.appcommonhandle("关闭",null),
			productbug_mainedit: commonLogic.appcommonhandle("编辑",null),
			copy: commonLogic.appcommonhandle("Copy",null),
			productbug_bugfavorites: commonLogic.appcommonhandle("收藏",null),
			productbug_bugnfavorites: commonLogic.appcommonhandle("取消收藏",null),
			},
		},
		main_buildsub2_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
			productbug_unlinkbug_build: commonLogic.appcommonhandle("解除关联",null),
			},
		},
		main_buildsub3_grid: {
			columns: {
		...
		exportColumns: {
			...
			uiactions: {
			productbug_releaseunlinkbug: commonLogic.appcommonhandle("移除bug",null),
			},
		},
		...
		exportColumns: {
			...
			uiactions: {
			productbug_releaseunlinkbugbyleftbug: commonLogic.appcommonhandle("移除bug",null),
			},
		},
		main_copy_grid: {
			columns: {
