...
function getLocaleResourceBase(){
	const data:any = {
		...
		fields: {
			...
			begin: commonLogic.appcommonhandle("预计开始日期",null),
			statuss: commonLogic.appcommonhandle("状态",null),
			desc: commonLogic.appcommonhandle("描述",null),
			end: commonLogic.appcommonhandle("预计结束日期",null),
			...
			beginact: commonLogic.appcommonhandle("实际开始日期",null),
			endact: commonLogic.appcommonhandle("实际结束日期",null),
		},
			views: {
				subplaneditview: {
