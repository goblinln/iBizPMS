...
function getLocaleResourceBase(){
	...
	fields: {
		...
		views: {
			'listview': {
				caption: commonLogic.appcommonhandle("套件日志",null),
				title: commonLogic.appcommonhandle("套件日志列表视图",null),
			},
			'optionview': {
			...
			'editview': {
				caption: commonLogic.appcommonhandle("套件日志",null),
				title: commonLogic.appcommonhandle("套件日志编辑视图",null),
			},
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("套件日志列表视图（添加备注）",null),
			},
		},
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("套件日志基本信息",null), 
