...
function getLocaleResourceBase(){
	...
	fields: {
		...
		'objectid': commonLogic.appcommonhandle("项目编号",null),
	},
		views: {
			'addlistview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
				title: commonLogic.appcommonhandle("项目日志列表视图（添加备注）",null),
			},
			'editview': {
				caption: commonLogic.appcommonhandle("项目日志",null),
				title: commonLogic.appcommonhandle("项目日志编辑视图",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("项目日志",null),
				title: commonLogic.appcommonhandle("项目日志列表视图",null),
			},
			'optionview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("项目日志基本信息",null), 
