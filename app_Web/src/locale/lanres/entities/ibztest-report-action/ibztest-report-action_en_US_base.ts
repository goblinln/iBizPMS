	...
	fields: {
		...
		views: {
			'addlistview': {
				...
				title: commonLogic.appcommonhandle("报告日志列表视图（添加备注）",null),
			},
			'listview': {
				caption: commonLogic.appcommonhandle("报告日志",null),
				title: commonLogic.appcommonhandle("报告日志列表视图",null),
			},
			'editview': {
				caption: commonLogic.appcommonhandle("报告日志",null),
				title: commonLogic.appcommonhandle("报告日志编辑视图",null),
			},
			'optionview': {
				caption: commonLogic.appcommonhandle("添加备注",null),
		...
		main_form: {
			details: {
				'group1': commonLogic.appcommonhandle("报告日志基本信息",null), 
