...
// 注册部件插件
import { ProductSumGrid } from './plugin/grid-render/product-sum-grid';
...
import { BurnoutFigure } from './plugin/chart-render/burnout-figure';
...
export const PluginRegister = {
    install(v: any, opt: any) {
       ...
       // 注册编辑器插件
        ...
        // 注册部件插件
        v.component('app-grid-render-product-sum-grid',ProductSumGrid);
        ...
        v.component('app-chart-render-burnout-figure',BurnoutFigure);
