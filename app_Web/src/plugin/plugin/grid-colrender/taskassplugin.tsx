...
export class TASKASSPlugin {
    ...
    public handleActionClick (data: any, event: any, column: any, parentContainer: any) {
        AppViewLogicService.getInstance().excuteViewLogic(`${parentContainer.controlInstance.controlType.toLowerCase()}_${column}_click`,event,parentContainer,data,parentContainer.controlInstance.getPSAppViewLogics);
    }
