...
import { ViewTool, AppServiceBase } from 'ibiz-core';
...
/**
    ...
    public onAction(item: any, ctrlname: string, tag: string, $event: any) {
        ...
        AppViewLogicService.getInstance().excuteViewLogic(`${ctrlname}_${tag}_click`, $event, this, this.currentselectedNode, this.controlInstance.getPSAppViewLogics);
    }
            ...
            <div
                ...
                element-loading-spinner="el-icon-loading">
                    ...
                    {   
                        ...
                        ] : !this.loading ? this.renderNoData() : null
                    }
            </div>
        );
    }
