<template>
    <div style="width: 100%;height:100%;display: flex;justify-content: space-between;">
        <div v-if="!itemName" class="chart-no-data">
            <i class="el-icon-data-analysis"></i> {{ $t('app.commonWords.noData') }}
        </div>
        <!-- 图表 -->
        <div style="width: 39%;">
            <div
                ...
                class="app-charts"
                :id="chartId"
                style="width: 100%;height: 300px!important;padding: 6px 0;display: flex;justify-content: center;"
            ></div>
        ...
        <div class="legend" v-if="legendList.length > 0" style="width: 65%;padding-top:8px">
            <el-table
                ...
                max-height="275"
            >
                <el-table-column label="图例" width="50">
                ...
                <el-table-column :prop="itemName" label="条目"> </el-table-column>
                <el-table-column prop="srfcount" label="值" width="80"> </el-table-column>
                <el-table-column prop="percentage" label="百分比" width="80"> </el-table-column>
            </el-table>
        </div>
    </div>
</template>
