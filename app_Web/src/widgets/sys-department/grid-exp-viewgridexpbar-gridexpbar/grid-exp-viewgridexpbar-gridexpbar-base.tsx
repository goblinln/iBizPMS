...
export class GridExpViewgridexpbarGridexpbarBase extends GridExpBarControlBase {
     ...
     * @memberof GridExpViewgridexpbarBase
     */
    public navViewName: string = 'sys-employee-grid-exp-view-dept';
    ...
    */
    ...
    public gridexpbar_selectionchange(args: any [], tag?: string, $event2?: any): void {
        ...
        Object.assign(tempContext,{'sysdepartment':arg['sysdepartment']});
        Object.assign(tempContext,{srfparentdename:'SysDepartment',srfparentkey:arg['sysdepartment']});
        if(this.navFilter && !Object.is(this.navFilter,"")){
            Object.assign(tempViewParam,{[this.navFilter]:arg['sysdepartment']});
        }
        if(this.navPSDer && !Object.is(this.navPSDer,"")){
            Object.assign(tempViewParam,{[this.navPSDer]:arg['sysdepartment']});
        }
