 ...
 */
export default class BugStatsUIServiceBase extends UIService {
     ...
     * @memberof  BugStatsUIServiceBase
     */
    public dataService:BugStatsService = new BugStatsService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new BugStatsAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({bugstats:srfkey});
