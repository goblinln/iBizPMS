 ...
 */
export default class SysPostUIServiceBase extends UIService {
     ...
     * @memberof  SysPostUIServiceBase
     */
    public dataService:SysPostService = new SysPostService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new SysPostAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({syspost:srfkey});
