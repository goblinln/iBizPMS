 ...
 */
export default class IBIZProKeywordUIServiceBase extends UIService {
     ...
     * @memberof  IBIZProKeywordUIServiceBase
     */
    public dataService:IBIZProKeywordService = new IBIZProKeywordService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBIZProKeywordAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibizprokeyword:srfkey});
