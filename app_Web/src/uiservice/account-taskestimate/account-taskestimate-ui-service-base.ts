...
import AccountTaskestimateService from '@/service/account-taskestimate/account-taskestimate-service';
 ...
 */
export default class AccountTaskestimateUIServiceBase extends UIService {
     ...
     * @memberof  AccountTaskestimateUIServiceBase
     */
    public dataService:AccountTaskestimateService = new AccountTaskestimateService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new AccountTaskestimateAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({accounttaskestimate:srfkey});
