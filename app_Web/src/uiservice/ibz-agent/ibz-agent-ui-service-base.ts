 ...
 */
export default class IbzAgentUIServiceBase extends UIService {
     ...
     * @memberof  IbzAgentUIServiceBase
     */
    public dataService:IbzAgentService = new IbzAgentService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzAgentAuthService(opts);
        this.initViewMap();
     ...
     * @returns {Promise<any>}
     */
    public async IbzAgent_Edit(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        Object.assign(context, { ibzagent: '%ibzagent%' });
        Object.assign(params, { ibzagentid: '%ibzagent%' });
        Object.assign(params, { ibzagentname: '%ibzagentname%' });
        if(_this.context){
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                viewname: 'ibz-agent-create-edit-view', 
                height: 0, 
                width: 0,  
                title: actionContext.$t('entities.ibzagent.views.createeditview.title'),
     ...
     * @returns {Promise<any>}
     */
    public async IbzAgent_Create(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzagent:srfkey});
