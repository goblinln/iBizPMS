 ...
 */
export default class EmpLoyeeloadUIServiceBase extends UIService {
     ...
     * @memberof  EmpLoyeeloadUIServiceBase
     */
    public dataService:EmpLoyeeloadService = new EmpLoyeeloadService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new EmpLoyeeloadAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({employeeload:srfkey});
