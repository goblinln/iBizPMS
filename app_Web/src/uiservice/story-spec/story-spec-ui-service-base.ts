 ...
 */
export default class StorySpecUIServiceBase extends UIService {
     ...
     * @memberof  StorySpecUIServiceBase
     */
    public dataService:StorySpecService = new StorySpecService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new StorySpecAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({storyspec:srfkey});
