 ...
 */
export default class IbzproConfigUIServiceBase extends UIService {
     ...
     * @memberof  IbzproConfigUIServiceBase
     */
    public dataService:IbzproConfigService = new IbzproConfigService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzproConfigAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzproconfig:srfkey});
