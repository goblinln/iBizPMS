 ...
 */
export default class IbzCaseUIServiceBase extends UIService {
     ...
     * @memberof  IbzCaseUIServiceBase
     */
    public dataService:IbzCaseService = new IbzCaseService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzCaseAuthService(opts);
        this.initViewMap();
     ...
     * @returns {Promise<any>}
     */
    public async IbzCase_DeleteCz(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let confirmResult:boolean = await new Promise((resolve: any, reject: any) => {
          actionContext.$Modal.confirm({
              title: '警告',
              content: '您确认要删除该测试用例吗？',
              onOk: () => {resolve(true);},
        ...
        Object.assign(context, { ibzcase: '%ibzcase%' });
        Object.assign(params, { id: '%ibzcase%' });
     ...
     * @returns {Promise<any>}
     */
    public async IbzCase_Create(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                ...
                height: 0, 
                width: 0,  
                title: actionContext.$t('entities.ibzcase.views.neweditview.title'),
     ...
     * @returns {Promise<any>}
     */
    public async IbzCase_EditcaseCz(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                viewname: 'ibz-case-edit-edit-view', 
                height: 0, 
                width: 0,  
     ...
     * @returns {Promise<any>}
     */
    public async IbzCase_Editcase(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
     ...
     * @returns {Promise<any>}
     */
    public async IbzCase_Delete(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let confirmResult:boolean = await new Promise((resolve: any, reject: any) => {
          actionContext.$Modal.confirm({
              title: '警告',
              content: '您确认要删除该测试用例吗？',
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzcase:srfkey});
