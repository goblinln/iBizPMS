 ...
 */
export default class ProjectProductUIServiceBase extends UIService {
     ...
     * @memberof  ProjectProductUIServiceBase
     */
    public dataService:ProjectProductService = new ProjectProductService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new ProjectProductAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({projectproduct:srfkey});
