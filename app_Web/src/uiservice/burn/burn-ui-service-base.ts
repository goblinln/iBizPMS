 ...
 */
export default class BurnUIServiceBase extends UIService {
     ...
     * @memberof  BurnUIServiceBase
     */
    public dataService:BurnService = new BurnService();
     ...
     * @returns {Promise<any>}
     */
    public async Burn_ComputeBurn(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({burn:srfkey});
