 ...
 */
export default class IbizproProjectDailyUIServiceBase extends UIService {
     ...
     * @memberof  IbizproProjectDailyUIServiceBase
     */
    public dataService:IbizproProjectDailyService = new IbizproProjectDailyService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbizproProjectDailyAuthService(opts);
        this.initViewMap();
     ...
     * @returns {Promise<any>}
     */
    public async IbizproProjectDaily_ManualCreateDaily(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        ...
        Object.assign(context,{ISMANUAL:"yes"});
        Object.assign(params,{ismanual:"yes"});
        ...
        const backend = () => {
            const curService:IbizproProjectDailyService =  new IbizproProjectDailyService();
            curService.SumProjectDaily(context,data, true).then((response: any) => {
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibizproprojectdaily:srfkey});
