 ...
 */
export default class CompanyStatsUIServiceBase extends UIService {
     ...
     * @memberof  CompanyStatsUIServiceBase
     */
    public dataService:CompanyStatsService = new CompanyStatsService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new CompanyStatsAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({companystats:srfkey});
