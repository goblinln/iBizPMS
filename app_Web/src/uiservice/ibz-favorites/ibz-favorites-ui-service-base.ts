 ...
 */
export default class IbzFavoritesUIServiceBase extends UIService {
     ...
     * @memberof  IbzFavoritesUIServiceBase
     */
    public dataService:IbzFavoritesService = new IbzFavoritesService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzFavoritesAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzfavorites:srfkey});
