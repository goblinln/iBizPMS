 ...
 */
export default class SysTeamUIServiceBase extends UIService {
     ...
     * @memberof  SysTeamUIServiceBase
     */
    public dataService:SysTeamService = new SysTeamService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new SysTeamAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({systeam:srfkey});
