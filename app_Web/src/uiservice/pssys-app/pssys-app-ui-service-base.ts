 ...
 */
export default class PSSysAppUIServiceBase extends UIService {
     ...
     * @memberof  PSSysAppUIServiceBase
     */
    public dataService:PSSysAppService = new PSSysAppService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new PSSysAppAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pssysapp:srfkey});
