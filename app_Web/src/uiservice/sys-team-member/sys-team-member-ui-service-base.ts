 ...
 */
export default class SysTeamMemberUIServiceBase extends UIService {
     ...
     * @memberof  SysTeamMemberUIServiceBase
     */
    public dataService:SysTeamMemberService = new SysTeamMemberService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new SysTeamMemberAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({systeammember:srfkey});
