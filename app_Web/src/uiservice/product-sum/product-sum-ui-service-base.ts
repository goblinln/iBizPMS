 ...
 */
export default class ProductSumUIServiceBase extends UIService {
     ...
     * @memberof  ProductSumUIServiceBase
     */
    public dataService:ProductSumService = new ProductSumService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new ProductSumAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({productsum:srfkey});
