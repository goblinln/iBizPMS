...
import ProductLineService from '@/service/product-line/product-line-service';
 ...
 */
export default class ProductLineUIServiceBase extends UIService {
     ...
     * @memberof  ProductLineUIServiceBase
     */
    public dataService:ProductLineService = new ProductLineService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new ProductLineAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({productline:srfkey});
