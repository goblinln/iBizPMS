 ...
 */
export default class IbzproProductUserTaskUIServiceBase extends UIService {
     ...
     * @memberof  IbzproProductUserTaskUIServiceBase
     */
    public dataService:IbzproProductUserTaskService = new IbzproProductUserTaskService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzproProductUserTaskAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzproproductusertask:srfkey});
