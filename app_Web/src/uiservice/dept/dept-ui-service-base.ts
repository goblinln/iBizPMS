 ...
 */
export default class DeptUIServiceBase extends UIService {
     ...
     * @memberof  DeptUIServiceBase
     */
    public dataService:DeptService = new DeptService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new DeptAuthService(opts);
        this.initViewMap();
     ...
     * @returns {Promise<any>}
     */
    public async Dept_Edit(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        Object.assign(context, { dept: '%dept%' });
        Object.assign(params, { id: '%dept%' });
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                viewname: 'dept-edit-view', 
                height: 0, 
                width: 750,  
                title: actionContext.$t('entities.dept.views.editview.title'),
     ...
     * @returns {Promise<any>}
     */
    public async Dept_Delete(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let data: any = {};
        let parentContext:any = {};
        let parentViewParam:any = {};
        const _this: any = actionContext;
     ...
     * @returns {Promise<any>}
     */
    public async Dept_Create(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({dept:srfkey});
