 ...
 */
export default class ProjectModuleUIServiceBase extends UIService {
     ...
     * @memberof  ProjectModuleUIServiceBase
     */
    public dataService:ProjectModuleService = new ProjectModuleService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new ProjectModuleAuthService(opts);
        this.initViewMap();
     ...
     * @returns {Promise<any>}
     */
    public async ProjectModule_Fix(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
     ...
     * @returns {Promise<any>}
     */
    public async ProjectModule_OpenQuickCfgView(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        Object.assign(context, { projectmodule: '%projectmodule%' });
        Object.assign(params, { id: '%projectmodule%' });
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({projectmodule:srfkey});
