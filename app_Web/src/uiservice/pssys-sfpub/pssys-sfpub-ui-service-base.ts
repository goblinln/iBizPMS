 ...
 */
export default class PSSysSFPubUIServiceBase extends UIService {
     ...
     * @memberof  PSSysSFPubUIServiceBase
     */
    public dataService:PSSysSFPubService = new PSSysSFPubService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new PSSysSFPubAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pssyssfpub:srfkey});
