 ...
 */
export default class IBZProStoryUIServiceBase extends UIService {
     ...
     * @memberof  IBZProStoryUIServiceBase
     */
    public dataService:IBZProStoryService = new IBZProStoryService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBZProStoryAuthService(opts);
        this.initViewMap();
    ...
    public initViewMap(){
        this.allViewMap.set('MDATAVIEW:', {
            viewname: 'gridview',
            srfappde: 'ibzprostories',
            component: 'ibzpro-story-grid-view',
            openmode: '',
            title: '需求',
            width: 0,
            height: 0
        ...
        this.allViewMap.set('EDITVIEW:', {
            viewname: 'editview',
            srfappde: 'ibzprostories',
            component: 'ibzpro-story-edit-view',
            openmode: '',
            title: '需求',
            width: 0,
            height: 0
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzprostory:srfkey});
