 ...
 */
export default class IBIZProTagUIServiceBase extends UIService {
     ...
     * @memberof  IBIZProTagUIServiceBase
     */
    public dataService:IBIZProTagService = new IBIZProTagService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBIZProTagAuthService(opts);
        this.initViewMap();
    ...
    public initViewMap(){
        this.allViewMap.set('EDITVIEW:', {
            viewname: 'editview',
            srfappde: 'ibizprotags',
            component: 'ibizpro-tag-edit-view',
            openmode: '',
            title: '标签',
            width: 0,
            height: 0
        ...
        this.allViewMap.set('MDATAVIEW:', {
            viewname: 'gridview',
            srfappde: 'ibizprotags',
            component: 'ibizpro-tag-grid-view',
            openmode: '',
            title: '标签',
            width: 0,
            height: 0
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibizprotag:srfkey});
