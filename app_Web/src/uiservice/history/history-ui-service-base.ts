 ...
 */
export default class HistoryUIServiceBase extends UIService {
     ...
     * @memberof  HistoryUIServiceBase
     */
    public dataService:HistoryService = new HistoryService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new HistoryAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({history:srfkey});
