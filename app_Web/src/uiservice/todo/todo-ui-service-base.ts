...
export default class TodoUIServiceBase extends UIService {
    ...
    public initDeMainStateOPPrivsMap(){
        this.allDeMainStateOPPrivsMap.set('closed',Object.assign({'ACTIVATE':0,'ASSIGNTO':0,'CLOSE':0,'CREATE':0,'DELETE':0,'FINISH':0,'READ':0,'TOBUG':0,'TOTASK':0,'UPDATE':0},{'UPDATE':1,'DELETE':1,'ACTIVATE':1,}));
        this.allDeMainStateOPPrivsMap.set('doing',Object.assign({'ACTIVATE':0,'ASSIGNTO':0,'CLOSE':0,'CREATE':0,'DELETE':0,'FINISH':0,'READ':0,'TOBUG':0,'TOTASK':0,'UPDATE':0},{'FINISH':1,'ASSIGNTO':1,'DELETE':1,'TOTASK':1,'TOBUG':1,'UPDATE':1,}));
        this.allDeMainStateOPPrivsMap.set('done',Object.assign({'ACTIVATE':0,'ASSIGNTO':0,'CLOSE':0,'CREATE':0,'DELETE':0,'FINISH':0,'READ':0,'TOBUG':0,'TOTASK':0,'UPDATE':0},{'DELETE':1,'CLOSE':1,'UPDATE':1,'ACTIVATE':1,}));
        this.allDeMainStateOPPrivsMap.set('wait',Object.assign({'ACTIVATE':0,'ASSIGNTO':0,'CLOSE':0,'CREATE':0,'DELETE':0,'FINISH':0,'READ':0,'TOBUG':0,'TOTASK':0,'UPDATE':0},{'DELETE':1,'FINISH':1,'UPDATE':1,'TOBUG':1,'ASSIGNTO':1,'TOTASK':1,}));
    }
     ...
     * @returns {Promise<any>}
     */
    public async Todo_edit1Cz(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
     ...
     * @returns {Promise<any>}
     */
    public async Todo_TodoCreate(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                ...
                height: 0, 
                width: 0,  
                title: actionContext.$t('entities.todo.views.todocreateview.title'),
                placement: 'DRAWER_RIGHT',
            };
            openDrawer(view, data);
    }
     ...
     * @returns {Promise<any>}
     */
    public async Todo_closeCz(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
     ...
     * @returns {Promise<any>}
     */
    public async Todo_deleteCz(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let confirmResult:boolean = await new Promise((resolve: any, reject: any) => {
          actionContext.$Modal.confirm({
              title: '警告',
              content: '您确定要删除这条待办吗？',
     ...
     * @returns {Promise<any>}
     */
    public async Todo_assignToCz(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
