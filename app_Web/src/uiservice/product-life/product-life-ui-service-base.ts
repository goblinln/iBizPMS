 ...
 */
export default class ProductLifeUIServiceBase extends UIService {
     ...
     * @memberof  ProductLifeUIServiceBase
     */
    public dataService:ProductLifeService = new ProductLifeService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new ProductLifeAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({productlife:srfkey});
