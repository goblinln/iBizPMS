 ...
 */
export default class IbizproProductMonthlyUIServiceBase extends UIService {
     ...
     * @memberof  IbizproProductMonthlyUIServiceBase
     */
    public dataService:IbizproProductMonthlyService = new IbizproProductMonthlyService();
     ...
     * @memberof  IbizproProductMonthlyUIServiceBase
     */  
    public mainStateFields:Array<any> = ['ibizproproductmonthlyid'];
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbizproProductMonthlyAuthService(opts);
        this.initViewMap();
     ...
     * @returns {Promise<any>}
     */
    public async IbizproProductMonthly_ManualCreateMonthly(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        ...
        const backend = () => {
            const curService:IbizproProductMonthlyService =  new IbizproProductMonthlyService();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibizproproductmonthly:srfkey});
