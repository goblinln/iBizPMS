 ...
 */
export default class TaskestimatestatsUIServiceBase extends UIService {
     ...
     * @memberof  TaskestimatestatsUIServiceBase
     */
    public dataService:TaskestimatestatsService = new TaskestimatestatsService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new TaskestimatestatsAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({taskestimatestats:srfkey});
