 ...
 */
export default class SuiteCaseUIServiceBase extends UIService {
     ...
     * @memberof  SuiteCaseUIServiceBase
     */
    public dataService:SuiteCaseService = new SuiteCaseService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new SuiteCaseAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({suitecase:srfkey});
