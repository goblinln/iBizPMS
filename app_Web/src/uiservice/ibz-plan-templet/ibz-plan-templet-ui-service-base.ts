 ...
 */
export default class IbzPlanTempletUIServiceBase extends UIService {
     ...
     * @memberof  IbzPlanTempletUIServiceBase
     */
    public dataService:IbzPlanTempletService = new IbzPlanTempletService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzPlanTempletAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzplantemplet:srfkey});
