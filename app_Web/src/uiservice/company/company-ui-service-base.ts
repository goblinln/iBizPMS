 ...
 */
export default class CompanyUIServiceBase extends UIService {
     ...
     * @memberof  CompanyUIServiceBase
     */
    public dataService:CompanyService = new CompanyService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new CompanyAuthService(opts);
        this.initViewMap();
     ...
     * @returns {Promise<any>}
     */
    public async Company_EditDept(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({company:srfkey});
