...
import ProjectTaskestimateService from '@/service/project-taskestimate/project-taskestimate-service';
 ...
 */
export default class ProjectTaskestimateUIServiceBase extends UIService {
     ...
     * @memberof  ProjectTaskestimateUIServiceBase
     */
    public dataService:ProjectTaskestimateService = new ProjectTaskestimateService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new ProjectTaskestimateAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({projecttaskestimate:srfkey});
