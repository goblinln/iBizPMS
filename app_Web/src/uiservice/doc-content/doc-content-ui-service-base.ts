 ...
 */
export default class DocContentUIServiceBase extends UIService {
     ...
     * @memberof  DocContentUIServiceBase
     */
    public dataService:DocContentService = new DocContentService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new DocContentAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({doccontent:srfkey});
