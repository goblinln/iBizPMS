 ...
 */
export default class IbzLibModuleUIServiceBase extends UIService {
     ...
     * @memberof  IbzLibModuleUIServiceBase
     */
    public dataService:IbzLibModuleService = new IbzLibModuleService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzLibModuleAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzlibmodule:srfkey});
