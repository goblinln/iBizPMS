 ...
 */
export default class PRODUCTTEAMUIServiceBase extends UIService {
     ...
     * @memberof  PRODUCTTEAMUIServiceBase
     */
    public dataService:PRODUCTTEAMService = new PRODUCTTEAMService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new PRODUCTTEAMAuthService(opts);
        this.initViewMap();
    ...
    public initViewMap(){
        this.allViewMap.set('EDITVIEW:', {
            viewname: 'editview',
            srfappde: 'productteams',
            component: 'productteamedit-view',
            openmode: '',
            title: '产品团队',
            width: 0,
            height: 0
     ...
     * @returns {Promise<any>}
     */
    public async PRODUCTTEAM_RemoveMember(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let confirmResult:boolean = await new Promise((resolve: any, reject: any) => {
          actionContext.$Modal.confirm({
              title: '警告',
              content: '您确定从该项目中移除该用户吗？',
              onOk: () => {resolve(true);},
        ...
        Object.assign(context, { productteam: '%productteam%' });
        Object.assign(params, { id: '%productteam%' });
        ...
        const backend = () => {
            const curService:PRODUCTTEAMService =  new PRODUCTTEAMService();
     ...
     * @returns {Promise<any>}
     */
    public async PRODUCTTEAM_ManagerMember(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                viewname: 'productteamusr2-grid-view', 
                height: 0, 
                width: 0,  
                title: actionContext.$t('entities.productteam.views.usr2gridview.title'),
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({productteam:srfkey});
