 ...
 */
export default class CaseStatsUIServiceBase extends UIService {
     ...
     * @memberof  CaseStatsUIServiceBase
     */
    public dataService:CaseStatsService = new CaseStatsService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new CaseStatsAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({casestats:srfkey});
