 ...
 */
export default class UserTplUIServiceBase extends UIService {
     ...
     * @memberof  UserTplUIServiceBase
     */
    public dataService:UserTplService = new UserTplService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new UserTplAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({usertpl:srfkey});
