 ...
 */
export default class IbzReportRoleConfigUIServiceBase extends UIService {
     ...
     * @memberof  IbzReportRoleConfigUIServiceBase
     */
    public dataService:IbzReportRoleConfigService = new IbzReportRoleConfigService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzReportRoleConfigAuthService(opts);
        this.initViewMap();
    ...
    public initViewMap(){
        this.allViewMap.set('MDATAVIEW:', {
            ...
            component: 'ibz-report-role-config-grid-view',
            openmode: '',
            title: '汇报角色配置',
            width: 0,
            height: 0
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzreportroleconfig:srfkey});
