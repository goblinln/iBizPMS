 ...
 */
export default class IbzPlanTempletDetailUIServiceBase extends UIService {
     ...
     * @memberof  IbzPlanTempletDetailUIServiceBase
     */
    public dataService:IbzPlanTempletDetailService = new IbzPlanTempletDetailService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbzPlanTempletDetailAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzplantempletdetail:srfkey});
