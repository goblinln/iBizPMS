 ...
 */
export default class TaskStatsUIServiceBase extends UIService {
     ...
     * @memberof  TaskStatsUIServiceBase
     */
    public dataService:TaskStatsService = new TaskStatsService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new TaskStatsAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({taskstats:srfkey});
