 ...
 */
export default class IBIZProPluginUIServiceBase extends UIService {
     ...
     * @memberof  IBIZProPluginUIServiceBase
     */
    public dataService:IBIZProPluginService = new IBIZProPluginService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBIZProPluginAuthService(opts);
        this.initViewMap();
    ...
    public initViewMap(){
        this.allViewMap.set('EDITVIEW:', {
            viewname: 'editview',
            srfappde: 'ibizproplugins',
            component: 'ibizpro-plugin-edit-view',
            openmode: '',
            title: '系统插件',
            width: 0,
            height: 0
        ...
        this.allViewMap.set('MDATAVIEW:', {
            viewname: 'gridview',
            srfappde: 'ibizproplugins',
            component: 'ibizpro-plugin-grid-view',
            openmode: '',
            title: '系统插件',
            width: 0,
            height: 0
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibizproplugin:srfkey});
