 ...
 */
export default class PSSystemDBCfgUIServiceBase extends UIService {
     ...
     * @memberof  PSSystemDBCfgUIServiceBase
     */
    public dataService:PSSystemDBCfgService = new PSSystemDBCfgService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new PSSystemDBCfgAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({pssystemdbcfg:srfkey});
