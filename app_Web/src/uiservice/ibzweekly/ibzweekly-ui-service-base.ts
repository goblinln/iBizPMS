 ...
 */
export default class IBZWEEKLYUIServiceBase extends UIService {
    ...
    public initViewMap(){
        ...
        this.allViewMap.set('MDATAVIEW:', {
            viewname: 'gridview',
            srfappde: 'ibzweeklies',
            component: 'ibz-weekly-grid-view',
            openmode: '',
            title: '周报',
            width: 0,
            height: 0
     ...
     * @returns {Promise<any>}
     */
    public async IbzWeekly_edit(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
     ...
     * @returns {Promise<any>}
     */
    public async IbzWeekly_submitZZZ(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        ...
        const backend = () => {
            const curService:IBZWEEKLYService =  new IBZWEEKLYService();
     ...
     * @returns {Promise<any>}
     */
    public async IbzWeekly_createEveryWeekReport(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let data: any = {};
        let parentContext:any = {};
        let parentViewParam:any = {};
        const _this: any = actionContext;
        Object.assign(context,{IBZWEEKLY:"0"});
        Object.assign(params,{ibzweekly:"0"});
        const _args: any[] = Util.deepCopy(args);
        ...
        const backend = () => {
            const curService:IBZWEEKLYService =  new IBZWEEKLYService();
            curService.CreateEveryWeekReport(context,data, true).then((response: any) => {
                if (!response || response.status !== 200) {
                    actionContext.$Notice.error({ title: '错误', desc: response.message });
                    return;
                }
                actionContext.$Notice.success({ title: '成功', desc: '生成周报成功！' });
                const _this: any = actionContext;
                if (xData && xData.refresh && xData.refresh instanceof Function) {
                    xData.refresh(args);
                }
     ...
     * @returns {Promise<any>}
     */
    public async IbzWeekly_haveRead(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                viewname: 'ibz-weekly-edit-view-main-myweekly', 
                height: 0, 
                width: 0,  
                title: actionContext.$t('entities.ibzweekly.views.editviewmainmyweekly.title'),
     ...
     * @returns {Promise<any>}
     */
    public async IbzWeekly_create(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
