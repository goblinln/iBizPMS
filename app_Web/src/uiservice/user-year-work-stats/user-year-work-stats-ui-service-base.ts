 ...
 */
export default class UserYearWorkStatsUIServiceBase extends UIService {
     ...
     * @memberof  UserYearWorkStatsUIServiceBase
     */
    public dataService:UserYearWorkStatsService = new UserYearWorkStatsService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new UserYearWorkStatsAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({useryearworkstats:srfkey});
