 ...
 */
export default class IbizproProjectMonthlyUIServiceBase extends UIService {
     ...
     * @memberof  IbizproProjectMonthlyUIServiceBase
     */
    public dataService:IbizproProjectMonthlyService = new IbizproProjectMonthlyService();
     ...
     * @memberof  IbizproProjectMonthlyUIServiceBase
     */  
    public mainStateFields:Array<any> = ['ibizproprojectmonthlyid'];
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IbizproProjectMonthlyAuthService(opts);
        this.initViewMap();
    ...
    public initViewMap(){
        this.allViewMap.set('MDATAVIEW:', {
            viewname: 'gridview',
            srfappde: 'ibizproprojectmonthlies',
            component: 'ibizpro-project-monthly-grid-view',
            openmode: '',
            title: '项目月报',
            width: 0,
            height: 0
        ...
        this.allViewMap.set('EDITVIEW:', {
            viewname: 'editview',
            srfappde: 'ibizproprojectmonthlies',
            component: 'ibizpro-project-monthly-edit-view',
            openmode: 'DRAWER_TOP',
            title: '项目月报',
            width: 0,
            height: 0
     ...
     * @returns {Promise<any>}
     */
    public async IbizproProjectMonthly_ManualCreateMonthly(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        ...
        const backend = () => {
            const curService:IbizproProjectMonthlyService =  new IbizproProjectMonthlyService();
            curService.ManualCreateMonthly(context,data, true).then((response: any) => {
    ...
    public async getRDAppViewEX(srfkey:string,isEnableWorkflow:boolean,rdviewname:string){        
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibizproprojectmonthly:srfkey});
