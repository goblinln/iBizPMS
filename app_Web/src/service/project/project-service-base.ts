...
// 实体接口
     ...
     * @memberof ProjectServiceBase
     */
    public async FetchCurPersonalProjects(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        let tempData:any = JSON.parse(JSON.stringify(data));
        let res:any = await Http.getInstance().get(`/projects/fetchcurpersonalprojects`,tempData,isloading);
        return res;
    }

    /**
     * searchCurPersonalProjects接口方法
     *
     * @param {*} [context={}]
     * @param {*} [data={}]
     * @param {boolean} [isloading]
     ...
     * @memberof ProjectServiceBase
     */
    public async searchCurPersonalProjects(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        let tempData:any = JSON.parse(JSON.stringify(data));
        return await Http.getInstance().post(`/projects/searchcurpersonalprojects`,tempData,isloading);
    }
     ...
     * @memberof ProjectServiceBase
     */
    public async FetchCurUserTodo(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        let tempData:any = JSON.parse(JSON.stringify(data));
        let res:any = await Http.getInstance().get(`/projects/fetchcurusertodo`,tempData,isloading);
        return res;
    }

    /**
     * searchCurUserTodo接口方法
     *
     * @param {*} [context={}]
     * @param {*} [data={}]
     * @param {boolean} [isloading]
     ...
     * @memberof ProjectServiceBase
     */
    public async searchCurUserTodo(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        let tempData:any = JSON.parse(JSON.stringify(data));
        return await Http.getInstance().post(`/projects/searchcurusertodo`,tempData,isloading);
    }
    ...
    /**
     * FetchTempCurPersonalProjects接口方法
     *
     * @param {*} [context={}]
     * @param {*} [data={}]
     * @param {boolean} [isloading]
     ...
     * @memberof ProjectServiceBase
     */
    public async FetchTempCurPersonalProjects(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
    }
     ...
     * @memberof ProjectServiceBase
     */
    public async FetchTempCurUserTodo(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
    }
