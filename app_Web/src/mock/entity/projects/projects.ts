...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ibizpms-app-web\/projects\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ibizpms-app-web\/projects\/process-definitions-nodes$/)).reply((config: any) => {
