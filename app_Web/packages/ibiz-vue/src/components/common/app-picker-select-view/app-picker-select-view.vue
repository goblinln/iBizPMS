...
export default class AppPickerSelectView extends Vue {
    ...
    public onValueChange(newVal: any, oldVal: any) {
        if(this.isSingleSelect){
            ...
            if (!this.data || !this.valueitem || !this.data[this.valueitem]) {
                this.$throw((this.$t('components.apppickerselectview.error') as any)+this.name+(this.$t('components.apppickerselectview.valueitemexception') as any),'onValueChange');
            }else{
    ...
    public openLinkView($event: any): void {
        if (!this.data || !this.valueitem || !this.data[this.valueitem]) {
            this.$throw((this.$t('components.apppickerselectview.error') as any)+this.name+(this.$t('components.apppickerselectview.valueitemexception') as any),'openLinkView');
            return;
        }
        // 公共参数处理
        let data: any = {};
