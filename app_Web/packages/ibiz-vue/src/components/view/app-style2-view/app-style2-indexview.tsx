import { AuthServiceBase } from 'ibiz-core';
import { Component } from 'vue-property-decorator';
import { AppLayoutService, FooterItemsService } from '../../../app-service';
...
export class AppStyle2IndexView extends AppIndexViewBase {
    ...
    public async viewModelInit(){
        ...
        this.appMenuModel = this.menuInstance?.getAllMenuItem();
    ...
    protected click(item: any): void {
        const appMenu: any = (this.$refs[this.menuInstance?.name] as any).ctrl;
        if (appMenu) {
            appMenu.click(item);
        }
    }
    ...
    public renderLeftExp(){
        return (
            ...
            <app-content-left-exp 
                slot="leftExp"
                ref="leftExp"
                menuInstance={this.menuInstance}
