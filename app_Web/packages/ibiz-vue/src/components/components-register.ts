...
import { AppDefaultEditView2 } from './view/app-default-view/app-default-editview2';
import { AppDefaultEditView3 } from './view/app-default-view/app-default-editview3';
import { AppDefaultEditView4 } from './view/app-default-view/app-default-editview4';
...
export const ComponentsRegister = {
    install(v: any, opt: any) {
        ...
        v.component('app-default-editview2', AppDefaultEditView2);
        v.component('app-default-editview3', AppDefaultEditView3);
        v.component('app-default-editview4', AppDefaultEditView4);
        ...
        v.component('app-default-drbar', AppDefaultDrbar);
