...
export class AppTabViewPanelBase extends TabViewPanelBase {
    ...
    public render() {
        ...
        const { getEmbeddedPSAppDEView } = this.controlInstance;
        let tempContext: any = Object.assign(this.context, { viewpath: getEmbeddedPSAppDEView?.path || getEmbeddedPSAppDEView?.dynaModelFilePath });
        ...
        return (
            <div class={{ ...controlClassNames, 'tabviewpanel': true }} >
                {
                    this.isActivied && getEmbeddedPSAppDEView ?
