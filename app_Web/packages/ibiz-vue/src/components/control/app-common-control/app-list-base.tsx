...
export class AppListBase extends ListControlBase {
    ...
    public render() {
        ...
        return this.controlInstance.getBatchPSDEToolbar
        ?<div style="overflow:auto;">
            <div class={listClassName} style='height:100%;'>
                ...
                {this.controlInstance.getView().viewStyle && this.controlInstance.getView().viewStyle == "DEFAULT" ? <el-backtop target=".content-container .app-list"></el-backtop> : null}
            </div>
            {this.controlInstance.getBatchPSDEToolbar && (this.selections.length > 0 ?
    ...
    public renderHaveItems() {
        return this.items.map((item: any, index : number) => {
            let listItem:any = this.controlInstance.getPSDEListItems ? this.controlInstance.getPSDEListItems[index] : null;
    ...
    public renderNoItems() {
        return this.controlInstance.getQuickPSDEToolbar && this.renderQuickPSDEToolbar()
    }
