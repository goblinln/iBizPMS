    ...
    public renderContentLeft(){
        ...
        return (
            <layout style={{'font-family': this.selectFont,'height': '100vh'}}>
                <layout id="movebox">
                    <sider class="index_sider" width={this.collapseChange ? 64 : 200} hide-trigger value={this.collapseChange} id="left_move">
                        <div class="sider-top">
                            <div class="page-logo">
                    ...
                    {!this.collapseChange ? <div id="move_axis"></div> : null}
    ...
    public render(h: any) {
        ...
        return (
            <div class={viewClass}>
                ...
                { Object.is(this.viewInstance.mode, "vertical") ? this.renderContentLeft() : this.renderContentTop()}
            </div>
        );
    }
