import { CodeListServiceBase, IBizSearchFormModel, Util } from 'ibiz-core'
import { IBizSearchBarModel } from '../../../ibiz-core/src';
...
export class MDViewBase extends MainViewBase {
     ...
     * @memberof MDViewBase
     */
    public searchFormInstance !: IBizSearchFormModel;
     ...
     * @memberof MDViewBase
     */
    public quickSearchFormInstance !: IBizSearchFormModel;
     ...
     * @memberof MDViewBase
     */
    public searchBarInstance!: IBizSearchBarModel;
    ...
    public async loadQuickGroupModel() {
        ...
        try {
            let res: any = await this.codeListService.getDataItems({tag: this.quickGroupCodeList.codeName, type: this.quickGroupCodeList.codeListType});
    ...
    public async viewModelInit() {
        ...
        this.searchFormInstance = this.viewInstance.getControl('searchform');
        this.quickSearchFormInstance = this.viewInstance.getControl('quicksearchform');
        this.searchBarInstance = this.viewInstance.getControl('searchbar');
    }
    ...
    public async viewInit() {
        ...
        this.quickGroupCodeList = this.viewInstance.quickGroupCodeList;
    ...
    public renderQuickGroup() {
        ...
        if (this.viewInstance.getPSSysCounterRef?.id) {
            counterService = Util.findElementByField(this.counterServiceArray, 'id', this.viewInstance?.getPSSysCounterRef?.id )?.service;
        }
    ...
    public renderQuickSearch() {
        ...
        if (this.viewInstance.appDataEntity.getQuickSearchPlaceholder) {
            this.placeholder = this.viewInstance.appDataEntity.getQuickSearchPlaceholder();
        }
