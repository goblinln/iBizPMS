...
export class MainViewBase extends ViewBase {
    ...
    public initViewToolBar() {
        ...
        if (this.viewInstance && this.viewInstance.viewToolBarItems) {
            ...
            this.viewInstance.viewToolBarItems.forEach((item: IBizToolBarItemModel) => {
                ...
                targetViewToolbarItems.push(tempItem);
            })
        }
    ...
    public renderToolBar() {
        ...
        return (<view-toolbar slot='toolbar' counterServiceArray={this.counterServiceArray} toolbarModels={this.toolbarModels} on-item-click={(data: any, $event: any) => { this.handleItemClick(data, $event) }}></view-toolbar>);
    }
    ...
    public handleItemClick(data: any, $event: any) {
        AppViewLogicService.getInstance().excuteViewLogic(`toolbar_${data.tag}_click`, $event, this, undefined, this.viewInstance.getPSAppViewLogics);
    }
