...
import { IBizMEditViewModel, IBizMEditViewPanelModel, ViewState } from 'ibiz-core';
...
export class MEditViewBase extends MDViewBase {
     ...
     */
    public viewInstance!: IBizMEditViewModel;
    ...
    public async viewModelInit(arg?: any) {
        this.viewInstance = new IBizMEditViewModel(this.staticProps.modeldata, this.context);
        await this.viewInstance.loaded();
        await super.viewModelInit();
        this.meditViewPanelInstance = this.viewInstance.getControl('meditviewpanel');
    }
    ...
    public onCtrlEvent(controlname: string, action: string, data: any) {
        if (Object.is(controlname, this.viewInstance.viewMeditViewPanel?.name) && action) {
            switch (action) {
                case 'drdatasaved':
