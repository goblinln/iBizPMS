...
import { Util, ViewTool, AppServiceBase, ViewContext, ViewState, IBizViewModelBase } from 'ibiz-core';
...
export class ViewBase extends Vue {
    ...
    */
    ...
    public async initAppUIService() {
        if (this.viewInstance.appDataEntity && this.viewInstance.appDataEntity.codeName) {
    ...
    public parseViewParam(inputvalue: any = null): void {
        ...
        if (_this.viewInstance.appDeCodeName) {
    ...
    public counterRefresh() {
        if (this.counterServiceArray && this.counterServiceArray.length > 0) {
            this.counterServiceArray.forEach((item: any) => {
                if (item.refreshCounterData && item.refreshCounterData instanceof Function) {
                    item.refreshCounterData();
                }
            })
        }
    }
