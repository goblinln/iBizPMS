...
export class CalendarControlBase extends MDControlBase{
     ...
     * @memberof CalendarControlBase
     */
    public eventLimitClick(info: any) {
        let moreEle: any = info.moreEl;
        if (moreEle) {
            moreEle.className = 'fc-more fc-more-select';
        }
        this.ctrlEvent({ controlname: this.controlInstance.name, action: 'eventlimitclick', data: info });
        return 'popover';
    }
}
