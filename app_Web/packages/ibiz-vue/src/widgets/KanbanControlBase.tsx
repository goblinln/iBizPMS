...
export class KanbanControlBase extends MDControlBase {
    ...
    public async ctrlModelInit(args?:any) {
        ...
        this.groupCodelist = this.controlInstance.codeList ? { type: this.controlInstance.codeList.codeListType, tag: this.controlInstance.codeList.codeName } : {};
    ...
    public handleItemClick(data: any,$event: any) {
        AppViewLogicService.getInstance().excuteViewLogic(this.getViewLogicTag(this.controlInstance.name, 'quicktoolbar', data.tag),$event,this,undefined,this.controlInstance.getPSAppViewLogics);
    }
    ...
    public uiActionClick(detail: any, $event: any, group: any) {
        ...
        AppViewLogicService.getInstance().excuteViewLogic(this.getViewLogicTag(this.controlInstance.name, 'group', detail.name),$event,this,row,this.controlInstance.getPSAppViewLogics);
    }
