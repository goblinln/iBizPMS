...
export class GridControlBase extends MDControlBase {
    ...
    public async formatExcelData(filterVal: any, jsonData: any) {
        ...
        for (const codelist of codelistColumns) {
            let items: any = await this.codeListService.getDataItems({ tag: codelist.srfkey, type: codelist.codelistType, context: this.context, viewparams: this.viewparams });
    ...
    public async drawCodelistGroup() {
        ...
        if (this.codelistTag && this.codelistType) {
            allGroup = await this.codeListService.getDataItems({ tag: this.codelistTag, type: this.codelistType });
        }
        if (this.groupAppFieldCodelistTag && this.groupAppFieldCodelistType) {
            allGroupField = await this.codeListService.getDataItems({ tag: this.groupAppFieldCodelistTag, type: this.groupAppFieldCodelistType });
        }
    ...
    public getRowClassName(args: { row: any, rowIndex: number }) {
        const appde = this.controlInstance.appDataEntity?.keyField;
    ...
    public handleActionClick(data: any, event: any, column: any, detail: any) {
        AppViewLogicService.getInstance().excuteViewLogic(this.getViewLogicTag(this.controlInstance.name, column.codeName, detail.name), event, this, data, this.controlInstance.getPSAppViewLogics);
    }
    ...
    public columnUIAction(data: any, event: any, column: any) {
        ...
        AppViewLogicService.getInstance().excuteViewLogic(tag, event, this, data, this.controlInstance.getPSAppViewLogics);
    }
}
