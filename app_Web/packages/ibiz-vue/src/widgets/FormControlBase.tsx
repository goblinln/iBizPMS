...
import { IBizFormModel, Util, Verify } from 'ibiz-core';
...
export class FormControlBase extends MainControlBase {
    ...
    public validateEditorRuleAction(name: string, value: any) {
        // if (this.controlInstance.formItems.length > 0) {
        //     let curFormItem: any = this.controlInstance.formItems.find((item: any) => {
        //         return item.name === name;
        //     })
        //     if (!curFormItem)
        //         return;
        //     let condition: any = Verify.buildVerConditions(curFormItem.editor);
