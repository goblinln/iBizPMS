...
export class ExpBarControlBase extends MainControlBase {
    ...
    */
    ...
    public getQuickGroupDefaultSelect() {
        ...
        if (quickGroupCodeList?.getPSCodeItems?.length > 0) {
            for (const item of quickGroupCodeList.getPSCodeItems) {
    ...
    public initCtrlToolBar() {
        ...
        if (this.controlInstance && this.controlInstance.toolbar?.getPSDEToolbarItems?.length > 0) {
    ...
    */
    ...
    public renderQuickGroup() {
        ...
        if (enableCounter) {
            ...
            let sysCounter: any = this.controlInstance?.getView()?.getPSAppCounterRef;
            if (sysCounter?.id) {
