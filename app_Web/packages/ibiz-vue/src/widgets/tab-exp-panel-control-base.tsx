...
export class TabExpPanelBase extends MainControlBase {
    ...
    public async ctrlModelInit(args?: any) {
        ...
        let { allControls } = this.controlInstance;
    ...
    public ctrlInit() {
        ...
        if (this.context[this.controlInstance?.appDataEntity?.codeName?.toLowerCase()]) {
            Object.assign(this.context, { srfparentdename: this.controlInstance.appDataEntity.codeName.toLowerCase(), srfparentkey: this.context[this.controlInstance.appDataEntity.codeName.toLowerCase()] })
        }
        if (this.viewState) {
    ...
    public onCtrlEvent(controlname: string, action: string, data: any) {
        if (!Object.is(controlname, 'tabviewpanel')) {
            return this.ctrlEvent({ controlname, action, data });
        }
        switch (action) {
            case 'viewpanelDatasChange':
