import { CodeListServiceBase, DynamicService, IBizTreeGridExModel, Util } from "ibiz-core";
...
export class TreeGridExControlBase extends MDControlBase {
    ...
    public async initColumnsCodeList(){
        ...
        const { allTreeNodes } = this.controlInstance;
    ...
    public getColumnValue(task: any, field: string) {
        ...
        const { allTreeNodes } = this.controlInstance;
        const node: any = allTreeNodes?.find((_node: any) => {
    ...
    public renderColumns() {
        return (
            this.controlInstance.treeColumns.map((column: any) => {
