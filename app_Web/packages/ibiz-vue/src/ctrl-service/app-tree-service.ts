...
export class AppTreeService extends ControlServiceBase {
    ...
    public async searchNodeData(nodeJson: any, context: any = {}, searchFilter: any, filter: any): Promise<any> {
        ...
        if (nodeJson.getSortPSAppDEField && nodeJson.getSortPSAppDEField.codeName && nodeJson.sortDir) {
            Object.assign(searchFilter, { sort: `${nodeJson.getSortPSAppDEField.codeName.toLowerCase()},${nodeJson.sortDir.toLowerCase()}` });
        }
