 ...
 *
 * @export
 * @class IBZTestReportActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZTestReportActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZTestReportActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZTestReportAction.json";

    /**
     * Creates an instance of  IBZTestReportActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZTestReportActionAuthServiceBase
     */
