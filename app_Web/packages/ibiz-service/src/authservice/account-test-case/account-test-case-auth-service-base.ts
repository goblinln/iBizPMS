 ...
 *
 * @export
 * @class AccountTestCaseAuthServiceBase
 * @extends {AuthService}
 */
export class AccountTestCaseAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountTestCaseAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountTestCase.json";

    /**
     * Creates an instance of  AccountTestCaseAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountTestCaseAuthServiceBase
     */
