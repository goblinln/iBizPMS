 ...
 *
 * @export
 * @class ProductBuildAuthServiceBase
 * @extends {AuthService}
 */
export class ProductBuildAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductBuildAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductBuild.json";

    /**
     * Creates an instance of  ProductBuildAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductBuildAuthServiceBase
     */
