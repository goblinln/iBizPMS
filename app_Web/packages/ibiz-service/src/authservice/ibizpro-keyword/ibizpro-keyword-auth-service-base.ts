 ...
 *
 * @export
 * @class IBIZProKeywordAuthServiceBase
 * @extends {AuthService}
 */
export class IBIZProKeywordAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBIZProKeywordAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBIZProKeyword.json";

    /**
     * Creates an instance of  IBIZProKeywordAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBIZProKeywordAuthServiceBase
     */
