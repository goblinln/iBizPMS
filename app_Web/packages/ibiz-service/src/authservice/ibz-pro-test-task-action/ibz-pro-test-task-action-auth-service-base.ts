 ...
 *
 * @export
 * @class IbzProTestTaskActionAuthServiceBase
 * @extends {AuthService}
 */
export class IbzProTestTaskActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzProTestTaskActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzProTestTaskAction.json";

    /**
     * Creates an instance of  IbzProTestTaskActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzProTestTaskActionAuthServiceBase
     */
