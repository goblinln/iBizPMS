 ...
 *
 * @export
 * @class TestCaseLibCaseStepNestedAuthServiceBase
 * @extends {AuthService}
 */
export class TestCaseLibCaseStepNestedAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof TestCaseLibCaseStepNestedAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TestCaseLibCaseStepNested.json";

    /**
     * Creates an instance of  TestCaseLibCaseStepNestedAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TestCaseLibCaseStepNestedAuthServiceBase
     */
