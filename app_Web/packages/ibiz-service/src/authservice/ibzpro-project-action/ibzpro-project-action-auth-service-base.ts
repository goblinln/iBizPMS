 ...
 *
 * @export
 * @class IBZProProjectActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZProProjectActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZProProjectActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZProProjectAction.json";

    /**
     * Creates an instance of  IBZProProjectActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZProProjectActionAuthServiceBase
     */
