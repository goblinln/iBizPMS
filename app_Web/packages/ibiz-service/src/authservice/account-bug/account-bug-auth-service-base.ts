 ...
 *
 * @export
 * @class AccountBugAuthServiceBase
 * @extends {AuthService}
 */
export class AccountBugAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountBugAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountBug.json";

    /**
     * Creates an instance of  AccountBugAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountBugAuthServiceBase
     */
