 ...
 *
 * @export
 * @class IbzProReportlyActionAuthServiceBase
 * @extends {AuthService}
 */
export class IbzProReportlyActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzProReportlyActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzProReportlyAction.json";

    /**
     * Creates an instance of  IbzProReportlyActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzProReportlyActionAuthServiceBase
     */
