 ...
 *
 * @export
 * @class ProjectTaskReportAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectTaskReportAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectTaskReportAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectTaskReport.json";

    /**
     * Creates an instance of  ProjectTaskReportAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectTaskReportAuthServiceBase
     */
