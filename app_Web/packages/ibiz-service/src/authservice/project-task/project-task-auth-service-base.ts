 ...
 *
 * @export
 * @class ProjectTaskAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectTaskAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectTaskAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectTask.json";

    /**
     * Creates an instance of  ProjectTaskAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectTaskAuthServiceBase
     */
