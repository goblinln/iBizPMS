 ...
 *
 * @export
 * @class IbzProBuildActionAuthServiceBase
 * @extends {AuthService}
 */
export class IbzProBuildActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzProBuildActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzProBuildAction.json";

    /**
     * Creates an instance of  IbzProBuildActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzProBuildActionAuthServiceBase
     */
