 ...
 *
 * @export
 * @class ProductStoryAuthServiceBase
 * @extends {AuthService}
 */
export class ProductStoryAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductStoryAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductStory.json";

    /**
     * Creates an instance of  ProductStoryAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductStoryAuthServiceBase
     */
