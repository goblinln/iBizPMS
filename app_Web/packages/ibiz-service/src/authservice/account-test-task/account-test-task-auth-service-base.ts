 ...
 *
 * @export
 * @class AccountTestTaskAuthServiceBase
 * @extends {AuthService}
 */
export class AccountTestTaskAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountTestTaskAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountTestTask.json";

    /**
     * Creates an instance of  AccountTestTaskAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountTestTaskAuthServiceBase
     */
