 ...
 *
 * @export
 * @class ProductPlanActionAuthServiceBase
 * @extends {AuthService}
 */
export class ProductPlanActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductPlanActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductPlanAction.json";

    /**
     * Creates an instance of  ProductPlanActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductPlanActionAuthServiceBase
     */
