 ...
 *
 * @export
 * @class TestCaseLibAuthServiceBase
 * @extends {AuthService}
 */
export class TestCaseLibAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof TestCaseLibAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TestCaseLib.json";

    /**
     * Creates an instance of  TestCaseLibAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TestCaseLibAuthServiceBase
     */
