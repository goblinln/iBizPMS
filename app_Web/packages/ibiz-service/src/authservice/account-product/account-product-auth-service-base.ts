 ...
 *
 * @export
 * @class AccountProductAuthServiceBase
 * @extends {AuthService}
 */
export class AccountProductAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountProductAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountProduct.json";

    /**
     * Creates an instance of  AccountProductAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountProductAuthServiceBase
     */
