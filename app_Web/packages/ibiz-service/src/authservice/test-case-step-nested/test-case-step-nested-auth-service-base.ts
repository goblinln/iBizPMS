 ...
 *
 * @export
 * @class TestCaseStepNestedAuthServiceBase
 * @extends {AuthService}
 */
export class TestCaseStepNestedAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof TestCaseStepNestedAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TestCaseStepNested.json";

    /**
     * Creates an instance of  TestCaseStepNestedAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TestCaseStepNestedAuthServiceBase
     */
