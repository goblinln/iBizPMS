 ...
 *
 * @export
 * @class ProjectProductAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectProductAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectProductAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectProduct.json";

    /**
     * Creates an instance of  ProjectProductAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectProductAuthServiceBase
     */
