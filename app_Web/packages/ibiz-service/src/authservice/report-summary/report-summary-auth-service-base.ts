 ...
 *
 * @export
 * @class ReportSummaryAuthServiceBase
 * @extends {AuthService}
 */
export class ReportSummaryAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ReportSummaryAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ReportSummary.json";

    /**
     * Creates an instance of  ReportSummaryAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ReportSummaryAuthServiceBase
     */
