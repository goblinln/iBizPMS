 ...
 *
 * @export
 * @class IBZTaskActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZTaskActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZTaskActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZTaskAction.json";

    /**
     * Creates an instance of  IBZTaskActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZTaskActionAuthServiceBase
     */
