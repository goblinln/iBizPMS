 ...
 *
 * @export
 * @class DocContentAuthServiceBase
 * @extends {AuthService}
 */
export class DocContentAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof DocContentAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/DocContent.json";

    /**
     * Creates an instance of  DocContentAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  DocContentAuthServiceBase
     */
