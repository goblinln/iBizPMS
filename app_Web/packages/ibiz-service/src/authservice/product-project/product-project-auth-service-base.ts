 ...
 *
 * @export
 * @class ProductProjectAuthServiceBase
 * @extends {AuthService}
 */
export class ProductProjectAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductProjectAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductProject.json";

    /**
     * Creates an instance of  ProductProjectAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductProjectAuthServiceBase
     */
