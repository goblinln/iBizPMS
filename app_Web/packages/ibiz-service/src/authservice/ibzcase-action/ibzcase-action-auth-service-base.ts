 ...
 *
 * @export
 * @class IBZCaseActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZCaseActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZCaseActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZCaseAction.json";

    /**
     * Creates an instance of  IBZCaseActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZCaseActionAuthServiceBase
     */
