 ...
 *
 * @export
 * @class ProductDailyAuthServiceBase
 * @extends {AuthService}
 */
export class ProductDailyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductDailyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductDaily.json";

    /**
     * Creates an instance of  ProductDailyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductDailyAuthServiceBase
     */
