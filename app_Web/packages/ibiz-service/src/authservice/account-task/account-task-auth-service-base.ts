 ...
 *
 * @export
 * @class AccountTaskAuthServiceBase
 * @extends {AuthService}
 */
export class AccountTaskAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountTaskAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountTask.json";

    /**
     * Creates an instance of  AccountTaskAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountTaskAuthServiceBase
     */
