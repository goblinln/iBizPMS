 ...
 *
 * @export
 * @class StoryStageAuthServiceBase
 * @extends {AuthService}
 */
export class StoryStageAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof StoryStageAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/StoryStage.json";

    /**
     * Creates an instance of  StoryStageAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  StoryStageAuthServiceBase
     */
