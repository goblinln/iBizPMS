 ...
 * @extends {AuthService}
 */
export class ProjectTaskestimateAuthServiceBase extends AuthService {

    /**
     * Creates an instance of  ProjectTaskestimateAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectTaskestimateAuthServiceBase
     */
