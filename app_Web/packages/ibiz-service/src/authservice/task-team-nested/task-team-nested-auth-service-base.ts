 ...
 *
 * @export
 * @class TaskTeamNestedAuthServiceBase
 * @extends {AuthService}
 */
export class TaskTeamNestedAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof TaskTeamNestedAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TaskTeamNested.json";

    /**
     * Creates an instance of  TaskTeamNestedAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TaskTeamNestedAuthServiceBase
     */
