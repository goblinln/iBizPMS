 ...
 *
 * @export
 * @class ProductWeeklyAuthServiceBase
 * @extends {AuthService}
 */
export class ProductWeeklyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductWeeklyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductWeekly.json";

    /**
     * Creates an instance of  ProductWeeklyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductWeeklyAuthServiceBase
     */
