 ...
 *
 * @export
 * @class IbzProBugActionAuthServiceBase
 * @extends {AuthService}
 */
export class IbzProBugActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzProBugActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzProBugAction.json";

    /**
     * Creates an instance of  IbzProBugActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzProBugActionAuthServiceBase
     */
