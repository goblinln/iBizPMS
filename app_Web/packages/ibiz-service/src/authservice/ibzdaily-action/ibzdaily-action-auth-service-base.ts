 ...
 *
 * @export
 * @class IBZDailyActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZDailyActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZDailyActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZDailyAction.json";

    /**
     * Creates an instance of  IBZDailyActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZDailyActionAuthServiceBase
     */
