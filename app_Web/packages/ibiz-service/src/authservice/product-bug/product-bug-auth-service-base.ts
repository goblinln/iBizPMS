 ...
 *
 * @export
 * @class ProductBugAuthServiceBase
 * @extends {AuthService}
 */
export class ProductBugAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductBugAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductBug.json";

    /**
     * Creates an instance of  ProductBugAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductBugAuthServiceBase
     */
