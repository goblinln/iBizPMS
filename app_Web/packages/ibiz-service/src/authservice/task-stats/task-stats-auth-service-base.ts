 ...
 *
 * @export
 * @class TaskStatsAuthServiceBase
 * @extends {AuthService}
 */
export class TaskStatsAuthServiceBase extends AuthService {

    /**
     * Creates an instance of  TaskStatsAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TaskStatsAuthServiceBase
     */
