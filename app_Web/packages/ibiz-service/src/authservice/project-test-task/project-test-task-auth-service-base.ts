 ...
 *
 * @export
 * @class ProjectTestTaskAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectTestTaskAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectTestTaskAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectTestTask.json";

    /**
     * Creates an instance of  ProjectTestTaskAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectTestTaskAuthServiceBase
     */
