 ...
 *
 * @export
 * @class IBIZProTagAuthServiceBase
 * @extends {AuthService}
 */
export class IBIZProTagAuthServiceBase extends AuthService {

    /**
     * Creates an instance of  IBIZProTagAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBIZProTagAuthServiceBase
     */
