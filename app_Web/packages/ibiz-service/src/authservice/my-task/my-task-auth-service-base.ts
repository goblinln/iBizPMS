 ...
 *
 * @export
 * @class MyTaskAuthServiceBase
 * @extends {AuthService}
 */
export class MyTaskAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof MyTaskAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/MyTask.json";

    /**
     * Creates an instance of  MyTaskAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  MyTaskAuthServiceBase
     */
