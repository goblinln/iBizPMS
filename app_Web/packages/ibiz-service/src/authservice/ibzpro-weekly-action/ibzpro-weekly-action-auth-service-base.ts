 ...
 *
 * @export
 * @class IBZProWeeklyActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZProWeeklyActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZProWeeklyActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZProWeeklyAction.json";

    /**
     * Creates an instance of  IBZProWeeklyActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZProWeeklyActionAuthServiceBase
     */
