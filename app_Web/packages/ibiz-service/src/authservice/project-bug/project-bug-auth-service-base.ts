 ...
 *
 * @export
 * @class ProjectBugAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectBugAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectBugAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectBug.json";

    /**
     * Creates an instance of  ProjectBugAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectBugAuthServiceBase
     */
