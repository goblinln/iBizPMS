 ...
 *
 * @export
 * @class ProjectDailyAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectDailyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectDailyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectDaily.json";

    /**
     * Creates an instance of  ProjectDailyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectDailyAuthServiceBase
     */
