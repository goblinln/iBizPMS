 ...
 *
 * @export
 * @class IBZProProductLineAuthServiceBase
 * @extends {AuthService}
 */
export class IBZProProductLineAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZProProductLineAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZProProductLine.json";

    /**
     * Creates an instance of  IBZProProductLineAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZProProductLineAuthServiceBase
     */
