 ...
 *
 * @export
 * @class AccountProjectAuthServiceBase
 * @extends {AuthService}
 */
export class AccountProjectAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountProjectAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountProject.json";

    /**
     * Creates an instance of  AccountProjectAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountProjectAuthServiceBase
     */
