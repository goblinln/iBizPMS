 ...
 *
 * @export
 * @class ProductMonthlyAuthServiceBase
 * @extends {AuthService}
 */
export class ProductMonthlyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProductMonthlyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductMonthly.json";

    /**
     * Creates an instance of  ProductMonthlyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductMonthlyAuthServiceBase
     */
