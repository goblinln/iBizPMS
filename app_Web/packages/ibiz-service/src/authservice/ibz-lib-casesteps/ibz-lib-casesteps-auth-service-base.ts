 ...
 *
 * @export
 * @class IbzLibCasestepsAuthServiceBase
 * @extends {AuthService}
 */
export class IbzLibCasestepsAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzLibCasestepsAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzLibCasesteps.json";

    /**
     * Creates an instance of  IbzLibCasestepsAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzLibCasestepsAuthServiceBase
     */
