 ...
 *
 * @export
 * @class ProjectStoryAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectStoryAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectStoryAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectStory.json";

    /**
     * Creates an instance of  ProjectStoryAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectStoryAuthServiceBase
     */
