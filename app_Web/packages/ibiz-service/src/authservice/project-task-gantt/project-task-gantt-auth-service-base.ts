 ...
 *
 * @export
 * @class ProjectTaskGanttAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectTaskGanttAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectTaskGanttAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectTaskGantt.json";

    /**
     * Creates an instance of  ProjectTaskGanttAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectTaskGanttAuthServiceBase
     */
