 ...
 *
 * @export
 * @class IBZTestSuiteActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZTestSuiteActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZTestSuiteActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZTestSuiteAction.json";

    /**
     * Creates an instance of  IBZTestSuiteActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZTestSuiteActionAuthServiceBase
     */
