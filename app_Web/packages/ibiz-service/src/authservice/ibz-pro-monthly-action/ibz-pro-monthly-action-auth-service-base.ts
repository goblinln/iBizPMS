 ...
 *
 * @export
 * @class IbzProMonthlyActionAuthServiceBase
 * @extends {AuthService}
 */
export class IbzProMonthlyActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzProMonthlyActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzProMonthlyAction.json";

    /**
     * Creates an instance of  IbzProMonthlyActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzProMonthlyActionAuthServiceBase
     */
