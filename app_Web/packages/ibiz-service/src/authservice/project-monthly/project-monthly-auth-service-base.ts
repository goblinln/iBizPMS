 ...
 *
 * @export
 * @class ProjectMonthlyAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectMonthlyAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectMonthlyAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectMonthly.json";

    /**
     * Creates an instance of  ProjectMonthlyAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectMonthlyAuthServiceBase
     */
