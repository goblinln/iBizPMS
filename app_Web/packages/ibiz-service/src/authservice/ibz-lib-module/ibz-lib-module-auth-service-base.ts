 ...
 *
 * @export
 * @class IbzLibModuleAuthServiceBase
 * @extends {AuthService}
 */
export class IbzLibModuleAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IbzLibModuleAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzLibModule.json";

    /**
     * Creates an instance of  IbzLibModuleAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzLibModuleAuthServiceBase
     */
