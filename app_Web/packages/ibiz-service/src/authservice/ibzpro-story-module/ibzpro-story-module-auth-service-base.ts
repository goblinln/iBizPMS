 ...
 * @extends {AuthService}
 */
export class IBZProStoryModuleAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZProStoryModuleAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZProStoryModule.json";

    /**
     * Creates an instance of  IBZProStoryModuleAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZProStoryModuleAuthServiceBase
     */
