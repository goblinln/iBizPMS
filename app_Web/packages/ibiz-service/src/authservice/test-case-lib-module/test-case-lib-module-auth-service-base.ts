 ...
 *
 * @export
 * @class TestCaseLibModuleAuthServiceBase
 * @extends {AuthService}
 */
export class TestCaseLibModuleAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof TestCaseLibModuleAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TestCaseLibModule.json";

    /**
     * Creates an instance of  TestCaseLibModuleAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TestCaseLibModuleAuthServiceBase
     */
