 ...
 *
 * @export
 * @class AccountAuthServiceBase
 * @extends {AuthService}
 */
export class AccountAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/Account.json";

    /**
     * Creates an instance of  AccountAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountAuthServiceBase
     */
