 ...
 *
 * @export
 * @class IBZProToDoActionAuthServiceBase
 * @extends {AuthService}
 */
export class IBZProToDoActionAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof IBZProToDoActionAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZProToDoAction.json";

    /**
     * Creates an instance of  IBZProToDoActionAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZProToDoActionAuthServiceBase
     */
