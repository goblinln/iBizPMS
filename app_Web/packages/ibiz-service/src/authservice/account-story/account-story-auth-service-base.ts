 ...
 *
 * @export
 * @class AccountStoryAuthServiceBase
 * @extends {AuthService}
 */
export class AccountStoryAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof AccountStoryAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountStory.json";

    /**
     * Creates an instance of  AccountStoryAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountStoryAuthServiceBase
     */
