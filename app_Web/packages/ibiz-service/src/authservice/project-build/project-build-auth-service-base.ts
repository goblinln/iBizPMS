 ...
 *
 * @export
 * @class ProjectBuildAuthServiceBase
 * @extends {AuthService}
 */
export class ProjectBuildAuthServiceBase extends AuthService {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectBuildAuthServiceBase
     */
     protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectBuild.json";

    /**
     * Creates an instance of  ProjectBuildAuthServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectBuildAuthServiceBase
     */
