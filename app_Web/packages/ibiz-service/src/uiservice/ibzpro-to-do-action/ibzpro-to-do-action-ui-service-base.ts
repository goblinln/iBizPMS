 ...
 *
 * @export
 * @class IBZProToDoActionUIServiceBase
 */
export class IBZProToDoActionUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof IBZProToDoActionUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZProToDoAction.json";

    /**
     * Creates an instance of  IBZProToDoActionUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZProToDoActionUIServiceBase
     */
