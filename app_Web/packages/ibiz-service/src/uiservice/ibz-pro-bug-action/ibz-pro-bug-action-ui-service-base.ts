 ...
 *
 * @export
 * @class IbzProBugActionUIServiceBase
 */
export class IbzProBugActionUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof IbzProBugActionUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzProBugAction.json";

    /**
     * Creates an instance of  IbzProBugActionUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzProBugActionUIServiceBase
     */
