 ...
 *
 * @export
 * @class TaskTeamNestedUIServiceBase
 */
export class TaskTeamNestedUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof TaskTeamNestedUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TaskTeamNested.json";

    /**
     * Creates an instance of  TaskTeamNestedUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TaskTeamNestedUIServiceBase
     */
