 ...
 *
 * @export
 * @class AccountProjectUIServiceBase
 */
export class AccountProjectUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof AccountProjectUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountProject.json";

    /**
     * Creates an instance of  AccountProjectUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountProjectUIServiceBase
     */
