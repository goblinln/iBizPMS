 ...
 *
 * @export
 * @class TestCaseStepNestedUIServiceBase
 */
export class TestCaseStepNestedUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof TestCaseStepNestedUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TestCaseStepNested.json";

    /**
     * Creates an instance of  TestCaseStepNestedUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TestCaseStepNestedUIServiceBase
     */
