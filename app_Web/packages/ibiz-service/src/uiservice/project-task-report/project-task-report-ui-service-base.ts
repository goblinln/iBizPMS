 ...
 *
 * @export
 * @class ProjectTaskReportUIServiceBase
 */
export class ProjectTaskReportUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectTaskReportUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectTaskReport.json";

    /**
     * Creates an instance of  ProjectTaskReportUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectTaskReportUIServiceBase
     */
