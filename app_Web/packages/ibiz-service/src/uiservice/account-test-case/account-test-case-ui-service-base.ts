 ...
 *
 * @export
 * @class AccountTestCaseUIServiceBase
 */
export class AccountTestCaseUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof AccountTestCaseUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountTestCase.json";

    /**
     * Creates an instance of  AccountTestCaseUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountTestCaseUIServiceBase
     */
