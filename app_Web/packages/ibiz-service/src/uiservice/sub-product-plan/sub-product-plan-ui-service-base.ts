 ...
 */
export class SubProductPlanUIServiceBase extends UIServiceBase {
    ...
    protected initBasicData(){
        ...
        this.authService = new SubProductPlanAuthService({context:this.context});
        this.dataService = new SubProductPlanService();
    }
