 ...
 *
 * @export
 * @class ProjectTaskGanttUIServiceBase
 */
export class ProjectTaskGanttUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof ProjectTaskGanttUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectTaskGantt.json";

    /**
     * Creates an instance of  ProjectTaskGanttUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProjectTaskGanttUIServiceBase
     */
