 ...
 *
 * @export
 * @class TestCaseLibModuleUIServiceBase
 */
export class TestCaseLibModuleUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof TestCaseLibModuleUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/TestCaseLibModule.json";

    /**
     * Creates an instance of  TestCaseLibModuleUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  TestCaseLibModuleUIServiceBase
     */
