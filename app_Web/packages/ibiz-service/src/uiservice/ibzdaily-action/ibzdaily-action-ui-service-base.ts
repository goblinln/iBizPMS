 ...
 *
 * @export
 * @class IBZDailyActionUIServiceBase
 */
export class IBZDailyActionUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof IBZDailyActionUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZDailyAction.json";

    /**
     * Creates an instance of  IBZDailyActionUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZDailyActionUIServiceBase
     */
