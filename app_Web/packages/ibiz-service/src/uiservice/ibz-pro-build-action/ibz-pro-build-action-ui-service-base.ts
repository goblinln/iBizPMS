 ...
 *
 * @export
 * @class IbzProBuildActionUIServiceBase
 */
export class IbzProBuildActionUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof IbzProBuildActionUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IbzProBuildAction.json";

    /**
     * Creates an instance of  IbzProBuildActionUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IbzProBuildActionUIServiceBase
     */
