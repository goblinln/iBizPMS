 ...
 *
 * @export
 * @class IBZProReleaseActionUIServiceBase
 */
export class IBZProReleaseActionUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof IBZProReleaseActionUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/IBZProReleaseAction.json";

    /**
     * Creates an instance of  IBZProReleaseActionUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZProReleaseActionUIServiceBase
     */
