 ...
 *
 * @export
 * @class AccountTestTaskUIServiceBase
 */
export class AccountTestTaskUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof AccountTestTaskUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/AccountTestTask.json";

    /**
     * Creates an instance of  AccountTestTaskUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  AccountTestTaskUIServiceBase
     */
