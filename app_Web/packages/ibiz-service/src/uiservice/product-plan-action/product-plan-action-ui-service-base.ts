 ...
 *
 * @export
 * @class ProductPlanActionUIServiceBase
 */
export class ProductPlanActionUIServiceBase extends UIServiceBase {
     ...
     * @protected
     * @type {string}
     * @memberof ProductPlanActionUIServiceBase
     */
    protected dynaModelFilePath:string = "PSSYSAPPS/Web/PSAPPDATAENTITIES/ProductPlanAction.json";

    /**
     * Creates an instance of  ProductPlanActionUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  ProductPlanActionUIServiceBase
     */
