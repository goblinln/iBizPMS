...
export class TestResultBaseService extends EntityBaseService<ITestResult> {
    ...
    async Select(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && _context.testresult) {
            return this.http.get(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}/select`);
        }
        if (_context.product && _context.testtask && _context.testrun && _context.testresult) {
            return this.http.get(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}/select`);
        }
    ...
    async Create(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && true) {
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults`, _data);
        }
        if (_context.product && _context.testtask && _context.testrun && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
                _data[this.APPDEKEY] = null;
            }
            ...
            return this.http.post(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults`, _data);
        }
    ...
    async Update(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && _context.testresult) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}`, _data);
        }
        if (_context.product && _context.testtask && _context.testrun && _context.testresult) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}`, _data);
        }
        if (_context.testtask && _context.testrun && _context.testresult) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async Remove(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && _context.testresult) {
            return this.http.delete(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}`);
        }
        if (_context.product && _context.testtask && _context.testrun && _context.testresult) {
            return this.http.delete(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}`);
        }
        if (_context.testtask && _context.testrun && _context.testresult) {
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && _context.testresult) {
            const res = await this.http.get(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}`);
            return res;
        }
        if (_context.product && _context.testtask && _context.testrun && _context.testresult) {
            const res = await this.http.get(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/${_context.testresult}`);
            return res;
        }
        if (_context.testtask && _context.testrun && _context.testresult) {
    ...
    async GetDraft(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && true) {
            ...
            const res = await this.http.get(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/getdraft`, _data);
            return res;
        }
        if (_context.product && _context.testtask && _context.testrun && true) {
            _data[this.APPDENAME?.toLowerCase()] = undefined;
            _data[this.APPDEKEY] = undefined;
            const res = await this.http.get(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/getdraft`, _data);
            return res;
        }
        if (_context.testtask && _context.testrun && true) {
            _data[this.APPDENAME?.toLowerCase()] = undefined;
    ...
    async FetchCurTestRun(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && true) {
            return this.http.post(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/fetchcurtestrun`, _data);
        }
        if (_context.product && _context.testtask && _context.testrun && true) {
            return this.http.post(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/fetchcurtestrun`, _data);
        }
        if (_context.testtask && _context.testrun && true) {
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.testtask && _context.testrun && true) {
            return this.http.post(`/projects/${_context.project}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/fetchdefault`, _data);
        }
        if (_context.product && _context.testtask && _context.testrun && true) {
            return this.http.post(`/products/${_context.product}/testtasks/${_context.testtask}/testruns/${_context.testrun}/testresults/fetchdefault`, _data);
        }
        if (_context.testtask && _context.testrun && true) {
