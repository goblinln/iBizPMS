...
export class TaskTeamBaseService extends EntityBaseService<ITaskTeam> {
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && true) {
            return this.http.get(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
        if (_context.product && _context.story && _context.task && true) {
            return this.http.get(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
        if (_context.product && _context.productplan && _context.task && true) {
            return this.http.get(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
        if (_context.project && _context.task && true) {
            return this.http.get(`/projects/${_context.project}/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
        if (_context.story && _context.task && true) {
            return this.http.get(`/stories/${_context.story}/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
        if (_context.productplan && _context.task && true) {
            return this.http.get(`/productplans/${_context.productplan}/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
        if (_context.projectmodule && _context.task && true) {
            return this.http.get(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
        if (_context.task && true) {
            return this.http.get(`/tasks/${_context.task}/taskteams/fetchdefault`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
}
