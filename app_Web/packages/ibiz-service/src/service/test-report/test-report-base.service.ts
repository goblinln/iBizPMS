...
export class TestReportBaseService extends EntityBaseService<ITestReport> {
    ...
    async InitProjectReport(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}/initprojectreport`, _data);
        }
    ...
    async Create(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports`, _data);
        }
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
            const res = await this.http.get(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}`);
            return res;
        }
        if (_context.test && _context.testreport) {
    ...
    async InitTestTaskReportMulti(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}/inittesttaskreportmulti`, _data);
        }
        if (_context.test && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async InitProjectDuringReport(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}/initprojectduringreport`, _data);
        }
        if (_context.test && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async Update(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}`, _data);
        }
        if (_context.test && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async Remove(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
            return this.http.delete(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}`);
        }
        if (_context.test && _context.testreport) {
    ...
    async LoadTestReportBasic(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}/loadtestreportbasic`, _data);
        }
        if (_context.test && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && true) {
            return this.http.post(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/fetchdefault`, _data);
        }
        if (_context.test && true) {
    ...
    async GetDraft(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && true) {
            ...
            const res = await this.http.get(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/getdraft`, _data);
            return res;
        }
        if (_context.test && true) {
            _data[this.APPDENAME?.toLowerCase()] = undefined;
    ...
    async InitTestTaskReport(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.project && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/sysaccounts/${_context.sysaccount}/projects/${_context.project}/testreports/${_context.testreport}/inittesttaskreport`, _data);
        }
        if (_context.test && _context.testreport) {
        _data = await this.obtainMinor(_context, _data);
