...
export class ActionBaseService extends EntityBaseService<IAction> {
    ...
    async Create(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/testtasks/${_context.testtask}/actions`, _data);
        }
        if (_context.account && _context.project && _context.testreport && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/testreports/${_context.testreport}/actions`, _data);
        }
        if (_context.account && _context.project && _context.story && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/stories/${_context.story}/actions`, _data);
        }
        if (_context.account && _context.project && _context.task && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/tasks/${_context.task}/actions`, _data);
        }
        if (_context.account && _context.project && _context.build && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/builds/${_context.build}/actions`, _data);
        }
        if (_context.account && _context.project && _context.bug && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/actions`, _data);
        }
        if (_context.account && _context.project && _context.productplan && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/productplans/${_context.productplan}/actions`, _data);
        }
        if (_context.account && _context.product && _context.story && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/stories/${_context.story}/actions`, _data);
        }
        if (_context.account && _context.product && _context.productplan && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/productplans/${_context.productplan}/actions`, _data);
        }
        if (_context.account && _context.product && _context.build && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/builds/${_context.build}/actions`, _data);
        }
        if (_context.test && _context.testreport && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/accounts/${_context.account}/todos/${_context.todo}/actions`, _data);
        }
        if (_context.account && _context.testtask && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/testtasks/${_context.testtask}/actions`, _data);
        }
        if (_context.account && _context.task && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/tasks/${_context.task}/actions`, _data);
        }
        if (_context.account && _context.story && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/stories/${_context.story}/actions`, _data);
        }
        if (_context.account && _context.project && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/actions`, _data);
        }
        if (_context.account && _context.product && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/actions`, _data);
        }
        if (_context.account && _context.bug && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
            ...
            return this.http.post(`/accounts/${_context.account}/bugs/${_context.bug}/actions`, _data);
        }
        if (_context.testsuite && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/accounts/${_context.account}/actions`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.testtask && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/testtasks/${_context.testtask}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.project && _context.testreport && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/testreports/${_context.testreport}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.project && _context.story && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/stories/${_context.story}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.project && _context.task && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/tasks/${_context.task}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.project && _context.build && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/builds/${_context.build}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.project && _context.bug && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.project && _context.productplan && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/productplans/${_context.productplan}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.product && _context.story && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/products/${_context.product}/stories/${_context.story}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.product && _context.productplan && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/products/${_context.product}/productplans/${_context.productplan}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.product && _context.build && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/products/${_context.product}/builds/${_context.build}/actions/${_context.action}`);
            return res;
        }
        ...
        if (_context.account && _context.todo && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/todos/${_context.todo}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.testtask && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/testtasks/${_context.testtask}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.task && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/tasks/${_context.task}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.story && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/stories/${_context.story}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.project && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.product && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/products/${_context.product}/actions/${_context.action}`);
            return res;
        }
        if (_context.account && _context.bug && _context.action) {
            const res = await this.http.get(`/accounts/${_context.account}/bugs/${_context.bug}/actions/${_context.action}`);
            return res;
        }
    ...
    async FetchMyTrends(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.testtask && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/testtasks/${_context.testtask}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.project && _context.testreport && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/testreports/${_context.testreport}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.project && _context.story && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/stories/${_context.story}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.project && _context.task && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/tasks/${_context.task}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.project && _context.build && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/builds/${_context.build}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.project && _context.bug && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.project && _context.productplan && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/productplans/${_context.productplan}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.product && _context.story && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/stories/${_context.story}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.product && _context.productplan && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/productplans/${_context.productplan}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.product && _context.build && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/builds/${_context.build}/actions/fetchmytrends`, _data);
        }
        if (_context.test && _context.testreport && true) {
        ...
        if (_context.account && _context.todo && true) {
            return this.http.post(`/accounts/${_context.account}/todos/${_context.todo}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.testtask && true) {
            return this.http.post(`/accounts/${_context.account}/testtasks/${_context.testtask}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.task && true) {
            return this.http.post(`/accounts/${_context.account}/tasks/${_context.task}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.story && true) {
            return this.http.post(`/accounts/${_context.account}/stories/${_context.story}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.project && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.product && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/actions/fetchmytrends`, _data);
        }
        if (_context.account && _context.bug && true) {
            return this.http.post(`/accounts/${_context.account}/bugs/${_context.bug}/actions/fetchmytrends`, _data);
        }
        if (_context.testsuite && true) {
        ...
        if (_context.account && true) {
            return this.http.post(`/accounts/${_context.account}/actions/fetchmytrends`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async Update(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.testtask && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/testtasks/${_context.testtask}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.project && _context.testreport && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/testreports/${_context.testreport}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.project && _context.story && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/stories/${_context.story}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.project && _context.task && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/tasks/${_context.task}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.project && _context.build && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/builds/${_context.build}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.project && _context.bug && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.project && _context.productplan && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/productplans/${_context.productplan}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.product && _context.story && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/products/${_context.product}/stories/${_context.story}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.product && _context.productplan && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/products/${_context.product}/productplans/${_context.productplan}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.product && _context.build && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/products/${_context.product}/builds/${_context.build}/actions/${_context.action}`, _data);
        }
        if (_context.test && _context.testreport && _context.action) {
        _data = await this.obtainMinor(_context, _data);
        ...
        if (_context.account && _context.todo && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/todos/${_context.todo}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.testtask && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/testtasks/${_context.testtask}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.task && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/tasks/${_context.task}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.story && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/stories/${_context.story}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.project && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.product && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/products/${_context.product}/actions/${_context.action}`, _data);
        }
        if (_context.account && _context.bug && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/bugs/${_context.bug}/actions/${_context.action}`, _data);
        }
        if (_context.testsuite && _context.action) {
        _data = await this.obtainMinor(_context, _data);
        ...
        if (_context.account && _context.action) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/actions/${_context.action}`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async FetchMy(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.testtask && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/testtasks/${_context.testtask}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.project && _context.testreport && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/testreports/${_context.testreport}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.project && _context.story && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/stories/${_context.story}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.project && _context.task && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/tasks/${_context.task}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.project && _context.build && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/builds/${_context.build}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.project && _context.bug && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.project && _context.productplan && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/productplans/${_context.productplan}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.product && _context.story && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/stories/${_context.story}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.product && _context.productplan && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/productplans/${_context.productplan}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.product && _context.build && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/builds/${_context.build}/actions/fetchmy`, _data);
        }
        if (_context.test && _context.testreport && true) {
        ...
        if (_context.account && _context.todo && true) {
            return this.http.post(`/accounts/${_context.account}/todos/${_context.todo}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.testtask && true) {
            return this.http.post(`/accounts/${_context.account}/testtasks/${_context.testtask}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.task && true) {
            return this.http.post(`/accounts/${_context.account}/tasks/${_context.task}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.story && true) {
            return this.http.post(`/accounts/${_context.account}/stories/${_context.story}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.project && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.product && true) {
            return this.http.post(`/accounts/${_context.account}/products/${_context.product}/actions/fetchmy`, _data);
        }
        if (_context.account && _context.bug && true) {
            return this.http.post(`/accounts/${_context.account}/bugs/${_context.bug}/actions/fetchmy`, _data);
        }
        if (_context.testsuite && true) {
        ...
        if (_context.account && true) {
            return this.http.post(`/accounts/${_context.account}/actions/fetchmy`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
