...
export class DocLibBaseService extends EntityBaseService<IDocLib> {
    ...
    async Select(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.doclib) {
            return this.http.get(`/projects/${_context.project}/doclibs/${_context.doclib}/select`);
        }
        if (_context.product && _context.doclib) {
            return this.http.get(`/products/${_context.product}/doclibs/${_context.doclib}/select`);
        }
    ...
    async FetchByProductNotFiles(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && true) {
            return this.http.post(`/projects/${_context.project}/doclibs/fetchbyproductnotfiles`, _data);
        }
        if (_context.product && true) {
            return this.http.post(`/products/${_context.product}/doclibs/fetchbyproductnotfiles`, _data);
        }
    ...
    async FetchByProjectNotFiles(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && true) {
            return this.http.post(`/projects/${_context.project}/doclibs/fetchbyprojectnotfiles`, _data);
        }
        if (_context.product && true) {
            return this.http.post(`/products/${_context.product}/doclibs/fetchbyprojectnotfiles`, _data);
        }
    ...
    async FetchCurDocLib(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && true) {
            return this.http.post(`/projects/${_context.project}/doclibs/fetchcurdoclib`, _data);
        }
        if (_context.product && true) {
            return this.http.post(`/products/${_context.product}/doclibs/fetchcurdoclib`, _data);
        }
    ...
    async FetchRootModuleMuLu(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && true) {
            return this.http.post(`/projects/${_context.project}/doclibs/fetchrootmodulemulu`, _data);
        }
        if (_context.product && true) {
            return this.http.post(`/products/${_context.product}/doclibs/fetchrootmodulemulu`, _data);
        }
