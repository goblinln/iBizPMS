...
export class BugBaseService extends EntityBaseService<IBug> {
    ...
    async Update(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}`, _data);
        }
        ...
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/accounts/${_context.account}/bugs/${_context.bug}`, _data);
        }
    ...
    async Confirm(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/confirm`, _data);
        }
        if (_context.test && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.bug) {
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}`);
            return res;
        }
        if (_context.test && _context.bug) {
        ...
        if (_context.account && _context.bug) {
            const res = await this.http.get(`/accounts/${_context.account}/bugs/${_context.bug}`);
            return res;
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    ...
    async FetchAccount(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/fetchaccount`, _data);
        }
        ...
        if (_context.account && true) {
            return this.http.post(`/accounts/${_context.account}/bugs/fetchaccount`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async Remove(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.bug) {
            return this.http.delete(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}`);
        }
        if (_context.test && _context.bug) {
        ...
        if (_context.account && _context.bug) {
            return this.http.delete(`/accounts/${_context.account}/bugs/${_context.bug}`);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async FetchMyFavorites(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/fetchmyfavorites`, _data);
        }
        if (_context.test && true) {
        ...
        if (_context.account && true) {
            return this.http.post(`/accounts/${_context.account}/bugs/fetchmyfavorites`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async Activate(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/activate`, _data);
        }
        if (_context.test && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
        ...
        if (_context.account && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/bugs/${_context.bug}/activate`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async BugFavorites(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/bugfavorites`, _data);
        }
        if (_context.test && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
        ...
        if (_context.account && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/bugs/${_context.bug}/bugfavorites`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async GetDraft(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && true) {
            ...
            const res = await this.http.get(`/accounts/${_context.account}/projects/${_context.project}/bugs/getdraft`, _data);
            return res;
        }
        if (_context.test && true) {
            _data[this.APPDENAME?.toLowerCase()] = undefined;
        ...
        if (_context.account && true) {
            _data[this.APPDENAME?.toLowerCase()] = undefined;
            _data[this.APPDEKEY] = undefined;
            const res = await this.http.get(`/accounts/${_context.account}/bugs/getdraft`, _data);
            return res;
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    ...
    async BugNFavorites(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/${_context.bug}/bugnfavorites`, _data);
        }
        if (_context.test && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
        ...
        if (_context.account && _context.bug) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/bugs/${_context.bug}/bugnfavorites`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async Create(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs`, _data);
        }
        if (_context.test && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/accounts/${_context.account}/bugs`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.account && _context.project && true) {
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/fetchdefault`, _data);
        }
        if (_context.test && true) {
        ...
        if (_context.account && true) {
            return this.http.post(`/accounts/${_context.account}/bugs/fetchdefault`, _data);
        }
    return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
    ...
    public async ConfirmBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        if(_context.account && _context.project && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/confirmbatch`,_data);
        }
        if(_context.test && true){
        _data = await this.obtainMinor(_context, _data);
        ...
        if(_context.account && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/bugs/confirmbatch`,_data);
        }
        return new HttpResponse(null, { status: 404, statusText: '无匹配请求地址!' });
    }
    ...
    public async AssignToBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        if(_context.account && _context.project && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/assigntobatch`,_data);
        }
        if(_context.test && true){
        _data = await this.obtainMinor(_context, _data);
    ...
    public async ActivateBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        if(_context.account && _context.project && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/accounts/${_context.account}/projects/${_context.project}/bugs/activatebatch`,_data);
        }
        if(_context.test && true){
        _data = await this.obtainMinor(_context, _data);
