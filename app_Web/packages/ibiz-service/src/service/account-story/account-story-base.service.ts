...
export class AccountStoryBaseService extends EntityBaseService<IAccountStory> {
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        if (_context.sysaccount && _context.accountstory) {
            const res = await this.http.get(`/sysaccounts/${encodeURIComponent(_context.sysaccount)}/accountstories/${encodeURIComponent(_context.accountstory)}`);
        res.data = await this.afterExecuteAction(_context,res?.data,'Get');
            return res;
        }
        const res = await this.http.get(`/accountstories/${encodeURIComponent(_context.accountstory)}`);
        res.data = await this.afterExecuteAction(_context,res?.data,'Get');
        return res;
            } catch (error) {
    ...
    async FetchAccount(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        if (_context.sysaccount && true) {
            const res = await this.http.post(`/sysaccounts/${encodeURIComponent(_context.sysaccount)}/accountstories/fetchaccount`, _data);
    ...
    async FetchMy(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        try {
        if (_context.sysaccount && true) {
            const res = await this.http.post(`/sysaccounts/${encodeURIComponent(_context.sysaccount)}/accountstories/fetchmy`, _data);
    ...
    async FetchMyFavorites(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        try {
        if (_context.sysaccount && true) {
            const res = await this.http.post(`/sysaccounts/${encodeURIComponent(_context.sysaccount)}/accountstories/fetchmyfavorites`, _data);
