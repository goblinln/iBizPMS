...
export class TestReultBaseService extends EntityBaseService<ITestReult> {
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        if (_context.sysaccount && _context.testcase && _context.testreult) {
            const res = await this.http.get(`/sysaccounts/${_context.sysaccount}/testcases/${_context.testcase}/testreults/${_context.testreult}`);
            return res;
        }
