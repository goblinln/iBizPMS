...
export class BuildBaseService extends EntityBaseService<IBuild> {
    ...
    async LinkStory(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && _context.build) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/${_context.build}/linkstory`, _data);
        }
    ...
    async Update(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && _context.build) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/tests/${_context.test}/builds/${_context.build}`, _data);
        }
        if (_context.project && _context.build) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async UnlinkStory(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && _context.build) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/${_context.build}/unlinkstory`, _data);
        }
        if (_context.project && _context.build) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async Create(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/tests/${_context.test}/builds`, _data);
        }
    ...
    async Remove(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && _context.build) {
            return this.http.delete(`/tests/${_context.test}/builds/${_context.build}`);
        }
        if (_context.project && _context.build) {
    ...
    async FetchProductBuild(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && true) {
            return this.http.post(`/tests/${_context.test}/builds/fetchproductbuild`, _data);
        }
        if (_context.project && true) {
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && true) {
            return this.http.post(`/tests/${_context.test}/builds/fetchdefault`, _data);
        }
        if (_context.project && true) {
    ...
    async GetDraft(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && true) {
            ...
            const res = await this.http.get(`/tests/${_context.test}/builds/getdraft`, _data);
            return res;
        }
        if (_context.project && true) {
            _data[this.APPDENAME?.toLowerCase()] = undefined;
    ...
    async LinkBug(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && _context.build) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/${_context.build}/linkbug`, _data);
        }
        if (_context.project && _context.build) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async UnlinkBug(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && _context.build) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/${_context.build}/unlinkbug`, _data);
        }
        if (_context.project && _context.build) {
        _data = await this.obtainMinor(_context, _data);
    ...
    this.log.warn([`[Build]>>>[UnlinkBug函数]异常`]);
    return new HttpResponse({message:'无匹配请求地址'}, { status: 404, statusText: '无匹配请求地址!' });
    }
    /**
     * Get
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.test && _context.build) {
            const res = await this.http.get(`/tests/${_context.test}/builds/${_context.build}`);
            return res;
        }
        if (_context.project && _context.build) {
    ...
    public async LinkStoryBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        if(_context.test && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/linkstorybatch`,_data);
        }
        if(_context.project && true){
        _data = await this.obtainMinor(_context, _data);
    ...
    public async UnlinkStoryBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        if(_context.test && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/unlinkstorybatch`,_data);
        }
        if(_context.project && true){
        _data = await this.obtainMinor(_context, _data);
    ...
    public async LinkBugBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        if(_context.test && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/linkbugbatch`,_data);
        }
        if(_context.project && true){
        _data = await this.obtainMinor(_context, _data);
    ...
    public async UnlinkBugBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        if(_context.test && true){
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tests/${_context.test}/builds/unlinkbugbatch`,_data);
        }
        if(_context.project && true){
        _data = await this.obtainMinor(_context, _data);
        ...
        this.log.warn([`[Build]>>>[UnlinkBugBatch函数]异常`]);
        return new HttpResponse({message:'无匹配请求地址'}, { status: 404, statusText: '无匹配请求地址!' });
    }
}
