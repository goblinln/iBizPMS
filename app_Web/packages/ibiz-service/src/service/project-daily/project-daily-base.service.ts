...
export class ProjectDailyBaseService extends EntityBaseService<IProjectDaily> {
    ...
    protected dynaModelFilePath:string = 'PSSYSAPPS/Web/PSAPPDATAENTITIES/ProjectDaily.json';
    ...
    async Create(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        const res = await this.http.post(`/projectdailies`, _data);
        return res;
            } catch (error) {
    ...
    async Get(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        try {
        const res = await this.http.get(`/projectdailies/${encodeURIComponent(_context.projectdaily)}`);
    ...
    async Summary(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        try {
        const res = await this.http.post(`/projectdailies/${encodeURIComponent(_context.projectdaily)}/summary`, _data);
        return res;
            } catch (error) {
                return this.handleResponseError(error);
            }
    ...
    async Update(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        const res = await this.http.put(`/projectdailies/${encodeURIComponent(_context.projectdaily)}`, _data);
        return res;
            } catch (error) {
                return this.handleResponseError(error);
            }
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        try {
        const res = await this.http.post(`/projectdailies/fetchdefault`, _data);
    ...
    public async SummaryBatch(_context: any = {},_data: any = {}): Promise<HttpResponse> {
        _data = await this.obtainMinor(_context, _data);
        const res = await this.http.post(`/projectdailies/summarybatch`,_data);
        return res;
    }
}
