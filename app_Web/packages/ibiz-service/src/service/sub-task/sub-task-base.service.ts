...
export class SubTaskBaseService extends EntityBaseService<ISubTask> {
    ...
    async ComputeBeginAndEnd(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        if (_context.product && _context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        if (_context.product && _context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        if (_context.project && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        if (_context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        if (_context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        if (_context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        if (_context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tasks/${_context.task}/subtasks/${_context.subtask}/computebeginandend`, _data);
        }
        return this.http.post(`/subtasks/${_context.subtask}/computebeginandend`, _data);
    }
    /**
     * ComputeWorkingHours
     *
    ...
    async ComputeWorkingHours(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        if (_context.product && _context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        if (_context.product && _context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        if (_context.project && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        if (_context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        if (_context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        if (_context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        if (_context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tasks/${_context.task}/subtasks/${_context.subtask}/computeworkinghours`, _data);
        }
        return this.http.post(`/subtasks/${_context.subtask}/computeworkinghours`, _data);
    }
    /**
     * ConfirmStoryChange
     *
    ...
    async Delete(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        if (_context.product && _context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        if (_context.product && _context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        if (_context.project && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        if (_context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        if (_context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        if (_context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        if (_context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tasks/${_context.task}/subtasks/${_context.subtask}/delete`, _data);
        }
        return this.http.post(`/subtasks/${_context.subtask}/delete`, _data);
    }
    /**
     * DeleteEstimate
     *
    ...
    async RecordTimZeroLeftAfterContinue(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        if (_context.product && _context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        if (_context.product && _context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        if (_context.project && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        if (_context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        if (_context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        if (_context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        if (_context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
        }
        return this.http.post(`/subtasks/${_context.subtask}/recordtimzeroleftaftercontinue`, _data);
    }
    /**
    ...
    async RecordTimateZeroLeft(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        if (_context.product && _context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        if (_context.product && _context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        if (_context.project && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        if (_context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        if (_context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        if (_context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        if (_context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
        }
        return this.http.post(`/subtasks/${_context.subtask}/recordtimatezeroleft`, _data);
    }
    /**
    ...
    async RecordTimateZeroLeftAfterStart(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        if (_context.product && _context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        if (_context.product && _context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        if (_context.project && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        if (_context.story && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        if (_context.productplan && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        if (_context.projectmodule && _context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        if (_context.task && _context.subtask) {
        _data = await this.obtainMinor(_context, _data);
            return this.http.post(`/tasks/${_context.task}/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
        }
        return this.http.post(`/subtasks/${_context.subtask}/recordtimatezeroleftafterstart`, _data);
    }
    /**
     * Restart
     *
    ...
    async FetchCurProjectTaskQuery(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && true) {
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        if (_context.product && _context.story && _context.task && true) {
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        if (_context.product && _context.productplan && _context.task && true) {
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        if (_context.project && _context.task && true) {
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        if (_context.story && _context.task && true) {
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        if (_context.productplan && _context.task && true) {
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        if (_context.projectmodule && _context.task && true) {
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        if (_context.task && true) {
            return this.http.post(`/tasks/${_context.task}/subtasks/fetchcurprojecttaskquery`, _data);
        }
        return this.http.post(`/subtasks/fetchcurprojecttaskquery`, _data);
    }
    /**
     * FetchDefault
     *
