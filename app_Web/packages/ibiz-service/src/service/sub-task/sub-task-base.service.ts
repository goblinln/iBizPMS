...
export class SubTaskBaseService extends EntityBaseService<ISubTask> {
     ...
     * @memberof SubTaskService
     */
    async ChildTask(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && _context.projectmodule && _context.task && true) {
            return this.http.post(`/projects/${_context.project}/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        if (_context.product && _context.story && _context.task && true) {
            return this.http.post(`/products/${_context.product}/stories/${_context.story}/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        if (_context.product && _context.productplan && _context.task && true) {
            return this.http.post(`/products/${_context.product}/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        if (_context.project && _context.task && true) {
            return this.http.post(`/projects/${_context.project}/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        if (_context.story && _context.task && true) {
            return this.http.post(`/stories/${_context.story}/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        if (_context.productplan && _context.task && true) {
            return this.http.post(`/productplans/${_context.productplan}/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        if (_context.projectmodule && _context.task && true) {
            return this.http.post(`/projectmodules/${_context.projectmodule}/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        if (_context.task && true) {
            return this.http.post(`/tasks/${_context.task}/subtasks/childtask`, _data);
        }
        return this.http.post(`/subtasks/childtask`, _data);
    }
    /**
     * GetUserConcat
     *
