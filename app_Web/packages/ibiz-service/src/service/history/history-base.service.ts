...
export class HistoryBaseService extends EntityBaseService<IHistory> {
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        if (_context.test && _context.testcase && _context.action && true) {
            return this.http.post(`/tests/${_context.test}/testcases/${_context.testcase}/actions/${_context.action}/histories/fetchdefault`, _data);
        }
        ...
        if (_context.product && _context.productrelease && _context.action && true) {
            return this.http.post(`/products/${_context.product}/productreleases/${_context.productrelease}/actions/${_context.action}/histories/fetchdefault`, _data);
        }
        ...
        if (_context.test && _context.testtask && _context.action && true) {
            return this.http.post(`/tests/${_context.test}/testtasks/${_context.testtask}/actions/${_context.action}/histories/fetchdefault`, _data);
        }
        ...
        if (_context.weekly && _context.action && true) {
            return this.http.post(`/weeklies/${_context.weekly}/actions/${_context.action}/histories/fetchdefault`, _data);
        }
