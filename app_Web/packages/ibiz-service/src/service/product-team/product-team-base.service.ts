...
export class ProductTeamBaseService extends EntityBaseService<IProductTeam> {
    ...
    async Remove(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.product && _context.productteam) {
            return this.http.delete(`/sysaccounts/${_context.sysaccount}/products/${_context.product}/productteams/${_context.productteam}`);
        }
    ...
    async Update(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        _data = await this.obtainMinor(_context, _data);
            return this.http.put(`/sysaccounts/${_context.sysaccount}/products/${_context.product}/productteams/${_context.productteam}`, _data);
        }
        if (_context.product && _context.productteam) {
        _data = await this.obtainMinor(_context, _data);
    ...
    async GetDraft(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.sysaccount && _context.product && true) {
            ...
            const res = await this.http.get(`/sysaccounts/${_context.sysaccount}/products/${_context.product}/productteams/getdraft`, _data);
            return res;
        }
        if (_context.product && true) {
            _data[this.APPDENAME?.toLowerCase()] = undefined;
    ...
    async Create(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        _data = await this.obtainMinor(_context, _data);
            ...
            return this.http.post(`/sysaccounts/${_context.sysaccount}/products/${_context.product}/productteams`, _data);
        }
        if (_context.product && true) {
        _data = await this.obtainMinor(_context, _data);
            if (!_data.srffrontuf || _data.srffrontuf != 1) {
