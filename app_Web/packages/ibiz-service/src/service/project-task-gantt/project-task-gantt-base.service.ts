...
import { IProjectTaskGantt, ProjectTaskGantt } from '../../entities';
import keys from '../../entities/project-task-gantt/project-task-gantt-keys';
import { isNil, isEmpty } from 'ramda';
import { PSDEDQCondEngine } from 'ibiz-core';
import { GetUserConcatLogic } from '../../logic/entity/project-task-gantt/get-user-concat/get-user-concat-logic';

/**
 * 任务服务对象基类
 *
 * @export
 * @class ProjectTaskGanttBaseService
 * @extends {EntityBaseService}
 */
export class ProjectTaskGanttBaseService extends EntityBaseService<IProjectTaskGantt> {
    protected get keys(): string[] {
        return keys;
    }
    protected SYSTEMNAME = 'iBizPMS';
    protected APPNAME = 'Web';
    protected APPDENAME = 'ProjectTaskGantt';
    protected APPDENAMEPLURAL = 'ProjectTaskGantts';
    ...
    newEntity(data: IProjectTaskGantt): ProjectTaskGantt {
        return new ProjectTaskGantt(data);
    }

    async addLocal(context: IContext, entity: IProjectTaskGantt): Promise<IProjectTaskGantt | null> {
        return this.cache.add(context, new ProjectTaskGantt(entity) as any);
    }

    async createLocal(context: IContext, entity: IProjectTaskGantt): Promise<IProjectTaskGantt | null> {
        return super.createLocal(context, new ProjectTaskGantt(entity) as any);
    }

    async getLocal(context: IContext, srfKey: string): Promise<IProjectTaskGantt> {
    ...
    async updateLocal(context: IContext, entity: IProjectTaskGantt): Promise<IProjectTaskGantt> {
        return super.updateLocal(context, new ProjectTaskGantt(entity) as any);
    }

    async getDraftLocal(_context: IContext, entity: IProjectTaskGantt = {}): Promise<IProjectTaskGantt> {
        ...
        return new ProjectTaskGantt(entity);
    }
    ...
    async FetchTypeGroup(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        if (_context.project && true) {
            return this.http.post(`/projects/${_context.project}/projecttaskgantts/fetchtypegroup`, _data);
        }
