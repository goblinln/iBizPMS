...
export class TestCaseStepBaseService extends EntityBaseService<ITestCaseStep> {
    ...
    async FetchDefault(_context: any = {}, _data: any = {}): Promise<HttpResponse> {
        ...
        if (_context.account && _context.testcase && true) {
            return this.http.post(`/accounts/${_context.account}/testcases/${_context.testcase}/testcasesteps/fetchdefault`, _data);
        }
