...
/**
 * 代码表--用户真实名称（动态-表格）（未指派）
 *
 * @export
 * @class UserRealNameUnAssignTo_Gird
 */
export default class UserRealNameUnAssignTo_Gird {

    /**
     * 是否启用缓存
     *
     * @type boolean
     * @memberof UserRealNameUnAssignTo_Gird
     */
    ...
    public codelistModel:any = {
        codelistid:"UserRealNameUnAssignTo_Gird"
    };
    ...
    public getExpirationTime(){
        return UserRealNameUnAssignTo_Gird.expirationTime;
    }
    ...
    public setExpirationTime(value:any){
        UserRealNameUnAssignTo_Gird.expirationTime = value; 
    }
