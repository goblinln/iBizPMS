 ...
 *
 * @export
 * @class MyCompleteTask
 */
export default class MyCompleteTask {
    ...
    public getExpirationTime(){
        return MyCompleteTask.expirationTime;
    }
    ...
    public setExpirationTime(value:any){
        MyCompleteTask.expirationTime = value; 
    }
    ...
    public getItems(context: any={}, data: any={}, isloading?: boolean): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            const promise: Promise<any> = this.taskService.FetchMyCompleteTask(context, data);
