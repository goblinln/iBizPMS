 ...
 *
 * @export
 * @class ProjectTeamProduct
 */
export default class ProjectTeamProduct {
    ...
    public getExpirationTime(){
        return ProjectTeamProduct.expirationTime;
    }
    ...
    public setExpirationTime(value:any){
        ProjectTeamProduct.expirationTime = value; 
    }
