 ...
 *
 * @export
 * @class TaskTeamUserTemp
 */
export default class TaskTeamUserTemp {

    /**
     * 是否启用缓存
     *
     * @type boolean
     * @memberof TaskTeamUserTemp
     */
    ...
    public getExpirationTime(){
        return TaskTeamUserTemp.expirationTime;
    }
    ...
    public setExpirationTime(value:any){
        TaskTeamUserTemp.expirationTime = value; 
    }
    ...
    public getItems(context: any={}, data: any={}, isloading?: boolean): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            const promise: Promise<any> = this.sysemployeeService.FetchProjectTeamTaskUserTemp(context, data);
