...
import { IIBZDailyAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZDailyActionBase
 * @extends {EntityBase}
 * @implements {IIBZDailyAction}
 */
export abstract class IBZDailyActionBase extends EntityBase implements IIBZDailyAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZDailyActionBase
     */
