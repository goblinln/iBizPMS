...
import { IIbizproProjectDaily } from '../interface';
 ...
 * @export
 * @abstract
 * @class IbizproProjectDailyBase
 * @extends {EntityBase}
 * @implements {IIbizproProjectDaily}
 */
export abstract class IbizproProjectDailyBase extends EntityBase implements IIbizproProjectDaily {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IbizproProjectDailyBase
     */
