...
import { IIbzProTestTaskAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IbzProTestTaskActionBase
 * @extends {EntityBase}
 * @implements {IIbzProTestTaskAction}
 */
export abstract class IbzProTestTaskActionBase extends EntityBase implements IIbzProTestTaskAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IbzProTestTaskActionBase
     */
