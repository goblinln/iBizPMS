...
import { IAccountProduct } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountProductBase
 * @extends {EntityBase}
 * @implements {IAccountProduct}
 */
export abstract class AccountProductBase extends EntityBase implements IAccountProduct {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountProductBase
     */
