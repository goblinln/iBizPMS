...
import { IProductStory } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductStoryBase
 * @extends {EntityBase}
 * @implements {IProductStory}
 */
export abstract class ProductStoryBase extends EntityBase implements IProductStory {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductStoryBase
     */
