...
import { IProductSum } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductSumBase
 * @extends {EntityBase}
 * @implements {IProductSum}
 */
export abstract class ProductSumBase extends EntityBase implements IProductSum {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductSumBase
     */
