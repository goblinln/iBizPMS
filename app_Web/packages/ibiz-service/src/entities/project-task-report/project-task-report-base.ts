...
import { IProjectTaskReport } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProjectTaskReportBase
 * @extends {EntityBase}
 * @implements {IProjectTaskReport}
 */
export abstract class ProjectTaskReportBase extends EntityBase implements IProjectTaskReport {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProjectTaskReportBase
     */
