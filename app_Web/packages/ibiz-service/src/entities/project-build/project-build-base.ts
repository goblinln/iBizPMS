...
import { IProjectBuild } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProjectBuildBase
 * @extends {EntityBase}
 * @implements {IProjectBuild}
 */
export abstract class ProjectBuildBase extends EntityBase implements IProjectBuild {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProjectBuildBase
     */
