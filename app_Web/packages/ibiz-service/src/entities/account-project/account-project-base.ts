...
import { IAccountProject } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountProjectBase
 * @extends {EntityBase}
 * @implements {IAccountProject}
 */
export abstract class AccountProjectBase extends EntityBase implements IAccountProject {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountProjectBase
     */
