...
import { IProductMonthly } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductMonthlyBase
 * @extends {EntityBase}
 * @implements {IProductMonthly}
 */
export abstract class ProductMonthlyBase extends EntityBase implements IProductMonthly {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductMonthlyBase
     */
