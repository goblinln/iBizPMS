...
import { IIbzProMonthlyAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IbzProMonthlyActionBase
 * @extends {EntityBase}
 * @implements {IIbzProMonthlyAction}
 */
export abstract class IbzProMonthlyActionBase extends EntityBase implements IIbzProMonthlyAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IbzProMonthlyActionBase
     */
