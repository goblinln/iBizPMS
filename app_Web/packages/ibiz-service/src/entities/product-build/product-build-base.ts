...
import { IProductBuild } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductBuildBase
 * @extends {EntityBase}
 * @implements {IProductBuild}
 */
export abstract class ProductBuildBase extends EntityBase implements IProductBuild {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductBuildBase
     */
