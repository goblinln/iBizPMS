...
import { IIBZTestReportAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZTestReportActionBase
 * @extends {EntityBase}
 * @implements {IIBZTestReportAction}
 */
export abstract class IBZTestReportActionBase extends EntityBase implements IIBZTestReportAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZTestReportActionBase
     */
