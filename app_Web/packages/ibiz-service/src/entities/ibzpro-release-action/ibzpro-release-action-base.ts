...
import { IIBZProReleaseAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZProReleaseActionBase
 * @extends {EntityBase}
 * @implements {IIBZProReleaseAction}
 */
export abstract class IBZProReleaseActionBase extends EntityBase implements IIBZProReleaseAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZProReleaseActionBase
     */
