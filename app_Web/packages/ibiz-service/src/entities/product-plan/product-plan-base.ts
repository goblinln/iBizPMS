...
import { IProductPlan } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductPlanBase
 * @extends {EntityBase}
 * @implements {IProductPlan}
 */
export abstract class ProductPlanBase extends EntityBase implements IProductPlan {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductPlanBase
     */
