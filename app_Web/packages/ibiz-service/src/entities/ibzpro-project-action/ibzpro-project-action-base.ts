...
import { IIBZProProjectAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZProProjectActionBase
 * @extends {EntityBase}
 * @implements {IIBZProProjectAction}
 */
export abstract class IBZProProjectActionBase extends EntityBase implements IIBZProProjectAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZProProjectActionBase
     */
