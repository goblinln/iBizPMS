...
import { IIbzProBuildAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IbzProBuildActionBase
 * @extends {EntityBase}
 * @implements {IIbzProBuildAction}
 */
export abstract class IbzProBuildActionBase extends EntityBase implements IIbzProBuildAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IbzProBuildActionBase
     */
