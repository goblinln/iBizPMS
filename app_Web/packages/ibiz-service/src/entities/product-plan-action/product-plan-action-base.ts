...
import { IProductPlanAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductPlanActionBase
 * @extends {EntityBase}
 * @implements {IProductPlanAction}
 */
export abstract class ProductPlanActionBase extends EntityBase implements IProductPlanAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductPlanActionBase
     */
