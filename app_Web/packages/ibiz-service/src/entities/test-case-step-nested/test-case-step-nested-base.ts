...
import { ITestCaseStepNested } from '../interface';
 ...
 * @export
 * @abstract
 * @class TestCaseStepNestedBase
 * @extends {EntityBase}
 * @implements {ITestCaseStepNested}
 */
export abstract class TestCaseStepNestedBase extends EntityBase implements ITestCaseStepNested {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof TestCaseStepNestedBase
     */
