...
import { IAccountTestTask } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountTestTaskBase
 * @extends {EntityBase}
 * @implements {IAccountTestTask}
 */
export abstract class AccountTestTaskBase extends EntityBase implements IAccountTestTask {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountTestTaskBase
     */
