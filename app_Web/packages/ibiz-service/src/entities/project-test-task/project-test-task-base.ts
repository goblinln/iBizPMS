...
import { IProjectTestTask } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProjectTestTaskBase
 * @extends {EntityBase}
 * @implements {IProjectTestTask}
 */
export abstract class ProjectTestTaskBase extends EntityBase implements IProjectTestTask {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProjectTestTaskBase
     */
