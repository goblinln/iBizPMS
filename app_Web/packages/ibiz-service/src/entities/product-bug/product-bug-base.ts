...
import { IProductBug } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductBugBase
 * @extends {EntityBase}
 * @implements {IProductBug}
 */
export abstract class ProductBugBase extends EntityBase implements IProductBug {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductBugBase
     */
