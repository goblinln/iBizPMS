...
import { IIbzProReportlyAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IbzProReportlyActionBase
 * @extends {EntityBase}
 * @implements {IIbzProReportlyAction}
 */
export abstract class IbzProReportlyActionBase extends EntityBase implements IIbzProReportlyAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IbzProReportlyActionBase
     */
