...
import { IIBZTestSuiteAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZTestSuiteActionBase
 * @extends {EntityBase}
 * @implements {IIBZTestSuiteAction}
 */
export abstract class IBZTestSuiteActionBase extends EntityBase implements IIBZTestSuiteAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZTestSuiteActionBase
     */
