...
import { ITaskTeamNested } from '../interface';
 ...
 * @export
 * @abstract
 * @class TaskTeamNestedBase
 * @extends {EntityBase}
 * @implements {ITaskTeamNested}
 */
export abstract class TaskTeamNestedBase extends EntityBase implements ITaskTeamNested {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof TaskTeamNestedBase
     */
