...
import { IProjectTaskGantt } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProjectTaskGanttBase
 * @extends {EntityBase}
 * @implements {IProjectTaskGantt}
 */
export abstract class ProjectTaskGanttBase extends EntityBase implements IProjectTaskGantt {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProjectTaskGanttBase
     */
