...
import { IIBZProStory } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZProStoryBase
 * @extends {EntityBase}
 * @implements {IIBZProStory}
 */
export abstract class IBZProStoryBase extends EntityBase implements IIBZProStory {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZProStoryBase
     */
