...
import { IIBZProProductAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZProProductActionBase
 * @extends {EntityBase}
 * @implements {IIBZProProductAction}
 */
export abstract class IBZProProductActionBase extends EntityBase implements IIBZProProductAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZProProductActionBase
     */
