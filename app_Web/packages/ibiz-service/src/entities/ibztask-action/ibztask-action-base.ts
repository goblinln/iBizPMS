...
import { IIBZTaskAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZTaskActionBase
 * @extends {EntityBase}
 * @implements {IIBZTaskAction}
 */
export abstract class IBZTaskActionBase extends EntityBase implements IIBZTaskAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZTaskActionBase
     */
