...
import { IProjectBug } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProjectBugBase
 * @extends {EntityBase}
 * @implements {IProjectBug}
 */
export abstract class ProjectBugBase extends EntityBase implements IProjectBug {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProjectBugBase
     */
