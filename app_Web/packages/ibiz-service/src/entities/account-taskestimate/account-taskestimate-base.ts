...
import { IAccountTaskestimate } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountTaskestimateBase
 * @extends {EntityBase}
 * @implements {IAccountTaskestimate}
 */
export abstract class AccountTaskestimateBase extends EntityBase implements IAccountTaskestimate {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountTaskestimateBase
     */
