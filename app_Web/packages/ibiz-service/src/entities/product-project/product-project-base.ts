...
import { IProductProject } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProductProjectBase
 * @extends {EntityBase}
 * @implements {IProductProject}
 */
export abstract class ProductProjectBase extends EntityBase implements IProductProject {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProductProjectBase
     */
