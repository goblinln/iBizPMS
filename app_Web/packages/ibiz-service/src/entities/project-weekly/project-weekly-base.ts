...
import { IProjectWeekly } from '../interface';
 ...
 * @export
 * @abstract
 * @class ProjectWeeklyBase
 * @extends {EntityBase}
 * @implements {IProjectWeekly}
 */
export abstract class ProjectWeeklyBase extends EntityBase implements IProjectWeekly {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof ProjectWeeklyBase
     */
