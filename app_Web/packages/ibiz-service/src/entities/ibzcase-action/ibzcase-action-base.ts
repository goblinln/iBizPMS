...
import { IIBZCaseAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZCaseActionBase
 * @extends {EntityBase}
 * @implements {IIBZCaseAction}
 */
export abstract class IBZCaseActionBase extends EntityBase implements IIBZCaseAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZCaseActionBase
     */
