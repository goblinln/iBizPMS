...
import { IAccountStory } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountStoryBase
 * @extends {EntityBase}
 * @implements {IAccountStory}
 */
export abstract class AccountStoryBase extends EntityBase implements IAccountStory {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountStoryBase
     */
