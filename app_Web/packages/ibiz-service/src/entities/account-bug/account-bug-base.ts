...
import { IAccountBug } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountBugBase
 * @extends {EntityBase}
 * @implements {IAccountBug}
 */
export abstract class AccountBugBase extends EntityBase implements IAccountBug {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountBugBase
     */
