...
import { IIBZProToDoAction } from '../interface';
 ...
 * @export
 * @abstract
 * @class IBZProToDoActionBase
 * @extends {EntityBase}
 * @implements {IIBZProToDoAction}
 */
export abstract class IBZProToDoActionBase extends EntityBase implements IIBZProToDoAction {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof IBZProToDoActionBase
     */
