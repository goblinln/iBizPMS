...
import { IAccountTestCase } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountTestCaseBase
 * @extends {EntityBase}
 * @implements {IAccountTestCase}
 */
export abstract class AccountTestCaseBase extends EntityBase implements IAccountTestCase {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountTestCaseBase
     */
