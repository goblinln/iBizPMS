...
import { IAccountTask } from '../interface';
 ...
 * @export
 * @abstract
 * @class AccountTaskBase
 * @extends {EntityBase}
 * @implements {IAccountTask}
 */
export abstract class AccountTaskBase extends EntityBase implements IAccountTask {
    /**
     * 实体名称
     *
     * @readonly
     * @type {string}
     * @memberof AccountTaskBase
     */
