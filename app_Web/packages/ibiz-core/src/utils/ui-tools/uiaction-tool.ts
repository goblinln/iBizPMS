...
export class UIActionTool {
    ...
    private static formatData(actionTarget: any, args: any,parentContext:any,parentParams:any, _params: any): any {
        let _data: any = {};
        if (Object.is(actionTarget, 'SINGLEKEY') || Object.is(actionTarget, 'NONE') || Object.is(actionTarget, 'SINGLEDATA')) {
            let [arg] = args;
            Object.keys(_params).forEach((name: string) => {
                ...
                if (value && typeof(value) === 'string' && value.startsWith('%') && value.endsWith('%')) {
                    ...
                    if (arg && arg.hasOwnProperty(key) && (Object.is(actionTarget, 'SINGLEKEY') || Object.is(actionTarget, 'NONE') || Object.is(actionTarget, 'SINGLEDATA'))) {
