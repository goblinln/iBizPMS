...
import { ControlFactory, ModelUtil } from '../../utils';
/**
 * 视图模型基类
 * 
...
export class IBizViewModelBase {
    ...
    public constructor(opts: any, context: any) {
        this.defaultOption = ModelUtil.getInstance().getDefaultValueByTag(opts.viewType);
    ...
    get getPSAppCounterRef() {
        return this.viewModelData.getPSAppCounterRef;
    }
