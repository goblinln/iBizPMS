...
export class UIServiceBase {
     ...
     * @memberof UIServiceBase
     */
    protected entityModel !: IBizEntityModel;
    ...
    protected async loaded() {
        const modelData: any = await DynamicService.getInstance(this.context).getAppEntityModelJsonData(this.dynaModelFilePath);
        this.entityModel = new IBizEntityModel(modelData);
    ...
    protected initDeMainStateMap() {
        if (this.entityModel && this.entityModel.getAllPSDEMainStates && this.entityModel.getAllPSDEMainStates.length > 0) {
            this.entityModel.getAllPSDEMainStates.forEach((element: any) => {
    ...
    protected initDeMainStateOPPrivsMap() {
        if (this.entityModel && this.entityModel.getAllPSDEMainStates && this.entityModel.getAllPSDEMainStates.length > 0) {
            this.entityModel.getAllPSDEMainStates.forEach((element: any) => {
                ...
                if (this.entityModel && this.entityModel.getAllPSDEOPPrivs && this.entityModel.getAllPSDEOPPrivs.length > 0) {
                    this.entityModel.getAllPSDEOPPrivs.forEach((deOPPriv: any) => {
                ...
                if (element.getPSDEMainStateOPPrivs && element.getPSDEMainStateOPPrivs.length > 0) {
                    element.getPSDEMainStateOPPrivs.forEach((mainStateOPPriv: any) => {
                        if (element.oPPrivAllowMode) {
