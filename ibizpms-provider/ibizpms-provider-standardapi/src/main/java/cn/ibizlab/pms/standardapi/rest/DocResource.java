...
public class DocResource {
    ...
    @PreAuthorize("quickTest('ZT_DOC', 'READ')")
	@ApiOperation(value = "根据产品获取我创建或更新文档（权限）", tags = {"文档" } ,notes = "根据产品获取我创建或更新文档（权限）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/docs/fetchmy")
	public ResponseEntity<List<DocDTO>> fetchMyByProduct(@PathVariable("product_id") Long product_id,@RequestBody DocSearchContext context) {
	...
	public ResponseEntity<List<DocDTO>> fetchMyFavouritesByProduct(@PathVariable("product_id") Long product_id,@RequestBody DocSearchContext context) {
        context.setN_product_eq(product_id);
        Page<Doc> domains = docService.searchMyFavourite(context) ;
        List<DocDTO> list = docMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("quickTest('ZT_DOC', 'READ')")
	@ApiOperation(value = "根据产品获取最新更新（与我相关）", tags = {"文档" } ,notes = "根据产品获取最新更新（与我相关）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/docs/fetchlastedmodify")
	public ResponseEntity<List<DocDTO>> fetchLastedModifyByProduct(@PathVariable("product_id") Long product_id,@RequestBody DocSearchContext context) {
        context.setN_product_eq(product_id);
        Page<Doc> domains = docService.searchLastedModify(context) ;
        List<DocDTO> list = docMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("quickTest('ZT_DOC', 'DELETE')")
    @ApiOperation(value = "根据产品批量删除文档", tags = {"文档" },  notes = "根据产品批量删除文档")
	@RequestMapping(method = RequestMethod.DELETE, value = "/products/{product_id}/docs/batch")
    ...
    @PreAuthorize("quickTest('ZT_DOC', 'READ')")
	@ApiOperation(value = "根据项目获取我创建或更新文档（权限）", tags = {"文档" } ,notes = "根据项目获取我创建或更新文档（权限）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/docs/fetchmy")
	public ResponseEntity<List<DocDTO>> fetchMyByProject(@PathVariable("project_id") Long project_id,@RequestBody DocSearchContext context) {
	...
	public ResponseEntity<List<DocDTO>> fetchMyFavouritesByProject(@PathVariable("project_id") Long project_id,@RequestBody DocSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Doc> domains = docService.searchMyFavourite(context) ;
        List<DocDTO> list = docMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("quickTest('ZT_DOC', 'READ')")
	@ApiOperation(value = "根据项目获取最新更新（与我相关）", tags = {"文档" } ,notes = "根据项目获取最新更新（与我相关）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/docs/fetchlastedmodify")
	public ResponseEntity<List<DocDTO>> fetchLastedModifyByProject(@PathVariable("project_id") Long project_id,@RequestBody DocSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Doc> domains = docService.searchLastedModify(context) ;
        List<DocDTO> list = docMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("quickTest('ZT_DOC', 'DELETE')")
    @ApiOperation(value = "根据项目批量删除文档", tags = {"文档" },  notes = "根据项目批量删除文档")
	@RequestMapping(method = RequestMethod.DELETE, value = "/projects/{project_id}/docs/batch")
