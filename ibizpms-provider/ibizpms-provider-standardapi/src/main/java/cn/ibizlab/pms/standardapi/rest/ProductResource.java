...
public class ProductResource {
    ...
    @PreAuthorize("@ProductRuntime.quickTest('READ')")
	@ApiOperation(value = "根据系统用户获取默认查询", tags = {"产品" } ,notes = "根据系统用户获取默认查询")
    @RequestMapping(method= RequestMethod.POST , value="/sysaccounts/{sysuser_id}/products/fetchcurdefault")
	public ResponseEntity<List<ProductDTO>> fetchCurDefaultBySysUser(@PathVariable("sysuser_id") String sysuser_id,@RequestBody ProductSearchContext context) {
    ...
    @PreAuthorize("@ProductRuntime.quickTest('READ')")
	@ApiOperation(value = "根据系统用户获取当前项目", tags = {"产品" } ,notes = "根据系统用户获取当前项目")
    @RequestMapping(method= RequestMethod.POST , value="/sysaccounts/{sysuser_id}/products/fetchcurproject")
	public ResponseEntity<List<ProductDTO>> fetchCurProjectBySysUser(@PathVariable("sysuser_id") String sysuser_id,@RequestBody ProductSearchContext context) {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/sysaccounts/{sysuser_id}/products/{product_id}/close")
    public ResponseEntity<ProductDTO> closeBySysUser(@PathVariable("sysuser_id") String sysuser_id, @PathVariable("product_id") Long product_id, @RequestBody ProductDTO productdto) {
        Product domain = productMapping.toDomain(productdto);
	...
	public ResponseEntity<List<ProductDTO>> fetchAccountBySysUser(@PathVariable("sysuser_id") String sysuser_id,@RequestBody ProductSearchContext context) {
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/sysaccounts/{sysuser_id}/products/{product_id}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/sysaccounts/{sysuser_id}/products/batch")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/sysaccounts/{sysuser_id}/products/fetchmy")
