...
public class DocLibResource {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/doclibs/fetchprojectdir")
	public ResponseEntity<List<DocLibDTO>> fetchprojectdir(@RequestBody DocLibSearchContext context) {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/doclibs/fetchproductdir")
	public ResponseEntity<List<DocLibDTO>> fetchproductdir(@RequestBody DocLibSearchContext context) {
    ...
    @PreAuthorize("test('ZT_DOCLIB', 'ZT_PRODUCT', #product_id, 'MANAGE', #doclib_id, 'COLLECT')")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/doclibs/fetchprojectdir")
	public ResponseEntity<List<DocLibDTO>> fetchProjectDirByProduct(@PathVariable("product_id") Long product_id,@RequestBody DocLibSearchContext context) {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/doclibs/fetchproductdir")
	public ResponseEntity<List<DocLibDTO>> fetchProductDirByProduct(@PathVariable("product_id") Long product_id,@RequestBody DocLibSearchContext context) {
        context.setN_product_eq(product_id);
        Page<DocLib> domains = doclibService.searchByProductNotFiles(context) ;
        List<DocLibDTO> list = doclibMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("test('ZT_DOCLIB', 'ZT_PROJECT', #project_id, 'DOCLIBMANAGE', #doclib_id, 'COLLECT')")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/doclibs/fetchprojectdir")
	public ResponseEntity<List<DocLibDTO>> fetchProjectDirByProject(@PathVariable("project_id") Long project_id,@RequestBody DocLibSearchContext context) {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/doclibs/fetchproductdir")
	public ResponseEntity<List<DocLibDTO>> fetchProductDirByProject(@PathVariable("project_id") Long project_id,@RequestBody DocLibSearchContext context) {
        context.setN_project_eq(project_id);
        Page<DocLib> domains = doclibService.searchByProductNotFiles(context) ;
        List<DocLibDTO> list = doclibMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
