...
public class ProjectModuleResource {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/projects/{project_id}/projectmodules/fetchdefault")
	...
	@RequestMapping(method = RequestMethod.PUT, value = "/accounts/{sysuser_id}/projects/{project_id}/projectmodules/{projectmodule_id}")
