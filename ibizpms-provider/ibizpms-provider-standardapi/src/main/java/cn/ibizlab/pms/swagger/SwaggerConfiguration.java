package cn.ibizlab.pms.swagger;

import cn.ibizlab.pms.util.security.SpringContextHolder;
import cn.ibizlab.pms.util.web.IBZOperationParameterReader;
...
public class SwaggerConfiguration {
    ...
    public Docket docket() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
				.apis(RequestHandlerSelectors.basePackage("cn.ibizlab.pms"))
                //.paths(or(regex("/rest/.*")))
	...
	public Docket standardapiDocket() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("cn.ibizlab.pms.standardapi"))
				//.paths(or(regex("/rest/standardapi/.*")))
				.paths(PathSelectors.any())
				.build()
				;
	}
	...
	public Docket webapiDocket() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("cn.ibizlab.pms.webapi"))
