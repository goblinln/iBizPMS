...
public class TaskResource {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/tasks/fetchmyfavorites")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/projects/{project_id}/tasks/fetchmyfavorites")
