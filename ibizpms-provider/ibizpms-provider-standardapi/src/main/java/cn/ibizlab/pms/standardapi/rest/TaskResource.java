...
public class TaskResource {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/tasks/fetchmy")
    ...
    @PreAuthorize("@TaskRuntime.quickTest('DENY')")
    @ApiOperation(value = "根据系统用户检查多人任务操作权限", tags = {"任务" },  notes = "根据系统用户检查多人任务操作权限")
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/tasks/{task_id}/taskforward")
    public ResponseEntity<TaskDTO> taskForwardBySysUser(@PathVariable("sysuser_id") String sysuser_id, @PathVariable("task_id") Long task_id, @RequestBody TaskDTO taskdto) {
        Task domain = taskMapping.toDomain(taskdto);
	...
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/tasks/{task_id}/taskfavorites")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/tasks/fetchaccount")
    ...
    @PreAuthorize("@TaskRuntime.quickTest('DENY')")
    @ApiOperation(value = "根据系统用户任务收藏", tags = {"任务" },  notes = "根据系统用户任务收藏")
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/tasks/{task_id}/tasknfavorites")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/projects/{project_id}/tasks/fetchmy")
    ...
    @PreAuthorize("@TaskRuntime.quickTest('DENY')")
    @ApiOperation(value = "根据系统用户项目检查多人任务操作权限", tags = {"任务" },  notes = "根据系统用户项目检查多人任务操作权限")
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/projects/{project_id}/tasks/{task_id}/taskforward")
    public ResponseEntity<TaskDTO> taskForwardBySysUserProject(@PathVariable("sysuser_id") String sysuser_id, @PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskDTO taskdto) {
        Task domain = taskMapping.toDomain(taskdto);
        domain.setProject(project_id);
        domain.setId(task_id);
        domain = taskService.taskForward(domain) ;
	...
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/projects/{project_id}/tasks/{task_id}/taskfavorites")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/projects/{project_id}/tasks/fetchaccount")
    ...
    @PreAuthorize("@TaskRuntime.quickTest('DENY')")
    @ApiOperation(value = "根据系统用户项目任务收藏", tags = {"任务" },  notes = "根据系统用户项目任务收藏")
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/projects/{project_id}/tasks/{task_id}/tasknfavorites")
