...
/**
 * 服务DTO对象[AccountProjectDTO]
 */
@Data
@ApiModel("用户项目")
@JsonFilter(value = "dtofieldfilter")
public class AccountProjectDTO extends DTOBase implements Serializable {
    ...
    private List<cn.ibizlab.pms.standardapi.dto.ProjectTeamDTO> projectteams;   
