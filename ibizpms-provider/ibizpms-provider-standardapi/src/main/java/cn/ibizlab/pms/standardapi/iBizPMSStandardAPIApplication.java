package cn.ibizlab.pms.standardapi;
...
//        ,excludeFilters={
//                @ComponentScan.Filter(type= org.springframework.context.annotation.FilterType.REGEX,pattern="cn.ibizlab.pms.standardapi.rest.xxx"),
//        }
)
...
@EnableAsync
@EnableScheduling
public class iBizPMSStandardAPIApplication extends WebMvcConfigurerAdapter{

    @Autowired
    SearchContextHandlerMethodArgumentResolver resolver;

    public static void main(String[] args) {
        SpringApplication.run(iBizPMSStandardAPIApplication.class, args);
    }
