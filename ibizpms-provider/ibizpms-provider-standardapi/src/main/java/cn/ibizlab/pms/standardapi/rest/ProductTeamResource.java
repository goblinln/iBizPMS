...
public class ProductTeamResource {
    ...
    @PreAuthorize("@ProductRuntime.test(#productteam_id, 'READ')")
    ...
    @PreAuthorize("@ProductRuntime.test(#productteam_id, 'DELETE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#productteam_id, 'UPDATE')")
