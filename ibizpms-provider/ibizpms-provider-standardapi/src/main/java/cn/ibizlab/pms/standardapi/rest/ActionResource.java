...
public class ActionResource {
    ...
    @VersionCheck(entity = "action" , versionfield = "updatedate")
    @PreAuthorize("test('ZT_ACTION', 'ZT_PROJECT', #project_id, 'BUGMANAGE', #action_id, 'DENY')")
    ...
    @PreAuthorize("test('ZT_ACTION', 'ZT_PROJECT', #project_id, 'BUGMANAGE', 'DENY')")
    ...
    @PreAuthorize("test('ZT_ACTION', 'ZT_PROJECT', #project_id, 'STORYMANAGE', 'DENY')")
