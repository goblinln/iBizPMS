...
public class ProjectResource {
	...
	public ResponseEntity<List<ProjectDTO>> fetchProjectCurDefaultQueryByProduct(@PathVariable("product_id") Long product_id,@RequestBody ProjectSearchContext context) {
    ...
    @PreAuthorize("@ProjectRuntime.quickTest('READ')")
	@ApiOperation(value = "根据产品查询默认查询", tags = {"项目" } ,notes = "根据产品查询默认查询")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/projects/searchcurdefaultquery")
	public ResponseEntity<Page<ProjectDTO>> searchProjectCurDefaultQueryByProduct(@PathVariable("product_id") Long product_id, @RequestBody ProjectSearchContext context) {
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'SUSPEND')")
    @ApiOperation(value = "根据产品挂起项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'START')")
    @ApiOperation(value = "根据产品开始项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'CLOSE')")
    @ApiOperation(value = "根据产品关闭项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'MANAGE')")
    @ApiOperation(value = "根据产品关联需求项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'PUTOFF')")
    @ApiOperation(value = "根据产品延期项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @ApiOperation(value = "根据产品解除关联产品项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'ACTIVATE')")
    @ApiOperation(value = "根据产品激活项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'MANAGE')")
    @ApiOperation(value = "根据产品解除关联需求项目", tags = {"项目" },  notes = "根据产品项目")
    ...
    @ApiOperation(value = "根据产品关联产品项目", tags = {"项目" },  notes = "根据产品项目")
