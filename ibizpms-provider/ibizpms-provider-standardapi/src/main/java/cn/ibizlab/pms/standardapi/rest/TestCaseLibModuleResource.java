...
public class TestCaseLibModuleResource {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/testcaselibs/{ibzlib_id}/testcaselibmodules/checkkey")
    public ResponseEntity<Boolean> checkKeyByIbzLib(@PathVariable("ibzlib_id") Long ibzlib_id, @RequestBody TestCaseLibModuleDTO testcaselibmoduledto) {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/testcaselibs/{ibzlib_id}/testcaselibmodules/save")
    public ResponseEntity<TestCaseLibModuleDTO> saveByIbzLib(@PathVariable("ibzlib_id") Long ibzlib_id, @RequestBody TestCaseLibModuleDTO testcaselibmoduledto) {
        IbzLibModule domain = testcaselibmoduleMapping.toDomain(testcaselibmoduledto);
        domain.setRoot(ibzlib_id);
        ibzlibmoduleService.save(domain);
        return ResponseEntity.status(HttpStatus.OK).body(testcaselibmoduleMapping.toDto(domain));
    }
    ...
    @RequestMapping(method= RequestMethod.POST , value="/testcaselibs/{ibzlib_id}/testcaselibmodules/fetchroot_nobranch")
	public ResponseEntity<List<TestCaseLibModuleDTO>> fetchRoot_NoBranchByIbzLib(@PathVariable("ibzlib_id") Long ibzlib_id,@RequestBody IbzLibModuleSearchContext context) {
        context.setN_root_eq(ibzlib_id);
        ibzlibmoduleRuntime.addAuthorityConditions(context,"READ");
