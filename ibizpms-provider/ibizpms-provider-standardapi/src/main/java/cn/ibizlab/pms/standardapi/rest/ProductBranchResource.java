...
public class ProductBranchResource {
    ...
    @PreAuthorize("@ProductRuntime.test(#productbranch_id, 'UPDATE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#productbranch_id, 'READ')")
    ...
    @PreAuthorize("@ProductRuntime.test(#productbranch_id, 'DELETE')")
