...
public class TestCaseResource {
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/testcases/fetchaccount")
    ...
    @PreAuthorize("@CaseRuntime.quickTest('FAVORITE')")
    @ApiOperation(value = "根据系统用户行为", tags = {"测试用例" },  notes = "根据系统用户行为")
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/testcases/{testcase_id}/casefavorite")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/testcases/fetchmyfavorites")
    ...
    @RequestMapping(method= RequestMethod.POST , value="/accounts/{sysuser_id}/testcases/fetchmy")
    ...
    @PreAuthorize("@CaseRuntime.quickTest('NFAVORITE')")
    @ApiOperation(value = "根据系统用户CaseNFavorite", tags = {"测试用例" },  notes = "根据系统用户CaseNFavorite")
	@RequestMapping(method = RequestMethod.POST, value = "/accounts/{sysuser_id}/testcases/{testcase_id}/casenfavorite")
