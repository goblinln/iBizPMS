...
public class ProjectTaskestimateResource {
    ...
    @PreAuthorize("@ProjectTaskestimateModelImpl.test(#projecttaskestimate_id,'CREATE')")
    ...
    @PreAuthorize("@ProjectTaskestimateModelImpl.test(#projecttaskestimate_id,'UPDATE')")
    ...
    @PreAuthorize("@ProjectTaskestimateModelImpl.test(#projecttaskestimate_id,'DELETE')")
    ...
    @PreAuthorize("@ProjectTaskestimateModelImpl.test(#projecttaskestimate_id,'READ')")
    ...
    @PreAuthorize("@ProjectTaskestimateModelImpl.test('READ')")
