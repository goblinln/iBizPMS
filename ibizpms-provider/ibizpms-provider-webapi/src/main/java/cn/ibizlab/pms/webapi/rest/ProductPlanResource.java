...
import cn.ibizlab.pms.core.zentao.model.impl.ProductPlanModelImpl;
...
public class ProductPlanResource {
    ...
    @Autowired
    public ProductPlanModelImpl productplanModelImpl;

    @Autowired
    @Lazy
    public ProductPlanMapping productplanMapping;

    @PreAuthorize("@ProductPlanModelImpl.test(#productplan_id,'CREATE')")
    ...
    @PreAuthorize("@ProductPlanModelImpl.test(#productplan_id,'UPDATE')")
    ...
    @PreAuthorize("@ProductPlanModelImpl.test(#productplan_id,'DELETE')")
    ...
    @PreAuthorize("@ProductPlanModelImpl.test(#productplan_id,'READ')")
    ...
    @PreAuthorize("@ProductPlanModelImpl.test('READ')")
	...
	public ResponseEntity<List<ProductPlanDTO>> fetchChildPlan(ProductPlanSearchContext context) {
        productplanModelImpl.addAuthorityConditions(context,"READ");
