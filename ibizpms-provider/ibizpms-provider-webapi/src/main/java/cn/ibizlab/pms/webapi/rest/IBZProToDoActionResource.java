...
public class IBZProToDoActionResource {
    ...
    @ApiOperation(value = "根据待办建立ToDo日志", tags = {"ToDo日志" },  notes = "根据待办建立ToDo日志")
	@RequestMapping(method = RequestMethod.POST, value = "/todos/{todo_id}/ibzprotodoactions")
    public ResponseEntity<IBZProToDoActionDTO> createByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody IBZProToDoActionDTO ibzprotodoactiondto) {
        IBZProToDoAction domain = ibzprotodoactionMapping.toDomain(ibzprotodoactiondto);
    ...
    @PreAuthorize("@TodoRuntime.test(#todo_id,'CREATE')")
    @ApiOperation(value = "根据待办批量建立ToDo日志", tags = {"ToDo日志" },  notes = "根据待办批量建立ToDo日志")
	@RequestMapping(method = RequestMethod.POST, value = "/todos/{todo_id}/ibzprotodoactions/batch")
    public ResponseEntity<Boolean> createBatchByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody List<IBZProToDoActionDTO> ibzprotodoactiondtos) {
        List<IBZProToDoAction> domainlist=ibzprotodoactionMapping.toDomain(ibzprotodoactiondtos);
        for(IBZProToDoAction domain:domainlist){
            domain.setObjectid(todo_id);
        }
        ibzprotodoactionService.createBatch(domainlist);
        return  ResponseEntity.status(HttpStatus.OK).body(true);
    }

    @PreAuthorize("@TodoRuntime.test(#todo_id,'UPDATE')")
    @ApiOperation(value = "根据待办更新ToDo日志", tags = {"ToDo日志" },  notes = "根据待办更新ToDo日志")
	@RequestMapping(method = RequestMethod.PUT, value = "/todos/{todo_id}/ibzprotodoactions/{ibzprotodoaction_id}")
    public ResponseEntity<IBZProToDoActionDTO> updateByTodo(@PathVariable("todo_id") Long todo_id, @PathVariable("ibzprotodoaction_id") Long ibzprotodoaction_id, @RequestBody IBZProToDoActionDTO ibzprotodoactiondto) {
        IBZProToDoAction domain = ibzprotodoactionMapping.toDomain(ibzprotodoactiondto);
        domain.setObjectid(todo_id);
        domain.setId(ibzprotodoaction_id);
		ibzprotodoactionService.update(domain);
    ...
    @PreAuthorize("@TodoRuntime.test(#todo_id,'UPDATE')")
    @ApiOperation(value = "根据待办批量更新ToDo日志", tags = {"ToDo日志" },  notes = "根据待办批量更新ToDo日志")
	@RequestMapping(method = RequestMethod.PUT, value = "/todos/{todo_id}/ibzprotodoactions/batch")
    public ResponseEntity<Boolean> updateBatchByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody List<IBZProToDoActionDTO> ibzprotodoactiondtos) {
        List<IBZProToDoAction> domainlist=ibzprotodoactionMapping.toDomain(ibzprotodoactiondtos);
        for(IBZProToDoAction domain:domainlist){
            domain.setObjectid(todo_id);
        }
        ibzprotodoactionService.updateBatch(domainlist);
        return  ResponseEntity.status(HttpStatus.OK).body(true);
    }

    @PreAuthorize("@TodoRuntime.test(#todo_id,'DELETE')")
    @ApiOperation(value = "根据待办删除ToDo日志", tags = {"ToDo日志" },  notes = "根据待办删除ToDo日志")
	@RequestMapping(method = RequestMethod.DELETE, value = "/todos/{todo_id}/ibzprotodoactions/{ibzprotodoaction_id}")
    public ResponseEntity<Boolean> removeByTodo(@PathVariable("todo_id") Long todo_id, @PathVariable("ibzprotodoaction_id") Long ibzprotodoaction_id) {
		return ResponseEntity.status(HttpStatus.OK).body(ibzprotodoactionService.remove(ibzprotodoaction_id));
    }

    @PreAuthorize("@TodoRuntime.test(#todo_id,'DELETE')")
    @ApiOperation(value = "根据待办批量删除ToDo日志", tags = {"ToDo日志" },  notes = "根据待办批量删除ToDo日志")
	@RequestMapping(method = RequestMethod.DELETE, value = "/todos/{todo_id}/ibzprotodoactions/batch")
    ...
    @ApiOperation(value = "根据待办获取ToDo日志", tags = {"ToDo日志" },  notes = "根据待办获取ToDo日志")
	@RequestMapping(method = RequestMethod.GET, value = "/todos/{todo_id}/ibzprotodoactions/{ibzprotodoaction_id}")
    public ResponseEntity<IBZProToDoActionDTO> getByTodo(@PathVariable("todo_id") Long todo_id, @PathVariable("ibzprotodoaction_id") Long ibzprotodoaction_id) {
        IBZProToDoAction domain = ibzprotodoactionService.get(ibzprotodoaction_id);
        IBZProToDoActionDTO dto = ibzprotodoactionMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据待办获取ToDo日志草稿", tags = {"ToDo日志" },  notes = "根据待办获取ToDo日志草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/todos/{todo_id}/ibzprotodoactions/getdraft")
    public ResponseEntity<IBZProToDoActionDTO> getDraftByTodo(@PathVariable("todo_id") Long todo_id, IBZProToDoActionDTO dto) {
        IBZProToDoAction domain = ibzprotodoactionMapping.toDomain(dto);
        domain.setObjectid(todo_id);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprotodoactionMapping.toDto(ibzprotodoactionService.getDraft(domain)));
    }

    @ApiOperation(value = "根据待办检查ToDo日志", tags = {"ToDo日志" },  notes = "根据待办检查ToDo日志")
	@RequestMapping(method = RequestMethod.POST, value = "/todos/{todo_id}/ibzprotodoactions/checkkey")
    public ResponseEntity<Boolean> checkKeyByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody IBZProToDoActionDTO ibzprotodoactiondto) {
        return  ResponseEntity.status(HttpStatus.OK).body(ibzprotodoactionService.checkKey(ibzprotodoactionMapping.toDomain(ibzprotodoactiondto)));
    }
    ...
    public ResponseEntity<IBZProToDoActionDTO> saveByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody IBZProToDoActionDTO ibzprotodoactiondto) {
        ...
        domain.setObjectid(todo_id);
        ibzprotodoactionService.save(domain);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprotodoactionMapping.toDto(domain));
    }

    @ApiOperation(value = "根据待办批量保存ToDo日志", tags = {"ToDo日志" },  notes = "根据待办批量保存ToDo日志")
	@RequestMapping(method = RequestMethod.POST, value = "/todos/{todo_id}/ibzprotodoactions/savebatch")
    public ResponseEntity<Boolean> saveBatchByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody List<IBZProToDoActionDTO> ibzprotodoactiondtos) {
        List<IBZProToDoAction> domainlist=ibzprotodoactionMapping.toDomain(ibzprotodoactiondtos);
        for(IBZProToDoAction domain:domainlist){
             domain.setObjectid(todo_id);
        }
        ibzprotodoactionService.saveBatch(domainlist);
        return  ResponseEntity.status(HttpStatus.OK).body(true);
    }
	...
	public ResponseEntity<List<IBZProToDoActionDTO>> fetchIBZProToDoActionDefaultByTodo(@PathVariable("todo_id") Long todo_id,@RequestBody IBZProToDoActionSearchContext context) {
        context.setN_objectid_eq(todo_id);
        Page<IBZProToDoAction> domains = ibzprotodoactionService.searchDefault(context) ;
        List<IBZProToDoActionDTO> list = ibzprotodoactionMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
    ...
    @PreAuthorize("@TodoRuntime.test(#todo_id,'READ')")
	@ApiOperation(value = "根据待办查询数据集", tags = {"ToDo日志" } ,notes = "根据待办查询数据集")
    @RequestMapping(method= RequestMethod.POST , value="/todos/{todo_id}/ibzprotodoactions/searchdefault")
	public ResponseEntity<Page<IBZProToDoActionDTO>> searchIBZProToDoActionDefaultByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody IBZProToDoActionSearchContext context) {
        context.setN_objectid_eq(todo_id);
        Page<IBZProToDoAction> domains = ibzprotodoactionService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(ibzprotodoactionMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("@TodoRuntime.test(#todo_id,'READ')")
	@ApiOperation(value = "根据待办获取动态(根据类型过滤)", tags = {"ToDo日志" } ,notes = "根据待办获取动态(根据类型过滤)")
    @RequestMapping(method= RequestMethod.POST , value="/todos/{todo_id}/ibzprotodoactions/fetchtype")
	public ResponseEntity<List<IBZProToDoActionDTO>> fetchIBZProToDoActionTypeByTodo(@PathVariable("todo_id") Long todo_id,@RequestBody IBZProToDoActionSearchContext context) {
        context.setN_objectid_eq(todo_id);
        Page<IBZProToDoAction> domains = ibzprotodoactionService.searchType(context) ;
        List<IBZProToDoActionDTO> list = ibzprotodoactionMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("@TodoRuntime.test(#todo_id,'READ')")
	@ApiOperation(value = "根据待办查询动态(根据类型过滤)", tags = {"ToDo日志" } ,notes = "根据待办查询动态(根据类型过滤)")
    @RequestMapping(method= RequestMethod.POST , value="/todos/{todo_id}/ibzprotodoactions/searchtype")
	public ResponseEntity<Page<IBZProToDoActionDTO>> searchIBZProToDoActionTypeByTodo(@PathVariable("todo_id") Long todo_id, @RequestBody IBZProToDoActionSearchContext context) {
        context.setN_objectid_eq(todo_id);
        Page<IBZProToDoAction> domains = ibzprotodoactionService.searchType(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(ibzprotodoactionMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
