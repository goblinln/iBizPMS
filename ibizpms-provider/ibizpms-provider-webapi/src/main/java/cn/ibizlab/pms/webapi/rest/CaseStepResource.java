...
public class CaseStepResource {
    ...
    @PreAuthorize("hasPermission(this.casestepMapping.toDomain(#casestepdto),'iBizPMS-CaseStep-Create')")
    ...
    @PreAuthorize("hasPermission(this.casestepMapping.toDomain(#casestepdtos),'iBizPMS-CaseStep-Create')")
    ...
    @PreAuthorize("hasPermission(this.casestepService.get(#casestep_id),'iBizPMS-CaseStep-Update')")
    ...
    @PreAuthorize("hasPermission(this.casestepService.getCasestepByEntities(this.casestepMapping.toDomain(#casestepdtos)),'iBizPMS-CaseStep-Update')")
    ...
    @PreAuthorize("hasPermission(this.casestepService.get(#casestep_id),'iBizPMS-CaseStep-Remove')")
    ...
    @PreAuthorize("hasPermission(this.casestepService.getCasestepByIds(#ids),'iBizPMS-CaseStep-Remove')")
    ...
    @PostAuthorize("hasPermission(this.casestepMapping.toDomain(returnObject.body),'iBizPMS-CaseStep-Get')")
    ...
    @PreAuthorize("hasPermission(this.casestepMapping.toDomain(#casestepdto),'iBizPMS-CaseStep-Save')")
    ...
    @PreAuthorize("hasPermission(this.casestepMapping.toDomain(#casestepdtos),'iBizPMS-CaseStep-Save')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-CaseStep-searchCurTest-all') and hasPermission(#context,'iBizPMS-CaseStep-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-CaseStep-searchDefault-all') and hasPermission(#context,'iBizPMS-CaseStep-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-CaseStep-searchDefault1-all') and hasPermission(#context,'iBizPMS-CaseStep-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-CaseStep-searchMob-all') and hasPermission(#context,'iBizPMS-CaseStep-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-CaseStep-searchVersion-all') and hasPermission(#context,'iBizPMS-CaseStep-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-CaseStep-searchVersions-all') and hasPermission(#context,'iBizPMS-CaseStep-Get')")
