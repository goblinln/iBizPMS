...
public class IbzproConfigResource {
    ...
    @PreAuthorize("@IbzproConfigModelImpl.test(#ibzproconfig_id,'CREATE')")
    ...
    @PreAuthorize("@IbzproConfigModelImpl.test(#ibzproconfig_id,'UPDATE')")
    ...
    @PreAuthorize("@IbzproConfigModelImpl.test(#ibzproconfig_id,'DELETE')")
    ...
    @PreAuthorize("@IbzproConfigModelImpl.test(#ibzproconfig_id,'READ')")
    ...
    @PreAuthorize("@IbzproConfigModelImpl.test('READ')")
