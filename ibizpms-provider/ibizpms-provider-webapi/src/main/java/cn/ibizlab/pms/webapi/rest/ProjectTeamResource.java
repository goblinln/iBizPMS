...
public class ProjectTeamResource {
    ...
    @PreAuthorize("@ProjectTeamModelImpl.test(#projectteam_id,'CREATE')")
    ...
    @PreAuthorize("@ProjectTeamModelImpl.test(#projectteam_id,'UPDATE')")
    ...
    @PreAuthorize("@ProjectTeamModelImpl.test(#projectteam_id,'DELETE')")
    ...
    @PreAuthorize("@ProjectTeamModelImpl.test(#projectteam_id,'READ')")
    ...
    @PreAuthorize("@ProjectTeamModelImpl.test('READ')")
