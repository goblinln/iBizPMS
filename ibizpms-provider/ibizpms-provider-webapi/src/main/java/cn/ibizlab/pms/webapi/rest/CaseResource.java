...
import cn.ibizlab.pms.core.zentao.model.impl.CaseModelImpl;
...
public class CaseResource {
    ...
    @Autowired
    public CaseModelImpl caseModelImpl;
    ...
    @PreAuthorize("@CaseModelImpl.test(#case_id,'CREATE')")
    ...
    @PreAuthorize("@CaseModelImpl.test(#case_id,'UPDATE')")
    ...
    @PreAuthorize("@CaseModelImpl.test(#case_id,'DELETE')")
    ...
    @PreAuthorize("@CaseModelImpl.test(#case_id,'READ')")
    ...
    @PreAuthorize("@CaseModelImpl.test('READ')")
	...
	public ResponseEntity<List<CaseDTO>> fetchBatchNew(CaseSearchContext context) {
        caseModelImpl.addAuthorityConditions(context,"READ");
