...
public class ProjectResource {
    ...
    @PreAuthorize("@ProjectModelImpl.test(#project_id,'CREATE')")
    ...
    @PreAuthorize("@ProjectModelImpl.test(#project_id,'UPDATE')")
    ...
    @PreAuthorize("@ProjectModelImpl.test(#project_id,'DELETE')")
    ...
    @PreAuthorize("@ProjectModelImpl.test(#project_id,'READ')")
    ...
    @PreAuthorize("@ProjectModelImpl.test('READ')")
