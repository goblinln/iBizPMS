...
import cn.ibizlab.pms.core.ibizpro.model.impl.IbzproProjectUserTaskModelImpl;
...
public class IbzproProjectUserTaskResource {
    ...
    @Autowired
    public IbzproProjectUserTaskModelImpl ibzproprojectusertaskModelImpl;

    @Autowired
    @Lazy
    public IbzproProjectUserTaskMapping ibzproprojectusertaskMapping;

    @PreAuthorize("@IbzproProjectUserTaskModelImpl.test(#ibzproprojectusertask_id,'CREATE')")
    ...
    @PreAuthorize("@IbzproProjectUserTaskModelImpl.test(#ibzproprojectusertask_id,'UPDATE')")
    ...
    @PreAuthorize("@IbzproProjectUserTaskModelImpl.test(#ibzproprojectusertask_id,'DELETE')")
    ...
    @PreAuthorize("@IbzproProjectUserTaskModelImpl.test(#ibzproprojectusertask_id,'READ')")
    ...
    @PreAuthorize("@IbzproProjectUserTaskModelImpl.test('READ')")
	...
	public ResponseEntity<List<IbzproProjectUserTaskDTO>> fetchDefault(IbzproProjectUserTaskSearchContext context) {
        ibzproprojectusertaskModelImpl.addAuthorityConditions(context,"READ");
