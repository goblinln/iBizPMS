...
public class ModuleResource {
    ...
    @PreAuthorize("@ModuleModelImpl.test(#module_id,'CREATE')")
    ...
    @PreAuthorize("@ModuleModelImpl.test(#module_id,'UPDATE')")
    ...
    @PreAuthorize("@ModuleModelImpl.test(#module_id,'DELETE')")
    ...
    @PreAuthorize("@ModuleModelImpl.test(#module_id,'READ')")
    ...
    @PreAuthorize("@ModuleModelImpl.test('READ')")
