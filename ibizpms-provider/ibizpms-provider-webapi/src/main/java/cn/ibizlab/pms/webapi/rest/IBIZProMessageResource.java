...
public class IBIZProMessageResource {
    ...
    @PreAuthorize("@IBIZProMessageModelImpl.test(#ibizpromessage_id,'CREATE')")
    ...
    @PreAuthorize("@IBIZProMessageModelImpl.test(#ibizpromessage_id,'UPDATE')")
    ...
    @PreAuthorize("@IBIZProMessageModelImpl.test(#ibizpromessage_id,'DELETE')")
    ...
    @PreAuthorize("@IBIZProMessageModelImpl.test(#ibizpromessage_id,'READ')")
    ...
    @PreAuthorize("@IBIZProMessageModelImpl.test('READ')")
