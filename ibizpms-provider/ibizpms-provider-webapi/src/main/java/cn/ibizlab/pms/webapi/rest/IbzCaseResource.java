...
public class IbzCaseResource {
    ...
    @PreAuthorize("@IbzCaseModelImpl.test(#ibzcase_id,'CREATE')")
    ...
    @PreAuthorize("@IbzCaseModelImpl.test(#ibzcase_id,'UPDATE')")
    ...
    @PreAuthorize("@IbzCaseModelImpl.test(#ibzcase_id,'DELETE')")
    ...
    @PreAuthorize("@IbzCaseModelImpl.test(#ibzcase_id,'READ')")
    ...
    @PreAuthorize("@IbzCaseModelImpl.test('READ')")
