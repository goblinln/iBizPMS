...
public class StorySpecResource {
    ...
    @PreAuthorize("@StorySpecModelImpl.test(#storyspec_id,'CREATE')")
    ...
    @PreAuthorize("@StorySpecModelImpl.test(#storyspec_id,'UPDATE')")
    ...
    @PreAuthorize("@StorySpecModelImpl.test(#storyspec_id,'DELETE')")
    ...
    @PreAuthorize("@StorySpecModelImpl.test(#storyspec_id,'READ')")
    ...
    @PreAuthorize("@StorySpecModelImpl.test('READ')")
