...
public class TestModuleResource {
    ...
    @PreAuthorize("@TestModuleModelImpl.test(#testmodule_id,'CREATE')")
    ...
    @PreAuthorize("@TestModuleModelImpl.test(#testmodule_id,'UPDATE')")
    ...
    @PreAuthorize("@TestModuleModelImpl.test(#testmodule_id,'DELETE')")
    ...
    @PreAuthorize("@TestModuleModelImpl.test(#testmodule_id,'READ')")
    ...
    @PreAuthorize("@TestModuleModelImpl.test('READ')")
