...
public class TestModuleResource {
    ...
    @PreAuthorize("@ProductRuntime.test(#testmodule_id, 'UPDATE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#testmodule_id, 'DELETE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#testmodule_id, 'READ')")
