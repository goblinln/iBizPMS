...
public class BuildResource {
    ...
    @PreAuthorize("@BuildModelImpl.test(#build_id,'CREATE')")
    ...
    @PreAuthorize("@BuildModelImpl.test(#build_id,'UPDATE')")
    ...
    @PreAuthorize("@BuildModelImpl.test(#build_id,'DELETE')")
    ...
    @PreAuthorize("@BuildModelImpl.test(#build_id,'READ')")
    ...
    @PreAuthorize("@BuildModelImpl.test('READ')")
