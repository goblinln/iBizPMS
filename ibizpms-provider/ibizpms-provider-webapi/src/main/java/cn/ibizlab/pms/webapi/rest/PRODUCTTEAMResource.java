...
import cn.ibizlab.pms.core.ibiz.model.impl.PRODUCTTEAMModelImpl;
...
public class PRODUCTTEAMResource {
    ...
    @Autowired
    public PRODUCTTEAMModelImpl productteamModelImpl;

    @Autowired
    @Lazy
    public PRODUCTTEAMMapping productteamMapping;

    @PreAuthorize("@PRODUCTTEAMModelImpl.test(#productteam_id,'CREATE')")
    ...
    @PreAuthorize("@PRODUCTTEAMModelImpl.test(#productteam_id,'UPDATE')")
    ...
    @PreAuthorize("@PRODUCTTEAMModelImpl.test(#productteam_id,'DELETE')")
    ...
    @PreAuthorize("@PRODUCTTEAMModelImpl.test(#productteam_id,'READ')")
    ...
    @PreAuthorize("@PRODUCTTEAMModelImpl.test('READ')")
	...
	public ResponseEntity<List<PRODUCTTEAMDTO>> fetchDefault(PRODUCTTEAMSearchContext context) {
        productteamModelImpl.addAuthorityConditions(context,"READ");
