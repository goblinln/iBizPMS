...
public class PSSysSFPubResource {
    ...
    @ApiOperation(value = "生成后台服务架构报表", tags = {"后台服务架构"}, notes = "生成后台服务架构报表")
    @RequestMapping(method = RequestMethod.GET, value = "/pssyssfpubs/report/{report_id}.{type}")
    public void report(@PathVariable("report_id") String report_id, @PathVariable("type") String type, PSSysSFPubSearchContext context, HttpServletResponse response) {
    }

    @ApiOperation(value = "打印后台服务架构", tags = {"后台服务架构"}, notes = "打印后台服务架构")
    @RequestMapping(method = RequestMethod.GET, value = "/pssyssfpubs/{pssyssfpub_ids}/print/{print_id}.{type}")
    public void print(@PathVariable("pssyssfpub_ids") Set<String> pssyssfpub_ids, @PathVariable("print_id") String print_id, @PathVariable("type") String type, HttpServletResponse response) {
    }
