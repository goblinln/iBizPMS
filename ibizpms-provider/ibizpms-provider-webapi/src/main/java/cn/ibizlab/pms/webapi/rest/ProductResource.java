...
public class ProductResource {
    ...
    @PreAuthorize("@ProductModelImpl.test(#product_id,'CREATE')")
    ...
    @PreAuthorize("@ProductModelImpl.test(#product_id,'UPDATE')")
    ...
    @PreAuthorize("@ProductModelImpl.test(#product_id,'DELETE')")
    ...
    @PreAuthorize("@ProductModelImpl.test(#product_id,'READ')")
    ...
    @PreAuthorize("@ProductModelImpl.test('READ')")
