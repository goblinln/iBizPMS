...
public class SysPostResource {
    ...
    @PreAuthorize("@SysPostModelImpl.test(#syspost_id,'CREATE')")
    ...
    @PreAuthorize("@SysPostModelImpl.test(#syspost_id,'UPDATE')")
    ...
    @PreAuthorize("@SysPostModelImpl.test(#syspost_id,'DELETE')")
    ...
    @PreAuthorize("@SysPostModelImpl.test(#syspost_id,'READ')")
    ...
    @PreAuthorize("@SysPostModelImpl.test('READ')")
