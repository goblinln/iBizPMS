...
public class SysPostResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-SysPost-Create-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-SysPost-Get-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-SysPost-Remove-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-SysPost-Update-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-SysPost-Save-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-SysPost-searchDefault-all')")
