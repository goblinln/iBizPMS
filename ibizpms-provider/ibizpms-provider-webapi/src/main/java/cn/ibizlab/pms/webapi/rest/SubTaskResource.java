...
public class SubTaskResource {
    ...
    @PreAuthorize("@TaskModelImpl.test(#subtask_id,'CREATE')")
    ...
    @PreAuthorize("@TaskModelImpl.test(#subtask_id,'UPDATE')")
    ...
    @PreAuthorize("@TaskModelImpl.test(#subtask_id,'DELETE')")
    ...
    @PreAuthorize("@TaskModelImpl.test(#subtask_id,'READ')")
    ...
    @PreAuthorize("@TaskModelImpl.test('READ')")
