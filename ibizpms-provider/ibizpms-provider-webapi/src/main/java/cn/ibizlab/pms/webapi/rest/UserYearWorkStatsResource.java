...
public class UserYearWorkStatsResource {
    ...
    @PreAuthorize("@UserYearWorkStatsModelImpl.test(#useryearworkstats_id,'CREATE')")
    ...
    @PreAuthorize("@UserYearWorkStatsModelImpl.test(#useryearworkstats_id,'UPDATE')")
    ...
    @PreAuthorize("@UserYearWorkStatsModelImpl.test(#useryearworkstats_id,'DELETE')")
    ...
    @PreAuthorize("@UserYearWorkStatsModelImpl.test(#useryearworkstats_id,'READ')")
    ...
    @PreAuthorize("@UserYearWorkStatsModelImpl.test('READ')")
