...
public class IbzReportResource {
    ...
    @PreAuthorize("@IbzReportModelImpl.test(#ibzreport_id,'CREATE')")
    ...
    @PreAuthorize("@IbzReportModelImpl.test(#ibzreport_id,'UPDATE')")
    ...
    @PreAuthorize("@IbzReportModelImpl.test(#ibzreport_id,'DELETE')")
    ...
    @PreAuthorize("@IbzReportModelImpl.test(#ibzreport_id,'READ')")
    ...
    @PreAuthorize("@IbzReportModelImpl.test('READ')")
	@ApiOperation(value = "获取汇报汇总", tags = {"汇报汇总" } ,notes = "获取汇报汇总")
