...
public class BranchResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-Branch-Create-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-Branch-Update-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-Branch-Remove-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-Branch-Get-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-Branch-Save-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-Branch-searchCurProduct-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-Branch-searchDefault-all')")
