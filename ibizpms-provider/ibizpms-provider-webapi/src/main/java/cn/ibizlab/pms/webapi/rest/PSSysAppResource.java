...
public class PSSysAppResource {
    ...
    @PreAuthorize("hasPermission(this.pssysappMapping.toDomain(#pssysappdto),'pms-PSSysApp-Create')")
    ...
    @PreAuthorize("hasPermission(this.pssysappMapping.toDomain(#pssysappdtos),'pms-PSSysApp-Create')")
    ...
    @PreAuthorize("hasPermission(this.pssysappService.getPssysappByEntities(this.pssysappMapping.toDomain(#pssysappdtos)),'pms-PSSysApp-Update')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-PSSysApp-searchBuild-all') and hasPermission(#context,'pms-PSSysApp-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-PSSysApp-searchDefault-all') and hasPermission(#context,'pms-PSSysApp-Get')")
