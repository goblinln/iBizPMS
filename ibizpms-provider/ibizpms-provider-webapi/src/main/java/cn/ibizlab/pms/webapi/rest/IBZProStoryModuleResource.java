...
import cn.ibizlab.pms.core.ibizpro.model.impl.IBZProStoryModuleModelImpl;
...
public class IBZProStoryModuleResource {
    ...
    @Autowired
    public IBZProStoryModuleModelImpl ibzprostorymoduleModelImpl;

    @Autowired
    @Lazy
    public IBZProStoryModuleMapping ibzprostorymoduleMapping;

    @PreAuthorize("@IBZProStoryModuleModelImpl.test(#ibzprostorymodule_id,'CREATE')")
    ...
    @PreAuthorize("@IBZProStoryModuleModelImpl.test(#ibzprostorymodule_id,'UPDATE')")
    ...
    @PreAuthorize("@IBZProStoryModuleModelImpl.test(#ibzprostorymodule_id,'DELETE')")
    ...
    @PreAuthorize("@IBZProStoryModuleModelImpl.test(#ibzprostorymodule_id,'READ')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-IBZProStoryModule-SyncFromIBIZ-all')")
    ...
    @PreAuthorize("@IBZProStoryModuleModelImpl.test('READ')")
	...
	public ResponseEntity<List<IBZProStoryModuleDTO>> fetchDefault(IBZProStoryModuleSearchContext context) {
        ibzprostorymoduleModelImpl.addAuthorityConditions(context,"READ");
