...
import cn.ibizlab.pms.core.ibiz.model.impl.ProductLifeModelImpl;
...
public class ProductLifeResource {
    ...
    @Autowired
    public ProductLifeModelImpl productlifeModelImpl;

    @Autowired
    @Lazy
    public ProductLifeMapping productlifeMapping;

    @PreAuthorize("@ProductLifeModelImpl.test('READ')")
	...
	public ResponseEntity<List<ProductLifeDTO>> fetchRoadMapYear(ProductLifeSearchContext context) {
        productlifeModelImpl.addAuthorityConditions(context,"READ");
