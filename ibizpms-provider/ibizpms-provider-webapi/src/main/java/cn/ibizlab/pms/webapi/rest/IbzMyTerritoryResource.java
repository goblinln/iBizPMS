...
public class IbzMyTerritoryResource {
    ...
    @PreAuthorize("@IbzMyTerritoryModelImpl.test(#ibzmyterritory_id,'CREATE')")
    ...
    @PreAuthorize("@IbzMyTerritoryModelImpl.test(#ibzmyterritory_id,'UPDATE')")
    ...
    @PreAuthorize("@IbzMyTerritoryModelImpl.test(#ibzmyterritory_id,'DELETE')")
    ...
    @PreAuthorize("@IbzMyTerritoryModelImpl.test(#ibzmyterritory_id,'READ')")
    ...
    @PreAuthorize("@IbzMyTerritoryModelImpl.test('READ')")
