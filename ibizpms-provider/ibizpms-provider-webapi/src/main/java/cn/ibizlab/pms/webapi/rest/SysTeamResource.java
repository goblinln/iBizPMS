...
public class SysTeamResource {
    ...
    @ApiOperation(value = "生成组报表", tags = {"组"}, notes = "生成组报表")
    @RequestMapping(method = RequestMethod.GET, value = "/systeams/report/{report_id}.{type}")
    public void report(@PathVariable("report_id") String report_id, @PathVariable("type") String type, SysTeamSearchContext context, HttpServletResponse response) {
    }

    @ApiOperation(value = "打印组", tags = {"组"}, notes = "打印组")
    @RequestMapping(method = RequestMethod.GET, value = "/systeams/{systeam_ids}/print/{print_id}.{type}")
    public void print(@PathVariable("systeam_ids") Set<String> systeam_ids, @PathVariable("print_id") String print_id, @PathVariable("type") String type, HttpServletResponse response) {
    }
