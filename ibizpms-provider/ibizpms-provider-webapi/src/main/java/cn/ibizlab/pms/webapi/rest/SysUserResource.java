...
public class SysUserResource {
    ...
    @PreAuthorize("@SysUserModelImpl.test(#sysuser_id,'CREATE')")
    ...
    @PreAuthorize("@SysUserModelImpl.test(#sysuser_id,'UPDATE')")
    ...
    @PreAuthorize("@SysUserModelImpl.test(#sysuser_id,'DELETE')")
    ...
    @PreAuthorize("@SysUserModelImpl.test(#sysuser_id,'READ')")
    ...
    @PreAuthorize("@SysUserModelImpl.test('READ')")
