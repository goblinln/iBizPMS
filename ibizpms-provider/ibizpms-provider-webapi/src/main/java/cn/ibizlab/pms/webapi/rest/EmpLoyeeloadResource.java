...
public class EmpLoyeeloadResource {
    ...
    @PreAuthorize("@EmpLoyeeloadModelImpl.test(#employeeload_id,'CREATE')")
    ...
    @PreAuthorize("@EmpLoyeeloadModelImpl.test(#employeeload_id,'UPDATE')")
    ...
    @PreAuthorize("@EmpLoyeeloadModelImpl.test(#employeeload_id,'DELETE')")
    ...
    @PreAuthorize("@EmpLoyeeloadModelImpl.test(#employeeload_id,'READ')")
    ...
    @PreAuthorize("@EmpLoyeeloadModelImpl.test('READ')")
