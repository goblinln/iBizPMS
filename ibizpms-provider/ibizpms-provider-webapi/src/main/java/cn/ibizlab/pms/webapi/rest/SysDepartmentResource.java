...
public class SysDepartmentResource {
    ...
    @PreAuthorize("@SysDepartmentModelImpl.test(#sysdepartment_id,'CREATE')")
    ...
    @PreAuthorize("@SysDepartmentModelImpl.test(#sysdepartment_id,'UPDATE')")
    ...
    @PreAuthorize("@SysDepartmentModelImpl.test(#sysdepartment_id,'DELETE')")
    ...
    @PreAuthorize("@SysDepartmentModelImpl.test(#sysdepartment_id,'READ')")
    ...
    @PreAuthorize("@SysDepartmentModelImpl.test('READ')")
