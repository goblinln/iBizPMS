...
public class UserResource {
    ...
    @PreAuthorize("@UserModelImpl.test(#user_id,'CREATE')")
    ...
    @PreAuthorize("@UserModelImpl.test(#user_id,'UPDATE')")
    ...
    @PreAuthorize("@UserModelImpl.test(#user_id,'DELETE')")
    ...
    @PreAuthorize("@UserModelImpl.test(#user_id,'READ')")
    ...
    @PreAuthorize("@UserModelImpl.test('READ')")
