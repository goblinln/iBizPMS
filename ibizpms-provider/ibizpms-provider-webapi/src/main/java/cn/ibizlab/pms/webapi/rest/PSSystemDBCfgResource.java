...
public class PSSystemDBCfgResource {
    ...
    @ApiOperation(value = "生成系统数据库报表", tags = {"系统数据库"}, notes = "生成系统数据库报表")
    @RequestMapping(method = RequestMethod.GET, value = "/pssystemdbcfgs/report/{report_id}.{type}")
    public void report(@PathVariable("report_id") String report_id, @PathVariable("type") String type, PSSystemDBCfgSearchContext context, HttpServletResponse response) {
    }

    @ApiOperation(value = "打印系统数据库", tags = {"系统数据库"}, notes = "打印系统数据库")
    @RequestMapping(method = RequestMethod.GET, value = "/pssystemdbcfgs/{pssystemdbcfg_ids}/print/{print_id}.{type}")
    public void print(@PathVariable("pssystemdbcfg_ids") Set<String> pssystemdbcfg_ids, @PathVariable("print_id") String print_id, @PathVariable("type") String type, HttpServletResponse response) {
    }
