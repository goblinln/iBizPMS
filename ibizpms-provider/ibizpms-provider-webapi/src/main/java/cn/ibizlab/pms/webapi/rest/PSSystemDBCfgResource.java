...
public class PSSystemDBCfgResource {
    ...
    @PreAuthorize("@PSSystemDBCfgModelImpl.test(#pssystemdbcfg_id,'CREATE')")
    ...
    @PreAuthorize("@PSSystemDBCfgModelImpl.test(#pssystemdbcfg_id,'UPDATE')")
    ...
    @PreAuthorize("@PSSystemDBCfgModelImpl.test(#pssystemdbcfg_id,'DELETE')")
    ...
    @PreAuthorize("@PSSystemDBCfgModelImpl.test(#pssystemdbcfg_id,'READ')")
    ...
    @PreAuthorize("@PSSystemDBCfgModelImpl.test('READ')")
