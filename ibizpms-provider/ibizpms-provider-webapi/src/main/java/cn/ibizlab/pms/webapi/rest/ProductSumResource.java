...
public class ProductSumResource {
    ...
    @PreAuthorize("@ProductSumModelImpl.test(#productsum_id,'CREATE')")
    ...
    @PreAuthorize("@ProductSumModelImpl.test(#productsum_id,'UPDATE')")
    ...
    @PreAuthorize("@ProductSumModelImpl.test(#productsum_id,'DELETE')")
    ...
    @PreAuthorize("@ProductSumModelImpl.test(#productsum_id,'READ')")
    ...
    @PreAuthorize("@ProductSumModelImpl.test('READ')")
