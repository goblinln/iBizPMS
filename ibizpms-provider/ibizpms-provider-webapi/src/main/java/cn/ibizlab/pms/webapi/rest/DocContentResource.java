...
public class DocContentResource {
    ...
    @PreAuthorize("@DocContentModelImpl.test(#doccontent_id,'CREATE')")
    ...
    @PreAuthorize("@DocContentModelImpl.test(#doccontent_id,'UPDATE')")
    ...
    @PreAuthorize("@DocContentModelImpl.test(#doccontent_id,'DELETE')")
    ...
    @PreAuthorize("@DocContentModelImpl.test(#doccontent_id,'READ')")
    ...
    @PreAuthorize("@DocContentModelImpl.test('READ')")
