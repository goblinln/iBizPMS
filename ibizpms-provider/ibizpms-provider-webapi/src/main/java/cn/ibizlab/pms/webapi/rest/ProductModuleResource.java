...
import cn.ibizlab.pms.core.ibiz.model.impl.ProductModuleModelImpl;
...
public class ProductModuleResource {
    ...
    @Autowired
    public ProductModuleModelImpl productmoduleModelImpl;

    @Autowired
    @Lazy
    public ProductModuleMapping productmoduleMapping;

    @PreAuthorize("@ProductModuleModelImpl.test(#productmodule_id,'CREATE')")
    ...
    @PreAuthorize("@ProductModuleModelImpl.test(#productmodule_id,'UPDATE')")
    ...
    @PreAuthorize("@ProductModuleModelImpl.test(#productmodule_id,'DELETE')")
    ...
    @PreAuthorize("@ProductModuleModelImpl.test(#productmodule_id,'READ')")
    ...
    @PreAuthorize("@ProductModuleModelImpl.test('READ')")
	...
	public ResponseEntity<List<ProductModuleDTO>> fetchByPath(ProductModuleSearchContext context) {
        productmoduleModelImpl.addAuthorityConditions(context,"READ");
