...
public class taskestimatestatsResource {
    ...
    @PreAuthorize("@TaskEstimateStatsModelImpl.test(#taskestimatestats_id,'CREATE')")
    ...
    @PreAuthorize("@TaskEstimateStatsModelImpl.test(#taskestimatestats_id,'UPDATE')")
    ...
    @PreAuthorize("@TaskEstimateStatsModelImpl.test(#taskestimatestats_id,'DELETE')")
    ...
    @PreAuthorize("@TaskEstimateStatsModelImpl.test(#taskestimatestats_id,'READ')")
    ...
    @PreAuthorize("@TaskEstimateStatsModelImpl.test('READ')")
