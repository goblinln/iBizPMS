...
public class HistoryResource {
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'CREATE')")
    @ApiOperation(value = "根据项目系统日志批量建立操作历史", tags = {"操作历史" },  notes = "根据项目系统日志批量建立操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/projects/{project_id}/actions/{action_id}/histories/batch")
    public ResponseEntity<Boolean> createBatchByProjectAction(@PathVariable("project_id") Long project_id, @PathVariable("action_id") Long action_id, @RequestBody List<HistoryDTO> historydtos) {
        List<History> domainlist=historyMapping.toDomain(historydtos);
        for(History domain:domainlist){
            domain.setAction(action_id);
        }
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'UPDATE')")
    @ApiOperation(value = "根据项目系统日志批量更新操作历史", tags = {"操作历史" },  notes = "根据项目系统日志批量更新操作历史")
	@RequestMapping(method = RequestMethod.PUT, value = "/projects/{project_id}/actions/{action_id}/histories/batch")
    public ResponseEntity<Boolean> updateBatchByProjectAction(@PathVariable("project_id") Long project_id, @PathVariable("action_id") Long action_id, @RequestBody List<HistoryDTO> historydtos) {
        List<History> domainlist=historyMapping.toDomain(historydtos);
        for(History domain:domainlist){
            domain.setAction(action_id);
        }
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'DELETE')")
    @ApiOperation(value = "根据项目系统日志批量删除操作历史", tags = {"操作历史" },  notes = "根据项目系统日志批量删除操作历史")
	@RequestMapping(method = RequestMethod.DELETE, value = "/projects/{project_id}/actions/{action_id}/histories/batch")
    public ResponseEntity<Boolean> removeBatchByProjectAction(@RequestBody List<Long> ids) {
        historyService.removeBatch(ids);
        return  ResponseEntity.status(HttpStatus.OK).body(true);
    }
    ...
    @ApiOperation(value = "根据项目系统日志批量保存操作历史", tags = {"操作历史" },  notes = "根据项目系统日志批量保存操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/projects/{project_id}/actions/{action_id}/histories/savebatch")
    public ResponseEntity<Boolean> saveBatchByProjectAction(@PathVariable("project_id") Long project_id, @PathVariable("action_id") Long action_id, @RequestBody List<HistoryDTO> historydtos) {
        List<History> domainlist=historyMapping.toDomain(historydtos);
        for(History domain:domainlist){
             domain.setAction(action_id);
        }
