...
public class TaskResource {
    ...
    @PreAuthorize("@TaskModelImpl.test(#task_id,'CREATE')")
    ...
    @PreAuthorize("@TaskModelImpl.test(#task_id,'UPDATE')")
    ...
    @PreAuthorize("@TaskModelImpl.test(#task_id,'DELETE')")
    ...
    @PreAuthorize("@TaskModelImpl.test(#task_id,'READ')")
