...
public class TaskResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-RecordTimZeroLeftAfterContinue-all')")
    @ApiOperation(value = "继续后剩余工时为0", tags = {"任务" },  notes = "继续后剩余工时为0")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-RecordTimZeroLeftAfterContinue-all')")
    @ApiOperation(value = "批量处理[继续后剩余工时为0]", tags = {"任务" },  notes = "批量处理[继续后剩余工时为0]")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-RecordTimateZeroLeftAfterStart-all')")
    @ApiOperation(value = "开始后剩余工时为0", tags = {"任务" },  notes = "开始后剩余工时为0")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-RecordTimateZeroLeftAfterStart-all')")
    @ApiOperation(value = "批量处理[开始后剩余工时为0]", tags = {"任务" },  notes = "批量处理[开始后剩余工时为0]")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "获取指派给我任务（EE）", tags = {"任务" } ,notes = "获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchAssignedToMyTaskEE(TaskSearchContext context) {
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "查询指派给我任务（EE）", tags = {"任务" } ,notes = "查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchAssignedToMyTaskEE(@RequestBody TaskSearchContext context) {
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "获取通过模块查询（聚微）", tags = {"任务" } ,notes = "获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchByModuleEE(TaskSearchContext context) {
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "查询通过模块查询（聚微）", tags = {"任务" } ,notes = "查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchByModuleEE(@RequestBody TaskSearchContext context) {
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefault-all')")
	@ApiOperation(value = "获取数据查询（子任务）", tags = {"任务" } ,notes = "获取数据查询（子任务）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchChildDefault(TaskSearchContext context) {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchChildDefaultMore(TaskSearchContext context) {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "获取我相关的任务（聚微）", tags = {"任务" } ,notes = "获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchMyAllTaskEE(TaskSearchContext context) {
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "查询我相关的任务（聚微）", tags = {"任务" } ,notes = "查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchMyAllTaskEE(@RequestBody TaskSearchContext context) {
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "获取我的任务", tags = {"任务" } ,notes = "获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchMyProjectTask(TaskSearchContext context) {
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "查询我的任务", tags = {"任务" } ,notes = "查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchMyProjectTask(@RequestBody TaskSearchContext context) {
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "获取人员任务", tags = {"任务" } ,notes = "获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchPersonnalTasks(TaskSearchContext context) {
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "查询人员任务", tags = {"任务" } ,notes = "查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchPersonnalTasks(@RequestBody TaskSearchContext context) {
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "获取项目成员任务", tags = {"任务" } ,notes = "获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchProjectMemberTask(TaskSearchContext context) {
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "查询项目成员任务", tags = {"任务" } ,notes = "查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchProjectMemberTask(@RequestBody TaskSearchContext context) {
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "获取项目任务（聚微）", tags = {"任务" } ,notes = "获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchProjectTaskEE(TaskSearchContext context) {
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "查询项目任务（聚微）", tags = {"任务" } ,notes = "查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchProjectTaskEE(@RequestBody TaskSearchContext context) {
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据任务模块获取指派给我任务（EE）", tags = {"任务" } ,notes = "根据任务模块获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskAssignedToMyTaskEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据任务模块查询指派给我任务（EE）", tags = {"任务" } ,notes = "根据任务模块查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskAssignedToMyTaskEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据任务模块获取通过模块查询（聚微）", tags = {"任务" } ,notes = "根据任务模块获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchTaskByModuleEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据任务模块查询通过模块查询（聚微）", tags = {"任务" } ,notes = "根据任务模块查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchTaskByModuleEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchChildDefault(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据任务模块获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据任务模块获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultMoreByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchChildDefaultMore(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据任务模块查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据任务模块查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据任务模块获取我相关的任务（聚微）", tags = {"任务" } ,notes = "根据任务模块获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyAllTaskEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据任务模块查询我相关的任务（聚微）", tags = {"任务" } ,notes = "根据任务模块查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyAllTaskEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据任务模块获取我的任务", tags = {"任务" } ,notes = "根据任务模块获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyProjectTaskByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据任务模块查询我的任务", tags = {"任务" } ,notes = "根据任务模块查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyProjectTaskByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据任务模块获取人员任务", tags = {"任务" } ,notes = "根据任务模块获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchTaskPersonnalTasksByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据任务模块查询人员任务", tags = {"任务" } ,notes = "根据任务模块查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchTaskPersonnalTasksByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据任务模块获取项目成员任务", tags = {"任务" } ,notes = "根据任务模块获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectMemberTaskByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据任务模块查询项目成员任务", tags = {"任务" } ,notes = "根据任务模块查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectMemberTaskByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据任务模块获取项目任务（聚微）", tags = {"任务" } ,notes = "根据任务模块获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectTaskEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据任务模块查询项目任务（聚微）", tags = {"任务" } ,notes = "根据任务模块查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectTaskEEByProjectModule(@PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据产品计划获取指派给我任务（EE）", tags = {"任务" } ,notes = "根据产品计划获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskAssignedToMyTaskEEByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据产品计划查询指派给我任务（EE）", tags = {"任务" } ,notes = "根据产品计划查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskAssignedToMyTaskEEByProductPlan(@PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据产品计划获取通过模块查询（聚微）", tags = {"任务" } ,notes = "根据产品计划获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchTaskByModuleEEByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据产品计划查询通过模块查询（聚微）", tags = {"任务" } ,notes = "根据产品计划查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchTaskByModuleEEByProductPlan(@PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchChildDefault(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据产品计划获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据产品计划获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultMoreByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchChildDefaultMore(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据产品计划查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据产品计划查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据产品计划获取我相关的任务（聚微）", tags = {"任务" } ,notes = "根据产品计划获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyAllTaskEEByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据产品计划查询我相关的任务（聚微）", tags = {"任务" } ,notes = "根据产品计划查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyAllTaskEEByProductPlan(@PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据产品计划获取我的任务", tags = {"任务" } ,notes = "根据产品计划获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyProjectTaskByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据产品计划查询我的任务", tags = {"任务" } ,notes = "根据产品计划查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyProjectTaskByProductPlan(@PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据产品计划获取人员任务", tags = {"任务" } ,notes = "根据产品计划获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchTaskPersonnalTasksByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据产品计划查询人员任务", tags = {"任务" } ,notes = "根据产品计划查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchTaskPersonnalTasksByProductPlan(@PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据产品计划获取项目成员任务", tags = {"任务" } ,notes = "根据产品计划获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectMemberTaskByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据产品计划查询项目成员任务", tags = {"任务" } ,notes = "根据产品计划查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectMemberTaskByProductPlan(@PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据产品计划获取项目任务（聚微）", tags = {"任务" } ,notes = "根据产品计划获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectTaskEEByProductPlan(@PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据产品计划查询项目任务（聚微）", tags = {"任务" } ,notes = "根据产品计划查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectTaskEEByProductPlan(@PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据需求获取指派给我任务（EE）", tags = {"任务" } ,notes = "根据需求获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskAssignedToMyTaskEEByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据需求查询指派给我任务（EE）", tags = {"任务" } ,notes = "根据需求查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskAssignedToMyTaskEEByStory(@PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据需求获取通过模块查询（聚微）", tags = {"任务" } ,notes = "根据需求获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchTaskByModuleEEByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据需求查询通过模块查询（聚微）", tags = {"任务" } ,notes = "根据需求查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchTaskByModuleEEByStory(@PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchChildDefault(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据需求获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据需求获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultMoreByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchChildDefaultMore(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据需求查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据需求查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据需求获取我相关的任务（聚微）", tags = {"任务" } ,notes = "根据需求获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyAllTaskEEByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据需求查询我相关的任务（聚微）", tags = {"任务" } ,notes = "根据需求查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyAllTaskEEByStory(@PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据需求获取我的任务", tags = {"任务" } ,notes = "根据需求获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyProjectTaskByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据需求查询我的任务", tags = {"任务" } ,notes = "根据需求查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyProjectTaskByStory(@PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据需求获取人员任务", tags = {"任务" } ,notes = "根据需求获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchTaskPersonnalTasksByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据需求查询人员任务", tags = {"任务" } ,notes = "根据需求查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchTaskPersonnalTasksByStory(@PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据需求获取项目成员任务", tags = {"任务" } ,notes = "根据需求获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectMemberTaskByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据需求查询项目成员任务", tags = {"任务" } ,notes = "根据需求查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectMemberTaskByStory(@PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据需求获取项目任务（聚微）", tags = {"任务" } ,notes = "根据需求获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectTaskEEByStory(@PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据需求查询项目任务（聚微）", tags = {"任务" } ,notes = "根据需求查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectTaskEEByStory(@PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据项目获取指派给我任务（EE）", tags = {"任务" } ,notes = "根据项目获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskAssignedToMyTaskEEByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据项目查询指派给我任务（EE）", tags = {"任务" } ,notes = "根据项目查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskAssignedToMyTaskEEByProject(@PathVariable("project_id") Long project_id, @RequestBody TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据项目获取通过模块查询（聚微）", tags = {"任务" } ,notes = "根据项目获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchTaskByModuleEEByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据项目查询通过模块查询（聚微）", tags = {"任务" } ,notes = "根据项目查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchTaskByModuleEEByProject(@PathVariable("project_id") Long project_id, @RequestBody TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchChildDefault(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据项目获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据项目获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultMoreByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchChildDefaultMore(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据项目查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据项目查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据项目获取我相关的任务（聚微）", tags = {"任务" } ,notes = "根据项目获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyAllTaskEEByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据项目查询我相关的任务（聚微）", tags = {"任务" } ,notes = "根据项目查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyAllTaskEEByProject(@PathVariable("project_id") Long project_id, @RequestBody TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据项目获取我的任务", tags = {"任务" } ,notes = "根据项目获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyProjectTaskByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据项目查询我的任务", tags = {"任务" } ,notes = "根据项目查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyProjectTaskByProject(@PathVariable("project_id") Long project_id, @RequestBody TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据项目获取人员任务", tags = {"任务" } ,notes = "根据项目获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchTaskPersonnalTasksByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据项目查询人员任务", tags = {"任务" } ,notes = "根据项目查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchTaskPersonnalTasksByProject(@PathVariable("project_id") Long project_id, @RequestBody TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据项目获取项目成员任务", tags = {"任务" } ,notes = "根据项目获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectMemberTaskByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据项目查询项目成员任务", tags = {"任务" } ,notes = "根据项目查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectMemberTaskByProject(@PathVariable("project_id") Long project_id, @RequestBody TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据项目获取项目任务（聚微）", tags = {"任务" } ,notes = "根据项目获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectTaskEEByProject(@PathVariable("project_id") Long project_id,TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据项目查询项目任务（聚微）", tags = {"任务" } ,notes = "根据项目查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectTaskEEByProject(@PathVariable("project_id") Long project_id, @RequestBody TaskSearchContext context) {
        context.setN_project_eq(project_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据产品产品计划获取指派给我任务（EE）", tags = {"任务" } ,notes = "根据产品产品计划获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskAssignedToMyTaskEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据产品产品计划查询指派给我任务（EE）", tags = {"任务" } ,notes = "根据产品产品计划查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskAssignedToMyTaskEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据产品产品计划获取通过模块查询（聚微）", tags = {"任务" } ,notes = "根据产品产品计划获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchTaskByModuleEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据产品产品计划查询通过模块查询（聚微）", tags = {"任务" } ,notes = "根据产品产品计划查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchTaskByModuleEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchChildDefault(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据产品产品计划获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据产品产品计划获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultMoreByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchChildDefaultMore(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据产品产品计划查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据产品产品计划查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据产品产品计划获取我相关的任务（聚微）", tags = {"任务" } ,notes = "根据产品产品计划获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyAllTaskEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据产品产品计划查询我相关的任务（聚微）", tags = {"任务" } ,notes = "根据产品产品计划查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyAllTaskEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据产品产品计划获取我的任务", tags = {"任务" } ,notes = "根据产品产品计划获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyProjectTaskByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据产品产品计划查询我的任务", tags = {"任务" } ,notes = "根据产品产品计划查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyProjectTaskByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据产品产品计划获取人员任务", tags = {"任务" } ,notes = "根据产品产品计划获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchTaskPersonnalTasksByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据产品产品计划查询人员任务", tags = {"任务" } ,notes = "根据产品产品计划查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchTaskPersonnalTasksByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据产品产品计划获取项目成员任务", tags = {"任务" } ,notes = "根据产品产品计划获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectMemberTaskByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据产品产品计划查询项目成员任务", tags = {"任务" } ,notes = "根据产品产品计划查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectMemberTaskByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据产品产品计划获取项目任务（聚微）", tags = {"任务" } ,notes = "根据产品产品计划获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectTaskEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id,TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据产品产品计划查询项目任务（聚微）", tags = {"任务" } ,notes = "根据产品产品计划查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectTaskEEByProductProductPlan(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @RequestBody TaskSearchContext context) {
        context.setN_plan_eq(productplan_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据产品需求获取指派给我任务（EE）", tags = {"任务" } ,notes = "根据产品需求获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskAssignedToMyTaskEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据产品需求查询指派给我任务（EE）", tags = {"任务" } ,notes = "根据产品需求查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskAssignedToMyTaskEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据产品需求获取通过模块查询（聚微）", tags = {"任务" } ,notes = "根据产品需求获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchTaskByModuleEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据产品需求查询通过模块查询（聚微）", tags = {"任务" } ,notes = "根据产品需求查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchTaskByModuleEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchChildDefault(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据产品需求获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据产品需求获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultMoreByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchChildDefaultMore(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据产品需求查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据产品需求查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据产品需求获取我相关的任务（聚微）", tags = {"任务" } ,notes = "根据产品需求获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyAllTaskEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据产品需求查询我相关的任务（聚微）", tags = {"任务" } ,notes = "根据产品需求查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyAllTaskEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据产品需求获取我的任务", tags = {"任务" } ,notes = "根据产品需求获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyProjectTaskByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据产品需求查询我的任务", tags = {"任务" } ,notes = "根据产品需求查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyProjectTaskByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据产品需求获取人员任务", tags = {"任务" } ,notes = "根据产品需求获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchTaskPersonnalTasksByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据产品需求查询人员任务", tags = {"任务" } ,notes = "根据产品需求查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchTaskPersonnalTasksByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据产品需求获取项目成员任务", tags = {"任务" } ,notes = "根据产品需求获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectMemberTaskByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据产品需求查询项目成员任务", tags = {"任务" } ,notes = "根据产品需求查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectMemberTaskByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据产品需求获取项目任务（聚微）", tags = {"任务" } ,notes = "根据产品需求获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectTaskEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id,TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据产品需求查询项目任务（聚微）", tags = {"任务" } ,notes = "根据产品需求查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectTaskEEByProductStory(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @RequestBody TaskSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据项目任务模块获取指派给我任务（EE）", tags = {"任务" } ,notes = "根据项目任务模块获取指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchassignedtomytaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskAssignedToMyTaskEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskEE-all')")
	@ApiOperation(value = "根据项目任务模块查询指派给我任务（EE）", tags = {"任务" } ,notes = "根据项目任务模块查询指派给我任务（EE）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchassignedtomytaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskAssignedToMyTaskEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据项目任务模块获取通过模块查询（聚微）", tags = {"任务" } ,notes = "根据项目任务模块获取通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchbymoduleee")
	public ResponseEntity<List<TaskDTO>> fetchTaskByModuleEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModuleEE-all')")
	@ApiOperation(value = "根据项目任务模块查询通过模块查询（聚微）", tags = {"任务" } ,notes = "根据项目任务模块查询通过模块查询（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchbymoduleee")
	public ResponseEntity<Page<TaskDTO>> searchTaskByModuleEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchByModuleEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchchilddefault")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchChildDefault(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据项目任务模块获取数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据项目任务模块获取数据查询（子任务）（更多）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchchilddefaultmore")
	public ResponseEntity<List<TaskDTO>> fetchTaskChildDefaultMoreByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchChildDefaultMore(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildDefaultMore-all')")
	@ApiOperation(value = "根据项目任务模块查询数据查询（子任务）（更多）", tags = {"任务" } ,notes = "根据项目任务模块查询数据查询（子任务）（更多）")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据项目任务模块获取我相关的任务（聚微）", tags = {"任务" } ,notes = "根据项目任务模块获取我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchmyalltaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyAllTaskEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAllTaskEE-all')")
	@ApiOperation(value = "根据项目任务模块查询我相关的任务（聚微）", tags = {"任务" } ,notes = "根据项目任务模块查询我相关的任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchmyalltaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyAllTaskEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyAllTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据项目任务模块获取我的任务", tags = {"任务" } ,notes = "根据项目任务模块获取我的任务")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchmyprojecttask")
	public ResponseEntity<List<TaskDTO>> fetchTaskMyProjectTaskByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyProjectTask-all')")
	@ApiOperation(value = "根据项目任务模块查询我的任务", tags = {"任务" } ,notes = "根据项目任务模块查询我的任务")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchmyprojecttask")
	public ResponseEntity<Page<TaskDTO>> searchTaskMyProjectTaskByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchMyProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据项目任务模块获取人员任务", tags = {"任务" } ,notes = "根据项目任务模块获取人员任务")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchpersonnaltasks")
	public ResponseEntity<List<TaskDTO>> fetchTaskPersonnalTasksByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchPersonnalTasks-all')")
	@ApiOperation(value = "根据项目任务模块查询人员任务", tags = {"任务" } ,notes = "根据项目任务模块查询人员任务")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchpersonnaltasks")
	public ResponseEntity<Page<TaskDTO>> searchTaskPersonnalTasksByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchPersonnalTasks(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据项目任务模块获取项目成员任务", tags = {"任务" } ,notes = "根据项目任务模块获取项目成员任务")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchprojectmembertask")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectMemberTaskByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectMemberTask-all')")
	@ApiOperation(value = "根据项目任务模块查询项目成员任务", tags = {"任务" } ,notes = "根据项目任务模块查询项目成员任务")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchprojectmembertask")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectMemberTaskByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectMemberTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据项目任务模块获取项目任务（聚微）", tags = {"任务" } ,notes = "根据项目任务模块获取项目任务（聚微）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/fetchprojecttaskee")
	public ResponseEntity<List<TaskDTO>> fetchTaskProjectTaskEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id,TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
        List<TaskDTO> list = taskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTaskEE-all')")
	@ApiOperation(value = "根据项目任务模块查询项目任务（聚微）", tags = {"任务" } ,notes = "根据项目任务模块查询项目任务（聚微）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/searchprojecttaskee")
	public ResponseEntity<Page<TaskDTO>> searchTaskProjectTaskEEByProjectProjectModule(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @RequestBody TaskSearchContext context) {
        context.setN_module_eq(projectmodule_id);
        Page<Task> domains = taskService.searchProjectTaskEE(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
