...
public class IbizproProjectMonthlyResource {
    ...
    @PreAuthorize("test('IBIZPRO_PROJECTMONTHLY', #ibizproprojectmonthly_id, 'NONE')")
    ...
    @PreAuthorize("test('IBIZPRO_PROJECTMONTHLY', #ibizproprojectmonthly_id, 'DELETE')")
    ...
    @PreAuthorize("quickTest('IBIZPRO_PROJECTMONTHLY', 'DELETE')")
    ...
    @PreAuthorize("test('IBIZPRO_PROJECTMONTHLY', #ibizproprojectmonthly_id, 'UPDATE')")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/ibizproprojectmonthlies/report/{report_id}.{type}")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/ibizproprojectmonthlies/{ibizproprojectmonthly_ids}/print/{print_id}.{type}")
    public void print(@PathVariable("ibizproprojectmonthly_ids") Set<String> ibizproprojectmonthly_ids, @PathVariable("print_id") String print_id, @PathVariable("type") String type, HttpServletResponse response) {
        ...
        try {
            ...
            for (String ibizproprojectmonthly_id : ibizproprojectmonthly_ids) {
                domains.add(ibizproprojectmonthlyService.get( ibizproprojectmonthly_id));
            }
            ...
            throw new DataEntityRuntimeException(String.format("打印数据[%s]发生错误：%s", ibizproprojectmonthly_ids, e.getMessage()), Errors.INTERNALERROR, ibizproprojectmonthlyRuntime);
        }
    }
