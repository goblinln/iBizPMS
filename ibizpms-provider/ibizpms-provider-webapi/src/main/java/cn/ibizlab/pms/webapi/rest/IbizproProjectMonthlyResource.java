...
import cn.ibizlab.pms.core.ibizpro.model.impl.IbizproProjectMonthlyModelImpl;
...
public class IbizproProjectMonthlyResource {
    ...
    @Autowired
    public IbizproProjectMonthlyModelImpl ibizproprojectmonthlyModelImpl;

    @Autowired
    @Lazy
    public IbizproProjectMonthlyMapping ibizproprojectmonthlyMapping;

    @PreAuthorize("@IbizproProjectMonthlyModelImpl.test(#ibizproprojectmonthly_id,'CREATE')")
    ...
    @PreAuthorize("@IbizproProjectMonthlyModelImpl.test(#ibizproprojectmonthly_id,'UPDATE')")
    ...
    @PreAuthorize("@IbizproProjectMonthlyModelImpl.test(#ibizproprojectmonthly_id,'DELETE')")
    ...
    @PreAuthorize("@IbizproProjectMonthlyModelImpl.test(#ibizproprojectmonthly_id,'READ')")
    ...
    @PreAuthorize("@IbizproProjectMonthlyModelImpl.test('READ')")
	...
	public ResponseEntity<List<IbizproProjectMonthlyDTO>> fetchDefault(IbizproProjectMonthlySearchContext context) {
        ibizproprojectmonthlyModelImpl.addAuthorityConditions(context,"READ");
