...
public class TestTaskResource {
    ...
    @PreAuthorize("@TestTaskModelImpl.test(#testtask_id,'CREATE')")
    ...
    @PreAuthorize("@TestTaskModelImpl.test(#testtask_id,'UPDATE')")
    ...
    @PreAuthorize("@TestTaskModelImpl.test(#testtask_id,'DELETE')")
    ...
    @PreAuthorize("@TestTaskModelImpl.test(#testtask_id,'READ')")
    ...
    @PreAuthorize("@TestTaskModelImpl.test('READ')")
