...
public class TestTaskResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestTask-Create-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestTask-Update-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestTask-Remove-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestTask-Get-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestTask-Save-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestTask-searchDefault-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestTask-searchMyTestTaskPc-all')")
