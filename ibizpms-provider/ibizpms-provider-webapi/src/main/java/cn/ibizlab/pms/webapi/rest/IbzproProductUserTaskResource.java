...
import cn.ibizlab.pms.core.ibizpro.model.impl.IbzproProductUserTaskModelImpl;
...
public class IbzproProductUserTaskResource {
    ...
    @Autowired
    public IbzproProductUserTaskModelImpl ibzproproductusertaskModelImpl;

    @Autowired
    @Lazy
    public IbzproProductUserTaskMapping ibzproproductusertaskMapping;

    @PreAuthorize("@IbzproProductUserTaskModelImpl.test(#ibzproproductusertask_id,'CREATE')")
    ...
    @PreAuthorize("@IbzproProductUserTaskModelImpl.test(#ibzproproductusertask_id,'UPDATE')")
    ...
    @PreAuthorize("@IbzproProductUserTaskModelImpl.test(#ibzproproductusertask_id,'DELETE')")
    ...
    @PreAuthorize("@IbzproProductUserTaskModelImpl.test(#ibzproproductusertask_id,'READ')")
    ...
    @PreAuthorize("@IbzproProductUserTaskModelImpl.test('READ')")
	...
	public ResponseEntity<List<IbzproProductUserTaskDTO>> fetchDefault(IbzproProductUserTaskSearchContext context) {
        ibzproproductusertaskModelImpl.addAuthorityConditions(context,"READ");
