...
import cn.ibizlab.pms.core.report.model.impl.IbzDailyModelImpl;
...
public class IbzDailyResource {
    ...
    @Autowired
    public IbzDailyModelImpl ibzdailyModelImpl;

    @Autowired
    @Lazy
    public IbzDailyMapping ibzdailyMapping;

    @PreAuthorize("@IbzDailyModelImpl.test(#ibzdaily_id,'CREATE')")
    ...
    @PreAuthorize("@IbzDailyModelImpl.test(#ibzdaily_id,'UPDATE')")
    ...
    @PreAuthorize("@IbzDailyModelImpl.test(#ibzdaily_id,'DELETE')")
    ...
    @PreAuthorize("@IbzDailyModelImpl.test(#ibzdaily_id,'READ')")
    ...
    @PreAuthorize("@IbzDailyModelImpl.test('READ')")
	...
	public ResponseEntity<List<IbzDailyDTO>> fetchDefault(IbzDailySearchContext context) {
        ibzdailyModelImpl.addAuthorityConditions(context,"READ");
