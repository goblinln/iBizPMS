...
public class SysEmployeeResource {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/sysemployees/report/{report_id}.{type}")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/sysemployees/{sysemployee_ids}/print/{print_id}.{type}")
    public void print(@PathVariable("sysemployee_ids") Set<String> sysemployee_ids, @PathVariable("print_id") String print_id, @PathVariable("type") String type, HttpServletResponse response) {
    }
