...
public class TestResultResource {
    ...
    @PreAuthorize("hasPermission(this.testresultMapping.toDomain(#testresultdto),'iBizPMS-TestResult-Create')")
    ...
    @PreAuthorize("hasPermission(this.testresultMapping.toDomain(#testresultdtos),'iBizPMS-TestResult-Create')")
    ...
    @PreAuthorize("hasPermission(this.testresultService.get(#testresult_id),'iBizPMS-TestResult-Update')")
    ...
    @PreAuthorize("hasPermission(this.testresultService.getTestresultByEntities(this.testresultMapping.toDomain(#testresultdtos)),'iBizPMS-TestResult-Update')")
    ...
    @PreAuthorize("hasPermission(this.testresultService.get(#testresult_id),'iBizPMS-TestResult-Remove')")
    ...
    @PreAuthorize("hasPermission(this.testresultService.getTestresultByIds(#ids),'iBizPMS-TestResult-Remove')")
    ...
    @PostAuthorize("hasPermission(this.testresultMapping.toDomain(returnObject.body),'iBizPMS-TestResult-Get')")
    ...
    @PreAuthorize("hasPermission(this.testresultMapping.toDomain(#testresultdto),'iBizPMS-TestResult-Save')")
    ...
    @PreAuthorize("hasPermission(this.testresultMapping.toDomain(#testresultdtos),'iBizPMS-TestResult-Save')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestResult-searchCurTestRun-all') and hasPermission(#context,'iBizPMS-TestResult-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-TestResult-searchDefault-all') and hasPermission(#context,'iBizPMS-TestResult-Get')")
