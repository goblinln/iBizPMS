...
public class TaskTeamResource {
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_TASK', #task_id, 'CREATE', 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_TASK', #task_id, 'UPDATE', #taskteam_id, 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_TASK', #task_id, 'DELETE', #taskteam_id, 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_TASK', #task_id, 'DELETE', 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_TASK', #task_id, 'READ', #taskteam_id, 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_TASK', #task_id, 'READ', 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_PROJECT', #project_id, 'TASKMANAGE', 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_PROJECT', #project_id, 'TASKMANAGE', #taskteam_id, 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_PROJECT', #project_id, 'READ', #taskteam_id, 'DENY')")
    ...
    @PreAuthorize("test('IBZ_TASKTEAM', 'ZT_PROJECT', #project_id, 'READ', 'DENY')")
