...
public class SysRoleResource {
    ...
    @ApiOperation(value = "生成系统角色报表", tags = {"系统角色"}, notes = "生成系统角色报表")
    @RequestMapping(method = RequestMethod.GET, value = "/sysroles/report/{report_id}.{type}")
    public void report(@PathVariable("report_id") String report_id, @PathVariable("type") String type, SysRoleSearchContext context, HttpServletResponse response) {
    }

    @ApiOperation(value = "打印系统角色", tags = {"系统角色"}, notes = "打印系统角色")
    @RequestMapping(method = RequestMethod.GET, value = "/sysroles/{sysrole_ids}/print/{print_id}.{type}")
    public void print(@PathVariable("sysrole_ids") Set<String> sysrole_ids, @PathVariable("print_id") String print_id, @PathVariable("type") String type, HttpServletResponse response) {
    }
