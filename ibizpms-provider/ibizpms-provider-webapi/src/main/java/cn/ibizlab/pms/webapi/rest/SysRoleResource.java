...
public class SysRoleResource {
    ...
    @PreAuthorize("hasPermission(this.sysroleMapping.toDomain(#sysroledto),'pms-SysRole-Create')")
    ...
    @PreAuthorize("hasPermission(this.sysroleMapping.toDomain(#sysroledtos),'pms-SysRole-Create')")
    ...
    @PostAuthorize("hasPermission(this.sysroleMapping.toDomain(returnObject.body),'pms-SysRole-Get')")
    ...
    @PreAuthorize("hasPermission(this.sysroleService.get(#sysrole_id),'pms-SysRole-Remove')")
    ...
    @PreAuthorize("hasPermission(this.sysroleService.getSysroleByIds(#ids),'pms-SysRole-Remove')")
    ...
    @PreAuthorize("hasPermission(this.sysroleService.get(#sysrole_id),'pms-SysRole-Update')")
    ...
    @PreAuthorize("hasPermission(this.sysroleService.getSysroleByEntities(this.sysroleMapping.toDomain(#sysroledtos)),'pms-SysRole-Update')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-SysRole-searchDefault-all') and hasPermission(#context,'pms-SysRole-Get')")
