...
public class SysTeamMemberResource {
    ...
    @PreAuthorize("@SysTeamMemberModelImpl.test(#systeammember_id,'CREATE')")
    ...
    @PreAuthorize("@SysTeamMemberModelImpl.test(#systeammember_id,'UPDATE')")
    ...
    @PreAuthorize("@SysTeamMemberModelImpl.test(#systeammember_id,'DELETE')")
    ...
    @PreAuthorize("@SysTeamMemberModelImpl.test(#systeammember_id,'READ')")
    ...
    @PreAuthorize("@SysTeamMemberModelImpl.test('READ')")
