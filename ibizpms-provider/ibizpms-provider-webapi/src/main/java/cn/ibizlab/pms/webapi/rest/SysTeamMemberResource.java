...
public class SysTeamMemberResource {
    ...
    @ApiOperation(value = "生成组成员报表", tags = {"组成员"}, notes = "生成组成员报表")
    @RequestMapping(method = RequestMethod.GET, value = "/systeammembers/report/{report_id}.{type}")
    public void report(@PathVariable("report_id") String report_id, @PathVariable("type") String type, SysTeamMemberSearchContext context, HttpServletResponse response) {
    }

    @ApiOperation(value = "打印组成员", tags = {"组成员"}, notes = "打印组成员")
    @RequestMapping(method = RequestMethod.GET, value = "/systeammembers/{systeammember_ids}/print/{print_id}.{type}")
    public void print(@PathVariable("systeammember_ids") Set<String> systeammember_ids, @PathVariable("print_id") String print_id, @PathVariable("type") String type, HttpServletResponse response) {
    }
