...
public class TaskEstimateResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "获取日志日", tags = {"任务预计" } ,notes = "获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchActionDate(TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "查询日志日", tags = {"任务预计" } ,notes = "查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchActionDate(@RequestBody TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "获取日志日（项目）", tags = {"任务预计" } ,notes = "获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchActionDateByProject(TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "查询日志日（项目）", tags = {"任务预计" } ,notes = "查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchActionDateByProject(@RequestBody TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "获取所有人员", tags = {"任务预计" } ,notes = "获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchAllAccounts(TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "查询所有人员", tags = {"任务预计" } ,notes = "查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchAllAccounts(@RequestBody TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "获取所有项目", tags = {"任务预计" } ,notes = "获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchAllProjects(TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "查询所有项目", tags = {"任务预计" } ,notes = "查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchAllProjects(@RequestBody TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "获取我管辖的所有人员", tags = {"任务预计" } ,notes = "获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchMyAccounts(TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "查询我管辖的所有人员", tags = {"任务预计" } ,notes = "查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchMyAccounts(@RequestBody TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "获取日志日（我的）", tags = {"任务预计" } ,notes = "获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchMyActionDate(TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "查询日志日（我的）", tags = {"任务预计" } ,notes = "查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchMyActionDate(@RequestBody TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "获取人员日志", tags = {"任务预计" } ,notes = "获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchPersonalEstimate(TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
        return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
                .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "查询人员日志", tags = {"任务预计" } ,notes = "查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchPersonalEstimate(@RequestBody TaskEstimateSearchContext context) {
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据任务获取日志日", tags = {"任务预计" } ,notes = "根据任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByTask(@PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据任务查询日志日", tags = {"任务预计" } ,notes = "根据任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByTask(@PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByTask(@PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByTask(@PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据任务获取所有人员", tags = {"任务预计" } ,notes = "根据任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByTask(@PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据任务查询所有人员", tags = {"任务预计" } ,notes = "根据任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByTask(@PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据任务获取所有项目", tags = {"任务预计" } ,notes = "根据任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByTask(@PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据任务查询所有项目", tags = {"任务预计" } ,notes = "根据任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByTask(@PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByTask(@PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByTask(@PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByTask(@PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByTask(@PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据任务获取人员日志", tags = {"任务预计" } ,notes = "根据任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByTask(@PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据任务查询人员日志", tags = {"任务预计" } ,notes = "根据任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByTask(@PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据任务模块任务获取日志日", tags = {"任务预计" } ,notes = "根据任务模块任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据任务模块任务查询日志日", tags = {"任务预计" } ,notes = "根据任务模块任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据任务模块任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据任务模块任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据任务模块任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据任务模块任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据任务模块任务获取所有人员", tags = {"任务预计" } ,notes = "根据任务模块任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据任务模块任务查询所有人员", tags = {"任务预计" } ,notes = "根据任务模块任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据任务模块任务获取所有项目", tags = {"任务预计" } ,notes = "根据任务模块任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据任务模块任务查询所有项目", tags = {"任务预计" } ,notes = "根据任务模块任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据任务模块任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据任务模块任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据任务模块任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据任务模块任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据任务模块任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据任务模块任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据任务模块任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据任务模块任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据任务模块任务获取人员日志", tags = {"任务预计" } ,notes = "根据任务模块任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据任务模块任务查询人员日志", tags = {"任务预计" } ,notes = "根据任务模块任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据产品计划任务获取日志日", tags = {"任务预计" } ,notes = "根据产品计划任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据产品计划任务查询日志日", tags = {"任务预计" } ,notes = "根据产品计划任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据产品计划任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据产品计划任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据产品计划任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据产品计划任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据产品计划任务获取所有人员", tags = {"任务预计" } ,notes = "根据产品计划任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据产品计划任务查询所有人员", tags = {"任务预计" } ,notes = "根据产品计划任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据产品计划任务获取所有项目", tags = {"任务预计" } ,notes = "根据产品计划任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据产品计划任务查询所有项目", tags = {"任务预计" } ,notes = "根据产品计划任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据产品计划任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据产品计划任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据产品计划任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据产品计划任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据产品计划任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据产品计划任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据产品计划任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据产品计划任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据产品计划任务获取人员日志", tags = {"任务预计" } ,notes = "根据产品计划任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据产品计划任务查询人员日志", tags = {"任务预计" } ,notes = "根据产品计划任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByProductPlanTask(@PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据需求任务获取日志日", tags = {"任务预计" } ,notes = "根据需求任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据需求任务查询日志日", tags = {"任务预计" } ,notes = "根据需求任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据需求任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据需求任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据需求任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据需求任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据需求任务获取所有人员", tags = {"任务预计" } ,notes = "根据需求任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据需求任务查询所有人员", tags = {"任务预计" } ,notes = "根据需求任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据需求任务获取所有项目", tags = {"任务预计" } ,notes = "根据需求任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据需求任务查询所有项目", tags = {"任务预计" } ,notes = "根据需求任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据需求任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据需求任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据需求任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据需求任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据需求任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据需求任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据需求任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据需求任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据需求任务获取人员日志", tags = {"任务预计" } ,notes = "根据需求任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/stories/{story_id}/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据需求任务查询人员日志", tags = {"任务预计" } ,notes = "根据需求任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByStoryTask(@PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据项目任务获取日志日", tags = {"任务预计" } ,notes = "根据项目任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据项目任务查询日志日", tags = {"任务预计" } ,notes = "根据项目任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据项目任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据项目任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据项目任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据项目任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据项目任务获取所有人员", tags = {"任务预计" } ,notes = "根据项目任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据项目任务查询所有人员", tags = {"任务预计" } ,notes = "根据项目任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据项目任务获取所有项目", tags = {"任务预计" } ,notes = "根据项目任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据项目任务查询所有项目", tags = {"任务预计" } ,notes = "根据项目任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据项目任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据项目任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据项目任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据项目任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据项目任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据项目任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据项目任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据项目任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据项目任务获取人员日志", tags = {"任务预计" } ,notes = "根据项目任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据项目任务查询人员日志", tags = {"任务预计" } ,notes = "根据项目任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByProjectTask(@PathVariable("project_id") Long project_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据产品产品计划任务获取日志日", tags = {"任务预计" } ,notes = "根据产品产品计划任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据产品产品计划任务查询日志日", tags = {"任务预计" } ,notes = "根据产品产品计划任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据产品产品计划任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据产品产品计划任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据产品产品计划任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据产品产品计划任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据产品产品计划任务获取所有人员", tags = {"任务预计" } ,notes = "根据产品产品计划任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据产品产品计划任务查询所有人员", tags = {"任务预计" } ,notes = "根据产品产品计划任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据产品产品计划任务获取所有项目", tags = {"任务预计" } ,notes = "根据产品产品计划任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据产品产品计划任务查询所有项目", tags = {"任务预计" } ,notes = "根据产品产品计划任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据产品产品计划任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据产品产品计划任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据产品产品计划任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据产品产品计划任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据产品产品计划任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据产品产品计划任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据产品产品计划任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据产品产品计划任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据产品产品计划任务获取人员日志", tags = {"任务预计" } ,notes = "根据产品产品计划任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据产品产品计划任务查询人员日志", tags = {"任务预计" } ,notes = "根据产品产品计划任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productplans/{productplan_id}/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByProductProductPlanTask(@PathVariable("product_id") Long product_id, @PathVariable("productplan_id") Long productplan_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据产品需求任务获取日志日", tags = {"任务预计" } ,notes = "根据产品需求任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据产品需求任务查询日志日", tags = {"任务预计" } ,notes = "根据产品需求任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据产品需求任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据产品需求任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据产品需求任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据产品需求任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据产品需求任务获取所有人员", tags = {"任务预计" } ,notes = "根据产品需求任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据产品需求任务查询所有人员", tags = {"任务预计" } ,notes = "根据产品需求任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据产品需求任务获取所有项目", tags = {"任务预计" } ,notes = "根据产品需求任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据产品需求任务查询所有项目", tags = {"任务预计" } ,notes = "根据产品需求任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据产品需求任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据产品需求任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据产品需求任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据产品需求任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据产品需求任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据产品需求任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据产品需求任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据产品需求任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据产品需求任务获取人员日志", tags = {"任务预计" } ,notes = "根据产品需求任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据产品需求任务查询人员日志", tags = {"任务预计" } ,notes = "根据产品需求任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByProductStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据项目任务模块任务获取日志日", tags = {"任务预计" } ,notes = "根据项目任务模块任务获取日志日")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDate-all')")
	@ApiOperation(value = "根据项目任务模块任务查询日志日", tags = {"任务预计" } ,notes = "根据项目任务模块任务查询日志日")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据项目任务模块任务获取日志日（项目）", tags = {"任务预计" } ,notes = "根据项目任务模块任务获取日志日（项目）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchactiondatebyproject")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateActionDateByProjectByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchActionDateByProject-all')")
	@ApiOperation(value = "根据项目任务模块任务查询日志日（项目）", tags = {"任务预计" } ,notes = "根据项目任务模块任务查询日志日（项目）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchactiondatebyproject")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateActionDateByProjectByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchActionDateByProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据项目任务模块任务获取所有人员", tags = {"任务预计" } ,notes = "根据项目任务模块任务获取所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchallaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllAccountsByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllAccounts-all')")
	@ApiOperation(value = "根据项目任务模块任务查询所有人员", tags = {"任务预计" } ,notes = "根据项目任务模块任务查询所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchallaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllAccountsByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据项目任务模块任务获取所有项目", tags = {"任务预计" } ,notes = "根据项目任务模块任务获取所有项目")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchallprojects")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateAllProjectsByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchAllProjects-all')")
	@ApiOperation(value = "根据项目任务模块任务查询所有项目", tags = {"任务预计" } ,notes = "根据项目任务模块任务查询所有项目")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchallprojects")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateAllProjectsByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchAllProjects(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据项目任务模块任务获取我管辖的所有人员", tags = {"任务预计" } ,notes = "根据项目任务模块任务获取我管辖的所有人员")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchmyaccounts")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyAccountsByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyAccounts-all')")
	@ApiOperation(value = "根据项目任务模块任务查询我管辖的所有人员", tags = {"任务预计" } ,notes = "根据项目任务模块任务查询我管辖的所有人员")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchmyaccounts")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyAccountsByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyAccounts(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据项目任务模块任务获取日志日（我的）", tags = {"任务预计" } ,notes = "根据项目任务模块任务获取日志日（我的）")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchmyactiondate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimateMyActionDateByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchMyActionDate-all')")
	@ApiOperation(value = "根据项目任务模块任务查询日志日（我的）", tags = {"任务预计" } ,notes = "根据项目任务模块任务查询日志日（我的）")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchmyactiondate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimateMyActionDateByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchMyActionDate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据项目任务模块任务获取人员日志", tags = {"任务预计" } ,notes = "根据项目任务模块任务获取人员日志")
    @RequestMapping(method= RequestMethod.GET , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/fetchpersonalestimate")
	public ResponseEntity<List<TaskEstimateDTO>> fetchTaskEstimatePersonalEstimateByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
        List<TaskEstimateDTO> list = taskestimateMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-TaskEstimate-searchPersonalEstimate-all')")
	@ApiOperation(value = "根据项目任务模块任务查询人员日志", tags = {"任务预计" } ,notes = "根据项目任务模块任务查询人员日志")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/projectmodules/{projectmodule_id}/tasks/{task_id}/taskestimates/searchpersonalestimate")
	public ResponseEntity<Page<TaskEstimateDTO>> searchTaskEstimatePersonalEstimateByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskEstimateSearchContext context) {
        context.setN_task_eq(task_id);
        Page<TaskEstimate> domains = taskestimateService.searchPersonalEstimate(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(taskestimateMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
