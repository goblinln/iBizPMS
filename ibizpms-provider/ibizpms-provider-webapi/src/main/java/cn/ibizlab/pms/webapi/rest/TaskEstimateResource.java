...
public class TaskEstimateResource {
    ...
    @PreAuthorize("@TaskEstimateModelImpl.test(#taskestimate_id,'CREATE')")
    ...
    @PreAuthorize("@TaskEstimateModelImpl.test(#taskestimate_id,'UPDATE')")
    ...
    @PreAuthorize("@TaskEstimateModelImpl.test(#taskestimate_id,'DELETE')")
    ...
    @PreAuthorize("@TaskEstimateModelImpl.test(#taskestimate_id,'READ')")
    ...
    @PreAuthorize("@TaskEstimateModelImpl.test('READ')")
