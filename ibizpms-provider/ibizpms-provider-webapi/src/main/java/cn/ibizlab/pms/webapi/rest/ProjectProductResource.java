...
public class ProjectProductResource {
    ...
    @PreAuthorize("hasPermission(this.projectproductMapping.toDomain(#projectproductdto),'iBizPMS-ProjectProduct-Create')")
    ...
    @PreAuthorize("hasPermission(this.projectproductMapping.toDomain(#projectproductdtos),'iBizPMS-ProjectProduct-Create')")
    ...
    @PreAuthorize("hasPermission(this.projectproductService.get(#projectproduct_id),'iBizPMS-ProjectProduct-Update')")
    ...
    @PreAuthorize("hasPermission(this.projectproductService.getProjectproductByEntities(this.projectproductMapping.toDomain(#projectproductdtos)),'iBizPMS-ProjectProduct-Update')")
    ...
    @PreAuthorize("hasPermission(this.projectproductService.get(#projectproduct_id),'iBizPMS-ProjectProduct-Remove')")
    ...
    @PreAuthorize("hasPermission(this.projectproductService.getProjectproductByIds(#ids),'iBizPMS-ProjectProduct-Remove')")
    ...
    @PostAuthorize("hasPermission(this.projectproductMapping.toDomain(returnObject.body),'iBizPMS-ProjectProduct-Get')")
    ...
    @PreAuthorize("hasPermission(this.projectproductMapping.toDomain(#projectproductdto),'iBizPMS-ProjectProduct-Save')")
    ...
    @PreAuthorize("hasPermission(this.projectproductMapping.toDomain(#projectproductdtos),'iBizPMS-ProjectProduct-Save')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-ProjectProduct-searchDefault-all') and hasPermission(#context,'iBizPMS-ProjectProduct-Get')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','iBizPMS-ProjectProduct-searchRelationPlan-all') and hasPermission(#context,'iBizPMS-ProjectProduct-Get')")
