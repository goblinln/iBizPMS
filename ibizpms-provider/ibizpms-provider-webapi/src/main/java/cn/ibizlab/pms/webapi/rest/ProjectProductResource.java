...
public class ProjectProductResource {
    ...
    @PreAuthorize("@ProjectProductModelImpl.test(#projectproduct_id,'CREATE')")
    ...
    @PreAuthorize("@ProjectProductModelImpl.test(#projectproduct_id,'UPDATE')")
    ...
    @PreAuthorize("@ProjectProductModelImpl.test(#projectproduct_id,'DELETE')")
    ...
    @PreAuthorize("@ProjectProductModelImpl.test(#projectproduct_id,'READ')")
    ...
    @PreAuthorize("@ProjectProductModelImpl.test('READ')")
