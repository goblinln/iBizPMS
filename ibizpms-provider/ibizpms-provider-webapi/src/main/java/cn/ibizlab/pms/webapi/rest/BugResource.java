...
import cn.ibizlab.pms.core.zentao.model.impl.BugModelImpl;
...
public class BugResource {
    ...
    @Autowired
    public BugModelImpl bugModelImpl;

    @Autowired
    @Lazy
    public BugMapping bugMapping;

    @PreAuthorize("@BugModelImpl.test(#bug_id,'CREATE')")
    ...
    @PreAuthorize("@BugModelImpl.test(#bug_id,'UPDATE')")
    ...
    @PreAuthorize("@BugModelImpl.test(#bug_id,'DELETE')")
    ...
    @PreAuthorize("@BugModelImpl.test(#bug_id,'READ')")
    ...
    @PreAuthorize("@BugModelImpl.test('READ')")
	...
	public ResponseEntity<List<BugDTO>> fetchAssignedToMyBug(BugSearchContext context) {
        bugModelImpl.addAuthorityConditions(context,"READ");
