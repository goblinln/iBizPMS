...
public class TestReportResource {
    ...
    @PreAuthorize("@TestReportRuntime.test(#ids, 'DELETE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#testreport_id, 'READ')")
    ...
    @PreAuthorize("@ProductRuntime.test(#testreport_id, 'TESTREPORTMANAGE')")
    ...
    @PreAuthorize("@ProjectRuntime.test(#testreport_id, 'READ')")
    ...
    @PreAuthorize("@ProjectRuntime.test(#testreport_id, 'UPDATE')")
    ...
    @PreAuthorize("@ProjectRuntime.test(#testreport_id, 'DELETE')")
