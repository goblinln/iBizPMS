...
public class TestReportResource {
    ...
    @PreAuthorize("@TestReportModelImpl.test(#testreport_id,'READ')")
    ...
    @PreAuthorize("@TestReportModelImpl.test(#testreport_id,'CREATE')")
    ...
    @PreAuthorize("@TestReportModelImpl.test(#testreport_id,'UPDATE')")
    ...
    @PreAuthorize("@TestReportModelImpl.test(#testreport_id,'DELETE')")
    ...
    @PreAuthorize("@TestReportModelImpl.test('READ')")
