...
public class IBZProBugHostoryResource {
    ...
    @ApiOperation(value = "根据需求BugBug日志建立Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志建立Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories")
    public ResponseEntity<IBZProBugHostoryDTO> createByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
		ibzprobughostoryService.create(domain);
        IBZProBugHostoryDTO dto = ibzprobughostoryMapping.toDto(domain);
    ...
    @PreAuthorize("@StoryRuntime.test(#story_id,'CREATE')")
    @ApiOperation(value = "根据需求BugBug日志批量建立Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志批量建立Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> createBatchByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
            domain.setAction(ibzprobugaction_id);
        }
    ...
    @ApiOperation(value = "根据需求BugBug日志更新Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志更新Bug操作历史")
	@RequestMapping(method = RequestMethod.PUT, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<IBZProBugHostoryDTO> updateByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
        domain.setId(ibzprobughostory_id);
		ibzprobughostoryService.update(domain);
    ...
    @PreAuthorize("@StoryRuntime.test(#story_id,'UPDATE')")
    @ApiOperation(value = "根据需求BugBug日志批量更新Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志批量更新Bug操作历史")
	@RequestMapping(method = RequestMethod.PUT, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> updateBatchByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
            domain.setAction(ibzprobugaction_id);
        }
    ...
    @ApiOperation(value = "根据需求BugBug日志删除Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志删除Bug操作历史")
	@RequestMapping(method = RequestMethod.DELETE, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<Boolean> removeByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id) {
		return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryService.remove(ibzprobughostory_id));
    }

    @PreAuthorize("@StoryRuntime.test(#story_id,'DELETE')")
    @ApiOperation(value = "根据需求BugBug日志批量删除Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志批量删除Bug操作历史")
	@RequestMapping(method = RequestMethod.DELETE, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> removeBatchByStoryBugIbzProBugAction(@RequestBody List<Long> ids) {
        ibzprobughostoryService.removeBatch(ids);
        return  ResponseEntity.status(HttpStatus.OK).body(true);
    }

    @PreAuthorize("@StoryRuntime.test(#story_id,'READ')")
    @ApiOperation(value = "根据需求BugBug日志获取Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志获取Bug操作历史")
	@RequestMapping(method = RequestMethod.GET, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<IBZProBugHostoryDTO> getByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id) {
        IBZProBugHostory domain = ibzprobughostoryService.get(ibzprobughostory_id);
        IBZProBugHostoryDTO dto = ibzprobughostoryMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据需求BugBug日志获取Bug操作历史草稿", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志获取Bug操作历史草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/getdraft")
    public ResponseEntity<IBZProBugHostoryDTO> getDraftByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, IBZProBugHostoryDTO dto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(dto);
        domain.setAction(ibzprobugaction_id);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryMapping.toDto(ibzprobughostoryService.getDraft(domain)));
    }

    @ApiOperation(value = "根据需求BugBug日志检查Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志检查Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/checkkey")
    public ResponseEntity<Boolean> checkKeyByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        return  ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryService.checkKey(ibzprobughostoryMapping.toDomain(ibzprobughostorydto)));
    }

    @ApiOperation(value = "根据需求BugBug日志保存Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志保存Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/save")
    public ResponseEntity<IBZProBugHostoryDTO> saveByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
        ibzprobughostoryService.save(domain);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryMapping.toDto(domain));
    ...
    @ApiOperation(value = "根据需求BugBug日志批量保存Bug操作历史", tags = {"Bug操作历史" },  notes = "根据需求BugBug日志批量保存Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/savebatch")
    public ResponseEntity<Boolean> saveBatchByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
             domain.setAction(ibzprobugaction_id);
        }
    ...
    @PreAuthorize("@StoryRuntime.test(#story_id,'READ')")
	@ApiOperation(value = "根据需求BugBug日志获取数据集", tags = {"Bug操作历史" } ,notes = "根据需求BugBug日志获取数据集")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/fetchdefault")
	public ResponseEntity<List<IBZProBugHostoryDTO>> fetchIBZProBugHostoryDefaultByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id,@RequestBody IBZProBugHostorySearchContext context) {
        context.setN_action_eq(ibzprobugaction_id);
        Page<IBZProBugHostory> domains = ibzprobughostoryService.searchDefault(context) ;
        List<IBZProBugHostoryDTO> list = ibzprobughostoryMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("@StoryRuntime.test(#story_id,'READ')")
	@ApiOperation(value = "根据需求BugBug日志查询数据集", tags = {"Bug操作历史" } ,notes = "根据需求BugBug日志查询数据集")
    @RequestMapping(method= RequestMethod.POST , value="/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/searchdefault")
	public ResponseEntity<Page<IBZProBugHostoryDTO>> searchIBZProBugHostoryDefaultByStoryBugIbzProBugAction(@PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostorySearchContext context) {
        context.setN_action_eq(ibzprobugaction_id);
        Page<IBZProBugHostory> domains = ibzprobughostoryService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(ibzprobughostoryMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @ApiOperation(value = "根据项目BugBug日志建立Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志建立Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories")
    public ResponseEntity<IBZProBugHostoryDTO> createByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
		ibzprobughostoryService.create(domain);
        IBZProBugHostoryDTO dto = ibzprobughostoryMapping.toDto(domain);
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'CREATE')")
    @ApiOperation(value = "根据项目BugBug日志批量建立Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志批量建立Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> createBatchByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
            domain.setAction(ibzprobugaction_id);
        }
    ...
    @ApiOperation(value = "根据项目BugBug日志更新Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志更新Bug操作历史")
	@RequestMapping(method = RequestMethod.PUT, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<IBZProBugHostoryDTO> updateByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
        domain.setId(ibzprobughostory_id);
		ibzprobughostoryService.update(domain);
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'UPDATE')")
    @ApiOperation(value = "根据项目BugBug日志批量更新Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志批量更新Bug操作历史")
	@RequestMapping(method = RequestMethod.PUT, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> updateBatchByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
            domain.setAction(ibzprobugaction_id);
        }
    ...
    @ApiOperation(value = "根据项目BugBug日志删除Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志删除Bug操作历史")
	@RequestMapping(method = RequestMethod.DELETE, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<Boolean> removeByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id) {
		return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryService.remove(ibzprobughostory_id));
    }

    @PreAuthorize("@ProjectRuntime.test(#project_id,'DELETE')")
    @ApiOperation(value = "根据项目BugBug日志批量删除Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志批量删除Bug操作历史")
	@RequestMapping(method = RequestMethod.DELETE, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> removeBatchByProjectBugIbzProBugAction(@RequestBody List<Long> ids) {
        ibzprobughostoryService.removeBatch(ids);
        return  ResponseEntity.status(HttpStatus.OK).body(true);
    }

    @PreAuthorize("@ProjectRuntime.test(#project_id,'READ')")
    @ApiOperation(value = "根据项目BugBug日志获取Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志获取Bug操作历史")
	@RequestMapping(method = RequestMethod.GET, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<IBZProBugHostoryDTO> getByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id) {
        IBZProBugHostory domain = ibzprobughostoryService.get(ibzprobughostory_id);
        IBZProBugHostoryDTO dto = ibzprobughostoryMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据项目BugBug日志获取Bug操作历史草稿", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志获取Bug操作历史草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/getdraft")
    public ResponseEntity<IBZProBugHostoryDTO> getDraftByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, IBZProBugHostoryDTO dto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(dto);
        domain.setAction(ibzprobugaction_id);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryMapping.toDto(ibzprobughostoryService.getDraft(domain)));
    }

    @ApiOperation(value = "根据项目BugBug日志检查Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志检查Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/checkkey")
    public ResponseEntity<Boolean> checkKeyByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        return  ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryService.checkKey(ibzprobughostoryMapping.toDomain(ibzprobughostorydto)));
    }

    @ApiOperation(value = "根据项目BugBug日志保存Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志保存Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/save")
    public ResponseEntity<IBZProBugHostoryDTO> saveByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
        ibzprobughostoryService.save(domain);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryMapping.toDto(domain));
    ...
    @ApiOperation(value = "根据项目BugBug日志批量保存Bug操作历史", tags = {"Bug操作历史" },  notes = "根据项目BugBug日志批量保存Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/savebatch")
    public ResponseEntity<Boolean> saveBatchByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
             domain.setAction(ibzprobugaction_id);
        }
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'READ')")
	@ApiOperation(value = "根据项目BugBug日志获取数据集", tags = {"Bug操作历史" } ,notes = "根据项目BugBug日志获取数据集")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/fetchdefault")
	public ResponseEntity<List<IBZProBugHostoryDTO>> fetchIBZProBugHostoryDefaultByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id,@RequestBody IBZProBugHostorySearchContext context) {
        context.setN_action_eq(ibzprobugaction_id);
        Page<IBZProBugHostory> domains = ibzprobughostoryService.searchDefault(context) ;
        List<IBZProBugHostoryDTO> list = ibzprobughostoryMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("@ProjectRuntime.test(#project_id,'READ')")
	@ApiOperation(value = "根据项目BugBug日志查询数据集", tags = {"Bug操作历史" } ,notes = "根据项目BugBug日志查询数据集")
    @RequestMapping(method= RequestMethod.POST , value="/projects/{project_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/searchdefault")
	public ResponseEntity<Page<IBZProBugHostoryDTO>> searchIBZProBugHostoryDefaultByProjectBugIbzProBugAction(@PathVariable("project_id") Long project_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostorySearchContext context) {
        context.setN_action_eq(ibzprobugaction_id);
        Page<IBZProBugHostory> domains = ibzprobughostoryService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(ibzprobughostoryMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("@ProductRuntime.test(#product_id,'CREATE')")
    @ApiOperation(value = "根据产品需求BugBug日志建立Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志建立Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories")
    public ResponseEntity<IBZProBugHostoryDTO> createByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
		ibzprobughostoryService.create(domain);
        IBZProBugHostoryDTO dto = ibzprobughostoryMapping.toDto(domain);
    ...
    @PreAuthorize("@ProductRuntime.test(#product_id,'CREATE')")
    @ApiOperation(value = "根据产品需求BugBug日志批量建立Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志批量建立Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> createBatchByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
            domain.setAction(ibzprobugaction_id);
        }
    ...
    @PreAuthorize("@ProductRuntime.test(#product_id,'UPDATE')")
    @ApiOperation(value = "根据产品需求BugBug日志更新Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志更新Bug操作历史")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<IBZProBugHostoryDTO> updateByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
        domain.setId(ibzprobughostory_id);
		ibzprobughostoryService.update(domain);
    ...
    @PreAuthorize("@ProductRuntime.test(#product_id,'UPDATE')")
    @ApiOperation(value = "根据产品需求BugBug日志批量更新Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志批量更新Bug操作历史")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> updateBatchByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
            domain.setAction(ibzprobugaction_id);
        }
    ...
    @PreAuthorize("@ProductRuntime.test(#product_id,'DELETE')")
    @ApiOperation(value = "根据产品需求BugBug日志删除Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志删除Bug操作历史")
	@RequestMapping(method = RequestMethod.DELETE, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<Boolean> removeByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id) {
		return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryService.remove(ibzprobughostory_id));
    }

    @PreAuthorize("@ProductRuntime.test(#product_id,'DELETE')")
    @ApiOperation(value = "根据产品需求BugBug日志批量删除Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志批量删除Bug操作历史")
	@RequestMapping(method = RequestMethod.DELETE, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/batch")
    public ResponseEntity<Boolean> removeBatchByProductStoryBugIbzProBugAction(@RequestBody List<Long> ids) {
        ibzprobughostoryService.removeBatch(ids);
        return  ResponseEntity.status(HttpStatus.OK).body(true);
    }

    @PreAuthorize("@ProductRuntime.test(#product_id,'READ')")
    @ApiOperation(value = "根据产品需求BugBug日志获取Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志获取Bug操作历史")
	@RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/{ibzprobughostory_id}")
    public ResponseEntity<IBZProBugHostoryDTO> getByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @PathVariable("ibzprobughostory_id") Long ibzprobughostory_id) {
        IBZProBugHostory domain = ibzprobughostoryService.get(ibzprobughostory_id);
        IBZProBugHostoryDTO dto = ibzprobughostoryMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据产品需求BugBug日志获取Bug操作历史草稿", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志获取Bug操作历史草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/getdraft")
    public ResponseEntity<IBZProBugHostoryDTO> getDraftByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, IBZProBugHostoryDTO dto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(dto);
        domain.setAction(ibzprobugaction_id);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryMapping.toDto(ibzprobughostoryService.getDraft(domain)));
    }

    @ApiOperation(value = "根据产品需求BugBug日志检查Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志检查Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/checkkey")
    public ResponseEntity<Boolean> checkKeyByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        return  ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryService.checkKey(ibzprobughostoryMapping.toDomain(ibzprobughostorydto)));
    }

    @ApiOperation(value = "根据产品需求BugBug日志保存Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志保存Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/save")
    public ResponseEntity<IBZProBugHostoryDTO> saveByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostoryDTO ibzprobughostorydto) {
        IBZProBugHostory domain = ibzprobughostoryMapping.toDomain(ibzprobughostorydto);
        domain.setAction(ibzprobugaction_id);
        ibzprobughostoryService.save(domain);
        return ResponseEntity.status(HttpStatus.OK).body(ibzprobughostoryMapping.toDto(domain));
    ...
    @ApiOperation(value = "根据产品需求BugBug日志批量保存Bug操作历史", tags = {"Bug操作历史" },  notes = "根据产品需求BugBug日志批量保存Bug操作历史")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/savebatch")
    public ResponseEntity<Boolean> saveBatchByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody List<IBZProBugHostoryDTO> ibzprobughostorydtos) {
        List<IBZProBugHostory> domainlist=ibzprobughostoryMapping.toDomain(ibzprobughostorydtos);
        for(IBZProBugHostory domain:domainlist){
             domain.setAction(ibzprobugaction_id);
        }
    ...
    @PreAuthorize("@ProductRuntime.test(#product_id,'READ')")
	@ApiOperation(value = "根据产品需求BugBug日志获取数据集", tags = {"Bug操作历史" } ,notes = "根据产品需求BugBug日志获取数据集")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/fetchdefault")
	public ResponseEntity<List<IBZProBugHostoryDTO>> fetchIBZProBugHostoryDefaultByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id,@RequestBody IBZProBugHostorySearchContext context) {
        context.setN_action_eq(ibzprobugaction_id);
        Page<IBZProBugHostory> domains = ibzprobughostoryService.searchDefault(context) ;
        List<IBZProBugHostoryDTO> list = ibzprobughostoryMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("@ProductRuntime.test(#product_id,'READ')")
	@ApiOperation(value = "根据产品需求BugBug日志查询数据集", tags = {"Bug操作历史" } ,notes = "根据产品需求BugBug日志查询数据集")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/stories/{story_id}/bugs/{bug_id}/ibzprobugactions/{ibzprobugaction_id}/ibzprobughostories/searchdefault")
	public ResponseEntity<Page<IBZProBugHostoryDTO>> searchIBZProBugHostoryDefaultByProductStoryBugIbzProBugAction(@PathVariable("product_id") Long product_id, @PathVariable("story_id") Long story_id, @PathVariable("bug_id") Long bug_id, @PathVariable("ibzprobugaction_id") Long ibzprobugaction_id, @RequestBody IBZProBugHostorySearchContext context) {
        context.setN_action_eq(ibzprobugaction_id);
        Page<IBZProBugHostory> domains = ibzprobughostoryService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(ibzprobughostoryMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
