...
public class StoryResource {
    ...
    @PreAuthorize("@StoryRuntime.quickTest('NONE')")
    ...
    @VersionCheck(entity = "story" , versionfield = "lastediteddate")
    @PreAuthorize("@ProductRuntime.test(#story_id, 'UPDATE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#story_id, 'DELETE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#story_id, 'READ')")
    ...
    @PreAuthorize("@ProductRuntime.test(#story_id, 'MANAGE')")
    ...
    @PreAuthorize("@ProductRuntime.test(#story_id, 'CREATE')")
