...
public class StoryResource {
    ...
    @PreAuthorize("@StoryModelImpl.test(#story_id,'CREATE')")
    ...
    @PreAuthorize("@StoryModelImpl.test(#story_id,'UPDATE')")
    ...
    @PreAuthorize("@StoryModelImpl.test(#story_id,'DELETE')")
    ...
    @PreAuthorize("@StoryModelImpl.test(#story_id,'READ')")
